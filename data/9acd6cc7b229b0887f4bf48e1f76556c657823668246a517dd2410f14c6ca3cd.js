...
st.getEmbeds = function (next) {
  var selectors = ['.embed-twitter', '.embedly-card', '.fb-post', '.fb-video', '.instagram-media', '.reddit', '.reddit-card', '.rm-shortcode', '.spotify', '.tumblr-embed', '.twitter-embed', '.twitter-follow', '.twitter-tweet', '.twitter-video', '.twitter-widget', 'embed', 'iframe', '[class^="PIN"]'];
  var config = [{
    type: "audio",
    url: "anchor.fm"
  }, {
  ...
  var sources = ['cite', 'data-click-to-open-target', 'data-href', 'data-instgrm-permalink', 'data-lazy-src', 'data-permalink', 'data-pin-href', 'data-src', 'data-src-2x', 'href', 'src'];
        ...
        try {
          const tcfapi_callback = data => {
            if (data && data.tcString) {
              var gdpr_domain = data.isServiceSpecific ? document.location.hostname : ".sharethis.com";
              __stdos__.data.setConsent({
...
__stdos__.logger = {
  ...
  log: function (a, h, j) {
    ...
    __stdos__.data.getEUConsent(function (consent) {
      ...
      var g = [h, a, "?event=" + a, "&" + __stdos__.logger.constructParamString(), "&version=" + __stdos__.logger.version, "&lang=" + __stdos__.logger.lang].join('');
              ...
              try {
                ...
                if (typeof res !== "undefined") {
                  ...
                  if (res.status === "true") {
                    ...
                    if (product === "ecommerce" || product === "privy-share-buttons" || product === "ga") {
                      return;
                    }
...
(function () {
  window.__sharethis__.md5 = "10f41be9c6cffb320cf01830b45fceb6";
})();
