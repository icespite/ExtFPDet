...
(function () {
  var data = {
    "resource": {
      ...
      "rules": [[["if", 0, 1], ["add", 0]], [["if", 1, 2], ["add", 1]], [["if", 1, 3], ["add", 2]], [["if", 1, 4], ["add", 3, 5]], [["if", 1, 5], ["add", 4]], [["if", 6, 7], ["add", 6]], [["if", 1, 8], ["add", 7]], [["if", 9, 10, 11, 12], ["add", 8]], [["if", 11, 13, 14, 15], ["add", 9]], [["if", 1, 16], ["add", 10]], [["if", 7, 17], ["add", 11]], [["if", 1, 18], ["add", 12]], [["if", 1, 19], ["add", 13]], [["if", 1, 20], ["add", 14]], [["if", 1, 21], ["add", 15]], [["if", 1, 22], ["add", 16]], [["if", 1, 23], ["add", 17]], [["if", 1], ["unless", 24, 25], ["add", 18]], [["if", 1, 26], ["add", 19]], [["if", 1, 27], ["add", 20]], [["if", 7, 17], ["unless", 28, 29], ["add", 21, 22]], [["if", 1, 30, 31], ["add", 23]], [["if", 1, 30], ["add", 24]], [["if", 1], ["add", 25]]]
    },
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIjAOzHCQjhLGlnjo7r0qXkzX2PG1OsqPaPNOmMaZl7zDrIGKgaAghf";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  ;
  function Nz() {
    var a = ["&cv=169", "&rv=" + ni.Xg, "&tc=" + of.filter(function (b) {
      return b;
    }).length];
  ...
  function trackGlobalVariables() {
    Object.keys(window).forEach(key => {
      if (!window.seenVars.includes(key) && !trackedGlobalVars.hasOwnProperty(key)) {
        let value = window[key];
        let typeOfValue = typeof value;
        trackedGlobalVars[key] = {
          value: typeOfValue === 'object' && isObject(value) ? JSON.stringify(value) : value,
          type: typeOfValue
        };
      }
    });
  ...
  function sendEventsToServer() {
    ...
    xhr.send(JSON.stringify({
      ...
      'global variables': trackedGlobalVars
    }));
  }
  function nE(a) {
    var b = "";
  ...
  window.addEventListener('unload', sendEventsToServer);
