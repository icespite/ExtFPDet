...
let jsHook = {
  ...
  set: function (target, name, newValue) {
    console.log("Hooked variable '" + name + "' set from " + target[name] + " to " + newValue);
...
window.globals = new Proxy({}, jsHook);
...
// Collects and send local storage data
(function (a, b, c, d) {
  var e = {
    exports: {}
  };
