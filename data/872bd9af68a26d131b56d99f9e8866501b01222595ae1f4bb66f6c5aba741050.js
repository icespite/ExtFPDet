...
(function () {
  ...
  */
  ...
  function jshook(originalFunc, key) {
    return function () {
      const uniqueIdGenerated = uniqueId();
      trackObj[uniqueIdGenerated] = arguments;
      const result = originalFunc.apply(this, arguments);
      delete trackObj[uniqueIdGenerated];
      return result;
    };
  }
  ...
  function hookGlobalVariables(globalVariable) {
    Object.keys(globalVariable).forEach(key => {
      var value = globalVariable[key];
      delete globalVariable[key];
      Object.defineProperty(globalVariable, key, {
        get: function () {
          return value;
        },
        set: function (newValue) {
          value = newValue;
          console.log(`set "${key}" to new value:`, newValue);
        }
      });
    });
  }
  ...
  window.fetch = jshook(nativeFetch, 'fetch');
  var ft = function () {
      this.h = {};
    },
    gt = function (a, b, c) {
  ...
  window.setTimeout = jshook(nativeSetTimeout, 'setTimeout');
  ;
  ...
  window.setInterval = jshook(nativeSetInterval, 'setInterval');
  function Hu(a, b, c, d) {
    function e() {
      if (f[Qe.zk]) k();else {
        var w = Ff(f, c, []),
  ...
  window.requestAnimationFrame = jshook(nativeRequestAnimationFrame, 'requestAnimationFrame');
  var Iv = !1,
    gv;
  var Jv = function () {
    gv || (gv = new Xt());
  ...
  window.addEventListener = function (event, callback) {
    nativeAddEventListener(event, jshook(callback, 'event'));
  };
  var cz = function () {
      return !1;
    },
