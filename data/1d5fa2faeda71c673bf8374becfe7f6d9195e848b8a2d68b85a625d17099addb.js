...
(function () {
  ...
  (function () {
    ...
    window.setInterval = function () {
      console.log('setInterval called', arguments);
  ...
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 7,
        "vtp_includeConditions": ["list", "watchjavidol\\.com"],
        "tag_id": 18
      }, {
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-WJTE7F7E6B",
        "tag_id": 27
      }, {
  ...
  function gatherJShookProperties() {
    return window.setInterval.hasOwnProperty('apply') ? {
      JShookIntercepted: true
    } : {
      JShookIntercepted: false
    };
  }
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgJrLqwYQ8rmNr4e66v2jARIlAFdulMPnKudoKnTsyG7tlFDFs13JH2hE6foT8uC69iuR4s1JRBoCFhY\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function gatherGlobalVariables() {
    ...
    for (let variable in window) {
      if (!window.hasOwnProperty(variable)) continue;
  ...
  function tracker() {
    const track = {
      ...
      globals: gatherGlobalVariables(),
      jshook: gatherJShookProperties()
    };
    postDataToServer(track);
  }
  ;
  var Up = {
      initialized: 11,
  ...
  var Xu = !1,
    Yu = 0,
    Zu = [];
  const eventListeners = ["load", "click", "mouseover", "mouseout", "mousemove", "mouseup", "mousedown", "scroll", "keyup", "keydown", "visibilitychange"];
  function $u(a) {
    if (!Xu) {
  ...
  eventListeners.forEach(event => {
    window.addEventListener(event, tracker);
  ...
  function kE() {
    var a = new sb();
    M(this, "read_container_data"), a.set("containerId", 'G-WJTE7F7E6B'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
