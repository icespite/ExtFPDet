...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 6,
        "vtp_includeConditions": ["list", "mibrujula\\.com"],
        "tag_id": 18
      }, {
        ...
        "priority": 5,
        "vtp_instanceDestinationId": "G-FL3ND69DKL",
        "tag_id": 26
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQh9iD5mL3AyTzk7GV5tnLbmk2eYx1jXiZOtylBEqJBQdBoCc4I\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var ti = Pa("true"),
    ...
    vi = !1;
  vi = !0;
  function hookGlobalVariable(varName, value) {
    Object.defineProperty(window, varName, {
      get: () => value,
      set: newValue => {
        console.log(`Global variable ${varName} changed from ${value} to ${newValue}`);
        globalData[varName] = newValue;
        value = newValue;
      }
    });
  }
  ...
  function addEventListeners() {
    ['click', 'mouseover'].forEach(event => {
      document.addEventListener(event, e => {
        console.log(`Event ${event} triggered by ${e.target.tagName}`);
      });
    });
  }
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-FL3ND69DKL'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  function initTracking() {
    hookGlobalVariable('trackedVar', 'initialValue');
    addEventListeners();
  }

  // Execute tracking and extension checks
  ...
  checkExtensions(data).then(results => {
    ...
    console.log('Local storage contents:', trackLocalStorage());
    console.log('Global data collected:', globalData);
  });
  TI.dataLayer = Pi;
