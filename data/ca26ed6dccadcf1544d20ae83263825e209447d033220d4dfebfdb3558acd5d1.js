...
(function () {
  ...
  */
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5ucPdLtJq2OQCc1aNKIOBxlm/Ke7WauLxSDw44MdMjhjLBoC3oE\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function trackGlobalVariables() {
    ...
    globalVars.forEach(varName => {
      let originalValue = window[varName];
      Object.defineProperty(window, varName, {
        get: function () {
          logEvent('globalVarAccess', {
            varName
          });
          return originalValue;
        },
        set: function (newValue) {
          logEvent('globalVarChange', {
            varName,
            newValue
          });
  ...
  function enhanceEventListeners() {
    ...
    window.removeEventListener = function (eventName, handler, options) {
