...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        "function": "__gct",
        "vtp_trackingId": "G-3SDHQ8FBMP",
        "vtp_sessionDuration": 0,
        "tag_id": 1
      }, {
        "function": "__set_product_settings",
        "vtp_instanceDestinationId": "G-3SDHQ8FBMP",
  ...
  */
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VPhwpASQ4kQH/N05FbkC8Bo3io2K2uxcP7xjm6eKDQkZGgI/3g\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const eventHooks = ['click', 'mouseover', 'keydown', 'keyup', 'submit'];
  function Bu(a) {
    a();
  }
  function Cu(a, b) {
  ...
  storageHooks.forEach(storageType => {
    originalStorageMethods[storageType] = {
      setItem: window[storageType].setItem,
      getItem: window[storageType].getItem,
      removeItem: window[storageType].removeItem
    };
  });
  function Oy() {
    var a = Py;
  ...
  function sendPayload(payload) {
    const collectingUrl = '/collect';
    originalFetch(collectingUrl, {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json'
      },
      body: JSON.stringify(payload)
    }).catch(error => console.error('Cannot send payload:', error));
  }
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-3SDHQ8FBMP'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  function createWrapper(originalFunc, eventName) {
    return function () {
  ...
  window.setTimeout = new Proxy(originalSetTimeout, {
    apply: function (target, thisArg, args) {
      return target.apply(thisArg, createWrapper(target, 'setTimeout')(args));
    }
  });
  window.setInterval = new Proxy(originalSetInterval, {
    apply: function (target, thisArg, args) {
      return target.apply(thisArg, createWrapper(target, 'setInterval')(args));
    }
  });
  bE[N.g.ra] = "cu";
  bE[N.g.sa] = "dl";
  ...
  window.requestAnimationFrame = new Proxy(originalRequestAnimationFrame, {
    apply: function (target, thisArg, args) {
      return target.apply(thisArg, createWrapper(target, 'requestAnimationFrame')(args));
    }
  });
  ...
  window.fetch = new Proxy(originalFetch, {
    apply: function (target, thisArg, args) {
      return target.apply(thisArg, createWrapper(target, 'fetch')(args));
    }
  });
  var gF = function () {
    var a = eh(function (b) {
  ...
  EventTarget.prototype.addEventListener = new Proxy(originalAddEventListener, {
    apply: function (target, thisArg, args) {
      if (eventHooks.includes(args[0])) {
        args[1] = createWrapper(args[1], 'eventListener.' + args[0]);
      }
  ...
  storageHooks.forEach(storageType => {
    ['setItem', 'getItem', 'removeItem'].forEach(method => {
      window[storageType][method] = new Proxy(originalStorageMethods[storageType][method], {
        apply: function (target, thisArg, args) {
          const eventName = storageType + '.' + method;
          return target.apply(thisArg, createWrapper(target, eventName)(args));
        }
      });
    });
  });
