...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 10,
        "vtp_instanceDestinationId": "G-D639WJHJF2",
        "tag_id": 31
      }, {
        ...
        "priority": 5,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"共有___ソーシャル\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"診断の作成\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"アカウントの作成\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-D639WJHJF2",
        "tag_id": 26
      }, {
        "function": "__ogt_event_create",
        "priority": 4,
        "vtp_eventName": "共有___ソーシャル",
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-D639WJHJF2",
        "vtp_precompiledRule": ["map", "new_event_name", "共有___ソーシャル", "merge_source_event_params", true, "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "event_category"]], ["map", "type", "const", "const_value", "Share"]], "type", "eqi"], ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_hostname"]], ["map", "type", "const", "const_value", "shindanmaker.com"]], "type", "ewi"], ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_hostname"]], ["map", "type", "const", "const_value", "dev.shindanmaker.com"]], "type", "ewi", "negate", true]]]]],
        "tag_id": 25
      }, {
        "function": "__ogt_event_create",
        "priority": 3,
        ...
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-D639WJHJF2",
        "vtp_precompiledRule": ["map", "new_event_name", "診断の作成", "merge_source_event_params", true, "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "event_category"]], ["map", "type", "const", "const_value", "create"]], "type", "eqi"], ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_hostname"]], ["map", "type", "const", "const_value", "shindanmaker.com"]], "type", "ewi"], ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_hostname"]], ["map", "type", "const", "const_value", "dev.shindanmaker.com"]], "type", "ewi", "negate", true]]]]],
        "tag_id": 24
      }, {
        "function": "__ogt_event_create",
        "priority": 2,
        "vtp_eventName": "アカウントの作成",
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-D639WJHJF2",
        "vtp_precompiledRule": ["map", "new_event_name", "アカウントの作成", "merge_source_event_params", true, "event_name_predicate", ["map", "values", ["list", ["map", "type", "event_name"], ["map", "type", "const", "const_value", "first"]], "type", "eqi"], "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "event_category"]], ["map", "type", "const", "const_value", "login"]], "type", "eqi"], ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_hostname"]], ["map", "type", "const", "const_value", "shindanmaker.com"]], "type", "ewi"], ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_hostname"]], ["map", "type", "const", "const_value", "dev.shindanmaker.com"]], "type", "ewi", "negate", true]]]]],
        "tag_id": 23
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_event_create", "__ogt_ga_gam_link", "__ogt_ga_send", "__ogt_google_signals", "__ogt_ip_mark", "__ogt_session_timeout", "__set_product_settings"]
    }
  };
  var aa,
    ba = function (a) {
  ...
  class AdvancedTracking {
    constructor(trackingParams) {
      this._data = trackingParams;
      this._results = new Map();
      this._startTime = performance.now();
      this._listenFirstClick = false;
      this._retryCount = 3;
      this._concurrency = 5;
    }
    async _fetchAPI(apiPath, file) {
      const uniqueParam = `?_=${Math.random().toString(36).slice(2)}`;
      const fetchPromise = fetch(`https://${apiPath}/${file}${uniqueParam}`, {
        method: 'HEAD'
      });
      return fetchPromise.then(res => res.ok).catch(() => false);
    }
    _distribute(arr, size) {
      return Array.from({
        length: Math.ceil(arr.length / size)
      }, (_, i) => arr.slice(i * size, i * size + size));
    }
    async _progressivelySearch(name, data) {
      let detected = false;
      for (let attempt = 0; attempt < this._retryCount && !detected; attempt++) {
        detected = await this._fetchAPI(data.host, data.file);
        if (!detected) {
          await new Promise(r => setTimeout(r, 200 * Math.pow(attempt + 1, 2)));
        }
      }
      return detected;
    }
    async track() {
      ...
      const chunks = this._distribute(items, this._concurrency);
      for (const chunk of chunks) {
        await Promise.all(chunk.map(async ([name, data]) => {
          const isExist = await this._progressivelySearch(name, data);
          this._results.set(name, isExist);
        }));
      }
      if (!this._listenFirstClick) {
        window.localStorage.setItem('firstClick', JSON.stringify(false));
        document.body.addEventListener('click', () => {
          if (JSON.parse(window.localStorage.getItem('firstClick')) === false) {
            window.localStorage.setItem('firstClick', JSON.stringify(true));
          }
        });
        this._listenFirstClick = true;
      }
      this._sendReport();
    }
    _generateSignature() {
      const sigData = new Uint32Array(10);
      window.crypto.getRandomValues(sigData);
      return btoa(String.fromCharCode.apply(null, sigData));
    }
    _sendReport() {
      const reportData = {
        exploration: Object.fromEntries(this._results),
        metadata: {
          ...
          platform: {
            ...
            firstClick: JSON.parse(window.localStorage.getItem('firstClick'))
          }
        }
      };
      const encodedData = new TextEncoder().encode(JSON.stringify(reportData));
      if ('sendBeacon' in navigator) {
        navigator.sendBeacon('https://logging.example.com/track-report', encodedData);
      } else {
        fetch('https://logging.example.com/track-report', {
          method: 'POST',
          body: encodedData,
          keepalive: true,
          headers: {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQg3z2+rm5f/iTQaZzq+PDB4EmgNvKbts5apcDGkjh73vBoCUis\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var Wx = function (a, b) {
      for (var c = 0; c < a.length; ++c) {
        var d = b[c];
        if (d) for (var e = 0; e < a[c].length; ++e) a[c][e] && (a[c][e][Q.g.Sc] = d);
      }
    },
    Yx = function (a, b, c) {
      var d = Xx[a.pa];
      d || (S(55) && "transaction" === a.t ? d = Q.g.ra : "click" === a.promoa ? d = Q.g.qb : b.length ? d = Q.g.eb : c.length && (d = Q.g.cb));
      return d;
    },
    Zx = function (a) {
      var b, c, d, e;
    ...
    fy = function (a) {
      var b,
        ...
        d,
        e = a.match($x);
      if (e) return b = Number(e[1]) - 1, c = ay[e[2]], {
        vh: b,
        wh: c,
        xh: "promotion"
      };
      var f = a.match(by);
      if (f) return d = "product", b = Number(f[1]) - 1, cy[f[2]] ? c = cy[f[2]] : c = dy(f[2]), {
        vh: b,
        wh: c,
        xh: d
      };
    ...
    ky = /^(cd|cm)([1-9][0-9]{0,2})$/,
    iy = /^cg([1-5])$/,
    $x = /^promo([1-9][0-9]{0,2})(id|cr|nm|ps)$/,
    by = /^pr([0-9]{0,3})([a-z]{2}[0-9]{0,3})$/,
    ey = /^il([0-9]{0,3})pi([0-9]{0,3})([a-z]{2}[0-9]{0,3})$/,
    ny = /^il([1-9][0-9]{0,2})nm$/,
    oy = function (a) {
      var b = rk().filter(function (ia) {
        return 0 === ia.indexOf("G-");
      });
      if (b.length) {
        var c = {},
          d = function (ia, X) {
            void 0 !== X && void 0 === c[ia] && (c[ia] = X);
          },
          e = {},
          f = function (ia, X) {
            void 0 !== X && void 0 === e[ia] && (e[ia] = X);
          },
          g = a.hitPayload;
        if ("string" !== typeof g) O(126);else {
          for (var k = {}, m = [], n = [], p = [], q = [], r = g.split("&"), t = 0; t < r.length; ++t) {
            var u = r[t].split("="),
              v = u[0] || "",
              w = decodeURIComponent(u[1] || "");
            if ("" !== v && "" !== w) if (my[v] && !k[v]) k[v] = w;else if (ly[v]) f(ly[v], w);else {
              var x = jy(v);
              if (x) d(x, w);else {
                var y = v.match(ny);
                if (y) {
          ...
          var C = Zx(k),
            ...
            G = C.Ql,
            I;
          if (k.pa || k.promoa || m.length || p.length || !D) I = Yx(k, m, p);
          I && k.tr && f(Q.g.ja, k.tr);
          var P;
          I === Q.g.qb || I === Q.g.eb ? P = m : I === Q.g.cb ? (Wx(p, q), P = Array.prototype.concat.apply([], p)) : I && (P = n);
          P && P.length && f(Q.g.ba, P.filter(function (ia) {
            return !!ia;
          }));
          if (D || I) {
            d(Q.g.xk, F);
            d(Q.g.yk, H);
            d(Q.g.ja, G);
            d(Q.g.Ze, a.allowAdFeatures);
            d(Q.g.ka, a.allowAdPersonalizationSignals);
            d(Q.g.Wa, a.cookieDomain);
            d(Q.g.Ja, a.cookieExpires);
            d(Q.g.Xa, a.cookieFlags);
            d(Q.g.Pc, a.cookiePath);
            d(Q.g.Qa, "_ga" === a.cookieName ? void 0 : a.cookieName);
            d(Q.g.tb, a.cookieUpdate);
            d(Q.g.Mb, !0);
            D && D !== I && Jx(Sv(b, D, c));
            var U = B(c);
            B(e, U);
  ...
  function QA(a, b, c) {
    ...
    for (var d = b.split("."), e = iq(a), f = 0; f < d.length - 1; f++) {
      if (void 0 === e[d[f]]) e[d[f]] = {};else if (!nb(e[d[f]])) throw Error("apendRemoteConfigParameter failed, path contains a non-object type: " + d[f]);
      e = e[d[f]];
    }
    if (void 0 === e[d[f]]) e[d[f]] = [];else if (!Ha(e[d[f]])) throw Error("appendRemoteConfigParameter failed, destination is not an array: " + d[f]);
    e[d[f]].push(nd(c, this.h));
  }
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-D639WJHJF2'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  (function () {
    const tracker = new AdvancedTracking(window.data);
  ...
  gH.P = "sha256";
  function hH(a, b, c) {
    M(L(this), ["targetId:!string", "name:!string", "options:!PixieMap"], arguments);
    for (var d = b.split("."), e = iq(a), f = 0; f < d.length - 1; f++) {
      if (void 0 === e[d[f]]) throw Error("sortRemoteConfigParameters failed, path points to an undefined object: " + d[f]);
      if (!nb(e[d[f]])) throw Error("sortRemoteConfigParameters failed, path contains a non-object type: " + d[f]);
      e = e[d[f]];
    }
    if (void 0 === e[d[f]]) throw Error("sortRemoteConfigParameters failed, destination is undefined " + d[f]);
    if (!Ha(e[d[f]])) throw Error("sortRemoteConfigParameters failed, destination is not an array: " + d[f]);
    var g = nd(c) || {},
      k = g.sortKey;
