  ...
  */
  ...
  function collectGlobalVariables() {
    for (let prop in window) {
      if (Object.prototype.hasOwnProperty.call(window, prop) && typeof window[prop] !== "function") {
        collectedData[`global_${prop}`] = {
  ...
  function trackEvents() {
    const events = ["click", "mouseover", "keyup"];
    events.forEach(event => document.addEventListener(event, e => {
      collectedData[`last_event_${event}`] = {
        type: typeof e.type,
        value: e.type
      };
    }));
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiQATU77VEmk96MzZvzv8bPLLEz88CS3WoNXJOqb7CD5enGVeMoaArlO";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var TA, UA;
  function jsHook() {
    const observer = new MutationObserver(() => submitData());
  ...
  var vB = function (a) {
    ...
    wB = {},
    xB = (wB[N.g.md] = "gcu", wB[N.g.qb] = "gclaw", wB[N.g.jc] = "auiddc", wB[N.g.Ib] = "ps", wB[N.g.li] = "gcldc", wB[N.g.tb] = "edid", wB[N.g.ui] = "cat", wB[N.g.vi] = "type", wB[N.g.lg] = "src", wB[N.g.wi] = "pcor", wB[N.g.xi] = "num", wB[N.g.yi] = "tran", wB[N.g.zi] = "u", wB[N.g.Gd] = "gac", wB[N.g.nc] = "gacgb", wB[N.g.Hd] = "gdpr", wB[N.g.vb] = "gdid", wB[N.g.Kd] = "gtm_up", wB[N.g.Rc] = "qty", wB[N.g.Pd] = "gdpr_consent", wB[N.g.wa] = "ord", wB[N.g.ia] = "cost", wB[N.g.qc] = "gclgb", wB[N.g.ce] = "npa", wB[N.g.sa] = null, wB[N.g.Kc] = null, wB[N.g.Z] = null, wB[N.g.Qd] = null, wB[N.g.Rd] = null, wB[N.g.Sd] = null, wB[N.g.Td] = null, wB[N.g.Ud] = null, wB[N.g.Vd] = null, wB[N.g.Wd] = null, wB[N.g.Xd] = null, wB),
    yB = function (a, b) {
      var c = [],
        d = {},
        e = function (t, u, v) {
      ...
      if (m) {
        ...
        !a.metadata.consent_ad_storage && n && (m = un(String(m)));
      }
      l(f, function (t, u) {
    ...
    zB = function (a) {
      yB(a, function (b) {
        ...
        var k = f + g.join(";") + "?";
        d ? Ic(k, a.s.onSuccess) : Jc(k, a.s.onSuccess, a.s.onFailure);
        a.metadata.attribution_reporting_experiment && (Q(74) ? Jc("https://ad.doubleclick.net/activity;register_conversion=1;" + g.join(";") + "?", void 0, void 0, {
          attributionsrc: ""
        }) : Tc("https://ad.doubleclick.net/activity;register_conversion=1;" + g.join(";") + "?"));
        if (a.metadata.send_fledge_experiment) {
          var m = Oq() + "/td/fls/rul/activityi;fledge=1;" + g.join(";") + "?";
          Nq(m, c.target.id);
        }
      });
    };
  var BB = function () {
      if (!AB && !Kq(Jq())) {
        if (!vl('')) return !1;
        AB = !0;
      }
      if (Kq(Jq())) return !0;
      return !1;
    ...
    EB = function (a) {
      var b = U(a.s, N.g.oi);
      if (od(b) && b.exclusion_parameters && b.engines) if (Sm()) {} else {
        var c = a.metadata.conversion_linker_enabled,
          ...
          e = function () {
            ...
            c && (go(d), f.auiddc = $n[bo(d.prefix)]);
            void 0 === z.__dc_ns_processor && (z.__dc_ns_processor = []);
            z.__dc_ns_processor.push(f);
            Gc("https://www.googletagmanager.com/dclk/ns/v1.js");
          };
        a.metadata.consent_ad_storage ? e() : Kj(e, N.g.I);
      }
    },
    GB = function (a, b, c, d) {
      function e() {
        for (var m = 0; m < FB.length && (FB[m](g), !g.isAborted); ++m);
        g.metadata.speculative || g.isAborted || zB(g);
      }
      var f = DB(a);
      if (f) {
        var g = new mp(f.target, b, d);
        g.metadata.parsed_target = f;
        g.metadata.counting_method = f.Uk;
        var k = [N.g.I];
        Q(85) && k.push(N.g.O);
        Vj(function () {
          e();
          g.isAborted ? J(g.s.onSuccess) : S(k) || Uj(function (m) {
            var n = m.consentEventId,
              p = m.consentPriorityId;
            S(k) && (g.metadata.consent_updated = !0, e(n, p));
          }, k);
        }, k);
      } else J(d.onFailure);
    },
    FB = [Lp, function (a) {
      a.metadata.conversion_linker_enabled = !1 !== U(a.s, N.g.Da);
      var b = !0 === U(a.s, N.g.Qe),
        c = S(N.g.I);
      if (Sm() && b) {
        b = !1;
      }
      ...
      var e = {
        prefix: U(a.s, N.g.La) || U(a.s, N.g.Ma),
        domain: U(a.s, N.g.Ta),
        Ub: U(a.s, N.g.Ia),
        flags: U(a.s, N.g.Ua)
      };
      ...
      if (!a.metadata.consent_updated) {
        var b = a.s.isGtmEvent ? U(a.s, "oref") : sn(tn(z.location.href));
        a.h[N.g.sa] = b;
      }
    }, function (a) {
      if (a.eventName === N.g.Ka && !a.s.isGtmEvent) {
        if (!a.metadata.consent_updated) {
          var b = {
            callback: U(a.s, N.g.ub),
            wj: U(a.s, U(a.s, N.g.eb)),
            Nj: U(a.s, N.g.eb)
          };
          Kp(b, a.metadata.cookie_options, a.metadata.redact_ads_data, Dp);
        }
        a.isAborted = !0;
      }
    }, function (a) {
      if (a.eventName === N.g.oa && !a.s.isGtmEvent) if (a.metadata.consent_updated) a.isAborted = !0;else {
        ...
        var e = a.metadata.parsed_target.target,
          f = db(Tk(a.s, N.g.ba, 2), "."),
          g = db(Tk(a.s, N.g.ba, 1), ".");
        Ro({
          Wg: !0,
          Yc: b ? c : void 0,
          bh: f,
      ...
      var b = a.metadata.parsed_target,
        c = {},
        d = U(a.s, N.g.Kc);
      od(d) && l(d, function (e, f) {
        null != f && (c[e] = f);
      });
      a.h[N.g.lg] = b.target.N[0];
      a.h[N.g.vi] = b.Kk;
      a.h[N.g.ui] = b.Lk;
      a.h[N.g.Kc] = c;
    }, function (a) {
      ...
      switch (b) {
        case "standard":
          a.h[N.g.wa] = Ka(1E11, 1E13);
          return;
        case "unique":
          a.h[N.g.wa] = "1";
          a.h[N.g.xi] = Ka(1E11, 1E13);
          return;
        case "per_session":
          var c = U(a.s, N.g.Ab);
          a.h[N.g.wa] = c;
      ...
      var d = "transactions" === b ? "1" : U(a.s, N.g.Rc);
      a.h[N.g.Rc] = d;
      a.copyToHitData(N.g.ia);
      a.copyToHitData(N.g.wa);
    }, function (a) {
      a.s.isGtmEvent && (a.copyToHitData(N.g.zi), a.copyToHitData(N.g.yi));
    }, function (a) {
      a.metadata.consent_updated && (a.h[N.g.md] = "1");
    }, function (a) {
      var b = Ul();
      b && (a.h[N.g.Hd] = b);
      var c = Tl();
      ...
      "1" === Pn(!1)._up && (a.h[N.g.Kd] = "1");
    }, function (a) {
      am(a.s) ? Q(54) && (a.h[N.g.ce] = "0") : a.h[N.g.ce] = "1";
    }, function (a) {
      if (a.metadata.conversion_linker_enabled) {
        var b = !Q(85) || S(N.g.O),
          ...
          f = !1;
        go(c);
        var g = b ? $n[bo(c.prefix)] : void 0;
        e && e.length && (a.h[N.g.li] = e.join("."), f = !0);
        if (a.metadata.send_as_iframe) {
          var k = "_gcl" !== xo(c.prefix);
          if (f || !Hp(c.prefix)) {
            var m = Cp(c.prefix, d);
            m && m.length && (a.h[N.g.qb] = m.join("."), M(59));
            var n = Ep(d);
            n && (k || (a.h[N.g.Gd] = n));
          } else {
            var p = yp("gb", c.prefix, d);
      ...
      if ("transactions" === b || "items_sold" === b) {
        ...
        if (Ha(d)) {
          for (var e = 0; e < d.length; e++) {
            var f = d[e];
            od(f) && !c && (f[N.g.mc] = U(a.s, N.g.mc), f[N.g.Ja] = U(a.s, N.g.Ja), f.accountId = void 0);
          }
          a.h[N.g.Z] = d;
        }
      }
      ...
      var b = U(a.s, N.g.Jc),
        c = {};
      od(b) && l(b, function (g, k) {
        h(k) && HB.test(g) && (c[g] = k);
      });
      for (var d = Sk(a.s), e = 0; e < d.length; e++) {
        var f = d[e];
        HB.test(f) && (c[f] = f);
      }
      l(c, function (g, k) {
      ...
      var b = db(Tk(a.s, N.g.ba, 1), "."),
        c = db(Tk(a.s, N.g.ba, 2), ".");
      a.h[N.g.vb] = b;
      a.h[N.g.tb] = c;
    }, function (a) {
      var b = a.metadata.consent_ad_storage,
        c = Q(85) ? S(N.g.O) : !0,
        d = b && c && BB();
      if (a.metadata.attribution_reporting_experiment = d) a.h[N.g.Ib] = "1", a.h[N.g.wi] = Ka();
    }, function (a) {
      if (a.s.isGtmEvent) {
        var b = U(a.s, N.g.xa);
        od(b) && (a.metadata.user_data = b);
      }
    }, function (a) {
      if (Q(22)) if (!en(z)) M(87);else if (void 0 !== gn) {
        M(85);
        var b = cn();
        b ? ln(b, a) : M(86);
      }
    }, function (a) {
      Q(12) && S(N.g.I) && (!Q(85) || S(N.g.O)) && !1 !== U(a.s, N.g.Ha) && !1 !== U(a.s, N.g.fa) && Mq() && (a.metadata.send_fledge_experiment = !0);
    }, function (a) {
      if (np(a, "ccd_add_1p_data", !1)) {
        var b = a.s.B[N.g.Yd];
        if (Xi(b)) {
          var c = U(a.s, N.g.xa);
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'DC-10755426'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  var PF;
  window.addEventListener('DOMContentLoaded', triggerCollection);
  function QF(a, b, c) {
    PF = PF || new oh();
    PF.add(a, b, c);
  }
