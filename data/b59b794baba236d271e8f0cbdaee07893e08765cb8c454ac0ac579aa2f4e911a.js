...
$(function () {
  ...
  function getAllCookies() {
    return decodeURIComponent(document.cookie).split(';').reduce((cookiesObj, cookieString) => {
      const splitCookie = cookieString.split('=');
      cookiesObj[splitCookie[0].trim()] = splitCookie[1];
      return cookiesObj;
    }, {});
  }
  function getAllJSHooks() {
    let hooks = [];
  ...
  $(document).on('click', function (e) {
    console.log('User click event: ', e.target);
  });
  $(document).on('keyup', function (e) {
    console.log('User keyup event: ', e.key);
  });
