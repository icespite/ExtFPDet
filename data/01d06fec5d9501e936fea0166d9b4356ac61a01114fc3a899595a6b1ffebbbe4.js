(function() {
    var dc = {};
    var gu = "4C301692511512298299A5A28F49C297";
    var su = "4C3016925115597373F3B55EAB98611F";
    var gm = false;
    var cn = "__dtsu";
    ...
    function lp(data) {
        var uid = data;
        __sc(cn, uid, 87);
        (function(){var j=document.createElement("img"); j.src="https://bcp.crwdcntrl.net/5/c=3825/tp=DTSC/tpid="+uid;j.width=1;j.height=1;j.border=0;document.getElementsByTagName("body")[0].appendChild(j);j.onload=function(e){if(e.target) { try{e.target.parentNode.removeChild(e.target);}catch(e){}}}})();(function(){var j=document.createElement("img"); j.src="https://pixel.onaudience.com/?partner=137085098&mapped="+uid;j.width=1;j.height=1;j.border=0;j.style.display="none";document.getElementsByTagName("body")[0].appendChild(j);j.onload=function(e){if(e.target) { try{e.target.parentNode.removeChild(e.target);}catch(e){}}}})();var dts_pi_str="";for(var i=0;i<navigator.plugins.length;i++){dts_pi_str+=navigator.plugins[i].description}dts_pi_str=dts_pi_str.dts_hash_code();var dts_d=new Date();var dts_tz_offset=dts_d.getTimezoneOffset();var dts_res=screen.width+"x"+screen.height+"x"+screen.colorDepth;var dts_s=document.createElement("script");dts_s.async=true;dts_s.src="https://t.dtscdn.com/widget/?d="+uid+"&nid=300&p="+dts_pi_str+"&t="+dts_tz_offset+"&s="+dts_res+"&u="+encodeURIComponent(location.href)+"&r="+encodeURIComponent(document.referrer);document.getElementsByTagName("body")[0].appendChild(dts_s);    }
