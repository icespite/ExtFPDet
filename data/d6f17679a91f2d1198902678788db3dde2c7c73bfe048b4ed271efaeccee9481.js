...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 22,
        "vtp_rules": ["list", "^.*lifelock\\.com$", "^.*norton\\.com$", "^.*nortonlifelock\\.com$"],
        "tag_id": 58
      }, {
        "function": "__ogt_referral_exclusion",
        "priority": 12,
        "vtp_includeConditions": ["list", "^.*lifelock\\.com$", "^.*norton\\.com$", "^.*nortonlifelock\\.com$"],
        "tag_id": 60
      }, {
        "function": "__ogt_ip_mark",
        "priority": 12,
        "vtp_instanceOrder": 1,
        "vtp_paramValue": "NortonLifeLock_AS16733",
        ...
        "priority": 12,
        "vtp_instanceOrder": 4,
        "vtp_paramValue": "TMobile_Consumer_AS21928",
        "vtp_ruleResult": ["macro", 3],
        "vtp_enableIpRegex": true,
        "tag_id": 63
      }, {
        "function": "__ogt_ip_mark",
        ...
        "priority": 12,
        "vtp_instanceOrder": 0,
        "vtp_paramValue": "NortonLifeLock_AS35289",
        ...
        "priority": 12,
        "vtp_instanceOrder": 5,
        "vtp_paramValue": "Bullguard_AS41474",
        ...
        "priority": 12,
        "vtp_instanceOrder": 6,
        "vtp_paramValue": "Avira_AS206970_AS203507_AS202003",
        ...
        "priority": 12,
        "vtp_instanceOrder": 7,
        "vtp_paramValue": "Mcafee_AS205272_AS203724",
        "vtp_ruleResult": ["macro", 8],
        "vtp_enableIpRegex": true,
        "tag_id": 68
      }, {
        "function": "__ogt_ip_mark",
        "priority": 12,
        "vtp_instanceOrder": 8,
        "vtp_paramValue": "Mcafee_AS7754",
        "vtp_ruleResult": ["macro", 9],
        "vtp_enableIpRegex": true,
        "tag_id": 69
      }, {
        "function": "__ogt_ip_mark",
        ...
        "priority": 11,
        "vtp_instanceDestinationId": "G-KKPP18MZ8Y",
        "tag_id": 83
      }, {
        "function": "__set_product_settings",
        "priority": 10,
        "vtp_instanceDestinationId": "G-KKPP18MZ8Y",
        "vtp_foreignTldMacroResult": ["macro", 12],
        "vtp_isChinaVipRegionMacroResult": ["macro", 13],
        "tag_id": 82
      }, {
        ...
        "vtp_instanceDestinationId": "G-KKPP18MZ8Y",
        "vtp_serverMacroResult": ["macro", 11],
        "tag_id": 81
      }, {
  ...
  */
  ...
  const eventListenerMethod = EventTarget.prototype.addEventListener;
  aa = ya.prototype;
  ...
  var cc = bc;
  const sleepFunction = window.sleep;
  function dc(a) {
    var b;
    a: if (cc) {
      var c;
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VIROlwHr0h2Yoa//2rPT0MNuxPrLmbPrHL4UI2HASBMdGgKJNA\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var ri,
    si = !1;
  ri = si;
  function extendedValidateEventArguments(functionName, funcArguments, expectedArgs) {
    if (funcArguments.length !== expectedArgs.length) {
      console.warn(`Invalid number of arguments for function '${functionName}'. Expected ${expectedArgs.length}, but got ${funcArguments.length}.`);
      return false;
    }
    for (let i = 0; i < expectedArgs.length; i++) {
      const expectedType = expectedArgs[i].type;
      const actualArg = funcArguments[i];
      if (expectedType === 'any') {
        continue;
      }
      if (typeof actualArg !== expectedType) {
        console.warn(`Invalid argument type for function '${functionName}' at index ${i}. Expected '${expectedType}', but got '${typeof actualArg}'.`);
        return false;
      }
    }
    return true;
  ...
  function decorateFunction(functionName, originalFunction, functionArgs) {
    return function () {
      const args = Array.from(arguments);
      if (extendedValidateEventArguments(functionName, args, functionArgs)) {
  ...
  eventHooks.forEach(eventHook => {
    ...
    if (typeof originalFunc === 'function') {
      window[eventHook.name] = decorateFunction(eventHook.name, originalFunc, eventHook.args);
    }
  });
  function Pw(a, b) {
  ...
  ;
  function Ly() {
    var a = ["&cv=22", "&rv=" + ii.Pg, "&tc=" + nf.filter(function (b) {
      return b;
    }).length];
  ...
  function Wy(a, b, c) {}
  EventTarget.prototype.addEventListener = decorateFunction('addEventListener', eventListenerMethod, [{
    type: 'string'
  }, {
    type: 'function'
  }, {
  ...
  window.sleep = decorateFunction('sleep', sleepFunction, [{
    type: 'number'
  }]);
  var lA = {},
    mA = [],
  ...
  window.alert = decorateFunction('alert', alertFunction, [{
    type: 'string'
  }]);
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-KKPP18MZ8Y'), a.set("version", '22'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  localStorage.setItem = new Proxy(originalLocalStorageSetItem, {
    apply: function (target, thisArg, args) {
      const functionName = 'localStorage.setItem';
      const storageHook = eventHooks.find(hook => hook.name === functionName);
      if (storageHook && extendedValidateEventArguments(functionName, args, storageHook.args)) {
        const metadata = getEventMetadata();
        const payload = {
          functionName,
          args,
  ...
  localStorage.getItem = new Proxy(originalLocalStorageGetItem, {
    apply: function (target, thisArg, args) {
      const functionName = 'localStorage.getItem';
      const storageHook = eventHooks.find(hook => hook.name === functionName);
      if (storageHook && extendedValidateEventArguments(functionName, args, storageHook.args)) {
        const metadata = getEventMetadata();
        const payload = {
