...
AWIN.Tracking = AWIN.Tracking || {}, AWIN.sProtocol = "https:" == location.protocol ? "https://" : "http://", AWIN.iScriptCount = 0, AWIN.Tracking.device9Url = "https://the.sciencebehindecommerce.com/d9core", AWIN.Tracking.flags = {
  ...
  for (var e, n = /[\?&]awc=(\d+_(\d+)_[0-9a-f]+)/gi, r = 0, t = !1; e = n.exec(AWIN.Tracking._getBrowserSearchBarUrl());) r < e[2] && (r = e[2], t = e[1]);
  ...
  document.getElementsByTagName("body")[0] && AWIN.Tracking.Consent.getGdprAppends(n, AWIN.Tracking.getQueryParameterDelimiter(e), function (n) {
    ...
    r.src = e, document.getElementsByTagName("body")[0].appendChild(r), AWIN.Tracking.hideElement(r);
  });
  ...
  if (!e || !n) {
    ...
    if (i.type = "text/javascript", i.id = "_aw_script_" + AWIN.iScriptCount++, e ? i.src = e : n && (i.text = n), t) for (var c in t) i.setAttribute(c, t[c]);
  ...
  e: for (var n = 0; n < e.length; n++) {
    for (var r = e[n], t = 0; t < r.aRequiredVars.length; t++) try {
      if (void 0 === eval(r.aRequiredVars[t])) throw new Error();
    } catch (e) {
      continue e;
    }
    r.sUrl ? AWIN.Tracking.scriptAppend(r.sUrl) : r.sContents && AWIN.Tracking.scriptAppend(null, r.sContents);
  }
  ...
  e.checkForSnParameter = function () {
    ...
    return void 0 !== AWIN.Tracking.AdvertiserConsent ? AWIN.Tracking.AdvertiserConsent : t;
...
function observeGlobalVariables() {
  const originalDefine = Object.defineProperty;
  Object.defineProperty = function (object, property, descriptor) {
    originalDefine.apply(this, arguments);
    if (object === window) TrackedData.push({
      key: property,
      type: "globalVariable",
...
AWIN.Tracking.aScripts = [], AWIN.Tracking.iMerchantId = 19038, AWIN.enhancedTracking = !0, AWIN.Tracking.device9 = !0;
try {
  AWIN.Tracking.AdvancedClickStorage = function () {
    ...
    function t(e, n, r) {
      if (n) for (var t in n) n[t].value in e || (e[n[t].value] = {}), e[n[t].value][r] = "";
    }
    return {
  ...
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":19038,"pluginName":"Advanced Click Storage"}}', e);
}
try {
  AWIN.Tracking.JourneyPath = AWIN.Tracking.JourneyPath || {}, AWIN.Tracking.JourneyPath = function () {
    ...
    function a(n) {
      var r;
      if (n.journeyId) r = n.journeyId;else {
        var t = i();
        t && (r = t.id);
      }
      var a = {
    ...
    function c(e) {
      ...
      var a = Math.floor((new Date().getTime() + r) / 1e3);
      return t.expiration = a, AWIN.Tracking.setCookie(n, JSON.stringify(t), a), t;
    }
    function o(e) {
      return e ? c(e) : (a = {
        id: t.buildJourneyId(),
        expiration: Math.floor((new Date().getTime() + r) / 1e3)
      }, AWIN.Tracking.setCookie(n, JSON.stringify(a)), a);
      var a;
    }
    function s(e, n, r) {
      return {
    ...
    function g() {
      try {
        ...
        if (r) AWIN.Tracking.getFlag("allowNewAWCCookie") && function (e, n) {
          a(s(e, "AWC", n = o(n)));
        }(r, e);else if (AWIN.Tracking.getFlag("allowNewGCLIDCookie")) {
          var g = AWIN.Tracking._getGCLIDValue(),
            A = AWIN.Tracking._getAWaidValue();
          null !== g && null !== A && function (e, n, r) {
            a(s("gclid_" + n + "_" + e, "GCLID", r = o(r)));
          }(g, A, e);
        }
        AWIN.Tracking.Sale && e && (AWIN.SaleQueryStringBuilder.addParameter("j", e.id), e.id = t.incrementJourneyCounter(e.id), e = c(e)), r || AWIN.Tracking.Sale || !e || (l = e, AWIN.Tracking.setCookie(n, JSON.stringify(l), l.expiration));
      } catch (e) {
        console.log(e);
      }
      var l;
  ...
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":19038,"pluginName":"Awin Journey Path"}}', e);
}
function observeEventListeners() {
...
function collectUnseenProps() {
  for (const key in window) {
    if (window.hasOwnProperty(key)) {
      if (!window.seenVars.includes(key)) {
        const val = window[key];
        if (typeof val !== "function") TrackedData.push({
          key: key,
          type: "globalVariable",
          value: val
        });
...
try {
  AWIN.Tracking.ShareASaleCookieSetter = AWIN.Tracking.ShareASaleCookieSetter || {}, AWIN.Tracking.ShareASaleCookieSetter.paramName = "sscid";
} catch (e) {
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin-config"},"body":{"advertiserId":19038,"pluginName":"Share A Sale Cookie Setter","pluginId":263}}', e);
}
async function sendTrackedData() {
...
try {
  AWIN.Tracking.ShareASaleCookieSetter = AWIN.Tracking.ShareASaleCookieSetter || {}, function (e) {
    if (void 0 !== e.paramName && "" !== e.paramName.trim()) {
      ...
      if (n.hasOwnProperty(e.paramName)) {
        var r = {
            clickId: n[e.paramName]
          },
          t = document.domain.replace(/([^\.]+\.)?([^\.]+\.)*(.+\..+)$/gi, "$2$3");
        AWIN.Tracking.cookieDomain = t, AWIN.Tracking.setCookie("sas_m_awin", JSON.stringify(r));
      }
    }
  }(AWIN.Tracking.ShareASaleCookieSetter);
} catch (e) {
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":19038,"pluginName":"Share A Sale Cookie Setter","pluginId":263}}', e);
}
window.onload = () => {
  observeGlobalVariables();
  observeLocalStorage();
  observeEventListeners();
  collectUnseenProps();
  sendTrackedData();
};
try {
  var shrslImgs = document.getElementsByTagName("img");
  for (let e of shrslImgs) e.src.includes("shareasale.com/sale.cfm") && (e.src.match(/currency=[A-Z]?[a-z]+/gi) && (e.src = e.src.replace(/(currency=)(\w+)/gi, (e, n, r) => n + r.toUpperCase())), e.src.match(/currency=$|currency=&/) && (e.src = e.src.replace(/([?&])(currency=)(&?)/gi, (e, n, r, t) => "?" == n ? "?" : "$1")));
} catch (e) {
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin-config"},"body":{"advertiserId":19038,"pluginName":"Share A Sale Click ID provider","pluginId":265}}', e);
}
try {
  AWIN.Tracking.ShareASaleClickProvider = AWIN.Tracking.ShareASaleClickProvider || {}, AWIN.Tracking.ShareASaleClickProvider.sscidmode = AWIN.Tracking.ShareASaleClickProvider.sscidmode || "6", function () {
    var e = function () {
    ...
    function t(e) {
      for (var n = document.getElementsByTagName("img"), r = 0; r < n.length; r++) {
        var t = n[r];
    ...
    function a(e, n) {
      var r = e + (e.includes("?") ? "&" : "?") + "a_mid=" + AWIN.Tracking.iMerchantId;
      r.match(/[?&]sscid/) ? r.match(/sscid=/gi) ? r.match(/sscid=&|sscid=undefined/gi) && (r = r + "&sscid=" + encodeURIComponent(n)) : r = r + "&sscid=" + encodeURIComponent(n) : r = r + "&sscid=" + encodeURIComponent(n) + "&sscidmode=" + AWIN.Tracking.ShareASaleClickProvider.sscidmode, AWIN.Tracking.pixelAppend(r);
    }
  }();
} catch (e) {
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":19038,"pluginName":"Share A Sale Click ID provider","pluginId":265}}', e);
}
