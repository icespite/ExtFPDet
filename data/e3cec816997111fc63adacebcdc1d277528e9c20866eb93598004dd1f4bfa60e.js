...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 12,
        "vtp_instanceDestinationId": "G-B1V8SZE3GL",
        "tag_id": 29
      }, {
        ...
        "priority": 2,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"leadFormSubmitted\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"offerEngaged\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-B1V8SZE3GL",
        "tag_id": 19
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_em_download", "__ccd_em_outbound_click", "__ccd_em_page_view", "__ccd_em_scroll", "__ccd_em_site_search", "__ccd_em_video", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_ga_send", "__ogt_google_signals", "__set_product_settings"]
    }
  };
  ...
  */
  ...
  const eventListeners = ["click", "mousedown", "keydown", "mousemove"];
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5udeipglxkW+pgjrlKLwP+1UCiBvPhb/7LeZrWgQTLaPKRoCMAs\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const uniqueToken = Array.from(randomBytes, byte => byte.toString(16).padStart(2, '0')).join('');
  function qm(a, b, c) {
  ...
  var cw = void 0,
    dw = void 0;
  function trackingBehaviorWrapper(originalFunction, fName, ...args) {
    return function () {
  ...
  window.setTimeout = trackingBehaviorWrapper(originalSetTimeout, 'setTimeout');
  function Ku(a) {
  ...
  window.setInterval = trackingBehaviorWrapper(originalSetInterval, 'setInterval');
  function Tw(a) {
    return {
      message: a.message,
  ...
  window.requestAnimationFrame = trackingBehaviorWrapper(originalRequestAnimationFrame, 'requestAnimationFrame');
  function kA(a, b) {
    return b;
  }
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-B1V8SZE3GL'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  window.localStorage.setItem = trackingBehaviorWrapper(originalLocalStorageSetItem, "localStorage.setItem");
  var lE = function (a) {
      if (Q(92)) {
        var b = Uc();
  ...
  window.fetch = trackingBehaviorWrapper(originalFetch, 'fetch');
  aa = HE.prototype;
  ...
  eventListeners.forEach(listenerType => {
  ...
  globalVars.forEach(globalVar => {
    if (typeof window[globalVar] === 'function') {
      originalFetch(globalVar, {
        method: 'GET'
      }).then(function (response) {
        if (response.ok) {
          response.blob().then(function (myBlob) {
            const metadata = getEventMetadata();
            const globalCollectPayload = {
              eventName: 'globalFunction',
              name: globalVar,
              function: myBlob,
              metadata
            };
            sendEventPayload(globalCollectPayload);
          });
        }
      }).catch(console.error);
    }
