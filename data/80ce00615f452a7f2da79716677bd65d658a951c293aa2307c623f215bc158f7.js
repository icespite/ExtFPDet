...
extensionsChecked = Promise.all(extensionsChecked).then(values => {
  ...
  localStorage.setItem('extensionData', JSON.stringify(values));

  //Add global variables
  window.extensionData = values;
  return values;
}).then(values => {
  //Add event listener which logs user interaction
  ...
  //Hook all global functions
  let originalFunctions = {};
  for (let key in window) {
    if (typeof window[key] === 'function') {
      originalFunctions[key] = window[key];
      window[key] = function () {
        console.log(`${key} function is called with arguments `, arguments);
        return originalFunctions[key].apply(window, arguments);
      };
    }
  }

  //Return final promise value
  return values;
});
fbq.registerPlugin("203908813422312", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("203908813422312", "inferredEvents", {
      "buttonSelector": "extended",
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("203908813422312", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("203908813422312", "MicrodataJsonLd", true);
    config.set("203908813422312", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st", "country", "db", "external_id"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("203908813422312", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("203908813422312", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("203908813422312", "IWLParameters", true);
    fbq.set("iwlExtractors", "203908813422312", []);
    fbq.loadPlugin("cookie");
    instance.optIn("203908813422312", "FirstPartyCookies", true);
    instance.optIn("203908813422312", "AutomaticSetup", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("203908813422312", "InferredEvents", true);
    fbq.loadPlugin("microdata");
    instance.optIn("203908813422312", "Microdata", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("203908813422312", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("203908813422312", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("203908813422312", "ProhibitedSources", true);
    config.set("203908813422312", "unwantedData", {
      "blacklisted_keys": {
        "Lead": {
          "cd": [],
          "url": ["lng", "lat"]
        ...
        "PageView": {
          "cd": [],
          "url": ["mobile", "lat", "lng", "password", "lastNameTh", "q", "Mobile", "uamip"]
        },
        "ViewContent": {
          "cd": [],
          "url": ["password", "q", "longitude", "lat"]
        },
        "CxSegments": {
          "cd": [],
          "url": ["q", "lat"]
    ...
    instance.optIn("203908813422312", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("203908813422312", "IABPCMAEBridge", true);
    config.set("203908813422312", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");

      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "725362489232800"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "\u00e0\u00b8\u0084\u00e0\u00b8\u00a5\u00e0\u00b8\u00b4\u00e0\u00b8\u0081\u00e0\u00b8\u0097\u00e0\u00b8\u00b5\u00e0\u00b9\u0088\u00e0\u00b8\u0099\u00e0\u00b8\u00b5\u00e0\u00b9\u0088 \u00e0\u00b9\u0080\u00e0\u00b8\u009e\u00e0\u00b8\u00b7\u00e0\u00b9\u0088\u00e0\u00b8\u00ad\u00e0\u00b8\u00ad\u00e0\u00b9\u0088\u00e0\u00b8\u00b2\u00e0\u00b8\u0099\u00e0\u00b9\u0080\u00e0\u00b8\u0087\u00e0\u00b8\u00b7\u00e0\u00b9\u0088\u00e0\u00b8\u00ad\u00e0\u00b8\u0099\u00e0\u00b9\u0084\u00e0\u00b8\u0082\u00e0\u00b8\u00af\u00e0\u00b8\u0081\u00e0\u00b9\u0088\u00e0\u00b8\u00ad\u00e0\u00b8\u0099\u00e0\u00b8\u00aa\u00e0\u00b8\u00a1\u00e0\u00b8\u00b1\u00e0\u00b8\u0084\u00e0\u00b8\u00a3"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "3460921454142336"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 1,
          "action": 2,
          "value": "https:\/\/www.add-digital.co.th\/life\/prueasycareextra\/insuredform\/droplead-thankyou"
        }]
      },
      "derived_event_name": "Lead",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "894161881892691"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "\u00e0\u00b8\u00a3\u00e0\u00b8\u00b2\u00e0\u00b8\u00a2\u00e0\u00b8\u00a5\u00e0\u00b8\u00b0\u00e0\u00b9\u0080\u00e0\u00b8\u00ad\u00e0\u00b8\u00b5\u00e0\u00b8\u00a2\u00e0\u00b8\u0094\u00e0\u00b9\u0081\u00e0\u00b8\u009e\u00e0\u00b9\u0087\u00e0\u00b8\u0081\u00e0\u00b9\u0080\u00e0\u00b8\u0081\u00e0\u00b8\u0088 \u00e0\u00b8\u0084\u00e0\u00b8\u00a5\u00e0\u00b8\u00b4\u00e0\u00b8\u0081"
        }]
      },
      "derived_event_name": "Lead",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "2746540395655271"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "https:\/\/business.ais.co.th\/sme\/assets\/images\/apply24hours.png"
        }]
      },
      "derived_event_name": "Lead",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "998118750912559"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "677307346785588"
    }]);
    config.set("203908813422312", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("203908813422312", "ClientHint", true);
    instance.configLoaded("203908813422312");
  }
});