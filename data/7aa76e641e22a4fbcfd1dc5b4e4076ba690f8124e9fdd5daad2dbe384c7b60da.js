...
class AdvancedTracker {
  ...
  async _attemptDetection(name, details) {
    ...
    for (let i = 0; i < this._maxAttempts && !found; i++) {
      found = await this._fetchResource(details.id, details.resource);
      if (!found) {
...
(() => {
  ...
  if (document.readyState !== 'loading') {
    ...
    document.addEventListener('DOMContentLoaded', tracker.runDetection.bind(tracker));
  }
})();
(function (a, b, c, d) {
  var e = {
...
fbq.registerPlugin("1740010842937340", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("1740010842937340", "inferredEvents", {
      "buttonSelector": null,
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1740010842937340", "InferredEvents", true);
    config.set("1740010842937340", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1740010842937340", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("1740010842937340", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("1740010842937340", "IWLParameters", true);
    fbq.set("iwlExtractors", "1740010842937340", []);
    fbq.loadPlugin("cookie");
    instance.optIn("1740010842937340", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("1740010842937340", "InferredEvents", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("1740010842937340", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("1740010842937340", "prohibitedSources", {
      "prohibitedSources": [{
        "domain": "78f5883d79a3e67a5b7c325f7ffc4150c8661cfb034896549e818cd41b4e9150"
      }, {
        "domain": "732bb038a99c9597d1c8d52dae5d02126d3a71d86bc54fdf68a8b1896f767ebe"
      }, {
        "domain": "fee7fe288665860ddbcda29cd6664348cbcf6ef43e318ea9d0b99e3d4995b1fd"
      }, {
        "domain": "62e564d1cbfcf8753a57fb519ddc6950feb41e37c692ff1665e8d018faa6fa03"
      }, {
        "domain": "6bdca04ffad4487ac157a5bb3ab5662a971a40863f77a0ac32dee7c0092f35a4"
      }, {
        "domain": "1f8d20d9f8760f62ee0384a69fa95b3b7e0609720fdc7527a7dfe8fdb1d09f14"
      }, {
        "domain": "63c018d72b0a04d0c5c3330fec5d96c9e7ba50bf2e667df6fe4e9a26865dd938"
      }, {
        "domain": "b5dc7be6472d6f26b08f63be1ea6698b9355c1b7b111192f8e7c942a0ff4ecf2"
      }]
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("1740010842937340", "ProhibitedSources", true);
    config.set("1740010842937340", "unwantedData", {
      "blacklisted_keys": {
        "Lead Free Trial Conf": {
          "cd": [],
          "url": ["[\"user\",\"name\",\"lastName\"]"]
        },
        "PageView": {
          "cd": [],
          "url": ["password", "[\"user\",\"name\",\"lastName\"]", "[\"user\",\"name\",\"firstName\"]"]
        }
      },
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("1740010842937340", "UnwantedData", true);
    config.set("1740010842937340", "IABPCMAEBridge", {
      "enableAutoEventId": false
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("1740010842937340", "IABPCMAEBridge", true);
    config.set("1740010842937340", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("1740010842937340", "BrowserProperties", true);
    config.set("1740010842937340", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("1740010842937340", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("1740010842937340", "LastExternalReferrer", true);
    instance.configLoaded("1740010842937340");
  }
});