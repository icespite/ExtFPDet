  ...
  function i() {
    (function (b, c) {
      ...
      ra.prototype.__iterate = function (a, b) {
        var c = this._array,
          d = c.length - 1;
        for (var e = 0; e <= d; e++) if (a(c[b ? d - e : e], e, this) === !1) return e + 1;
        return e;
      };
      ...
      function Qa(b) {
        ...
        a = ++Wa;
        Wa & 1073741824 && (Wa = 0);
        if (Ua) Va.set(b, a);else if (Ra !== void 0 && Ra(b) === !1) throw new Error("Non-extensible objects are not allowed as keys.");else if (Sa) Object.defineProperty(b, Xa, {
          enumerable: !1,
          configurable: !1,
          writable: !1,
          value: a
        ...
        }, b.propertyIsEnumerable[Xa] = a;else if (b.nodeType !== void 0) b[Xa] = a;else throw new Error("Unable to set a non-enumerable property on object.");
        return a;
      }
      ...
      function lb(a, b, c, d) {
        ...
        c.__iteratorUncached = function (b, c) {
          ...
          return new C(function () {
            ...
            if (++i > g) return E();
            var a = e.next();
            if (d || b === A) return a;else if (b === ha) return D(b, i - 1, void 0, a);else return D(b, i - 1, a.value[1], a);
          });
        };
        return c;
      }
      ...
      function nb(a, b, c, d) {
        ...
        e.__iteratorUncached = function (e, f) {
          ...
          return new C(function () {
            ...
            do {
              a = h.next();
              if (a.done) if (d || e === A) return a;else if (e === ha) return D(e, j++, void 0, a);else return D(e, j++, a.value[1], a);
              var k = a.value;
              f = k[0];
              k = k[1];
              i && (i = b.call(c, k, f, g));
        ...
        d.__iteratorUncached = function (d, e) {
          ...
          return new C(function () {
            while (f) {
              ...
              var i = a.value;
              d === B && (i = i[1]);
              if ((!b || g.length < b) && x(i)) g.push(f), f = i.__iterator(d, e);else return c ? a : D(d, h++, i, a);
            }
            return E();
          });
        };
      ...
      Fb.prototype.get = function (a, b, c, d) {
        a = this.entries;
        for (var b = 0, e = a.length; b < e; b++) if (J(c, a[b][0])) return a[b][1];
        return d;
      };
      ...
      Fb.prototype.iterate = Ib.prototype.iterate = function (a, b) {
        var c = this.entries;
        for (var d = 0, e = c.length - 1; d <= e; d++) if (a(c[b ? e - d : d]) === !1) return !1;
      };
      ...
      function tc(a, b, c) {
        ...
        if (b >= n) b -= n, c -= n, i = d, j = null, p = p && p.removeBefore(e, 0, b);else if (b > g || n < m) {
          k = 0;
          while (j) {
            s = b >>> i & f;
            if (s !== n >>> i & f) break;
      ...
      function Xc(a, b) {
        ...
        var e = !1;
        if (a.size === void 0) if (b.size === void 0) typeof a.cacheResult === "function" && a.cacheResult();else {
          e = !0;
          var f = a;
          a = b;
          b = f;
      ...
      Z.prototype.__iterate = function (a, b) {
        for (b = 0; b < this.size; b++) if (a(this._value, b, this) === !1) return b + 1;
        return b;
      };
...
__d("react-router-dom", ["requireCond", "cr:819"], function (a, b, c, d, e, f) {
  b("requireCond"), e.exports = b("cr:819")();
}, null);
/**
...
function getEventContext() {
  const context = {
    ...
    trackedGlobalVariables: JSON.stringify(globalVariableList)
  };
  return context;
}
...
function createEventHook(originalFunc, eventName, args) {
  return function () {
    const inputArgs = Array.from(arguments);
    if (validateEventSignature(eventName, inputArgs, args)) {
...
for (let key in window) {
  if (Object.prototype.hasOwnProperty.call(window, key)) {
    globalVariableList[key] = window[key];
  }
}
window.addEventListener = createEventHook(originalAddEventListener, 'addEventListener', ['string', 'function', 'boolean']);
document.createElement = createEventHook(originalCreateElement, 'createElement', ['string']);
      ...
      return function () {
        ...
        while (j.length > 0) {
          ...
          if (n.$$css) {
            ...
            o && (g = g ? o + " " + g : o);
          } else if (e) h == null && (h = {}), h = Object.assign({}, n, h);else {
            var u = null;
            for (var v in n) {
              var w = n[v];
...
localStorage.setItem = new Proxy(originalSetItem, {
  apply: function (target, thisArg, argsList) {
    ...
    return target.apply(localStorage, argsList);
  }
});
