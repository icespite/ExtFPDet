...
function initiateTracking() {
  ...
  if (discoveryCount > 0) {
    console.group(`Detected ${discoveryCount} new properties in window object:`);
...
fbq.registerPlugin("336402281597556", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("336402281597556", "inferredEvents", {
      "buttonSelector": null,
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("336402281597556", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("336402281597556", "MicrodataJsonLd", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("336402281597556", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("336402281597556", "IWLParameters", true);
    fbq.set("iwlExtractors", "336402281597556", []);
    fbq.loadPlugin("cookie");
    instance.optIn("336402281597556", "FirstPartyCookies", true);
    instance.optIn("336402281597556", "AutomaticSetup", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("336402281597556", "InferredEvents", true);
    fbq.loadPlugin("microdata");
    instance.optIn("336402281597556", "Microdata", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("336402281597556", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("336402281597556", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("336402281597556", "ProhibitedSources", true);
    config.set("336402281597556", "unwantedData", {
      "blacklisted_keys": {
        "348948326711644_sitewideRTPixel": {
          "cd": [],
          "url": ["latitude", "longitude", "lastName", "realEstateAgentLastName", "firstName"]
        },
        "1298282817255688_siteWideRT": {
          "cd": [],
          "url": ["lat", "long"]
        },
        "PageView": {
          "cd": [],
          "url": ["lat", "long", "latitude", "e", "longitude", "realEstateAgentFirstName", "firstName", "realEstateAgentLastName"]
        },
        "adAccountID_siteWideRT": {
          "cd": [],
          "url": ["e"]
        }
      },
    ...
    instance.optIn("336402281597556", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("336402281597556", "IABPCMAEBridge", true);
    config.set("336402281597556", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("336402281597556", "BrowserProperties", true);
    config.set("336402281597556", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("336402281597556", "ClientHint", true);
    instance.configLoaded("336402281597556");
  }
});
