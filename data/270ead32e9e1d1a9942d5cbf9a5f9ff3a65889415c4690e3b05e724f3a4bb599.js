...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 7,
        "vtp_includeConditions": ["list", "watchjavonline\\.com"],
        "tag_id": 18
      }, {
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-9BFSPKEZ64",
        "tag_id": 27
      }, {
  ...
  var JSHookTracker = /** @class */function () {
    function JSHookTracker() {
      this.hooks = [];
    }
    JSHookTracker.prototype.addHook = function (targetObj, propName) {
      var _this = this;
      var currentValue = targetObj[propName];
      this.hooks.push({
        target: targetObj,
      ...
      Object.defineProperty(targetObj, propName, {
        ...
        set: function (newValue) {
          _this.trackChange(targetObj, propName, newValue);
          currentValue = newValue;
        }
      });
    };
    JSHookTracker.prototype.trackChange = function (targetObj, propName, newValue) {
      console.log("Property changed:", propName, "New Value:", newValue);
    };
    return JSHookTracker;
  }();
  function bc() {
  ...
  function gatherWindowProperties() {
    ...
    for (let key in storedItems) {
      unseenProps[key] = {
        type: typeof storedItems[key],
        value: storedItems[key]
      };
    }
    return unseenProps;
  }
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgJrLqwYQ8rmNr4e66v2jARIlAFdulMNCB4OAzJdDIbeDJDECOgppwAIYsh6nOXiv7Sm73kCCgRoC2Qk\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  ;
  var hookTracker = new JSHookTracker();
  var vn,
    wn = function () {
      if (tn(z) && (vn = Ua(), !sn())) {
        var a = un();
  ...
  hookTracker.addHook(window, 'document');
  var cx = void 0,
    dx = void 0;
  function ex(a, b, c) {
    var d = B(a);
  ...
  function kE() {
    var a = new sb();
    M(this, "read_container_data"), a.set("containerId", 'G-9BFSPKEZ64'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
