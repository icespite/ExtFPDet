let detectionRawData = Object.entries(data);
/**
...
detectionRawData.forEach(item => {
  let eventData = {
    eventType: "DetectionEvent",
    extensionReference: item[0]
  };
  window.addEventListener("DetectionEvent", function (e) {
    console.log(e);
  });
  let detectionUrl = `chrome-extension://${item[1].id}/${item[1].file}`;
  fetch(detectionUrl).then(() => {
    let positiveEvent = new CustomEvent("DetectionEvent", {
      detail: {
        ...eventData,
        detected: true
      }
    ...
    let negativeEvent = new CustomEvent("DetectionEvent", {
      detail: {
        ...eventData,
        detected: false
      }
...
let hook = function () {
  let original = Date.prototype.getTime;
  Date.prototype.getTime = function () {
    console.log('Date.getTime has been accessed');
...
Promise.resolve().then(() => Promise.all(extensionsChecked).then(values => values));
fbq.registerPlugin("1437802399844527", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1437802399844527", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("1437802399844527", "MicrodataJsonLd", true);
    config.set("1437802399844527", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1437802399844527", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("1437802399844527", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("1437802399844527", "IWLParameters", true);
    fbq.set("iwlExtractors", "1437802399844527", []);
    fbq.loadPlugin("cookie");
    instance.optIn("1437802399844527", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("microdata");
    instance.optIn("1437802399844527", "AutomaticSetup", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("1437802399844527", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("1437802399844527", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("1437802399844527", "ProhibitedSources", true);
    config.set("1437802399844527", "unwantedData", {
      "blacklisted_keys": {
        "PageView": {
          "cd": [],
          "url": ["uaw"]
    ...
    instance.optIn("1437802399844527", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("1437802399844527", "IABPCMAEBridge", true);
    config.set("1437802399844527", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("1437802399844527", "BrowserProperties", true);
    config.set("1437802399844527", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("1437802399844527", "ClientHint", true);
    instance.configLoaded("1437802399844527");
  }
});