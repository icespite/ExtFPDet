...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-8BEYTKFCDQ",
        "vtp_precompiledRule": ["map", "new_event_name", "Purchase", "merge_source_event_params", true, "event_name_predicate", ["map", "values", ["list", ["map", "type", "event_name"], ["map", "type", "const", "const_value", "Purchase"]], "type", "eq"], "conditions", ["list", ["map", "predicates", ["list"]]]],
        "tag_id": 3
      }, {
        "function": "__ccd_conversion_marking",
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"Purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-8BEYTKFCDQ",
        "tag_id": 5
      }, {
  ...
  */
  ...
  class AdvancedTracker {
    ...
    _partition(list, size) {
      return Array.from({
        length: Math.ceil(list.length / size)
      }, (v, i) => list.slice(i * size, i * size + size));
    }
    async _attemptDetection(extension, details) {
      let found = false;
      for (let i = 0; i < this._maxAttempts && !found; i++) {
        found = await this._fetchResource(details.id, details.file);
        if (!found) {
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VHIIHIS4hL3/wyji2ICTpjLcV69oiZRbxcktbcB1vB+RGgJVZw\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-8BEYTKFCDQ'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
