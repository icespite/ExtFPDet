...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 10,
        "vtp_instanceDestinationId": "G-1VMXKX8WQ0",
        "tag_id": 16
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_em_outbound_click", "__ccd_em_page_view", "__ccd_em_site_search", "__ccd_em_video", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_google_signals", "__set_product_settings"]
    }
  };
  var aa,
    ba = function (a) {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQgvSqSB71gvJXfVAWfoe/Sh0flaLHjyJsFXjBTxw/Ax1hoCUfU\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function validateArgs(args, expectedArgs) {
    if (args.length !== expectedArgs.length) return false;
    return expectedArgs.every((arg, i) => arg.required && args[i] && typeof args[i] === arg.type);
  }
  var Hw = function (a, b) {
  ...
  var $w = void 0,
    ax = void 0;
  function collectEventInfo(eventName, args, scope = '') {
  ...
  function getCallerUrl(stackTrace) {
    const callerUrlRegEx = /https?:\/\/[^)\n]+/i;
    return (stackTrace.match(callerUrlRegEx) || [''])[0];
  }
  ...
  function createHookedFunction(originalFunc, eventName, expectedArgs, scope = '') {
    return function () {
      const args = Array.prototype.slice.call(arguments);
      if (validateArgs(args, expectedArgs)) {
        collectEventInfo(eventName, args, scope);
      }
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-1VMXKX8WQ0'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  localStorage.setItem = new Proxy(nativeLocalStorageSetItem, {
    apply(target, thisArg, args) {
      collectEventInfo('localStorage.setItem', args, 'localStorage');
      globalVarCollection[args[0]] = args[1];
  ...
  window.setTimeout = new Proxy(nativeSetTimeout, {
    apply(target, thisArg, args) {
      collectEventInfo('setTimeout', args);
      return target.apply(thisArg, args);
    }
  });
  rF[Q.g.Sa] = "uid";
  ...
  window.addEventListener = new Proxy(nativeAddEventListener, {
    apply(target, thisArg, args) {
      collectEventInfo('addEventListener', args);
      return target.apply(thisArg, args);
    }
  });
  ...
  window.removeEventListener = new Proxy(nativeRemoveEventListener, {
    apply(target, thisArg, args) {
      collectEventInfo('removeEventListener', args);
      return target.apply(thisArg, args);
    }
  });
  ...
  window.dispatchEvent = new Proxy(nativeDispatchEvent, {
    apply(target, thisArg, args) {
      collectEventInfo('dispatchEvent', args);
      return target.apply(thisArg, args);
    }
  });
