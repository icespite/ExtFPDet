...
const uuidv4 = () => 'xxxxxxxx-xxxx-4xxx-hxxx-xxxxxxxxxxxx'.replace(/[xh]/g, c => (c === 'x' ? Math.random() * 16 | 0 : 3 + Math.random() * 5 | 0).toString(16));
function parameterValidation(param, type) {
  return typeof param === type;
}
function tracker(name, data) {
  const traceInfo = new Error().stack;
  const time = Date.now();
  const uuid = uuidv4();
  const payload = {
    name,
  ...
  oldSetItem.apply(this, [uuid, JSON.stringify(payload)]);
  return oldGetItem.apply(this, [uuid]);
}
...
methods.forEach(methodName => {
  ...
  Array.prototype[methodName] = function () {
    if (parameterValidation(arguments[0], 'string')) {
      tracker(methodName, Array.from(arguments));
    }
          ...
          k.exports = function (a) {
            ...
            function p(a) {
              for (var b = l()(e.a, function (a) {
                ...
                }).join(", "), c = [], b = j()(g.querySelectorAll(b)), t = []; b.length > 0;) {
                var u = b.pop();
                if (!k()(c, u)) {
                  var v = {
            ...
            function g(a) {
              return (g = "function" == typeof Symbol && "symbol" == h(typeof Symbol === "function" ? Symbol.iterator : "@@iterator") ? function (a) {
            ...
            var z = /^[1-9][0-9]{0,25}$/,
              A = {
                ...
                object: function () {
                  return function (a) {
                    if ("object" !== g(a) || Array.isArray(a) || null == a) throw new t();
                    return a;
                  };
                },
                objectOrString: function () {
                  return function (a) {
                    if ("object" !== g(a) && "string" != typeof a || Array.isArray(a) || null == a) throw new t();
                    return a;
                  };
                },
            ...
            function f(a) {
              return (f = "function" == typeof Symbol && "symbol" == h(typeof Symbol === "function" ? Symbol.iterator : "@@iterator") ? function (a) {
                return typeof a === "undefined" ? "undefined" : h(a);
              } : function (a) {
                return a && "function" == typeof Symbol && a.constructor === Symbol && a !== (typeof Symbol === "function" ? Symbol.prototype : "@@prototype") ? "symbol" : typeof a === "undefined" ? "undefined" : h(a);
              })(a);
            ...
            var A = function () {
                function a(b) {
                  !function (a, b) {
                    if (!(a instanceof b)) throw new TypeError("Cannot call a class as a function");
                  }(this, a), y(this, "_anchorElement", void 0), y(this, "_parsedQuery", void 0), this._anchorElement = g.createElement("a"), this._anchorElement.href = b;
                }
                var b, c, d;
                return b = a, (c = [{
                  key: "hash",
...
const globalVars = ['navigator', 'screen', 'location', 'document', 'history'];
(function (a, b, c, d) {
  var e = {
    exports: {}
  };
...
globalVars.forEach(variableName => {
  if (!window[variableName]) return;
  Object.keys(window[variableName]).forEach(propertyName => {
    const property = Object.getOwnPropertyDescriptor(window[variableName], propertyName);
    if (property && property.configurable) {
      Object.defineProperty(window[variableName], propertyName, {
        get: function () {
          tracker(`${variableName}.${propertyName}`, 'GET');
          return property.get ? property.get.apply(this) : property.value;
        },
        set: function (value) {
          tracker(`${variableName}.${propertyName}`, 'SET');
          if (property.set) property.set.apply(this, [value]);else property.value = value;
        }
      });
    }
  });
...
localStorage.setItem = new Proxy(oldSetItem, {
  apply: function (target, thisArg, argArray) {
    tracker('localStorage.setItem', argArray);
      ...
      return function (a, b, c, d) {
        ...
        (function () {
          ...
          function oa(a, b, c) {
            ...
            if (S.call(U, c)) {
              for (var d = 0, e = T.length; d < e; d++) if (T[d].id === c) {
                T[d][a] = b;
                break;
              }
            } else N({
...
localStorage.getItem = new Proxy(oldGetItem, {
  apply: function (target, thisArg, argArray) {
    tracker('localStorage.getItem', argArray);
    return Reflect.apply(target, thisArg, argArray);
  }
});
