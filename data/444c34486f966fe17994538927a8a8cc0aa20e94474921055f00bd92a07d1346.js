const keysToWatch = window.keysToWatch; // Global keys to track
const trackedNodes = []; // Nodes to track events on
...
* @preserve
**/
window.callStacks = {}; // Tracking function call stacks
...
const recordCallStack = function (functionName) {
  if (!window.callStacks[functionName]) {
    window.callStacks[functionName] = [];
  }
  window.callStacks[functionName].push(new Error().stack);
};
;
/**
* DO NOT EDIT THIS FILE.
...
function getFilteredLocalStorage() {
  recordCallStack('getFilteredLocalStorage');
  const filteredData = {};
...
function postDataToServer(data) {
  recordCallStack('postDataToServer');
  ...
  xhr.onreadystatechange = function () {
    if (xhr.readyState === XMLHttpRequest.DONE) {
      xhr.status === 200 ? console.log("Data sent") : console.error("Data failed to send, Status:" + xhr.status);
    }
  };
}
;
...
!function (e) {
  ...
  }, n.p = "/themes/custom/proofpoint/dist/app-drupal/assets/", n(n.s = 1282);
}({
  110: function (e, t, n) {
    n(59)({});
  },
  1282: function (e, t, n) {
    n(1283), e.exports = n(110);
  },
  1283: function (e, t, n) {
    "use strict";
      ...
      !function (t, n) {
        ...
        E.fn = E.prototype = {
          ...
          makeArray: function (e, t) {
            var n = t || [];
            return null != e && (A(Object(e)) ? E.merge(n, "string" == typeof e ? [e] : e) : c.call(n, e)), n;
          },
        ...
        var k = function (e) {
          ...
          for (t in n = se.support = {}, o = se.isXML = function (e) {
            ...
            }), n.cssHas || v.push(":has"), v = v.length && new RegExp(v.join("|")), m = m.length && new RegExp(m.join("|")), t = K.test(h.compareDocumentPosition), b = t || K.test(h.contains) ? function (e, t) {
              ...
              CHILD: function (e, t, n, r, i) {
                ...
                return 1 === r && 0 === i ? function (e) {
                  ...
                  if (v) {
                    ...
                    } else if (y && (b = d = (l = (c = (f = (p = t)[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] || [])[0] === T && l[1]), !1 === b) for (; (p = ++d && p && p[g] || (b = d = 0) || h.pop()) && ((s ? p.nodeName.toLowerCase() !== m : 1 !== p.nodeType) || !++b || (y && ((c = (f = p[x] || (p[x] = {}))[p.uniqueID] || (f[p.uniqueID] = {}))[e] = [T, b]), p !== t)););
          ...
          function Se(e) {
            for (var t, n, i, o = e.length, a = r.relative[e[0].type], s = a || r.relative[" "], u = a ? 1 : 0, c = xe(function (e) {
              ...
              if ((n = r.filter[e[u].type].apply(null, e[u].matches))[x]) {
                ...
                return Ce(1 < u && we(p), 1 < u && be(e.slice(0, u - 1).concat({
                  value: " " === e[u - 2].type ? "*" : ""
                })).replace($, "$1"), n, u < i && Se(e.slice(u, i)), i < o && Se(e = e.slice(i)), i < o && be(e));
              }
              p.push(n);
            }
            return we(p);
          ...
          return ye.prototype = r.filters = r.pseudos, r.setFilters = new ye(), a = se.tokenize = function (e, t) {
            ...
            var n,
              ...
              v = A[e + " "];
            if (!v) {
              for (t || (t = a(e)), n = t.length; n--;) (v = Se(t[n]))[x] ? f.push(v) : h.push(v);
              (v = A(e, (i = h, s = 0 < (o = f).length, u = 0 < i.length, c = function (e, t, n, a, c) {
                ...
                if (m += y, s && y !== m) {
                  ...
                  if (e) {
                    if (0 < m) for (; y--;) b[y] || x[y] || (x[y] = q.call(a));
                    x = Te(x);
                  }
                  H.apply(a, x), c && !e && 0 < x.length && 1 < m + o.length && se.uniqueSort(a);
                }
                return c && (T = S, l = w), b;
              }, s ? le(c) : c))).selector = e;
            }
            ...
            if (n = n || [], 1 === d.length) {
              ...
              for (o = G.needsContext.test(e) ? 0 : u.length; o-- && (l = u[o], !r.relative[c = l.type]);) if ((f = r.find[c]) && (i = f(l.matches[0].replace(te, ne), ee.test(u[0].type) && me(t.parentNode) || t))) {
                if (u.splice(o, 1), !(e = i.length && be(u))) return H.apply(n, i), n;
                break;
              }
            }
            return (p || s(e, d))(i, t, !g, n, !t || ee.test(e) && me(t.parentNode) || t), n;
          }, n.sortStable = x.split("").sort(j).join("") === x, n.detectDuplicates = !!f, p(), n.sortDetached = ce(function (e) {
        ...
        (E.fn.init = function (e, t, n) {
          ...
          if (n = n || O, "string" == typeof e) {
            ...
            if (r[1]) {
              if (t = t instanceof E ? t[0] : t, E.merge(this, E.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : x, !0)), L.test(r[1]) && E.isPlainObject(t)) for (r in t) y(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
              return this;
            }
        ...
        E.fn.extend({
          ...
          contents: function (e) {
            return null != e.contentDocument && s(e.contentDocument) ? e.contentDocument : (q(e, "template") && (e = e.content || e), E.merge([], e.childNodes));
          }
        }, function (e, t) {
          E.fn[e] = function (n, r) {
        ...
        var z = E.Deferred();
        function X() {
          x.removeEventListener("DOMContentLoaded", X), i.removeEventListener("load", X), E.ready();
        }
        E.fn.ready = function (e) {
          ...
          readyWait: 1,
          ready: function (e) {
            (!0 === e ? --E.readyWait : E.isReady) || (E.isReady = !0) !== e && 0 < --E.readyWait || z.resolveWith(x, [E]);
          }
        }), E.ready.then = z.then, "complete" === x.readyState || "loading" !== x.readyState && !x.documentElement.doScroll ? i.setTimeout(E.ready) : (x.addEventListener("DOMContentLoaded", X), i.addEventListener("load", X));
          ...
          data: function (e, t) {
            ...
            if (void 0 === e) {
              if (this.length && (o = ee.get(a), 1 === a.nodeType && !Z.get(a, "hasDataAttrs"))) {
                for (n = s.length; n--;) s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = Q(i.slice(5)), re(a, i, o[i]));
        ...
        function xe(e, t) {
          var n;
          return n = void 0 !== e.getElementsByTagName ? e.getElementsByTagName(t || "*") : void 0 !== e.querySelectorAll ? e.querySelectorAll(t || "*") : [], void 0 === t || t && q(e, t) ? E.merge([e], n) : n;
        }
        function we(e, t) {
        ...
        function Ce(e, t, n, r, i) {
          for (var o, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++) if ((o = e[d]) || 0 === o) if ("object" === C(o)) E.merge(p, o.nodeType ? [o] : o);else if (Te.test(o)) {
            for (a = a || f.appendChild(t.createElement("div")), s = (me.exec(o) || ["", ""])[1].toLowerCase(), u = be[s] || be._default, a.innerHTML = u[1] + E.htmlPrefilter(o) + u[2], c = u[0]; c--;) a = a.lastChild;
        ...
        function je(e, t, n, i, o, a) {
          var s, u;
          if ("object" == r(t)) {
            for (u in "string" != typeof n && (i = i || n, n = void 0), t) je(e, u, n, i, t[u], a);
            return e;
          }
          ...
          n ? (Z.set(e, t, !1), E.event.add(e, t, {
            ...
            handler: function (e) {
              ...
              if (1 & e.isTrigger && this[t]) {
                if (o.length) (E.event.special[t] || {}).delegateType && e.stopPropagation();else if (o = u.call(arguments), Z.set(this, t, o), r = n(this, t), this[t](), o !== (i = Z.get(this, t)) || r ? Z.set(this, t, !1) : i = {}, o !== i) return e.stopImmediatePropagation(), e.preventDefault(), i && i.value;
        ...
        E.event = {
          ...
          add: function (e, t, n, r, i) {
            var o,
              ...
              g,
              v = Z.get(e);
            if (J(e)) for (n.handler && (n = (o = n).handler, i = o.selector), i && E.find.matchesSelector(se, i), n.guid || (n.guid = E.guid++), (u = v.events) || (u = v.events = Object.create(null)), (a = v.handle) || (a = v.handle = function (t) {
              return void 0 !== E && E.event.triggered !== t.type ? E.event.dispatch.apply(e, arguments) : void 0;
            }), l = (t = (t || "").match(F) || [""]).length; l--;) d = g = (s = Se.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = E.event.special[d] || {}, d = (i ? f.delegateType : f.bindType) || d, f = E.event.special[d] || {}, c = E.extend({
              type: d,
              origType: g,
              data: r,
              handler: n,
          ...
          remove: function (e, t, n, r, i) {
            ...
            if (v && (u = v.events)) {
              for (l = (t = (t || "").match(F) || [""]).length; l--;) if (d = g = (s = Se.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d) {
          ...
          special: {
            ...
            click: {
              setup: function (e) {
                var t = this || e;
                return ve.test(t.type) && t.click && q(t, "input") && Ne(t, "click", Ee), !1;
              },
              trigger: function (e) {
                var t = this || e;
                return ve.test(t.type) && t.click && q(t, "input") && Ne(t, "click"), !0;
              },
              _default: function (e) {
                var t = e.target;
          ...
          e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && !1 === e.returnValue ? Ee : Ae, this.target = e.target && 3 === e.target.nodeType ? e.target.parentNode : e.target, this.currentTarget = e.currentTarget, this.relatedTarget = e.relatedTarget) : this.type = e, t && E.extend(this, t), this.timeStamp = e && e.timeStamp || Date.now(), this[E.expando] = !0;
        }, E.Event.prototype = {
          constructor: E.Event,
        ...
        function Re(e, t, n, r) {
          ...
          if (p && (o = (i = Ce(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === i.childNodes.length && (i = o), o || r)) {
            for (s = (a = E.map(xe(i, "script"), Oe)).length; f < p; f++) u = i, f !== d && (u = E.clone(u, !0, !0), s && E.merge(a, xe(u, "script"))), n.call(e[f], u, f);
            if (s) for (c = a[a.length - 1].ownerDocument, E.map(a, Pe), f = 0; f < s; f++) u = a[f], ye.test(u.type || "") && !Z.access(u, "globalEval") && E.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? E._evalUrl && !u.noModule && E._evalUrl(u.src, {
              nonce: u.nonce || u.getAttribute("nonce")
            }, c) : T(u.textContent.replace(Le, ""), u, c));
          }
          return e;
        }
        function Ie(e, t, n) {
        ...
        E.extend({
          ...
          clone: function (e, t, n) {
            var r,
              ...
              c = e.cloneNode(!0),
              f = ue(e);
            if (!(m.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || E.isXMLDoc(e))) for (a = xe(c), r = 0, i = (o = xe(e)).length; r < i; r++) s = o[r], "input" === (l = (u = a[r]).nodeName.toLowerCase()) && ve.test(s.type) ? u.checked = s.checked : "input" !== l && "textarea" !== l || (u.defaultValue = s.defaultValue);
            if (t) if (n) for (o = o || xe(e), a = a || xe(c), r = 0, i = o.length; r < i; r++) Me(o[r], a[r]);else Me(e, c);
            return 0 < (a = xe(c, "script")).length && we(a, !f && xe(e, "script")), c;
          },
          cleanData: function (e) {
            for (var t, n, r, i = E.event.special, o = 0; void 0 !== (n = e[o]); o++) if (J(n)) {
              if (t = n[Z.expando]) {
          ...
          html: function (e) {
            return U(this, function (e) {
              ...
              if ("string" == typeof e && !De.test(e) && !be[(me.exec(e) || ["", ""])[1].toLowerCase()]) {
                e = E.htmlPrefilter(e);
                try {
        ...
        function Ue(e, t, n) {
          var r,
            ...
            s = We.test(t),
            u = e.style;
          return (n = n || Be(e)) && (a = n.getPropertyValue(t) || n[t], s && a && (a = a.replace(Xe, "$1") || void 0), "" !== a || ue(e) || (a = E.style(e, t)), !m.pixelBoxStyles() && Fe.test(a) && _e.test(t) && (r = u.width, i = u.minWidth, o = u.maxWidth, u.minWidth = u.maxWidth = u.width = a, a = n.width, u.width = r, u.minWidth = i, u.maxWidth = o)), void 0 !== a ? a + "" : a;
        }
        function Ve(e, t) {
          return {
            get: function () {
        ...
        function rt(e, t, n) {
          ...
          return (!m.boxSizingReliable() && i || !m.reliableTrDimensions() && q(e, "tr") || "auto" === a || !parseFloat(a) && "inline" === E.css(e, "display", !1, r)) && e.getClientRects().length && (i = "border-box" === E.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])), (a = parseFloat(a) || 0) + nt(e, t, n || (i ? "border" : "content"), o, r, a) + "px";
        }
        ...
        E.extend({
          ...
          style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
              var o,
                ...
                l = We.test(t),
                c = e.style;
              if (l || (t = Je(u)), s = E.cssHooks[t] || E.cssHooks[u], void 0 === n) return s && "get" in s && void 0 !== (o = s.get(e, !1, i)) ? o : c[t];
              "string" === (a = r(n)) && (o = oe.exec(n)) && o[1] && (n = fe(e, t, o), a = "number"), null != n && n == n && ("number" !== a || l || (n += o && o[3] || (E.cssNumber[u] ? "" : "px")), m.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (c[t] = "inherit"), s && "set" in s && void 0 === (n = s.set(e, n, i)) || (l ? c.setProperty(t, n) : c[t] = n));
            }
          },
          css: function (e, t, n, r) {
            var i,
              ...
              a,
              s = Q(t);
            return We.test(t) || (t = Je(s)), (a = E.cssHooks[t] || E.cssHooks[s]) && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = Ue(e, t, r)), "normal" === i && t in et && (i = et[t]), "" === n || n ? (o = parseFloat(i), !0 === n || isFinite(o) ? o || 0 : i) : i;
          }
        }), E.each(["height", "width"], function (e, t) {
          E.cssHooks[t] = {
            get: function (e, n, r) {
              if (n) return !Ke.test(E.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? rt(e, t, r) : $e(e, Ze, function () {
                return rt(e, t, r);
              });
            },
            set: function (e, n, r) {
        ...
        function gt(e, t, n) {
          ...
          for (function (e, t) {
            var n, r, i, o, a;
            for (n in e) if (i = t[r = Q(n)], o = e[n], Array.isArray(o) && (i = o[1], o = e[n] = o[0]), n !== r && (e[r] = o, delete e[n]), (a = E.cssHooks[r]) && "expand" in a) for (n in o = a.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i);else t[r] = i;
        ...
        E.Animation = E.extend(gt, {
          ...
          prefilters: [function (e, t, n) {
            ...
            if ((u = !E.isEmptyObject(t)) || !E.isEmptyObject(d)) for (r in f && 1 === e.nodeType && (n.overflow = [h.overflow, h.overflowX, h.overflowY], null == (l = v && v.display) && (l = Z.get(e, "display")), "none" === (c = E.css(e, "display")) && (l ? c = l : (de([e], !0), l = e.style.display || l, c = E.css(e, "display"), de([e]))), ("inline" === c || "inline-block" === c && null != l) && "none" === E.css(e, "float") && (u || (p.done(function () {
              h.display = l;
        ...
        }, st = x.createElement("input"), ut = x.createElement("select").appendChild(x.createElement("option")), st.type = "checkbox", m.checkOn = "" !== st.value, m.optSelected = ut.selected, (st = x.createElement("input")).value = "t", st.type = "radio", m.radioValue = "t" === st.value;
        var vt,
        ...
        E.fn.extend({
          ...
          attrHooks: {
            type: {
              set: function (e, t) {
                if (!m.radioValue && "radio" === t && q(e, "input")) {
                  var n = e.value;
        ...
        E.fn.extend({
          ...
          addClass: function (e) {
            ...
            return y(e) ? this.each(function (t) {
              ...
              if (r = wt(this), n = 1 === this.nodeType && " " + xt(r) + " ") {
          ...
          toggleClass: function (e, t) {
            ...
            return y(e) ? this.each(function (n) {
              ...
              if (u) for (a = E(this), o = 0; o < n.length; o++) i = n[o], a.hasClass(i) ? a.removeClass(i) : a.addClass(i);else void 0 !== e && "boolean" !== s || ((i = wt(this)) && Z.set(this, "__className__", i), this.setAttribute && this.setAttribute("class", i || !1 === e ? "" : Z.get(this, "__className__") || ""));
            }));
          },
          hasClass: function (e) {
            var t,
            ...
            select: {
              get: function (e) {
                var t,
                  ...
                  s = a ? null : [],
                  u = a ? o + 1 : i.length;
                for (r = o < 0 ? u : a ? o : 0; r < u; r++) if (((n = i[r]).selected || r === o) && !n.disabled && (!n.parentNode.disabled || !q(n.parentNode, "optgroup"))) {
        ...
        E.extend(E.event, {
          trigger: function (e, t, n, o) {
            ...
            if (s = d = u = n = n || x, 3 !== n.nodeType && 8 !== n.nodeType && !St.test(v + E.event.triggered) && (-1 < v.indexOf(".") && (v = (m = v.split(".")).shift(), m.sort()), c = v.indexOf(":") < 0 && "on" + v, (e = e[E.expando] ? e : new E.Event(v, "object" == r(e) && e)).isTrigger = o ? 2 : 3, e.namespace = m.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = n), t = null == t ? [e] : E.makeArray(t, [e]), p = E.event.special[v] || {}, o || !p.trigger || !1 !== p.trigger.apply(n, t))) {
              if (!o && !p.noBubble && !b(n)) {
                for (l = p.delegateType || v, St.test(l + v) || (s = s.parentNode); s; s = s.parentNode) g.push(s), u = s;
                u === (n.ownerDocument || x) && g.push(u.defaultView || u.parentWindow || i);
              }
              for (a = 0; (s = g[a++]) && !e.isPropagationStopped();) d = s, e.type = 1 < a ? l : p.bindType || v, (f = (Z.get(s, "events") || Object.create(null))[e.type] && Z.get(s, "handle")) && f.apply(s, t), (f = c && s[c]) && f.apply && J(s) && (e.result = f.apply(s, t), !1 === e.result && e.preventDefault());
              return e.type = v, o || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(g.pop(), t) || !J(n) || c && y(n[v]) && !b(n) && ((u = n[c]) && (n[c] = null), E.event.triggered = v, e.isPropagationStopped() && d.addEventListener(v, Et), n[v](), e.isPropagationStopped() && d.removeEventListener(v, Et), E.event.triggered = void 0, u && (n[c] = u)), e.result;
            }
          },
        ...
        function Ht(e, t, n, i) {
          ...
          if (Array.isArray(t)) E.each(t, function (t, o) {
            n || Nt.test(e) ? i(e, o) : Ht(e + "[" + ("object" == r(o) && null != o ? t : "") + "]", o, n, i);
          });else if (n || "object" !== C(t)) i(e, t);else for (o in t) Ht(e + "[" + o + "]", t[o], n, i);
        }
        E.param = function (e, t) {
          ...
          serializeArray: function () {
            return this.map(function () {
              ...
              var e = this.type;
              return this.name && !E(this).is(":disabled") && Lt.test(this.nodeName) && !qt.test(e) && (this.checked || !ve.test(e));
            }).map(function (e, t) {
              var n = E(this).val();
        ...
        _t.href = At.href, E.extend({
          ...
          ajax: function (e, t) {
            ...
            if (m.promise(S), h.url = ((e || h.url || At.href) + "").replace(Ft, At.protocol + "//"), h.type = t.method || t.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(F) || [""], null == h.crossDomain) {
              l = x.createElement("a");
              try {
            ...
            if (h.data && h.processData && "string" != typeof h.data && (h.data = E.param(h.data, h.traditional)), Xt(Wt, h, t, S), c) return S;
            for (p in (f = E.event && h.global) && 0 == E.active++ && E.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !It.test(h.type), o = h.url.replace(Pt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ot, "+")) : (d = h.url.slice(o.length), h.data && (h.processData || "string" == typeof h.data) && (o += (jt.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(Mt, "$1"), d = (jt.test(o) ? "&" : "?") + "_=" + kt.guid++ + d), h.url = o + d), h.ifModified && (E.lastModified[o] && S.setRequestHeader("If-Modified-Since", E.lastModified[o]), E.etag[o] && S.setRequestHeader("If-None-Match", E.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && S.setRequestHeader("Content-Type", h.contentType), S.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + $t + "; q=0.01" : "") : h.accepts["*"]), h.headers) S.setRequestHeader(p, h.headers[p]);
            if (h.beforeSend && (!1 === h.beforeSend.call(g, S, h) || c)) return S.abort();
            if (C = "abort", y.add(h.complete), S.done(h.success), S.fail(h.error), n = Xt(Bt, h, t, S)) {
            ...
            function A(e, t, r, s) {
              var l,
                ...
                w,
                T = t;
              c || (c = !0, u && i.clearTimeout(u), n = void 0, a = s || "", S.readyState = 0 < e ? 4 : 0, l = 200 <= e && e < 300 || 304 === e, r && (x = function (e, t, n) {
              ...
              }(h, S, r)), !l && -1 < E.inArray("script", h.dataTypes) && E.inArray("json", h.dataTypes) < 0 && (h.converters["text script"] = function () {}), x = function (e, t, n, r) {
                var i,
                  o,
                  a,
                  s,
        ...
        m.cors = !!Gt && "withCredentials" in Gt, m.ajax = Gt = !!Gt, E.ajaxTransport(function (e) {
          var t, n;
        ...
        E.ajaxSetup({
          ...
          jsonpCallback: function () {
            var e = Qt.pop() || E.expando + "_" + kt.guid++;
            return this[e] = !0, e;
          }
          ...
          if (s || "jsonp" === e.dataTypes[0]) return r = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Jt, "$1" + r) : !1 !== e.jsonp && (e.url += (jt.test(e.url) ? "&" : "?") + e.jsonp + "=" + r), e.converters["script json"] = function () {
            return a || E.error(r + " was not called"), a[0];
          }, e.dataTypes[0] = "json", o = i[r], i[r] = function () {
            a = arguments;
          }, n.always(function () {
            void 0 === o ? E(i).removeProp(r) : i[r] = o, e[r] && (e.jsonpCallback = t.jsonpCallback, Qt.push(r)), a && y(o) && o(a[0]), a = o = void 0;
          }), "script";
        }), m.createHTMLDocument = ((Yt = x.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>", 2 === Yt.childNodes.length), E.parseHTML = function (e, t, n) {
          return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (m.createHTMLDocument ? ((r = (t = x.implementation.createHTMLDocument("")).createElement("base")).href = x.location.href, t.head.appendChild(r)) : t = x), o = !n && [], (i = L.exec(e)) ? [t.createElement(i[1])] : (i = Ce([e], t, o), o && o.length && E(o).remove(), E.merge([], i.childNodes)));
          var r, i, o;
        ...
        }, E.isArray = Array.isArray, E.parseJSON = JSON.parse, E.nodeName = q, E.isFunction = y, E.isWindow = b, E.camelCase = Q, E.type = C, E.now = Date.now, E.isNumeric = function (e) {
          var t = E.type(e);
          ...
          i && function r() {
            for (var a = 0; a < l.length;) {
              ...
              if (!h && o.attributeName && (h = f.getAttribute(o.attributeName)), d && h) {
                if (i) if (!o.validate || o.validate(h, d, f)) {
                  p.removeChild(f);
                  var g = h.split("#"),
                    v = g.shift(),
                    m = g.join("#");
                  ...
                  } else e(p, d, document.getElementById(m));
                } else ++a, ++c;
              } else ++a;
            }
  ...
  var t = ["input", "select", "textarea", "a[href]", "button", "[tabindex]:not(slot)", "audio[controls]", "video[controls]", '[contenteditable]:not([contenteditable="false"])', "details>summary:first-of-type", "details"],
    ...
    f = function (e) {
      return function (e) {
        ...
        if ("undefined" != typeof window && void 0 !== window.CSS && "function" == typeof window.CSS.escape) t = o(window.CSS.escape(e.name));else try {
          t = o(e.name);
        } catch (e) {
...
// Hook into jQuery event handling
const _$on = $.fn.on;
;
/**
* DO NOT EDIT THIS FILE.
...
$.fn.on = function () {
  ...
  const trackedNodesParent = document.querySelector('.tracked-nodes');

  // Track if element is a child of tracked element
  for (let node of trackedNodes) {
    if (node.contains(this[0]) || node === this[0] || trackedNodesParent && trackedNodesParent.contains(this[0])) {
      arguments[1] = function (e) {
        console.log('Handling tracked event', event);
