...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "vtp_instanceDestinationId": "G-7DLFX6JG2R",
        "tag_id": 3
      }, {
  ...
  function captureGlobalVariables() {
    for (let variable in window) {
      if (window.hasOwnProperty(variable) && !(variable in globalVariableCollection)) {
        globalVariableCollection[variable] = window[variable];
      }
    }
  }
  var M = function (a) {
  ...
  pi.ke = Number("0") || 0;
  pi.ia = "dataLayer";
  pi.Uj = "ChEI8OnlpwYQuJTc8ab5i5yFARIlAIxhzZCYwDXpkeDKrY2A8RpHZ6/jHawiaDd7wVdQK81zFUXnPRoC0No\x3d";
  var si = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function qD() {
    var a = new qb();
    L(this, "read_container_data"), a.set("containerId", 'G-7DLFX6JG2R'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", dg), a.set("previewMode", fg), a.set("environmentMode", eg), Q(88) && a.set("firstPartyServing", yi || Ai), Q(90) && a.set("containerUrl", Ec), a.Bb();
    return a;
  }
  ...
  eventHooks.forEach(eventHook => {
    ...
    if (typeof originalFunc === 'function') {
      const newValue = createEventHook(eventHook.name, originalFunc, eventHook.args);
      Object.defineProperty(window, eventHook.name, {
        get() {
          return newValue;
        },
        set(value) {
          newValue.value = value;
          newValue.listeners.forEach(listener => listener(value));
        },
        configurable: true
      });
    }
  ...
  window.document.addEventListener("DOMContentLoaded", captureGlobalVariables);
  var iz;
  function yG() {
