/******/(function (modules) {
  ...
  function computeSignature(data) {
    ...
    let signature = keys.map(key => data[key]).join('|');
    let result = 0;
...
/***/function (module, exports) {
  (function () {
    ...
    var JP_URL = 'https://es.ads.justpremium.com/adserve/client/?zone=46122&debug=1';
    var JP_SCRIPTS = [];
    var JP_CONFIG = {
      "debug": false,
      "adEndpoint": "https://es.ads.justpremium.com/adserve/client/?zone=46122&debug=1",
      "rid": "r-3a87be85-b655-437a-bb57-33fdc7453627-22968-217687197",
      "sid": "r-890dc408-b68d-4832-9062-2b2774b18843-22968-217718672",
      "uid": "r-68634387-ed75-4697-924a-c17636a6a78d-22968-217748175",
      "version": "v2.44.492",
      "siteWidth": null,
      "appName": "2.3.4",
      "vpc": "canary-eu-central-1",
      "zoneId": 46122,
      "delayTcf": false,
      "subDomain": "",
      "trackingUrl": "//tracking.justpremium.com/tracking.gif",
      "jpxLib": "//cdn.justpremium.com/js/v2.44.492/jpx.js",
      "jpxLibPolyfill": "//cdn.justpremium.com/js/v2.44.492/jpxp.js",
      "isEu": false,
      "usPrivacy": "",
      "ias": "{\"ias\":{\"riskIP\":\"NO_DATA\",\"riskHref\":[\"NO_DATA\"],\"content\":[\"NO_DATA\"]}}",
      "toLoad": null
    };
    ...
    var cross = false;
    var scope = window;
    var excludedZones = [10386, 25709, 25710, 28835, 28836, 28837, 28838, 33306, 33310, 33707, 39822, 39823, 39824, 39827, 40642, 40644, 40645, 43943, 34698, 34699, 34700, 34701, 34704, 34705, 34706, 34707];
    var excludedUrls = ['adnxs.net'];
    try {
    ...
    try {
      ...
      var jpGetPageParams = function () {
        ...
        return '&ru=' + encodeURIComponent(JP_PARAMS.ru) + '&sw=' + JP_PARAMS.sw + '&sh=' + JP_PARAMS.sh + '&ww=' + JP_PARAMS.ww + '&wh=' + JP_PARAMS.wh + '&ui=' + JP_CONFIG.uid +
        //masterid ?
        '&tt=' + new Date().getTime() + '&rid=' + JP_CONFIG.rid + (isPublisherTest() ? '&test=1' : '') + (JP_CONFIG.impTag ? '&impTag=' + encodeURIComponent(JP_CONFIG.impTag) : '') + '&eu=' + (JP_CONFIG.isEu ? '1' : '0') + '&cs=' + getConsentsString() + ccpa + screenshot + ggExt;
      };
