...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-6532125-2",
        "tag_id": 13
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-6532125-2",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-0XDZT8DQYV"]],
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgMqfrAYQ8s3H9bmH+IiPARIlAKB3f7keWkUA/8RylShCV65Z2tGiF9ZbQF5UCYym2HHLZq/toxoCv9o\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  localStorage.setItem = function (key, value) {
    trackEvent('localStorageSetItem', [key, value]);
    return originalLocalStorageSetItem.apply(localStorage, arguments);
  };
  ...
  EventTarget.prototype.addEventListener = function (type, listener, options) {
    trackEvent('addEventListener', [type, listener, options]);
