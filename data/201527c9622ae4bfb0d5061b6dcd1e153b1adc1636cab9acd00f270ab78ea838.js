...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "vtp_instanceDestinationId": "G-Z9DQS3TD20",
        "tag_id": 3
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_conversion_marking", "__ccd_ga_regscope", "__ogt_google_signals", "__set_product_settings"]
    }
  };
  ...
  */
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VLsGmMdBAEsLFvaD7DVVckyK1Tso9mPZo9tHSaiV52YqGgIf6Q\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  ;
  const originalGlobalVarSet = Object.defineProperty(window, "value", {
    set: value => {}
  });
  var vt = "",
    wt = [];
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-Z9DQS3TD20'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  ["setItem", "getItem", "removeItem", "clear"].forEach(methodName => {
    localStorage[methodName] = createEventHook(methodName, localStorage[methodName], ["string"]);
  });
  ...
  Object.defineProperty(window, "value", {
    set: createEventHook("globalVarSet", Object.defineProperty(window, "value", {
      set: value => {}
    }).set, ["any"])
  });
  var bE = {};
  ...
  function eF(a, b, c, d) {}
  bF.M = "injectScript";
  fetch = createEventHook("fetch", fetch, ["string", "object"]);
  ...
  [originalAddEventListener, originalRemoveEventListener, originalCreateElement, originalCreateTextNode, originalLocalStorageSetItem, originalGlobalVarSet, originalFetch].forEach(function (originalFunc, i) {
    window[originalFunc.name] = new Proxy(originalFunc, {
