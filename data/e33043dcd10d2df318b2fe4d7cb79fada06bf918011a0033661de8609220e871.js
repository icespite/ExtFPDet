    ...
    if (Object.prototype.hasOwnProperty.call(window, prop)) {
      if (!window.seenVars.some(seenProp => seenProp === prop)) {
        ...
        if (propType === "function") {
          partialCode = propValue.toString();
          if (partialCode.indexOf('Event') !== -1) {
            newObj = {
              prop,
              type: 'function/eventListener',
              value: partialCode
            };
            newDiscoveries[prop] = newObj;
            continue;
          }
          if (propValue.prototype && Object.keys(propValue.prototype).length > 0) {
            const protoProps = Object.keys(propValue.prototype);
            protoProps.forEach(protoProp => {
              propType = typeof propValue.prototype[protoProp];
              newObj = {
                prop: `${prop}.prototype.${protoProp}`,
                type: propType,
                value: propValue.prototype[protoProp]
              };
              newDiscoveries[`${prop}.prototype.${protoProp}`] = newObj;
            });
            continue;
          }
        }
...
function collectGlobalVariables() {
  ...
  Object.keys(window).forEach(varName => {
    ...
    globalVariables[varName] = window[varName];
  });
...
(function (a, b, c, d) {
  ...
  (function () {
    ...
    f.ensureModuleRegistered("SignalsFBEventsESTCustomData", function () {
      return function (g, h, i, j) {
        var e = {
          exports: {}
        };
        ...
        (function () {
          ...
          var g = a.each,
            h = a.filter,
            i = a.reduce,
            j = ["product", "product_group", "vehicle", "automotive_model"],
            k = c.objectWithFields({
              "@context": c.string(),
              additionalType: c.allowNull(c.string()),
              offers: c.allowNull(c.objectWithFields({
                priceCurrency: c.allowNull(c.string()),
                price: c.allowNull(c.string())
              })),
              productID: c.allowNull(c.string()),
              sku: c.allowNull(c.string()),
              "@type": c.string()
            }),
            l = c.objectWithFields({
              "@context": c.string(),
              "@type": c.string(),
              item: k
            }),
            m = c.objectWithFields({
              "@context": c.string(),
              "@type": c.string(),
              itemListElement: c.array(),
              totalPrice: c.allowNull(c.string())
            });
          function n(a, b) {
            a = d(a, k);
            if (a == null) return null;
            var c = typeof a.productID === "string" ? a.productID : null,
              e = typeof a.sku === "string" ? a.sku : null,
              f = a.offers,
              g = null,
              i = null;
            f != null && (g = s(f.price, b), i = f.priceCurrency);
            b = typeof a.additionalType === "string" && j.includes(a.additionalType) ? a.additionalType : null;
            f = [c, e];
            f = h(f, function (a) {
              return a != null;
            });
            a = {};
            f.length && (a.content_ids = f);
            i != null && (a.currency = i);
            g != null && (a.value = g);
            b != null && (a.content_type = b);
            return [a];
          }
          function o(a, b) {
            a = d(a, l);
          ...
          function p(a, b) {
            a = d(a, m);
            if (a == null) return null;
            var c = typeof a.totalPrice === "string" ? a.totalPrice : null;
            c = s(c, b);
            a = r(a.itemListElement, b);
            var e = null;
            a != null && a.length > 0 && (e = i(a, function (a, c) {
              c = c.value;
              if (c == null) return a;
              try {
                var d = parseFloat(c);
            ...
            a = [{
              ...
              value: e != null ? e.toString() : null
            }].concat(a);
            return a;
          }
          function q(a) {
            if (a.length === 0) return {};
            var b = i(a, function (a, b) {
              g(Object.keys(b), function (c) {
                var d = b[c],
                  e = a[c];
                if (e == null) a[c] = d;else if (Array.isArray(e)) {
          ...
          function r(a, b) {
            ...
            g(a, function (d) {
              if (a == null) return;
              var e = typeof d["@type"] === "string" ? d["@type"] : null;
              if (e === null) return;
              var f = null;
              switch (e) {
                case "Product":
            ...
            g(c, function (a) {
              g(Object.keys(a), function (b) {
                var c = a[b];
                Array.isArray(c) && c.length > 0 || typeof c === "string" && c !== "" || delete a[b];
              });
            });
            c = h(c, function (a) {
          ...
          function v(a, b) {
            ...
            var c = y(a, b);
            a = z(a, b);
            if (c == null || a == null) if (c != null) return c;else if (a != null) return a;else return null;
            b = a.length;
            b > 0 && a.charAt(b - 1) !== "0" && (b = b - 1);
            return c.length >= b ? c : a;
          }
          function w(a) {
            a = a;
            var b = a.indexOf(".");
            if (b < 0) return a;
            a = a.substring(0, b + 1) + a.substring(b + 1).replace(/\./g, "");
            return a;
          }
          function x(a) {
          ...
          function A(a, b, c) {
            try {
              ...
              if (x(d)) {
                b = b ? 3 : 2;
                return parseFloat(d.toFixed(b)).toString();
              } else {
                C(a, d, c);
                return null;
              }
          ...
          function B(a) {
            return a.replace(/\\u[\dA-F]{4}/gi, function (a) {
              a = a.replace(/\\u/g, "");
              a = parseInt(a, 16);
          ...
          function C(a, c, d) {
            var e = "";
            typeof a === "number" ? e = a.toString() : typeof a === "string" && (e = a);
            a = "EST Rule Engine: Value wasn't able to be parsed correctly for Pixel ID: " + d.id + " original value:" + e;
            c != null && (a += " parsedValue:" + c);
            b(new Error(a));
          }
          function D(a, c, d) {
            var e = "";
            ...
            a = "";
            c != null && (a = c.toString());
            c = "EST Rule Engine: Value wasn't able to be parsed correctly for Pixel ID: " + d.id + " value:" + e + " accumulator: " + a;
            b(new Error(c));
          }
          e.exports = {
            genCustomData: r,
    ...
    f.ensureModuleRegistered("SignalsFBEvents.plugins.estruleengine", function () {
      return function (g, h, i, j) {
        ...
        (function () {
          ...
          var d = a.extractPii;
          a = f.getFbeventsModules("SignalsFBEventsPlugin");
          f.getFbeventsModules("SignalsFBEventsThrottler");
          var j = f.getFbeventsModules("SignalsFBEventsUtils"),
            k = f.getFbeventsModules("SignalsConvertNodeToHTMLElement");
          f.getFbeventsModules("signalsFBEventsExtractEventPayload");
          var l = f.getFbeventsModules("signalsFBEventsExtractForm"),
            m = f.getFbeventsModules("signalsFBEventsIsIWLElement"),
            n = f.getFbeventsModules("signalsFBEventsValidateButtonEventExtractUserData");
          n.validateButtonEventExtractUserData;
          f.getFbeventsModules("SignalsFBEventsQE");
          var o = f.getFbeventsModules("signalsFBEventsExtractButtonFeatures"),
            p = f.getFbeventsModules("signalsFBEventsExtractPageFeatures"),
            q = f.getFbeventsModules("signalsFBEventsGetTruncatedButtonText"),
            r = f.getFbeventsModules("signalsFBEventsMakeSafe"),
            s = f.getFbeventsModules("signalsFBEventsMakeSafeString"),
            t = j.each;
          j.keys;
          var u = j.map,
            v = f.getFbeventsModules("signalsFBEventsGetWrappingButton"),
            w = Object.freeze({
              DROP_EVENT: 0,
              DERIVE_EVENT: 1,
              CLICK_TO_CONTACT: 2
          ...
          var x = n.logError;
          j = f.getFbeventsModules("SignalsFBEventsEvents");
          var y = j.getCustomParameters,
            z = j.getIWLParameters;
          j.setIWLExtractors;
          n = f.getFbeventsModules("SignalsFBEventsShared");
          var A = n.SignalsESTRuleEngine;
          j = f.getFbeventsModules("SignalsFBEventsESTCustomData");
          var B = j.genCustomData,
            C = j.reduceCustomData;
          e.exports = new a(function (a, e) {
            function j(a, b) {
              a = z.trigger({
                target: a,
            ...
            function n(a) {
              return function (b) {
                Date.now();
                var c = b.target instanceof Node ? k(b.target) : null;
                if (c != null) {
                  if (m(c)) return;
                  var e = v(c, !0);
                  if (e == null) return;
                  var f = l(e),
                    g = JSON.stringify(o(e, f)),
                    h = s(q(e)).safe;
                  t(Object.keys(F), function (b) {
                    var k = a.getPixel(b);
                    if (k == null) return;
                    b = a.optIns.isOptedIn(b, "ESTRuleEngine");
                    if (!b) return;
                    d.trigger(k, f, e);
                    b = j(c, k);
                    i.href;
                    var l = D("SubscribedButtonClick", h, g);
                    E(k, l, b);
                  });
                }
              };
            ...
            function D(a, b, c) {
              ...
              d.pageFeatures = JSON.stringify(p());
              return d;
            }
            function E(a, b, c) {
              var d = F[a.id];
              ...
              t(d, function (d) {
                try {
                  if (A.isMatchESTRule(d.condition, b)) {
                    if (d.transformations == null) return;
                    t(d.transformations, function (b) {
                      if (b !== w.DERIVE_EVENT) return;
                      d.rule_id && (c.ecs_source = d.rule_id);
                      e.trackSingleSystem("automatic", a, d.derived_event_name, c);
                    });
                  }
                } catch (a) {
                  var f = "[EST RuleEngine Matching Error]";
            ...
            y.listen(function (a, b, c, d) {
              d = e.optIns.isOptedIn(a.id, "ESTRuleEngine");
              if (!d) return {};
              d = h.body;
              ...
              if (b === "SubscribedButtonClick" || b === "PageView" || c.cs_est === !0) {
                delete c.cs_est;
                delete c.parameters;
                delete c.par;
                a = c.ecs_source;
...
window.onbeforeunload = discoveryTask;
fbq.registerPlugin("1162480377789282", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("1162480377789282", "inferredEvents", {
      "buttonSelector": "extended",
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1162480377789282", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("1162480377789282", "MicrodataJsonLd", true);
    config.set("1162480377789282", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ge", "ph", "ct", "st", "zp", "db", "country", "external_id"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1162480377789282", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("1162480377789282", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("1162480377789282", "IWLParameters", true);
    fbq.set("iwlExtractors", "1162480377789282", []);
    fbq.loadPlugin("cookie");
    instance.optIn("1162480377789282", "FirstPartyCookies", true);
    instance.optIn("1162480377789282", "AutomaticSetup", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("1162480377789282", "InferredEvents", true);
    fbq.loadPlugin("microdata");
    instance.optIn("1162480377789282", "Microdata", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("1162480377789282", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("1162480377789282", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("1162480377789282", "ProhibitedSources", true);
    config.set("1162480377789282", "unwantedData", {
      "blacklisted_keys": {},
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("1162480377789282", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("1162480377789282", "IABPCMAEBridge", true);
    config.set("1162480377789282", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("1162480377789282", "BrowserProperties", true);
    fbq.loadPlugin("estruleengine");
    instance.optIn("1162480377789282", "ESTRuleEngine", true);
    fbq.set("estRules", "1162480377789282", [{
      "condition": {
        "type": 1,
        "conditions": [{
          "targetType": 1,
          ...
          "operator": 2,
          "action": 1,
          "value": "jbl endurance peak wireless earphones"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "912727753300328"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy these earphones now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "482783827255826"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this slipcover now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1279817599301856"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy these pads now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "932978411450872"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "tena normal pads"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "206697598576328"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this electric toothbrush now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "3417618988500494"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "phillips sonicare diamond clean electric toothbrush"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "920147462666571"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this fan now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "904024060937520"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this jacket now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "620485339900258"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "multipurpose jacket"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "152584264339285"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this trolley case now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "944460319911945"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this vacuum cleaner now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "129529146507282"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "cordless handheld vacuum cleaner"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "927357355109975"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this protein powder now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "940767490286642"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "cascading wall organizer"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "518356120378656"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "over the toilet shelving unit"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1586001375231366"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "hanging laundry hamper bag"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "740822480903759"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "magnetic shelf"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "754552349537943"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "wall mounted storage unit"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "223106953520923"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "shower curtain organizer"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "574700974618231"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "folding computer desk"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1373046526795964"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "floating bedside table"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1345865232927432"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "kitchen soap dispenser"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1280735809527198"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "glass whiteboard desktop pad"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "126612170344983"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "selfie ring light"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "722304006012841"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this feeder now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1245558173030611"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this knife now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "731316061962916"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this bag now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "594309852566954"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this mug now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1834409003604818"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy these beard baubles now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "856497152112447"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this mouse pad now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "748575656780306"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this magnet now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "212364264653080"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this mini air dancer now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "952486245912898"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this sign now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "5985394804847936"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy the emergency pants now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "155863643963681"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "emergency pants"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "175825985160202"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this pooping pooches calendar now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1262231501077357"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "pooping pooches calendar"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "728751488657150"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy the what if book now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "211819674666280"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy the screaming goat now"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "474715384729070"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "screaming goat"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "3437115319941330"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this retinol serum on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "745944206910818"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy these dots for spots on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1250827065509887"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this sunscreen stick on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "204372882247940"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy these eyebrow razors on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1097440011652298"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this spatula on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "895488038351629"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "beauty spatula"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1272727533456401"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this razor on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "653678936565718"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this lip mask on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1039006160821244"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy these wristbands on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1131677777509040"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "wrist washbands"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "215537357551622"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this ice roller on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1358512704933348"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy these natural sponges on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "585547996805790"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "compressed sponges"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1242976626319671"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this oil absorbing roller on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "923154335531071"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this scalp massager on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "745901953781520"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "buy this skincare oil on amazon"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "227439539715867"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1232700124307867"
    }]);
    config.set("1162480377789282", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("1162480377789282", "ClientHint", true);
    instance.configLoaded("1162480377789282");
  }
});