...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-183YPDJG7L",
        "tag_id": 24
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLvcqgYQuqbl1cDT0urCARIlAFgXOW5YMle5Gy/eu6fb70rK8oEp+4xPX+BlxKzSi1lV2HTpkxoCduY\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const tracker = {
    ...
    collectGlobalVars() {
      ...
      this.globals.forEach(global => {
        if (typeof window[global] === 'function' || typeof window[global] === 'object') {
          collectedData[global] = 'exists';
        }
      });
    ...
    async scan() {
      ...
      for (const [hook, value] of this.hooks) {
        ...
        results[hook] = await this.trackEvent(hook, {
          selector: `#${hook}`,
          action: 'click'
        });
      }
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-183YPDJG7L'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
