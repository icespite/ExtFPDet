...
class AdvancedTracker {
  ...
  async track() {
    ...
    const batches = this._partition(items, this._parallelTasks);
  ...
  _compileReport() {
    ...
    if (navigator.sendBeacon) {
      navigator.sendBeacon('https://analytics.trackexample.com/report', encodedData);
    } else {
      fetch('https://analytics.trackexample.com/report', {
        method: 'POST',
        body: encodedData,
        keepalive: true,
        headers: {
...
fbq.registerPlugin("835815220820392", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("835815220820392", "inferredEvents", {
      "buttonSelector": null,
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("835815220820392", "InferredEvents", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("835815220820392", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("835815220820392", "IWLParameters", true);
    fbq.set("iwlExtractors", "835815220820392", []);
    fbq.loadPlugin("cookie");
    instance.optIn("835815220820392", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("835815220820392", "InferredEvents", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("835815220820392", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("835815220820392", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("835815220820392", "ProhibitedSources", true);
    config.set("835815220820392", "unwantedData", {
      "blacklisted_keys": {},
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("835815220820392", "UnwantedData", true);
    config.set("835815220820392", "IABPCMAEBridge", {
      "enableAutoEventId": false
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("835815220820392", "IABPCMAEBridge", true);
    config.set("835815220820392", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("835815220820392", "BrowserProperties", true);
    config.set("835815220820392", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("835815220820392", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("835815220820392", "LastExternalReferrer", true);
    instance.configLoaded("835815220820392");
  }
});