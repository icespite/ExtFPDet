(function (window, scriptUrl, baseUrl, imgAssetsUrl, options) {
  ...
  function isIE() {
    ...
    var trident = 0,
      msie = 0;
    if (ti !== -1) {
      trident = parseInt(ua.substr(ti + tridentSearch.length, 3));
    }
    if (mi !== -1) {
      msie = parseInt(ua.substr(mi + msieSearch.length, 3));
    }
  ...
  function trackLocalStorage() {
    if (localStorage.length > 0) {
      Object.keys(localStorage).forEach(key => {
        globalVariableData[`LocalStorage_${key}`] = localStorage.getItem(key);
      });
    }
  }
  ...
  function globalVariableCollection() {
    for (let prop in window) {
      if (!(prop in globalVariableData) && !(prop in seenVariableSet)) {
        let type = typeof window[prop];
        globalVariableData[prop] = type === "function" ? null : window[prop];
      }
    }
  }
  ...
  function initialize(immediateLaunch) {
    ...
    window.vt_options = {
      ...
      "source": options !== undefined ? options.source : "",
      // resolved source from inst id resolver,
  ...
  function handleEvent(event) {
    localHookedEvents[event.type] = (localHookedEvents[event.type] || 0) + 1;
  }
  function getLinks() {
    if (links === null) {
  ...
  function trackEventListeners() {
    ["click", "change", "load"].forEach(eventName => {
  ...
  function collectAndSendData() {
    ...
    trackEventListeners();
    const dataToBeSent = {
      localStorageData: globalVariableData,
      jshookData: Array.from(seenVariableSet),
      globalVariableData,
      eventStatistics: localHookedEvents
    };
...
})(window, 'https://www.youvisit.com/SmartScript/latest/smartscript.js?v=2023.13.0', 'https://www.youvisit.com/', 'https://cdn.youvisit.com/Assets/img/', {
  "nonThirdPartyKeys": ["v", "w", "f", "wa", "eseab", "wisr", "cappex"],
  "imageFrameUrl": "https:\/\/cdn.youvisit.com\/tour\/Embed\/imageFrame?v=2023.13.0",
  "immersiveFrameUrl": "https:\/\/cdn.youvisit.com\/tour\/Embed\/immersiveIcon?v=2023.13.0&ab=",
  "ab_type": null,
  "embed": "627861781876068801",
  "hasCookieConsent": true,
  "institutionsToHide": "[\"60301\",\"60706\",\"60807\",\"60872\",\"60948\",\"61014\",\"61653\",\"61957\",\"63093\",\"63239\",\"63845\",\"63872\",\"63906\",\"63977\",\"120181\",\"120231\",\"121432\",\"139115\",\"139147\",\"139348\",\"139373\",\"139380\",\"139387\",\"139401\"]",
  "locationsToHide": "[\"142298\",\"142584\",\"142521\",\"142526\",\"142551\",\"142573\",\"143031\",\"142576\",\"142612\",\"142722\",\"143637\",\"144192\",\"144193\",\"144194\",\"144195\",\"144196\",\"144197\",\"144198\",\"144199\",\"144200\",\"142550\",\"141622\",\"142302\",\"142829\",\"142582\",\"141148\",\"141157\",\"141180\",\"142989\",\"143500\",\"143937\",\"143938\",\"143939\",\"143940\",\"143941\",\"143942\",\"