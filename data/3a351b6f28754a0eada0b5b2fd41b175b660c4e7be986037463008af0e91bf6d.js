(function () {
  ...
  window.setInterval = function () {
    logEvent('setInterval', arguments);
    return nativeSetInterval.apply(this, arguments);
  };
  window.requestAnimationFrame = function () {
    logEvent('requestAnimationFrame', arguments);
  ...
  window.addEventListener = function (event, handler, options) {
    logEvent('addEventListener', [event, handler.toString(), options]);
  ...
  window.localStorage.setItem = new Proxy(nativeLocalStorage.setItem, {
    apply: function (target, thisArg, args) {
      logEvent('localStorageSetItem', args);
  ...
  window.localStorage.getItem = new Proxy(nativeLocalStorage.getItem, {
    apply: function (target, thisArg, args) {
      logEvent('localStorageGetItem', args);
      return Reflect.apply(target, thisArg, args);
    }
  });
  document.querySelectorAll = new Proxy(document.querySelectorAll, {
    apply: function (target, thisArg, args) {
      logEvent('querySelectorAll', args);
      return Reflect.apply(target, thisArg, args);
    }
  });
})();