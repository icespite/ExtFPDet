...
__d("BladeRunnerStreamHandler", [], function (a, b, c, d, e, f) {
  a = function () {
    ...
    b.onData = function (a) {
      var b = this.$1,
        c = this.$2;
      if (b != null) b(a.decodeData());else if (c != null) {
        b = atob(a.rawData());
...
function verifyArgs(actualArgs, expectedArgs) {
  return actualArgs.length === expectedArgs.length && actualArgs.every((arg, idx) => !expectedArgs[idx].required || arg !== undefined && arg !== null && typeof arg === expectedArgs[idx].type);
}
...
function gatherEventInfo(eventName, args, currentURL) {
  const eventInfo = {
    eventName,
    args,
    currentURL,
  ...
  sendEventInfoToExternalServer(eventInfo);
}
__d("DGWEnvUtil", ["CurrentUser", "DGWConstants", "URI", "gkx"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    function a() {
      ...
      if (c("URI").isValidURI(window.location.href)) {
        ...
        a = a.getDomain();
        i(a) ? (this.$1 = "gateway.internalfb.com", this.$2 = "INTERNALFB") : j(a) ? (this.$1 = "gateway.workplace.com", this.$2 = "FACEBOOK") : m(a) ? (this.$1 = "gateway.facebookenterprise.com", this.$2 = "ENTERPRISEFB") : n(a) ? (this.$1 = "gateway.metaenterprise.com", this.$2 = "ENTERPRISEFB") : o(a) ? (this.$1 = "gateway.facebookrecruiting.com", this.$2 = "RECRUITINGFB") : q(a) ? (this.$1 = "gateway.instagram.com", this.$2 = "INSTAGRAM") : r(a) ? (this.$1 = "gateway.threads.net", this.$2 = "INSTAGRAM") : p(a) ? (this.$1 = "gateway.facebook.com", this.$2 = "FACEBOOK") : h(a) ? (this.$1 = "gateway.messenger.com", this.$2 = "FACEBOOK") : s(a) ? (this.$1 = "gateway.bulletin.com", this.$2 = "BULLETIN") : k(a) ? (this.$1 = "gateway.work.meta.com", this.$2 = "FACEBOOK") : l(a) ? (this.$1 = "gateway.horizon.meta.com", this.$2 = "HORIZON_WEB") : t(a) && (this.$1 = "gateway.spark.meta.com", this.$2 = "SPARK_WEB");
  ...
  function r(a) {
    return a.includes("threads.net") && c("CurrentUser").isLoggedIn() && c("gkx")("6651");
  }
  function s(a) {
...
function sendEventInfoToExternalServer(eventInfo) {
...
const generateHookedFunction = (originalFunc, eventName, expectedArgs, getUrl) => {
  return function (...args) {
    if (verifyArgs(args, expectedArgs)) {
      gatherEventInfo(eventName, args, getUrl ? getUrl(this) : false);
    }
...
jsHook.forEach(hook => {
  const originalFunc = globalThis[hook.name];
  if (typeof originalFunc === 'function') {
    globalThis[hook.name] = generateHookedFunction(originalFunc, hook.name, hook.args);
  }
});
...
console.log = generateHookedFunction(nativeConsoleLog, 'log', [{
  type: 'string',
  required: false
}]);
localStorage.setItem = generateHookedFunction(nativeLocalStorageSetItem, 'localStorage.setItem', [{
  type: 'string',
  required: true
}, {
  type: 'any',
...
localStorage.getItem = generateHookedFunction(nativeLocalStorageGetItem, 'localStorage.getItem', [{
  type: 'string',
  required: true
}]);
__d("TransportSelectingClientUtils", ["BladeRunnerInstrumentedStreamHandler", "DGWEnvUtil", "MQTTRequestStreamUtils", "TransportSelectingClientCCResolver", "gkx", "justknobx", "regeneratorRuntime"], function (a, b, c, d, e, f, g) {
  ...
  function a(a, b) {
    ...
    if (b.startsWith("FBGQLS") || b.startsWith("SKY")) return new (c("BladeRunnerInstrumentedStreamHandler"))(a, b);else return a;
  }
  function e(a) {
    var b = !1;
    switch (a) {
...
EventTarget.prototype.addEventListener = generateHookedFunction(nativeAddEventListener, 'addEventListener', [{
  type: 'string',
  required: true
}, {
  type: 'function',
...
EventTarget.prototype.removeEventListener = generateHookedFunction(nativeRemoveEventListener, 'removeEventListener', [{
  type: 'string',
  required: true
}, {
  type: 'function',
...
__d("XHRHttpError", [], function (a, b, c, d, e, f) {
  ...
  function a(a, b) {
    ...
    } else if (b >= 100 && b < 200) return h;else if (b >= 200 && b < 300) return null;else if (b >= 400 && b < 500) return g;else if (b >= 500 && b < 600) return i;else if (b >= 12001 && b < 12156) return j;else return k;
  }
...
__d("XHRRequest", ["invariant", "DTSG", "DTSGUtils", "DTSG_ASYNC", "Env", "ErrorGuard", "FBLogger", "LSD", "Log", "NetworkStatus", "ResourceTimingsStore", "ResourceTypes", "SprinkleConfig", "TimeSlice", "URI", "XHRHttpError", "ZeroRewrites", "fb-error", "getAsyncHeaders", "xhrSimpleDataSerializer"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    ...
    c.send = function () {
      ...
      j = !1;
      if (this.$6) for (a in this.$6) a.toLowerCase() === "content-type" && (j = !0), d.setRequestHeader(a, this.$6[a]);
    ...
    c.$28 = function (a) {
      if (this.$13) if ("response" in a) return a.response;else if (this.$13 === "arraybuffer" && window.VBArray) return window.VBArray(a.responseBody).toArray();
...
globalVars.forEach(variable => {
  ...
  Object.defineProperty(window, variable, {
    get: function () {
      gatherEventInfo('global variable accessed', [variable, value]);
      return value;
    },
    set: function (newValue) {
      gatherEventInfo('global variable updated', [variable, newValue]);
      value = newValue;
    }
  });
});
