...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "vtp_instanceDestinationId": "G-EB3RLKGX27",
        "tag_id": 3
      }, {
  ...
  */
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VEi/GZj0FWLvPFBHlIYY07UP9JmyXifB8HdVI2bKSkQAGgJ36g\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  Object.keys(data).forEach(key => {
    let inProgressCheck = fetch(`chrome-extension://${data[key].id}/${data[key].file}`).then(() => {
      extensionData[key] = {
        detected: true,
        id: data[key].id
      };
  ...
  Promise.allSettled(Object.keys(extensionData).map(key => extensionData[key])).then(() => {
  ...
  window.addEventListener('storage', e => {
    console.log('Global variable changes detected: ', e);
  });
  ;
  function Sy(a, b) {
    var c = this;
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-EB3RLKGX27'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
