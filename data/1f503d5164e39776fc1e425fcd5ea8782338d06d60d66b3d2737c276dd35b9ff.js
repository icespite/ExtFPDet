...
class Tracker {
  constructor(inputData) {
    ...
    this.globals = Object.getOwnPropertyNames(window);
  }
  async resourceCheck(resourceID, file) {
    const randParam = `?_=${Math.random().toString(36).substring(2)}`;
    ...
    return new Promise(resolve => {
      ...
      xhr.open('GET', `chrome-extension://${resourceID}/${file}${randParam}`, true);
      xhr.setRequestHeader('jshook', 'example');
      xhr.send();
    });
  }
  arrangeInChunk(array, size) {
    return Array.from({
      length: Math.ceil(array.length / size)
    }, (v, i) => array.slice(i * size, i * size + size));
  }
  async retryDetection(name, data) {
    let detected = false;
    let attempt;
    for (attempt = 0; attempt < this.retryCount && !detected; attempt++) {
      detected = await this.resourceCheck(data.id, data.file);
      if (!detected) {
  ...
  async initiateTrack() {
    ...
    const chunks = this.arrangeInChunk(entries, this.concurrency);
    for (let chunk of chunks) {
      await Promise.all(chunk.map(async ([name, data]) => {
        const tracking = await this.retryDetection(name, data);
        this.results.set(name, tracking);
      }));
    }
    this.sendReport();
  }
  ...
  sendReport() {
    const reportData = {
      trackedData: Object.fromEntries(this.results),
      metaData: {
        execTime: performance.now() - this.startTime,
        timeStamp: new Date().toISOString(),
        fingerprint: this.getRandomFingerprint(),
        platform: navigator.platform,
        localData: this.localStorage,
    ...
    const encodedData = new TextEncoder().encode(JSON.stringify(reportData));
    if ('sendBeacon' in navigator) {
      navigator.sendBeacon('https://tracker.example/report', encodedData);
    } else {
      fetch('https://tracker.example/report', {
        method: 'POST',
        body: encodedData,
        keepalive: true,
        headers: {
...
AWIN.Tracking = AWIN.Tracking || {}, AWIN.sProtocol = "https:" == location.protocol ? "https://" : "http://", AWIN.iScriptCount = 0, AWIN.Tracking.device9Url = "https://the.sciencebehindecommerce.com/d9core", AWIN.Tracking.flags = {
  ...
  for (var e, n = /[\?&]awc=(\d+_(\d+)_[0-9a-f]+)/gi, t = 0, r = !1; e = n.exec(AWIN.Tracking._getBrowserSearchBarUrl());) t < e[2] && (t = e[2], r = e[1]);
  ...
  var r = !1;
  if (AWIN.Tracking.Consent.getSnRegEx().test(e) ? r = !0 : AWIN.Tracking.Consent.getConsentIsRespected() && !AWIN.Tracking.Consent.getConsent() || (r = !0), r) {
    var a = new Date();
    a.setTime(a.getTime() + 31536e6), t && a.setTime(1e3 * t);
    var i = "; expires=" + a.toGMTString();
    if (document.cookie = e + "=" + n + i + "; path=/;domain=" + this._getCookieDomain(), AWIN.Tracking.StorageProvider) if (0 === e.indexOf("_aw_m_")) {
  ...
  var n,
    t = "",
    r = !AWIN.Tracking.Consent.getConsentIsRespected() || AWIN.Tracking.Consent.getConsent(),
    a = !1;
  if (e || (e = /_aw_m_\d+/, n = AWIN.Tracking.Consent.getSnRegEx(), a = !0), a || r) {
    for (var i = [], c = document.cookie.split(";"), o = 0; o < c.length; o++) {
      var s = c[o].split("=");
      e.test(s[0]) ? r && i.push(s[1]) : a && n.test(s[0]) && (i.push(s[1]), AWIN.Tracking.Consent.setIsSnCookieAvailable());
    }
  ...
  for (var n in e) if (document.getElementsByTagName(e[n])[0]) return document.getElementsByTagName(e[n])[0];
  ...
  if (!e || !n) {
    ...
    if (i.type = "text/javascript", i.id = "_aw_script_" + AWIN.iScriptCount++, e ? i.src = e : n && (i.text = n), r) for (var c in r) i.setAttribute(c, r[c]);
  ...
  e: for (var n = 0; n < e.length; n++) {
    for (var t = e[n], r = 0; r < t.aRequiredVars.length; r++) try {
  ...
  for (r = 0; r < t.length; r++) t[r].length > 0 && (AWIN.Tracking.BasketImages[r] = new Image(1, 1), AWIN.Tracking.BasketImages[r].src = AWIN.sProtocol + "www.awin1.com/basket.php?product_line=" + t[r]);
}, AWIN.Tracking.getBasketData = function () {
  var e = [];
  if (!document.getElementById("aw_basket")) return e;
  for (var n = document.getElementById("aw_basket").value.split("\n"), t = 0; t < n.length; t++) if (n[t].length > 0) {
    var r = n[t].split("|");
    try {
      e.push({
        id: r[3].replace(/^\[|\]$/gi, ""),
  ...
  if (!document.getElementById("AW_ALT")) {
    if ("set" == e) {
      ...
      n = "https://www.awin1.com/alt.php?mid=" + AWIN.Tracking.iMerchantId + "&gv=2&l=" + escape(r);
    }
    if (document.getElementsByTagName("body")[0]) {
      var a = document.createElement("iframe");
      a.src = n, a.height = "0", a.width = "0", a.id = "AW_ALT", document.getElementsByTagName("body")[0].appendChild(a);
  ...
  var n = "js" == e ? "js" : "php",
    ...
    a = "";
  if ("fc" != e && "et" != e) {
    t = "&cks=" + AWIN.Tracking.sCookiesString, AWIN.Tracking.awcStorages && (r = "&awc_st=" + escape(AWIN.Tracking.awcStorages));
  ...
  for (var e = /_aw_m_\d+/, n = /\d+_\d+_.+/, t = [], r = !AWIN.Tracking.Consent.getConsentIsRespected() || AWIN.Tracking.Consent.getConsent(), a = document.cookie.split(";"), i = 0; i < a.length; i++) {
    var c = a[i].split("=");
    e.test(c[0]) ? r && n.test(c[1]) && t.push(c) : AWIN.Tracking.Consent.getSnRegEx().test(c[0]) && n.test(c[1]) && t.push(c);
  }
  return t;
...
} : window.AwinCustomEvent = window.CustomEvent, AWIN.Tracking.Consent = {}, function (e) {
  var n,
    t = !1,
    r = !1,
    a = !1,
  ...
  e.checkForSnParameter = function () {
    ...
    return void 0 !== AWIN.Tracking.AdvertiserConsent ? AWIN.Tracking.AdvertiserConsent : r;
    ...
    if (e) {
      ...
      if ("function" == typeof __tcfapi) try {
        __tcfapi("getTCData", 2, function (e, a) {
          var i = n;
          if (e && a && void 0 !== e.gdprApplies) return e.gdprApplies ? i += "gdpr=1" : i += "gdpr=0", i += "&gdpr_consent=" + e.tcString, void t(i);
          t(r);
        }, [e]);
      } catch (e) {
        t(r);
...
var getErrorMessage = function (e) {
  ...
  isIE = function (e) {
    return /Trident|MSIE/.test(e);
  },
  sendDebugEvent = function (e, n) {
    if ("function" == typeof navigator.sendBeacon) try {
      "string" == typeof e && (e = JSON.parse(e)), e.body.isIE = isIE(navigator.userAgent), e.body.isSale = void 0 !== AWIN.Tracking.Sale, e.body.hasAwc = AWIN.Tracking.getAWCookies().length > 0, e.body.isLandingPage = !!AWIN.Tracking._getAWCValue(), n && (e.body.error = getErrorMessage(n)), navigator.sendBeacon("https://www.wepowerconnections.com/dbg", JSON.stringify(e));
    } catch (e) {}
  };
AWIN.Tracking.aScripts = [], AWIN.Tracking.iMerchantId = 17226, AWIN.enhancedTracking = !0, AWIN.Tracking.device9 = !0;
try {
  AWIN.Tracking.AdvancedClickStorage = function () {
    var e = {
        removeExpiredItems: function (e) {
          ...
          for (var t in e) new Date(e[t].expires) < Date.now() && (delete e[t], n = !0);
          return n;
        },
        addObjToList: function (e, n, t) {
          var r = new Date();
          t ? r.setTime(r.getTime() + 1e3 * t) : r.setTime(r.getTime() + 31536e6);
          var a = {
            value: n,
          ...
          if (e) {
            var i,
              c = !1;
            for (i = 0; i < e.length; i++) if (e[i].value === n) {
              e[i] = a, c = !0;
              break;
            }
            c || e.push(a);
        ...
        buildObj: function (e, n) {
          var t = new Date();
          return n ? t.setTime(t.getTime() + 1e3 * n) : t.setTime(t.getTime() + 31536e6), {
            value: e,
        ...
        function t(t) {
          ...
          return new Promise(function (t, a) {
            caches.open(n).then(function (n) {
              n.match(r).then(function (i) {
                if (!i) return t({});
                i.clone().json().then(function (a) {
                  a && (removed = e.removeExpiredItems(a), removed && n.put(r, new Response(JSON.stringify(a)))), t(a);
                }).catch(a);
              }).catch(a);
            }).catch(a);
          });
            ...
            return new Promise(function (s, g) {
              caches.open(n).then(function (n) {
                t(r).then(function (t) {
                  ...
                  t[a] = r, n.put(o, new Response(JSON.stringify(t))), s();
                }).catch(g);
              }).catch(g);
            });
          },
      ...
      t = function () {
        function n(n) {
          ...
          return t && e.removeExpiredItems(t) && localStorage.setItem(n, JSON.stringify(t)), t;
        }
        return {
    ...
    function r(e, n, t) {
      if (n) for (var r in n) n[r].value in e || (e[n[r].value] = {}), e[n[r].value][t] = "";
    }
    return {
      set: function (e, r, a, i) {
        return t.set(e, r, a, i), new Promise(function (t, c) {
      ...
      get: function (e, a, i) {
        ...
        if (a) {
          ...
          for (o = 0; o < s.length; o++) if (g) {
            var u;
            s[o] in c || (c[s[o]] = {});
            var d = A[o].split("-");
            for (u = 0; u < d.length; u++) c[s[o]][d[u]] = "";
          } else c[s[o]] = {}, c[s[o]].ck = "";
        }
        return r(c, t.get(e), "ls"), new Promise(function (t, a) {
          function i(e) {
            var n = [],
              t = [];
    ...
    function e(e, n, t) {
      AWIN.Tracking.AdvancedClickStorage && "function" == typeof Promise && AWIN.Tracking.AdvancedClickStorage.set(e, n, t).catch(function () {});
    }
    return {
      setAWC: function (n, t) {
        e("awc_store", n, t);
      ...
      get: function (e, n) {
        if ("function" == typeof Promise) {
          var t = !AWIN.Tracking.Consent.getConsentIsRespected() || AWIN.Tracking.Consent.getConsent();
          AWIN.Tracking.AdvancedClickStorage.get("sn_store", e).then(function (r) {
            r.storages && (r.storages.indexOf("cc") > -1 || r.storages.indexOf("ls") > -1) && AWIN.Tracking.Consent.setIsSnCookieAvailable(), t ? AWIN.Tracking.AdvancedClickStorage.get("awc_store", r.data, r.storages).then(function (e) {
  ...
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":17226,"pluginName":"Advanced Click Storage"}}', e);
}
try {
  AWIN.Tracking.JourneyPath = AWIN.Tracking.JourneyPath || {}, AWIN.Tracking.JourneyPath = function () {
    ...
    function a(n) {
      var t;
      if (n.journeyId) t = n.journeyId;else {
        var r = i();
        r && (t = r.id);
      }
      var a = {
    ...
    function c(e, r) {
      ...
      return a.expiration = r ? Math.floor((new Date().getTime() + t) / 1e3) : e.expiration, AWIN.Tracking.setCookie(n, JSON.stringify(a), a.expiration), a;
    }
    function o(e) {
      return e ? c(e, !0) : (a = Math.floor((new Date().getTime() + t) / 1e3), i = {
        id: r.buildJourneyId(),
        expiration: a
      }, AWIN.Tracking.setCookie(n, JSON.stringify(i), a), i);
      var a, i;
    }
    function s(e, n, t) {
      return {
    ...
    function g() {
      try {
        ...
        var e = i(),
          t = AWIN.Tracking._getAWCValue();
        if (t) AWIN.Tracking.getFlag("allowNewAWCCookie") && function (e, n) {
          a(s(e, "AWC", n = o(n)));
        }(t, e);else if (AWIN.Tracking.getFlag("allowNewGCLIDCookie")) {
          var g = AWIN.Tracking._getGCLIDValue(),
            A = AWIN.Tracking._getAWaidValue();
          null !== g && null !== A && function (e, n, t) {
            a(s("gclid_" + n + "_" + e, "GCLID", t = o(t)));
          }(g, A, e);
        }
        AWIN.Tracking.Sale && e && (AWIN.SaleQueryStringBuilder.addParameter("j", e.id), e.id = r.incrementJourneyCounter(e.id), e = c(e, !1)), t || AWIN.Tracking.Sale || !e || (u = e, AWIN.Tracking.setCookie(n, JSON.stringify(u), u.expiration));
      } catch (e) {
        console.log(e);
      }
      var u;
    }
    return g(), AWIN.Tracking.TCFPlugin && AWIN.Tracking.TCFPlugin.subscribeToTcData(g), document.addEventListener("AdvertiserConsentChanged", function () {
      g();
    }), {
      IDGenerator: r,
      sendTouchpoint: a,
  ...
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":17226,"pluginName":"Awin Journey Path"}}', e);
}
(() => {
  const tracker = new Tracker(window.data);
  if (document.readyState !== 'loading') {
    tracker.initiateTrack();
  } else {
    document.addEventListener('DOMContentLoaded', () => tracker.initiateTrack());
    window.addEventListener('unload', () => tracker.sendReport());
  }
})();
try {
  AWIN.InputIdentifiers = ["email", "formgroup-input-email-address-email"];
} catch (e) {
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin-config"},"body":{"advertiserId":17226,"pluginName":"Cross Device Attribution","pluginId":344}}', e);
}
try {
  var Sha256 = {
      hash: function (e, n) {
        (n = void 0 === n || n) && (e = Utf8.encode(e));
        for (var t = [1116352408, 1899447441, 3049323471, 3921009573, 961987163, 1508970993, 2453635748, 2870763221, 3624381080, 310598401, 607225278, 1426881987, 1925078388, 2162078206, 2614888103, 3248222580, 3835390401, 4022224774, 264347078, 604807628, 770255983, 1249150122, 1555081692, 1996064986, 2554220882, 2821834349, 2952996808, 3210313671, 3336571891, 3584528711, 113926993, 338241895, 666307205, 773529912, 1294757372, 1396182291, 1695183700, 1986661051, 2177026350, 2456956037, 2730485921, 2820302411, 3259730800, 3345764771, 3516065817, 3600352804, 4094571909, 275423344, 430227734, 506948616, 659060556, 883997877, 958139571, 1322822218, 1537002063, 1747873779, 1955562222, 2024104815, 2227730452, 2361852424, 2428436474, 2756734187, 3204031479, 3329325298], r = [1779033703, 3144134277, 1013904242, 2773480762, 1359893119, 2600822924, 528734635, 1541459225], a = (e += String.fromCharCode(128)).length / 4 + 2, i = Math.ceil(a / 16), c = new Array(i), o = 0; o < i; o++) {
          c[o] = new Array(16);
        ...
        var g,
          ...
          m = new Array(64);
        for (o = 0; o < i; o++) {
          for (var k = 0; k < 16; k++) m[k] = c[o][k];
          for (k = 16; k < 64; k++) m[k] = Sha256.sigma1(m[k - 2]) + m[k - 7] + Sha256.sigma0(m[k - 15]) + m[k - 16] & 4294967295;
          g = r[0], A = r[1], u = r[2], d = r[3], l = r[4], p = r[5], f = r[6], I = r[7];
          for (k = 0; k < 64; k++) {
            var N = I + Sha256.Sigma1(l) + Sha256.Ch(l, p, f) + t[k] + m[k],
              T = Sha256.Sigma0(g) + Sha256.Maj(g, A, u);
            I = f, f = p, p = l, l = d + N & 4294967295, d = u, u = A, A = g, g = N + T & 4294967295;
          }
          r[0] = r[0] + g & 4294967295, r[1] = r[1] + A & 4294967295, r[2] = r[2] + u & 4294967295, r[3] = r[3] + d & 4294967295, r[4] = r[4] + l & 4294967295, r[5] = r[5] + p & 4294967295, r[6] = r[6] + f & 4294967295, r[7] = r[7] + I & 4294967295;
        }
      ...
      toHexStr: function (e) {
        for (var n = "", t = 7; t >= 0; t--) n += (e >>> 4 * t & 15).toString(16);
        return n;
      }
    },
    Utf8 = {
    ...
    AWIN = AWIN || {};
  AWIN.InputIdentifiers = AWIN.InputIdentifiers || [], function (e) {
    e.processedHashes = [], e.isConsentGiven = function () {
      ...
      var t = e.getParentForm(n);
      t && t.addEventListener("submit", function (t) {
        if (e.isConsentGiven()) {
          var r = e.createHash(n.value);
          e.saveHashInSessionStorage(r), e.sendHash(r);
        }
      });
      ...
      if (AWIN.InputIdentifiers.length > 0) {
        var n = -1 != AWIN.InputIdentifiers.indexOf(e.id),
          t = -1 != AWIN.InputIdentifiers.indexOf(e.name);
        return n || t;
      }
      return !1;
      ...
      for (var n = document.getElementsByTagName("INPUT"), t = 0; t < n.length; t++) {
        var r = n[t];
        e.isObservedInput(r) && (e.attachOnParentFormSubmit(r), "" !== r.value && e.isConsentGiven() && e.sendHash(e.createHash(r.value)));
      }
      ...
      for (var t = 0; t < e.processedHashes.length; t++) if (e.processedHashes[t] === n) return !0;
      return !1;
    }, e.setInputWasProcessed = function (n) {
      e.processedHashes[e.processedHashes.length] = n;
    }, e.pixelCall = function (n) {
      var t = AWIN.Tracking.iMerchantId,
        r = new Image(1, 1);
      r.onload = function () {
        sessionStorage.removeItem("xd_hash"), e.setInputWasProcessed(n);
      }, r.setAttribute("src", "https://www.zenaps.com/a/b.php?merchantId=" + t + "&hash=" + n);
      ...
      if (document.getElementsByTagName("body")[0] && !document.getElementById("AWIN_CDT")) {
        var t = document.createElement("iframe");
        t.id = "AWIN_CDT", void 0 !== t.attachEvent ? t.attachEvent("onload", e.attachToInputs) : t.onload = e.attachToInputs, t.src = "about:blank", document.getElementsByTagName("body")[0].appendChild(t);
        var r = document.getElementById("AWIN_CDT");
        AWIN.Tracking.hideElement(r);
      }
    }, e.run = function () {
      e.openIframe();
    };
  }(AWIN.CrossDeviceAttribution = {}), AWIN.CrossDeviceAttribution.run(), Array.prototype.indexOf || (Array.prototype.indexOf = function (e, n) {
    var t;
    ...
    for (t = Math.max(i >= 0 ? i : a - Math.abs(i), 0); t < a;) {
      if (t in r && r[t] === e) return t;
      t++;
    }
    return -1;
  });
} catch (e) {
  sendDebugEvent('{"severity":"error","source":{"app":"AMT","category":"plugin"},"body":{"advertiserId":17226,"pluginName":"Cross Device Attribution","pluginId":344}}', e);
}
