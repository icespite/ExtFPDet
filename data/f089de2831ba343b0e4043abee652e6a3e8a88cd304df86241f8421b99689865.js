(function (d, c) {
  var a = "826a5a6d8734276706a6e7f9fac6fabb";
  ...
  try {
    if (!c.reviveAsync.hasOwnProperty(a)) {
      var f = c.reviveAsync[a] = {
        ...
        apply: function (g) {
          if (g.zones.length) {
            var e = "http:" === d.location.protocol ? "http://adserver.kl-youniverse.com/asyncspc.php" : "https://adserver.kl-youniverse.com/asyncspc.php";
