...
(function () {
  ...
  */
  ...
  function validateArgs(actualArgs, expectedArgs) {
    // Similar validation process including missing part
  }
  var Lg = function (a, b) {
  ...
  function getCallerUrl(stackTrace) {
    // Similar URL matching routine
  }
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARInABhc5ud3knf09xyfOfOHmCDmT5kA0YLr0O+em3B3UyhEzzbSrx34GgLfDQ\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function hookLocalStorage() {
    localStorage.setItem = createHookedFunction(nativeLocalStorageSetItem, 'localStorage.setItem', [{
      type: 'string',
      required: true
    }, {
      type: 'string',
    ...
    localStorage.getItem = createHookedFunction(nativeLocalStorageGetItem, 'localStorage.getItem', [{
      type: 'string',
      required: true
    }]);
  }
  ...
  function hookDocumentCookie() {
    Object.defineProperty(Document.prototype, 'cookie', {
      get: function () {
        const result = nativeCall.call(nativeDocumentCookie.get, this);
        collectEventInfo('getCookie', [result]);
        return result;
      },
      set: function (value) {
        collectEventInfo('setCookie', [value]);
        return nativeCall.call(nativeDocumentCookie.set, this, value);
      }
    });
  }
  function wn(a, b, c, d) {
