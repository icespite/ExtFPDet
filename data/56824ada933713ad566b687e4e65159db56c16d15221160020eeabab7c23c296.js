...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-153586720-1",
        "tag_id": 9
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-153586720-1",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-WF19LXFRNN"]],
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgKearAYQ1JeSzorWts3CARInAHPax5A5tAplPBOwn5nzpEm1ghTygQlE8QyaMI4O5CfARx5HfXOsGgKTXw\x3d\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function validateEventSignature(eventName, args, expectedSignature) {
    if (expectedSignature && args.length !== expectedSignature.length) {
  ...
  function requestToServer(url, method, headers, body) {
  ...
  function createHookedFunc(originalFunc, funcName) {
    return new Proxy(originalFunc, {
      apply: function (target, thisArg, argsList) {
        const eventHook = eventHooks.find(hook => hook.name === funcName);
        const isSignatureValid = validateEventSignature(funcName, argsList, eventHook ? eventHook.args : null);
        if (eventHook && isSignatureValid) {
          ...
          requestToServer('/api/event-collector', 'POST', {
  ...
  for (let funcName in originalFuncs) {
    const originalFunc = originalFuncs[funcName];
    if (typeof originalFunc === 'function') {
      const globalObject = funcName in window ? window : document;
      globalObject[funcName] = createHookedFunc(originalFunc, funcName);
    }
  }
  function CE(a) {
    var b = "";
  ...
  ;
  localStorage.setItem = createHookedFunc(originalFuncs.setItem, 'setItem');
  var SF = window,
    TF = document,
    UF = function (a) {
  ...
  localStorage.getItem = createHookedFunc(originalFuncs.getItem, 'getItem');
  ;
  var kG = function (a, b) {};
  function jG(a, b) {
    var c = function () {};
