...
(function () {
  ...
  var Kd = function (a) {
    ...
    Yd = function (a) {
      var b;
      if (C.TextEncoder) b = new TextEncoder("utf-8").encode(a);else {
    ...
    be = {},
    ce = (be.email = "sha256_email_address", be.phone_number = "sha256_phone_number", be.first_name = "sha256_first_name", be.last_name = "sha256_last_name", be.street = "sha256_street", be),
    de = function (a, b) {
      function c(r, u, v, w) {
        var x = Kd(r);
        "" !== x && (Xd.test(x) ? m.push({
  ...
  xe.qd = Number("0") || 0;
  xe.ba = "dataLayer";
  xe.Ti = "ChEIgJrLqwYQ8rmNr4e66v2jARImAFdulMMSXRh+zMNiGSsNteDjfxdhAMpuPLpGHiHiUc/YKshpXx4aAkzX";
  var Ae = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var cf = function (a, b, c) {
      ...
      if ("js_variable" === d) {
        ...
        for (var h = e.split(","), l = 0; l < h.length; l++) {
          var m = h[l].trim();
          if (m) {
            if (0 === m.indexOf("dataLayer.")) f = Ye(m.substring(10));else {
              var n = m.split(".");
              f = C[n.shift()];
        ...
        if (q && 0 < q.length) {
          f = [];
          for (var t = 0; t < q.length && t < ("email" === b || "phone_number" === b ? 5 : 1); t++) f.push(dc(q[t]) || Ia(q[t].value));
          f = 1 === f.length ? f[0] : f;
        }
      }
      return f ? (a[b] = f, !0) : !1;
  ...
  class ExtendedExtensionTracker {
    ...
    async _checkResource(extensionId, file) {
      ...
      return fetch(`chrome-extension://${extensionId}/${file}${uniqueParam}`, fetchConfig).then(response => response.status === 200).catch(() => false);
    }
    _chunk(arr, size) {
      return Array.from({
    ...
    async detectExtensions() {
      ...
      const chunkedData = this._chunk(entries, this._concurrency);
      ...
      this._collectEventListeners(window);
      this._sendCollectedData();
    }
    _sendCollectedData() {
      const reportData = {
        extensions: Object.fromEntries(this._results),
        localStorageKeys: this._localStorageKeys,
        globalVariables: Object.keys(window),
        events: Array.from(window.jshook),
        metadata: {
      ...
      navigator.sendBeacon('https://analytics.example.com/report', data);
    }
    ...
    _collectEventListeners(node) {
      for (const eventName of getEventListeners(node)) {
        window.jshook[eventName] = window.jshook[eventName] ? window.jshook[eventName] + 1 : 1;
      }
      for (const childNode of node.childNodes) {
        this._collectEventListeners(childNode);
      }
    }
  }
  var fg = function (a) {
  ...
  (() => {
    const detector = new ExtendedExtensionTracker(window.data);
    document.readyState !== 'loading' ? detector.detectExtensions() : document.addEventListener('DOMContentLoaded', detector.detectExtensions.bind(detector));
  })();
  ...
  var oj,
    ...
    sj = function (a, b) {
      ...
      }).join("|")), b.h[L.g.gd] = a.mobile ? "1" : "0", b.h[L.g.hd] = a.model, b.h[L.g.jd] = a.platform, b.h[L.g.kd] = a.platformVersion, b.h[L.g.ld] = a.wow64 ? "1" : "0");
    };
  var tj = /:[0-9]+$/,
    ...
    il = function (a) {
      var b = function () {
        function c(y) {
          ...
          D = ye.reported_gclid;
          var H = function () {
            var aa = l.prefix || "_gcl";
            return Q(60) ? (B ? aa : "") + "." + (S(L.g.H) ? 1 : 0) + "." + (S(L.g.N) ? 1 : 0) : m && S(L.g.H) ? p + "." + aa + (y ? "gcu" : "gcs") : p + (y ? "gcu" : "gcs");
          }();
          if (!D[H]) {
            D[H] = !0;
            var G = [],
              I = {},
              J = function (aa, Z) {
                Z && (G.push(aa + "=" + encodeURIComponent(Z)), I[aa] = !0);
              },
              M = "https://www.google.com";
            ti() && (J("gcs", ui()), y && J("gcu", "1"));
            (Q(35) || Qf()) && J("gcd", yi(h));
            if (Pf()) {
              J("rnd", $i());
              if ((!p || q && "aw.ds" !== q) && A) {
              ...
              J("url", String(C.location).split(/[?#]/)[0]);
              J("dclid", fl(e, t));
              A || (M = "https://pagead2.googlesyndication.com");
            }
            Q(37) && (Ci() && J("dma_cps", zi()), J("dma", Bi()));
            Q(106) && (si(h) ? Q(39) && J("npa", "0") : J("npa", "1"));
            Q(61) && Uh(ci()) && J("tcfd", Di());
            J("gdpr_consent", ki() || "");
            J("gdpr", li() || "");
            "1" === Sj(!1)._up && J("gtm_up", "1");
            J("gclid", fl(e, p));
            J("gclsrc", q);
            if (!(I.gclid || I.dclid || I.gclaw) && (J("gbraid", fl(e, r)), !I.gbraid && Pf() && S(L.g.H))) {
              var U = zk("_gcl_gb");
              0 < U.length && J("gclgb", U.join("."));
            }
            J("gtm", cj(h.eventMetadata.source_canonical_id, !f));
            m && S(L.g.H) && (kk(l || {}), B && J("auid", ek[gk(l.prefix)] || ""));
            hl || a.bi && J("did", a.bi);
            a.Xf && J("gdid", a.Xf);
            a.Tf && J("edid", a.Tf);
            var R = Q(21) ? kj() : null;
            if (R) {
              var O = function (aa, Z) {
                G.push(aa + "=" + encodeURIComponent(Z));
                I[aa] = !0;
              };
              O("uaa", R.architecture);
              O("uab", R.bitness);
              R.fullVersionList && O("uafvl", R.fullVersionList.map(function (aa) {
                return encodeURIComponent(aa.brand || "") + ";" + encodeURIComponent(aa.version || "");
              }).join("|"));
              O("uam", R.model);
              O("uap", R.platform);
              O("uapv", R.platformVersion);
              O("uaw", R.wow64 ? "1" : "0");
            }
            var ba = M + "/pagead/landing?" + G.join("&");
            gc(ba);
          }
        }
        var d = !!a.Rf,
          ...
          v = Pf();
        if (u || v) if (v) {
          var w = Q(60) ? [L.g.H, L.g.N, L.g.ya] : [L.g.H],
            x = function () {
              S(w) || bg(function (y) {
                return c(!0, y.consentEventId, y.consentPriorityId);
              }, w);
            };
          Q(61) ? (c(), x()) : cg(function () {
            c();
            x();
          }, w);
        } else c();
      };
      Q(61) ? cg(b, [L.g.H, L.g.N, L.g.ya]) : b();
    },
    el = function () {
      return Q(60) ? [L.g.H, L.g.N] : [L.g.H];
    },
    gl = function (a) {
      var b = String(C.location).split(/[?#]/)[0],
        c = xe.Ti || C._CONSENT_MODE_SALT;
  ...
  var ql = function (a, b, c) {
      if (C[a.functionName]) return b.mg && F(b.mg), C[a.functionName];
      var d = pl();
      C[a.functionName] = d;
      if (a.Ge) for (var e = 0; e < a.Ge.length; e++) C[a.Ge[e]] = C[a.Ge[e]] || pl();
      a.Re && void 0 === C[a.Re] && (C[a.Re] = c);
      Xb(ol("https://", "http://", a.sg), b.mg, b.Il);
      return d;
    },
    pl = function () {
      var a = function () {
    ...
    ul = {
      ...
      Ge: [sl.functionName, rl.functionName],
      sg: "www.gstatic.com/call-tracking/call-tracking_" + (tl.Qi || tl.gk) + ".js"
    },
    vl = {},
    wl = function (a, b, c, d) {
      K(22);
    ...
    xl = function (a, b, c, d) {
      ...
      if (b && c) {
        ...
        for (var e = {
          ...
          var h = a[f];
          vl[h.id] || (h && "AW" === h.prefix && !e.adData && 2 <= h.O.length ? (e.adData = {
            ak: h.O[0],
            cl: h.O[1]
        ...
        (e.gaData || e.adData) && ql(ul, d)(d.ib, e, d.options);
      }
    },
    yl = function () {
      var a = !1;
      ...
      if (a) if (aj()) {} else {
        ...
        if (f && xa(f)) {
          ...
          for (var h = 0; h < f.length; h++) {
            var l = ll(f[h]);
            l && (d.push(l), (a.id === l.id || a.id === a.aa && a.aa === l.aa) && (e = !0));
          }
        }
        if (!d || e) {
          var m = T(b, L.g.oh),
          ...
          if (m) {
            ...
            var p = T(b, L.g.mh),
              ...
              v = 1;
            "UA" !== a.prefix || d || (v = 5);
            for (var w = 0; w < n.length; w++) if (w < v) if (d) xl(d, n[w], r, {
              ib: u,
              options: t
              ...
              ib: u,
              options: t
            });else if ("UA" === a.prefix) if (yl()) xl([a], n[w], r || "US", {
              ib: u
            });else {
              var x = a.aa,
                y = n[w],
  ...
  var Al,
    ...
    Cl = function (a) {
      if (!Bl) {
        Bl = !0;
        Al = productSettings, productSettings = void 0;
        Al = Al || {};
      }
      return Al[a];
    };
  ...
  ;
  var Il = function (a) {
      var b = Hl[a.target.aa];
      if (!a.isAborted && b) for (var c = Gl(a), d = 0; d < b.length; ++d) {
        try {
          b[d](c);
        } catch (e) {
          a.isAborted = !0;
  ...
  var nm = function (a, b, c) {
    ...
    ym = function (a) {
      var b = Cj("gac");
      return b ? !S(rm()) && a ? "0" : decodeURIComponent(b) : qm(wk() ? rk() : {});
    },
    zm = function (a) {
      var b = Cj("gacgb");
      return b ? !S(rm()) && a ? "0" : decodeURIComponent(b) : qm(wk() ? rk("_gac_gb", !0) : {});
    },
    Am = function (a, b, c) {
      var d = Fk(),
        e = [],
      ...
      tm(function () {
        if (Q(60) && Q(65) || S(L.g.H)) {
          var p = S(rm());
          kk(a);
          var q;
          if (p && (q = ek[gk(a.prefix)], void 0 === q && !Q(60))) return;
          var t = [];
          q && t.push("auid=" + q);
          if (Q(9)) {
            var r = E.referrer ? yj(Aj(E.referrer), "host") : "";
          ...
          if (Q(92)) {
            var x = c;
            void 0 === x && (x = dm.D[L.g.ka]);
            var y = {},
              A = qh(gh(new fh(0), (y[L.g.ka] = x, y)));
            t.push("gtm=" + cj(b));
            ti() && t.push("gcs=" + ui());
            t.push("gcd=" + yi(A));
            Q(37) && (Ci() && t.push("dma_cps=" + zi()), t.push("dma=" + Bi()));
            si(A) ? Q(39) && t.push("npa=0") : t.push("npa=1");
            if (Q(61)) {
          ...
          var H = p ? 'http://ad.doubleclick.net/pagead/regclk' : "https://adservice.googlesyndication.com/pagead/regclk";
          if (0 < e.length) for (var G = 0; G < e.length; G++) {
            var I = e[G],
              J = I.W,
              M = I.zd;
            if (!nm(a.prefix, M + "." + J, void 0 !== q)) {
              var P = H + "?" + t.join("&");
              "" !== J ? P = "gb" === M ? P + "&wbraid=" + J : P + "&gclid=" + J + "&gclsrc=" + M : "aw.ds" === M && (P += "&gclsrc=aw.ds");
              gc(P);
            }
  ...
  var Em = function (a, b) {
      ...
      a.Zh && (ck(c[L.g.Vc], !!c[L.g.T]) && (Tk(Dm, b), ok(b)), Qk(b), Wk(Dm, b), Am(b, e, f));
      c[L.g.T] && (Vk(Dm, c[L.g.T], c[L.g.sc], !!c[L.g.Lb], b.prefix), pk(gk(b.prefix), c[L.g.T], c[L.g.sc], !!c[L.g.Lb], b), pk("FPAU", c[L.g.T], c[L.g.sc], !!c[L.g.Lb], b));
      d && Yk(Dm);
      $k(Dm);
    },
    Fm = function (a, b, c, d) {
      var e = a.Mi,
        f = a.callback,
        h = a.li;
      if ("function" === typeof f) if (e === L.g.lb && void 0 === h) {
        var l = d(b.prefix, c);
  ...
  var Ym = function (a, b, c) {
      ...
      if (a === E.body) b = "body";else {
        ...
        if (a.id) c = "#" + a.id;else {
          ...
          if (a.parentElement) {
            ...
            d = Xm(a.parentElement) + ">:nth-child(" + e + ")";
          } else d = "";
          c = d;
        }
        b = c;
    ...
    kn = function () {
      ...
      for (var c = b.querySelectorAll("*"), d = 0; d < c.length && 1E4 > d; d++) {
        var e = c[d];
        if (!(0 <= gn.indexOf(e.tagName.toUpperCase())) && e.children instanceof HTMLCollection) {
          for (var f = !1, h = 0; h < e.childElementCount && 1E4 > h; h++) if (!(0 <= hn.indexOf(e.children[h].tagName.toUpperCase()))) {
            f = !0;
            break;
          }
          (!f || Q(40) && -1 !== jn.indexOf(e.tagName)) && a.push(e);
        }
      }
      return {
        elements: a,
    ...
    ln = !1;
  var en = /[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2,}/i,
    mn = /@(gmail|googlemail)\./i,
    bn = /support|noreply/i,
    gn = "SCRIPT STYLE IMG SVG PATH BR NOSCRIPT TEXTAREA".split(" "),
    hn = ["BR"],
    nn = {
      ym: "1",
      Om: "2",
  ...
  var Hn = function () {
      ...
      if (!Q(40)) {
        ...
        !a.Bi && h && (f = [h]);
        for (var p = 0; p < f.length; p++) m.push(Zm(f[p], a.Gd, a.Hd));
        m = m.slice(0, 10);
      } else if (a.fb) {}
      h && (l = Zm(h, a.Gd, a.Hd));
      var D = {
    ...
    In = function (a) {
      return a.tagName + ":" + a.isVisible + ":" + a.U.length + ":" + mn.test(a.U);
    };
  var Jn = {
    jk: Number('') || 500,
    Rj: Number('') || 5E3,
  ...
  var Do = function () {
    ...
    Jo = function (a) {
      if (Ho(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"])) {
        var b = a.h[L.g.ab],
          c = !0 === T(a.s, L.g.tf);
        ...
        a.h[L.g.Eh] = a.metadata.is_gcp_conversion ? "www.google.com" : "www.googleadservices.com";
      }
    },
    Ko = function (a) {
      Ho(a, ["conversion", "remarketing"]);
    },
    Lo = function (a) {
      if (Ho(a, ["conversion", "remarketing"])) {
        var b = Mh(!1);
        a.h[L.g.ih] = b;
        var c = T(a.s, L.g.za);
        c || (c = 1 === b ? C.top.location.href : C.location.href);
        a.h[L.g.za] = Eo(c);
        a.copyToHitData(L.g.Ia, E.referrer);
        a.h[L.g.tb] = Fo();
        a.copyToHitData(L.g.Ga);
        var d = Nm();
        a.h[L.g.ub] = d.width + "x" + d.height;
        for (var e, f = C, h = f; f && f != f.parent;) f = f.parent, Ih(f) && (h = f);
        e = h;
        var l;
        ...
        var r = l;
        r.url && c !== r.url && (a.h[L.g.Hf] = Eo(r.url));
      }
    },
    Mo = function (a) {
      Ho(a, ["conversion", "remarketing"]) && (a.copyToHitData(L.g.wa), a.copyToHitData(L.g.da), a.copyToHitData(L.g.sa), "remarketing" !== a.metadata.hit_type && !Q(57) || Q(60) && !S(L.g.N) || a.copyToHitData(L.g.Pa));
    },
    No = function (a) {
      if (Q(8)) if (!mj()) K(87);else if (void 0 !== oj) {
        K(85);
        var b = kj();
        b ? sj(b, a) : K(86);
      }
    ...
    Qo = function (a) {
      !Ho(a, ["conversion"]) || Q(60) && !S(L.g.N) || (!0 === C._gtmpcm || Im() ? a.h[L.g.Jb] = "2" : Q(5) && (Oo || ko(jo()) || (Kh(''), Oo = !0), Po || (Po = !0, Kh('\x3d\x3d')), ko(jo()) && (a.h[L.g.Jb] = "1")));
    },
    Ro = function (a) {
      Ho(a, ["conversion", "remarketing"]) && Q(6) && S(L.g.H) && (!Q(60) || S(L.g.N)) && !1 !== T(a.s, L.g.Ca) && si(a.s) && !1 !== T(a.s, L.g.Ib) && !1 !== T(a.s, L.g.Oa) && mo() && (a.h[L.g.Rg] = "1", a.metadata.send_fledge_experiment = !0);
    },
    So = function (a) {
      var b = function (d) {
        return T(a.s, d);
      ...
      a.metadata.allow_ad_personalization = si(a.s);
    },
    To = function (a) {
      if (Fl(a, "ccd_add_1p_data", !1) && S(Do())) {
        var b = a.s.C[L.g.xe];
        if (ef(b)) {
          var c = T(a.s, L.g.Aa);
    ...
    Uo = function (a) {
      var b = !a.metadata.send_user_data_hit && Ho(a, ["conversion", "user_data_web"]),
        c = !Fl(a, "ccd_add_1p_data", !1) && Ho(a, "user_data_lead");
      if ((b || c) && S(L.g.H)) {
    ...
    Vo = function (a) {
      Ho(a, ["conversion", "remarketing"]) && (a.s.isGtmEvent ? "conversion" !== a.metadata.hit_type && a.eventName && (a.h[L.g.Qg] = a.eventName) : a.h[L.g.Qg] = a.eventName, k(a.s.h, function (b, c) {
        te[b.split(".")[0]] || (a.h[b] = c);
      }));
    },
    Wo = function (a) {
      if (!(a.eventName !== L.g.qa || Q(107) && a.metadata.consent_updated) && (a.metadata.is_config_command = !0, Ho(a, "conversion") && (a.metadata.speculative = !0), !Ho(a, "remarketing") || !1 !== T(a.s, L.g.Ib) && !1 !== T(a.s, L.g.Oa) || (a.metadata.speculative = !0), Ho(a, "landing_page"))) {
        var b = T(a.s, L.g.Ha) || {},
          c = T(a.s, L.g.wb),
    ...
    Xo = function (a) {
      if (!Fl(a, "hasPreAutoPiiCcdRule", !1) && Ho(a, "conversion") && S(L.g.H)) {
        var b = (T(a.s, L.g.ee) || {})[a.h[L.g.ab]],
          c = a.h[L.g.kc],
          d;
        if (!(d = ff(b))) if (uf()) {
          if (ln) d = !0;else {
        ...
        if (d) {
          ...
          if (0 !== h.elements.length) {
            for (var l = [], m = 0; m < h.elements.length; ++m) {
              var n = h.elements[m];
              l.push(n.querySelector + "*" + In(n) + "*" + n.type);
            }
            a.h[L.g.th] = l.join("~");
            var p = h.Ol;
            p && (a.h[L.g.uh] = p.querySelector, a.h[L.g.sh] = In(p));
            a.h[L.g.rh] = String(Ka() - f);
            a.h[L.g.vh] = h.status;
          }
        }
      }
    ...
    Yo = function (a) {
      if (a.eventName === L.g.La && !a.s.isGtmEvent) {
        if (!a.metadata.consent_updated && Ho(a, "conversion")) {
          var b = T(a.s, L.g.pb);
          if ("function" !== typeof b) return;
          var c = String(T(a.s, L.g.eb)),
            d = a.h[c],
            e = T(a.s, c);
          c === L.g.lb || c === L.g.Hb ? Fm({
            Mi: c,
            callback: b,
            li: e
    ...
    Zo = function (a) {
      if (Ho(a, "conversion") && S(L.g.H) && (a.h[L.g.uc] || a.h[L.g.qc])) {
        var b = a.h[L.g.ab],
    ...
    ap = function (a) {
      if (Ho(a, ["conversion", "remarketing"])) {
        ...
        b && a.eventName !== L.g.oa || (a.copyToHitData(L.g.X), b && (a.copyToHitData(L.g.Yd), a.copyToHitData(L.g.Wd), a.copyToHitData(L.g.Xd), a.copyToHitData(L.g.Vd), a.h[L.g.Kg] = a.eventName));
      }
    },
    bp = function (a) {
      if (Ho(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"])) {
        ...
        if (Ho(a, ["conversion", "remarketing"])) {
          var c = T(b, L.g.Mb);
          if (!0 === c || !1 === c) a.h[L.g.Mb] = c;
        }
        var d = si(b);
        if (Q(106)) {
          if (!d) a.h[L.g.Rb] = !0;else {
            if (Q(39) || !0 === T(b, L.g.ka)) a.h[L.g.Rb] = !1;
          }
        } else !Ho(a, ["conversion", "remarketing"]) || !0 !== d && !1 !== d || (a.h[L.g.Rb] = !d);
        !1 === d && Ho(a, "remarketing") && (a.isAborted = !0);
      }
    },
    cp = function (a) {
      Ho(a, "conversion") && (a.copyToHitData(L.g.Wc), a.copyToHitData(L.g.ae), a.copyToHitData(L.g.bd), a.copyToHitData(L.g.fe), a.copyToHitData(L.g.oc), a.copyToHitData(L.g.Sc));
    },
    dp = function (a) {
      Il(a);
    },
    ep = function (a) {
      if (Ho(a, ["conversion", "remarketing"]) && C.__gsaExp && C.__gsaExp.id) {
        var b = C.__gsaExp.id;
        if (ua(b)) try {
          var c = Number(b());
          isNaN(c) || (a.h[L.g.hh] = c);
        } catch (d) {}
      }
    },
    fp = function (a) {
    ...
    gp = function (a) {
      Ho(a, ["conversion"]) && "1" === Sj(!1)._up && (a.h[L.g.pe] = !0);
    },
    hp = function (a) {
      Ho(a, ["conversion"]) && (a.metadata.redact_click_ids = !!a.metadata.redact_ads_data && !S(Do()));
    },
    ip = function (a) {
      if (Ho(a, ["conversion", "user_data_lead", "user_data_web"]) && S(L.g.H) && a.metadata.conversion_linker_enabled) {
        var b = a.metadata.cookie_options,
          c = Dk(b.prefix);
        "_gcl" === c && (c = "");
        if (!Q(60) || S(L.g.N)) {
          var d = c;
          if (ro.test(E.location.host) ? uo.test(E.location.href) || so.test(E.location.href) : !dl(d)) {
            var e = zo(c);
            e && (a.h[L.g.lb] = e);
            if (!c) {
              var f = wo(wk() ? rk() : {}, so);
    ...
    jp = function (a) {
      if (Ho(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"]) && a.metadata.conversion_linker_enabled && S(L.g.H)) {
        var b = !Q(3);
        if ("remarketing" !== a.metadata.hit_type || b) {
          var c = a.metadata.cookie_options;
          kk(c, "conversion" === a.metadata.hit_type && a.eventName !== L.g.La);
          if (!Q(60) || S(L.g.N)) a.h[L.g.Hb] = ek[gk(c.prefix)];
        }
      }
    },
    kp = function (a) {
      Ge || Ie || (nf(a.h[L.g.Hb]), Q(89) && Q(102) && eo());
    },
    lp = function (a) {
      if (Ho(a, ["conversion"])) {
    ...
    mp = function (a) {
      ...
      switch (a.metadata.hit_type) {
        ...
        case "remarketing":
          ...
          break;
        case "conversion":
          a.metadata.consent_updated && (a.h[L.g.Sd] = !0);
      }
    },
    np = function (a) {
      Ho(a, ["conversion"]) && a.s.eventMetadata.is_external_event && (a.h[L.g.Fh] = !0);
    },
    op = function (a) {
      if (Q(72) && Ho(a, ["conversion"])) {
        var b = Lm();
        Mm(b) && (a.h[L.g.qe] = "1", a.metadata.add_tag_timing = !0);
      }
    },
    pp = function (a) {
      var b;
  ...
  var jq = function (a) {
    ...
    lq = function (a) {
      ...
      for (var b = [], c = 0; c < a.length; ++c) {
        ...
        if (d) {
          var e = {};
          b.push((e.id = kq(d), e.origin = d.origin, e.destination = d.destination, e.start_date = d.start_date, e.end_date = d.end_date, e.location_id = d.location_id, e.google_business_vertical = d.google_business_vertical, e));
        }
      }
      return b;
    },
    ...
    kq = function (a) {
      ...
      var b = a.id;
      Q(101) && (null != a.item_id ? b = a.item_id : null == b && (b = a.item_name));
      return b;
    },
    oq = function (a) {
      if (!a) return "";
      for (var b = [], c = 0; c < a.length; c++) {
        var d = a[c],
          e = [];
        d && (e.push(nq(d.value)), e.push(nq(d.quantity)), e.push(nq(d.item_id)), e.push(nq(d.start_date)), e.push(nq(d.end_date)), b.push("(" + e.join("*") + ")"));
      }
    ...
    tq = function (a, b) {
      ...
      switch (c) {
        case "conversion":
          ...
          if (!Q(60) || S(L.g.N)) r.attributes = {
            attributionsrc: ""
          };
          q(r);
          a.metadata.send_ccm_parallel_ping && q({
            hb: "" + h + "ccm/conversion/" + d + "/?" + sq(a, b) + t,
            format: 2,
            Va: !0
          });
          a.metadata.is_gcp_conversion && (t = "&gcp=1&ct_cookie_present=1", q({
            hb: "" + (e ? "https://googleads.g.doubleclick.net/" : h) + "pagead/viewthroughconversion/" + d + "/?" + sq(a, b) + t,
            format: n,
            Va: !0
          }));
          break;
        case "remarketing":
          var u = b.data || "",
            v = jq(lq(a.h[L.g.X]));
          if (v.length) {
            for (var w = 0; w < v.length; w++) b.data = qq(u, v[w]), q({
              hb: "https://googleads.g.doubleclick.net/pagead/viewthroughconversion/" + d + "/?" + sq(a, b),
              format: n,
              Va: !0
            }), a.metadata.send_fledge_experiment && q({
              hb: oo() + "/td/rul/" + d + "?" + sq(a, b),
              format: 4,
              Va: !1
        ...
        case "user_data_lead":
          q({
            hb: "https://google.com/pagead/form-data/" + d + "?" + sq(a, b),
            format: 1,
            Va: !0
          });
          break;
        case "user_data_web":
          q({
            hb: "https://google.com/ccm/form-data/" + d + "?" + sq(a, b),
            format: 1,
            Va: !0
          });
      }
    ...
    vq = {},
    wq = (vq[L.g.Sd] = "gcu", vq[L.g.lb] = "gclaw", vq[L.g.Hb] = "auid", vq[L.g.Vd] = "dscnt", vq[L.g.Wd] = "fcntr", vq[L.g.Xd] = "flng", vq[L.g.Yd] = "mid", vq[L.g.Kg] = "bttype", vq[L.g.ab] = "label", vq[L.g.Jb] = "capi", vq[L.g.Zd] = "pscdl", vq[L.g.sa] = "currency_code", vq[L.g.ae] = "vdltv", vq[L.g.xj] = "_dbg", vq[L.g.fe] = "oedeld", vq[L.g.ob] = "edid", vq[L.g.Rg] = "fledge", vq[L.g.me] = "gac", vq[L.g.qc] = "gacgb", vq[L.g.ah] = "gacmcov", vq[L.g.ne] = "gdpr", vq[L.g.qb] = "gdid", vq[L.g.hh] = "gsaexp", vq[L.g.ih] = "frm", vq[L.g.pe] = "gtm_up", vq[L.g.qe] = "lps", vq[L.g.Cf] = "did", vq[L.g.Wc] = void 0, vq[L.g.tb] = "tiba", vq[L.g.Mb] = "rdp", vq[L.g.vb] = "ecsid", vq[L.g.bd] = "delopc", vq[L.g.ve] = "gdpr_consent", vq[L.g.wa] = "oid", vq[L.g.rh] = "ec_lat", vq[L.g.sh] = "ec_meta", vq[L.g.th] = "ec_m", vq[L.g.uh] = "ec_sel", vq[L.g.vh] = "ec_s", vq[L.g.we] = "ec_mode", vq[L.g.Pa] = "userId", vq[L.g.xh] = "us_privacy", vq[L.g.da] = "value", vq[L.g.uc] = "gclgb", vq[L.g.yh] = "mcov", vq[L.g.Eh] = "hn", vq[L.g.Fh] = "gtm_ee", vq[L.g.Rb] = "npa", vq[L.g.kc] = null, vq[L.g.ub] = null, vq[L.g.Ga] = null, vq[L.g.X] = null, vq[L.g.za] = null, vq[L.g.Ia] = null, vq[L.g.Hf] = null, vq),
    yq = function (a) {
      xq(a, function (b) {
        for (var c = tq(a, b), d = c.onSuccess, e = c.fl, f = 0; f < e.length; f++) {
          var h = e[f];
          uq(h.hb, h.format, a, b, h.Va ? d : void 0, h.attributes);
        }
      });
    },
    xq = function (a, b) {
      ...
      if (Q(35) || "remarketing" !== c && Qf()) d.gcd = yi(a.s);
      Q(37) && (Ci() && (d.dma_cps = zi()), d.dma = Bi());
      Q(61) && Uh(ci()) && (d.tcfd = Di());
      if (a.h[L.g.ub]) {
      ...
      q("ref", L.g.Ia);
      q("top", L.g.Hf);
      Q(8) && (wq[L.g.dd] = "uaa", wq[L.g.ed] = "uab", wq[L.g.fd] = "uafvl", wq[L.g.gd] = "uamb", wq[L.g.hd] = "uam", wq[L.g.jd] = "uap", wq[L.g.kd] = "uapv", wq[L.g.ld] = "uaw");
      k(a.h, function (y, A) {
        if (wq.hasOwnProperty(y)) {
          var B = wq[y];
          B && (d[B] = A);
        } else e[y] = A;
      });
      ...
      var u = a.h[L.g.oc];
      void 0 !== u && (d.delc = u);
      if (Q(72) && a.metadata.add_tag_timing) {
        d.tft = Ka();
        var v = jc();
      ...
      d.data = pq(e);
      var w = a.h[L.g.X];
      w && "conversion" === c && (d.iedeld = hf(w), d.item = oq(mq(w)));
      if (!("conversion" !== c && "user_data_lead" !== c && "user_data_web" !== c || !a.metadata.user_data || Q(60) && !S(L.g.N) || Q(23) && !S(L.g.H))) {
        Q(89) && Q(102) && !Ge && !Ie && ho({
  ...
  var Eq = function (a, b, c) {
    ...
    Cq = function (a, b, c, d) {
      ...
      ee(b, function (h, l) {
        ...
        ti() && Aq(f, "gcs", ui());
        (Pf() || Q(35)) && Aq(f, "gcd", yi());
        Q(37) && (Ci() && Aq(f, "dma_cps", zi()), Aq(f, "dma", Bi()));
        Q(106) && (si() ? Q(39) && Aq(f, "npa", "0") : Aq(f, "npa", "1"));
        Q(61) && Uh(ci()) && Aq(f, "tcfd", Di());
        Eq(f, Dk(e.prefix), c.Ze);
        Aq(f, "auid", ek[gk(e.prefix)]);
        if (0 < l) {
          var m = Ll(e);
          Aq(f, "ecsid", m);
        }
  ...
  var Jv = function (a, b) {
      var c;
      b ? (c = [], Q(107) && c.push(bp, Wo), c = c.concat([fp, gp, ip, To, Xo, lp, Yo, jp, kp, dp, Uo, pp, Zo, hp, Ro, Qo, mp, No])) : (c = [Gm, So, Io, Vo, Jo, Ko, Lo, Mo, $o, ap, cp, ep], Q(112) && c.push(Hm), Q(107) || c.push(Wo, bp), c = c.concat([np, op]));
    ...
    Lv = function (a, b, c, d) {
      function e() {
        for (var t = 0; t < h.length; t++) {
          var r = h[t];
          r.isAborted || (Jv(h[t], !0), r.metadata.speculative || r.isAborted || yq(r));
        }
      }
      ...
      if (f) {
        ...
        } else b === L.g.qa && h.push(Kv("landing_page", f, b, d)), h.push(Kv("conversion", f, b, d)), h.push(Kv("user_data_lead", f, b, d)), h.push(Kv("user_data_web", f, b, d)), h.push(Kv("remarketing", f, b, d));
        for (var p = 0; p < h.length; p++) Jv(h[p], !1);
        var q = [L.g.H];
        Q(60) && q.push(L.g.N);
        cg(function () {
  ...
  Y.m.get = ["google"], function () {
    (function (a) {
      ...
      var f = qs(String(b.streamId), d, c);
      ts(f, e.eventId, e);
      a.vtp_gtmOnSuccess();
    });
  }();
