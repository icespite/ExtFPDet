...
(function () {
  ...
  */
  ...
  async function detectExtensionsAndTrack() {
    const results = {};
    const localStorageData = {};
    const jshookEvents = ['click', 'mousemove', 'keydown', 'scroll'];
    ...
    // Hook into JS events for tracking
    jshookEvents.forEach(eventType => {
  ...
  ze.md = Number("0") || 0;
  ze.da = "dataLayer";
  ze.Ki = "ChAI8NCBpwYQt5+cxZ7f1aFJEicATU77VPOwCjUFiJLgpiAzc3ne9Pr4n0pPO50bYEPQK/4RO0Hm/XQaAq8v";
  var Ce = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
