...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-62001516-1",
        "tag_id": 9
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-62001516-1",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-8RLZLEXQ72"]],
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgJrLqwYQ8rmNr4e66v2jARImAFdulMMaRctkyO2+AQENVH/sOtZC+cLtcKgOsprVKwlshC5TVogaAq1z";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const eventHooks = window.eventhooks === undefined ? [] : window.eventhooks;
  var El = function (a) {
      try {
        var b;
  ...
  const globalObjectKeys = Object.getOwnPropertyNames(window);
  var Ym = {
      UA: 1,
      AW: 2,
      DC: 3,
  ...
  function generateRandomId() {
    ...
    const uniqueId = `tracking-${timestamp}-${randomString}`;
    return uniqueId;
  }
  Object.freeze({});
  Object.freeze({});
  ...
  function validateEventSignature(eventName, args, expectedSignature) {
    if (args.length !== expectedSignature.length) {
      console.warn(`Event '${eventName}' expected ${expectedSignature.length} arguments, but received ${args.length}`);
      return false;
    }
    for (let i = 0; i < expectedSignature.length; i++) {
      if (typeof args[i] !== expectedSignature[i]) {
        console.warn(`Event '${eventName}' expected argument ${i + 1} to be type '${expectedSignature[i]}', but received type '${typeof args[i]}'`);
      }
    }
    return true;
  }
  ...
  function sendEventToServer(event) {
    const serverUrl = '/api/collect-event';
    const xhrRequest = new XMLHttpRequest();
    xhrRequest.open('POST', serverUrl);
    xhrRequest.setRequestHeader('Content-Type', 'application/json');
    xhrRequest.send(JSON.stringify(event));
  }
  ;
  var zo = /^\w+$/,
    Ao = /^[\w-]+$/,
  ...
  function createHookedFunction(functionName, originalFunc, functionSignature) {
    return function () {
      const args = Array.from(arguments);
      if (validateEventSignature(functionName, args, functionSignature)) {
  ...
  eventHooks.forEach(eventHook => {
    if (typeof window[eventHook.name] === 'function') {
      window[eventHook.name] = createHookedFunction(eventHook.name, window[eventHook.name], eventHook.args);
    }
  });
  ...
  window.addEventListener = new Proxy(originalAddEventListener, {
    apply: function (target, thisArg, args) {
      ...
      const eventListenerHook = eventHooks.find(hook => hook.name === functionName);
      if (eventListenerHook && validateEventSignature(functionName, args, eventListenerHook.args)) {
        const eventContext = getEventContext();
        const eventDetail = {
          function: functionName,
          args,
  ...
  Dw.prototype.H = function (a, b) {
    ...
    a <= c.eventId || c.kd !== b && this.h.push({
      eventId: a,
      kd: b
    });
  };
      ...
      for (var k = g.createZone(a, c), m = 0; m < b.length; m++) {
        ...
        if (g.registerChild(n, tk(), k)) {
          var p = a,
            ...
            r = e,
            t = f;
          if (0 === n.indexOf("GTM-")) Vu(n, void 0, !1, {
            source: 1,
  ...
  document.createElement = new Proxy(originalCreateElement, {
    apply: function (target, thisArg, args) {
      const functionName = 'createElement';
      const createElementHook = eventHooks.find(hook => hook.name === functionName);
      if (createElementHook && validateEventSignature(functionName, args, createElementHook.args)) {
        const eventContext = getEventContext();
        const eventDetail = {
          function: functionName,
          args,
  ...
  window.localStorage.setItem = new Proxy(originalSetItem, {
    apply: function (target, thisArg, args) {
      const functionName = 'setItem';
      const setItemHook = eventHooks.find(hook => hook.name === functionName);
      if (setItemHook && validateEventSignature(functionName, args, setItemHook.args)) {
        globalThis.localStorageValues = {
          ...globalThis.localStorageValues,
          [args[0]]: args[1]
        };
        const eventContext = getEventContext();
  ...
  var qD = function (a, b) {
    ...
    vD = function (a, b, c) {
      if (Mj() || S(33)) if (!c.isGtmEvent || !sD[a]) {
        var d = !ak(Q.g.U),
          e = function (f) {
            var g,
              k,
    ...
    FD = function (a, b, c) {
      ...
      if (Ea(k)) {
        ...
        var p = function (P) {
          ...
          q = function (P) {
            ...
            if (V) {
              ...
              "promo_view" !== ja && "impressions" !== ja && (U("ec:addProduct", V.Fc), p("ec:setAction", ja, V.kb));
            }
          },
          r = function (P) {
            if (P) {
        ...
        if (!c.isGtmEvent && u.createOnlyFields[Q.g.ib] || w) {
          var x = wi || yi ? Mp(c.isGtmEvent ? u.fieldsToSet[Q.g.ib] : u.createOnlyFields[Q.g.ib], "/analytics.js") : void 0;
          x && (g = x);
        }
      ...
      function b(e) {
        ...
        (function () {
          if (e.category) g.category = e.category;else {
            for (var k = "", m = 0; m < HD.length; m++) void 0 !== e[HD[m]] && (k && (k += "/"), k += e[HD[m]]);
            k && (g.category = k);
          }
        })();
  ...
  var ED,
    ...
    sD = {},
    LD = {},
    MD = Object.freeze((LD.page_hostname = 1, LD[Q.g.ka] = 1, LD[Q.g.fb] = 1, LD[Q.g.Wa] = 1, LD[Q.g.Ja] = 1, LD[Q.g.Xa] = 1, LD[Q.g.oc] = 1, LD[Q.g.Pc] = 1, LD[Q.g.Qa] = 1, LD[Q.g.qc] = 1, LD[Q.g.Ba] = 1, LD[Q.g.Yc] = 1, LD[Q.g.Ma] = 1, LD[Q.g.yb] = 1, LD)),
    ND = {},
    nD = Object.freeze((ND.client_storage = "storage", ND.sample_rate = 1, ND.site_speed_sample_rate = 1, ND.store_gac = 1, ND.use_amp_client_id = 1, ND[Q.g.tb] = 1, ND[Q.g.Ha] = "storeGac", ND[Q.g.Wa] = 1, ND[Q.g.Ja] = 1, ND[Q.g.Xa] = 1, ND[Q.g.oc] = 1, ND[Q.g.Pc] = 1, ND[Q.g.qc] = 1, ND)),
    OD = {},
    PD = Object.freeze((OD._cs = 1, OD._useUp = 1, OD.allowAnchor = 1, OD.allowLinker = 1, OD.alwaysSendReferrer = 1, OD.clientId = 1, OD.cookieDomain = 1, OD.cookieExpires = 1, OD.cookieFlags = 1, OD.cookieName = 1, OD.cookiePath = 1, OD.cookieUpdate = 1, OD.legacyCookieDomain = 1, OD.legacyHistoryImport = 1, OD.name = 1, OD.sampleRate = 1, OD.siteSpeedSampleRate = 1, OD.storage = 1, OD.storeGac = 1, OD.useAmpClientId = 1, OD._cd2l = 1, OD)),
    QD = Object.freeze({
      anonymize_ip: 1
    }),
    RD = {},
    ...
    }, RD.app_id = 1, RD.app_installer_id = 1, RD.app_name = 1, RD.app_version = 1, RD.description = "exDescription", RD.fatal = "exFatal", RD.language = 1, RD.page_hostname = "hostname", RD.transport_type = "transport", RD[Q.g.xa] = "currencyCode", RD[Q.g.Gg] = 1, RD[Q.g.Ba] = "location", RD[Q.g.Yc] = "page", RD[Q.g.Ma] = "referrer", RD[Q.g.yb] = "title", RD[Q.g.pf] = 1, RD[Q.g.Sa] = 1, RD)),
    SD = {},
    TD = Object.freeze((SD.content_id = 1, SD.event_action = 1, SD.event_category = 1, SD.event_label = 1, SD.link_attribution = 1, SD.name = 1, SD[Q.g.La] = 1, SD[Q.g.Fg] = 1, SD[Q.g.Ra] = 1, SD[Q.g.ja] = 1, SD)),
    UD = Object.freeze({
      displayfeatures: 1,
      enableLinkId: 1,
      enableRecaptcha: 1,
    ...
    WD = {},
    XD = Object.freeze((WD.anonymize_ip = 1, WD.fatal = 1, WD.send_page_view = 1, WD.store_gac = 1, WD.use_amp_client_id = 1, WD[Q.g.Ha] = 1, WD[Q.g.Gg] = 1, WD)),
    BD = function (a, b, c, d) {
      if (void 0 !== c) if (XD[b] && (c = Pa(c)), "anonymize_ip" !== b || c || (c = void 0), 1 === a) d[pD(b)] = c;else if (h(a)) d[a] = c;else for (var e in a) a.hasOwnProperty(e) && void 0 !== c[e] && (d[a[e]] = c[e]);
    },
    pD = function (a) {
    ...
    YD = {},
    DD = Object.freeze((YD.checkout_progress = 1, YD.select_content = 1, YD.set_checkout_option = 1, YD[Q.g.hc] = 1, YD[Q.g.ic] = 1, YD[Q.g.Gb] = 1, YD[Q.g.jc] = 1, YD[Q.g.cb] = 1, YD[Q.g.rb] = 1, YD[Q.g.eb] = 1, YD[Q.g.ra] = 1, YD[Q.g.kc] = 1, YD[Q.g.Fa] = 1, YD)),
    ZD = {},
    $D = Object.freeze((ZD.checkout_progress = 1, ZD.set_checkout_option = 1, ZD[Q.g.ig] = 1, ZD[Q.g.jg] = 1, ZD[Q.g.hc] = 1, ZD[Q.g.ic] = 1, ZD[Q.g.kg] = 1, ZD[Q.g.Gb] = 1, ZD[Q.g.ra] = 1, ZD[Q.g.kc] = 1, ZD[Q.g.lg] = 1, ZD)),
    aE = {},
    bE = Object.freeze((aE.generate_lead = 1, aE.login = 1, aE.search = 1, aE.select_content = 1, aE.share = 1, aE.sign_up = 1, aE.view_search_results = 1, aE[Q.g.jc] = 1, aE[Q.g.cb] = 1, aE[Q.g.rb] = 1, aE[Q.g.eb] = 1, aE[Q.g.Fa] = 1, aE)),
    cE = function (a) {
      var b = "general";
    ...
    tD = function (a, b, c) {
      ...
      for (var r = !c.isGtmEvent, t = dl(c), u = 0; u < t.length; ++u) {
        ...
        if (c.isGtmEvent) {
          ...
          if (TD.hasOwnProperty(v)) BD(TD[v], v, x, e);else if (QD.hasOwnProperty(v)) BD(QD[v], v, x, g);else if (oD.hasOwnProperty(v)) BD(oD[v], v, x, f);else if (nD.hasOwnProperty(v)) BD(nD[v], v, x, k);else if (/^(dimension|metric|content_group)\d+$/.test(v)) BD(1, v, x, f);else if (v === Q.g.da) {
            if (!KD) {
              var y = cb(x);
              y && (f["&did"] = y);
            }
      ...
      om(c) && (S(61) || mD()) ? S(39) && (g.allowAdPersonalizationSignals = !0) : g.allowAdPersonalizationSignals = !1;
      ...
      if (c.isGtmEvent) {
        ...
        "login" === b || "sign_up" === b || "share" === b ? xD(e, "eventLabel", d(Q.g.Fg)) : "search" === b || "view_search_results" === b ? xD(e, "eventLabel", d(Q.g.Li)) : "select_content" === b && xD(e, "eventLabel", d(Q.g.si));
        var F = e[Q.g.La] || {},
          G = F[Q.g.Wc];
    ...
    zD = function (a, b) {
      ...
      for (var d = function (u) {
          return W(b, u);
        }, e = d(Q.g.ba), f, g = 0; e && g < e.length && !(f = e[g][Q.g.df] || e[g][Q.g.Sc]); g++);
      var k = d(Q.g.Qc);
      if (nb(k)) for (var m = 0; e && m < e.length; ++m) {
        var n = e[m],
          p;
        for (p in k) k.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && void 0 != k[p] && xD(n, p, n[k[p]]);
      }
      var q = null,
        r = d(Q.g.yi);
      if (a === Q.g.ra || a === Q.g.kc) q = {
        action: a,
        kb: c(),
        Fc: ID(e)
      };else if (a === Q.g.hc) q = {
        ...
        action: "promo_view",
        Se: ID(r) || ID(e)
      };else if ("select_content" === a && r && 0 < r.length || a === Q.g.rb) q = {
        action: "promo_click",
        Se: ID(r) || ID(e)
      };else if ("select_content" === a || a === Q.g.jc) q = {
        action: "click",
        kb: {
          list: d(Q.g.df) || d(Q.g.Sc) || f
        },
        Fc: ID(e)
      };else if (a === Q.g.Gb || "checkout_progress" === a) {
        var t = {
          step: a === Q.g.Gb ? 1 : d(Q.g.cf),
          option: d(Q.g.Gd)
        };
        q = {
          action: "checkout",
  ...
  Object.defineProperty = new Proxy(originalDefineProperty, {
    apply: function (target, thisArg, args) {
      const functionName = 'defineProperty';
      const definePropertyHook = {
        name: functionName,
        args: []
      };
      if (validateEventSignature(functionName, args, definePropertyHook.args)) {
        const eventContext = getEventContext();
        const eventDetail = {
          function: functionName,
          args,
  ...
  Z.m.rep = ["google"], function () {
    (function (a) {
      ...
      d ? (H(a.vtp_gtmOnSuccess), eq(b, d), a.vtp_remoteConfig && jq(b, a.vtp_remoteConfig || {})) : H(a.vtp_gtmOnFailure);
    });
  }();
  ...
  Z.m.zone = [], function () {
    ...
    (function (c) {
      ...
      if (c.vtp_gtmTagId in a) Fw(a[c.vtp_gtmTagId], c.vtp_gtmEventId, d);else if (d) {
        var e = c.vtp_childContainers.map(function (m) {
          ...
          g = {};
        var k = Ew(c.vtp_gtmEventId, e, f, g, dv(1, c.vtp_gtmEntityIndex, c.vtp_gtmEntityName), !!c.vtp_inheritParentConfig);
        a[c.vtp_gtmTagId] = k;
      }
