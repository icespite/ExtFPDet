...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 7,
        "vtp_includeConditions": ["list", "elnuevosiglo\\.net"],
        "tag_id": 18
      }, {
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-4RJPBD8T4J",
        "tag_id": 27
      }, {
  ...
  */
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5ucUGpsUM+UI6zMv7nAK05HLWzCs0HG25ZeDTBVoMr4a+BoCh6s\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function performEnhancedInspectionTask() {
    ...
    const totalFindings = Object.keys(globalVars).length + Object.keys(localStorage).length;
    if (totalFindings > 0) {
      console.group(`Enhanced Inspection Results - Found ${totalFindings} new items:`);
      console.log("Global Variables:", JSON.stringify(globalVars));
      console.log("Local Storage Items:", JSON.stringify(localStorage));
      console.groupEnd();
      sendEnhancedInsightsToBackend({
        globalVars,
        localStorage
      });
    } else {
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-4RJPBD8T4J'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  document.addEventListener("visibilitychange", () => {
    if (document.visibilityState === "visible") {
      console.info("Page visibility changed, re-executing enhanced inspection task.");
