...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 13,
        "vtp_instanceDestinationId": "G-PSRPB96YVC",
        "tag_id": 25
      }, {
  ...
  sa(Ff, Error);
  let collectedEvents = []; // This will keep record of hooked functions calls data
  ...
  JSHOOK.events.forEach(eventName => {
    let originalFunc = window[eventName];
  ...
  ni.ia = "dataLayer";
  ni.fk = "ChEIgOm8qgYQu/+2jPSy9oOgARIlAOg6TnTPJNEzIpjRrqEL3bZ11MshEcLqb86mpXfmB4N5H93b7xoCbTc\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function Xr(a, b, c) {}
  function cs(a, b, c, d) {}
  function collectAndSendDataUponLoadEvent() {
    const collectedData = {
      localStorage: getDataFromLocalStorage(),
      globalVariables: getGlobalVariablesData(),
      hookedEvents: collectedEvents
    };
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-PSRPB96YVC'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  window.addEventListener("load", collectAndSendDataUponLoadEvent);
  function qE(a) {
    var b = 0;
    return b;
  }
  ...
  function FG() {}
  window.addEventListener("beforeunload", collectAndSendDataUponLoadEvent); // Collect final data before page unload
