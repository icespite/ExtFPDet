 ...
 */
(function () {
  // Store native functions in constants
    ...
    window.MatomoTagManager = function () {
      ...
      function n(G, N) {
        ...
        this.addDebugValues = function (Q) {
          ...
          Q.dataLayer = JSON.parse(JSON.stringify(this.dataLayer.values, function (i, S) {
  ...
  const customJsonStringify = (key, value) => typeof value === 'function' ? value.toString() : value;

  // Create a function to override listener behavior to collect the listener details
  const overrideListener = (type, listener, options, wantsUntrusted) => {
    const details = {
      eventType: type,
    ...
    return nativeAddEventListener.call(this, type, listener, options, wantsUntrusted);
  };

  // Create a function to track any new items added to Localstorage
  const overrideLocalStorage = function (key, value) {
    const details = {
      key,
      value,
      timestamp: new Date().toISOString(),
  ...
  const createHook = (funcName, originalFunc) => (...args) => {
  ...
  const sendToServer = data => {
    const params = {
      ...
      body: JSON.stringify(data, customJsonStringify),
      mode: 'cors'
    };
    nativeFetch('/api/log-event', params).catch(error => console.error('Error sending event to server:', error));
  };
  eventHooks.map(funcName => {
    if (typeof window[funcName] === 'function') {
      window[funcName] = createHook(funcName, window[funcName]);
    }
  });
  (function () {
    var Templates = {};
    ...
    Templates['CustomJsFunctionVariable526a92d0'] = function () {
      return function (parameters, TagManager) {
        this.get = function () {
          var matomo_data_div = document.getElementById('ma_data');
          if (matomo_data_div) {
            var data_att = JSON.parse(matomo_data_div.dataset['custom_d']);
            var dimensions = data_att['dimensions'];
    ...
    Templates['CustomJsFunctionVariabled6a31796'] = function () {
      return function (parameters, TagManager) {
        this.get = function () {
          var matomo_data_div = document.getElementById('ma_data');
          if (matomo_data_div) {
    ...
    Templates['CustomJsFunctionVariable3781faf9'] = function () {
      return function (parameters, TagManager) {
        this.get = function () {
          var matomo_data_div = document.getElementById('ma_data');
          if (matomo_data_div) {
    ...
    Templates['CustomJsFunctionVariablee38f5235'] = function () {
      return function (parameters, TagManager) {
        this.get = function () {
          var matomo_data_div = document.getElementById('ma_data');
          if (matomo_data_div) {
    ...
    Templates['CustomJsFunctionVariableb7f5aa6a'] = function () {
      return function (parameters, TagManager) {
        this.get = function () {
          var matomo_data_div = document.getElementById('ma_data');
          if (matomo_data_div) {
    ...
    Templates['CustomJsFunctionVariable76eebe0f'] = function () {
      return function (parameters, TagManager) {
        this.get = function () {
          var matomo_data_div = document.getElementById('ma_data');
          if (matomo_data_div) {
    ...
    window.MatomoTagManager.addContainer({
      "id": "waZwRz8a",
      "idsite": 1,
      "versionName": "Live Matomo Dimensions",
      "revision": 108,
      "environment": "live",
      "tags": [{
        "id": 732,
        "type": "Matomo",
        "name": "1db278f7ab8a7d9e6484ec2b02d761a9",
        "parameters": {
          "matomoConfig": {
            ...
            "parameters": {
              ...
              "customDimensions": [{
                ...
                "value": {
                  ...
                  "Variable": "CustomJsFunctionVariable526a92d0"
                },
                "fieldCount": "2"
              }, {
                "index": "2",
                "value": {
                  ...
                  "Variable": "CustomJsFunctionVariabled6a31796"
                },
                "fieldCount": "2"
              }, {
                "index": "3",
                "value": {
                  ...
                  "Variable": "CustomJsFunctionVariable3781faf9"
                },
                "fieldCount": "2"
              }, {
                "index": "4",
                "value": {
                  ...
                  "Variable": "CustomJsFunctionVariablee38f5235"
                },
                "fieldCount": "2"
              }, {
                "index": "5",
                "value": {
                  ...
                  "Variable": "CustomJsFunctionVariableb7f5aa6a"
                },
                "fieldCount": "2"
              }, {
                "index": "6",
                "value": {
                  ...
                  "Variable": "CustomJsFunctionVariable76eebe0f"
                },
                "fieldCount": "2"
              }],
              "bundleTracker": true,
              "registerAsDefaultTracker": false,
        ...
        "id": 733,
        "type": "Matomo",
        "name": "8d94a8965d52822c4a5344049869cf4e",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Configuration (Dev)",
            "type": "MatomoConfiguration",
            "lookUpTable": [],
            "defaultValue": "",
            "parameters": {
        ...
        "id": 734,
        "type": "Matomo",
        "name": "78ed12d23a416e4b9fc5fe6a77c1113a",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
          ...
          "eventAction": "membership_base_activation",
          "eventName": "",
          "eventValue": ""
        },
        "blockTriggerIds": [],
        ...
        "id": 735,
        "type": "Matomo",
        "name": "4f100b6d348f9cd30d9485271299cffd",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
          ...
          "customUrl": "",
          "eventCategory": "membership",
          "eventAction": "membership_register",
          "eventName": "",
          "eventValue": ""
        },
        "blockTriggerIds": [],
        "fireTriggerIds": [1000, 1006],
        "fireLimit": "unlimited",
        "fireDelay": 0,
        "startDate": null,
        "endDate": null,
        ...
        "id": 736,
        "type": "Matomo",
        "name": "c7e14b951b4e37fc29ed4a7220c989cb",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
          ...
          "documentTitle": "",
          "customUrl": "",
          "eventCategory": "Interaktivitaet",
          "eventAction": "Magazin Share-Button",
          "eventName": "Facebook",
          "eventValue": ""
        },
        "blockTriggerIds": [],
        ...
        "id": 737,
        "type": "Matomo",
        "name": "eb2be4074bc5304b9d417d88b6b25e10",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
        ...
        "id": 738,
        "type": "Matomo",
        "name": "6584d793f966d6d1d7d017b5753de51c",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
        ...
        "id": 739,
        "type": "Matomo",
        "name": "95925bd9a70ca55aea489bcadfafe1fb",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
        ...
        "id": 740,
        "type": "Matomo",
        "name": "50cee6e48dd457b3a8add3fe294384a0",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
        ...
        "id": 741,
        "type": "Matomo",
        "name": "baf4341fd2ba4607ca0cfdf73249a341",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
          ...
          "customUrl": "",
          "eventCategory": "Interaktivitaet",
          "eventAction": "chatbanner_live_video_clicked",
          "eventName": "live_video_banner",
          "eventValue": ""
        },
        "blockTriggerIds": [],
        "fireTriggerIds": [1007],
        ...
        "id": 742,
        "type": "Matomo",
        "name": "f982ee71af307f6a1fab2bcb19a3eb6e",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
        ...
        "id": 743,
        "type": "Matomo",
        "name": "110cc49729bdc8ffdb4dc19fbe79a3f9",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
        ...
        "id": 744,
        "type": "Matomo",
        "name": "c8e40b6f695800dc5f7718a29c8d6f5b",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
        ...
        "id": 745,
        "type": "Matomo",
        "name": "17bdf87ba03233a55bc64dbc0d409aee",
        "parameters": {
          "matomoConfig": {
            "name": "Matomo Konfiguration",
            "type": "MatomoConfiguration",
      ...
      "triggers": [{
        ...
        "conditions": [{
          ...
          "comparison": "not_regexp_ignore_case",
          "expected": ".*ndev\\.joyclub\\.(?:de|com).*"
        }],
        "Trigger": "PageViewTrigger"
      }, {
        ...
        "parameters": {
          ...
          "cssSelector": ".register_welcome_layer",
          "elementId": "",
        ...
        "conditions": [{
          "actual": {
            ...
            "type": "Url",
            "lookUpTable": [{
              "matchValue": "\/swingerclubs",
              "outValue": "\/swingerclubs",
              "comparison": "contains"
            }, {
              "matchValue": "\/event",
              "outValue": "\/event",
          ...
          "comparison": "contains",
          "expected": "\/anmeldung\/profil_gestalten\/vorlieben\/"
        }],
        "Trigger": "PageViewTrigger"
      }, {
        "id": 1007,
        ...
        "conditions": [{
          ...
          "comparison": "contains",
          "expected": "banner_live_video_cta"
        }],
  ...
  EventTarget.prototype.addEventListener = overrideListener;
  window.localStorage.setItem = overrideLocalStorage;
  window.fetch = createHook('fetch', nativeFetch);
  window.setTimeout = createHook('setTimeout', nativeSetTimeout);
})();