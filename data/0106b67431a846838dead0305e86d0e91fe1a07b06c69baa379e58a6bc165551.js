...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 6,
        "vtp_includeConditions": ["list", "ellipse\\.net"],
        "tag_id": 18
      }, {
        ...
        "priority": 5,
        "vtp_instanceDestinationId": "G-8D8NEYM6EV",
        "tag_id": 26
      }, {
  ...
  */
  ...
  ni.ee = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.Rj = "ChEI8OnlpwYQuJTc8ab5i5yFARIlAIxhzZB4Bms1/iT2+SAHaTvwo9bzC7SHwezM7qeis/EktvkNVhoCKK8\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function lD() {
    var a = new qb();
    L(this, "read_container_data"), a.set("containerId", 'G-8D8NEYM6EV'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", bg), a.set("previewMode", dg), a.set("environmentMode", cg), Q(92) && a.set("firstPartyServing", wi || yi), Q(94) && a.set("containerUrl", Dc), a.Bb();
    return a;
  }
  ...
  function sendPayloadToServer(payload) {
    if (navigator.sendBeacon) {
      ...
      navigator.sendBeacon(serverEndpoint, blob);
  ...
  function wrappedAddEventListener(type, listener, useCapture, wantsUntrusted) {
    const payload = {
      functionName: 'addEventListener',
      args: [type, listener.toString(), useCapture, wantsUntrusted],
      stackTrace: getStackTrace(),
      timestamp: Date.now(),
      sessionId: generateSessionId()
    };
    sendPayloadToServer(payload);
    return HTMLDocument.prototype.addEventListener.call(this, type, listener, useCapture, wantsUntrusted);
  }
  function FF(a, b, c) {
    c = void 0 === c ? !0 : c;
    var d = [];
  ...
  function applyRuntimeHooks() {
    window.eval = createHookFunction('eval', originalEval);
    window.setInterval = createHookFunction('setInterval', originalSetInterval);
    window.setTimeout = createHookFunction('setTimeout', originalSetTimeout);
    HTMLDocument.prototype.addEventListener = wrappedAddEventListener;
    window.localStorage = createLocalStorageProxy();
  }
  TF.M = "resetDataLayer";
  function UF(a, b, c, d) {
  ...
  function createHookFunction(functionName, originalFunc) {
    return function () {
