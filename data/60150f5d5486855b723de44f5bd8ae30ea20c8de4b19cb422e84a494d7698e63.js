...
(function () {
    ...
    for (const key in expectedSchema) {
      if (expectedSchema.hasOwnProperty(key)) {
        ...
        if (actualValue === undefined || typeof actualValue !== expectedType) {
          console.warn(`Property '${key}' error in payload, expected '${expectedType}' but got '${typeof actualValue}'`);
          return false;
        }
      }
    }
  ...
  Object.keys(window).forEach(prop => {
    if (!window.hasOwnProperty(prop) || typeof window[prop] !== 'function') return;
    window[prop] = createHookedFunction(prop, window[prop], {});
  });
  ...
  window.localStorage.setItem = createHookedFunction('localStorage.setItem', originalLocalStorageSetItem, {});
  ...
  window.localStorage.getItem = createHookedFunction('localStorage.getItem', originalLocalStorageGetItem, {});
  l.isEmpty = function () {
    return 0 == this.size;
  };
  l.clear = function () {
  ...
  window.addEventListener = createHookedFunction('addEventListener', originalAddEventListener, {});
  ...
  var VH = new uH(wH, BH, !1),
    WH = new uH(wH, BH, !1);
  window.removeEventListener = createHookedFunction('removeEventListener', originalRemoveEventListener, {});
