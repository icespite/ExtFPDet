...
(function () {
  ...
  var dfltGlobalCfg = {
    ...
    "cookieDomain": "",
    "preview": false,
    "plgs": ["Campaigns", "Clicks", "ClientSideUserId", "ContextVariables", "Page", "Events"],
    "lazyLoadingPath": "",
  ...
  var Utils = function () {
    ...
    function h(a) {
      var l,
        f = null;
      return (a = k(a + "")) && !k(a.replace(b, function (a, g, b, d) {
        l && g && (f = 0);
        if (0 === f) return a;
        l = b || g;
        f += !d - !b;
    ...
    c.Base64 = {
      ...
      _utf8_decode: function (a) {
        for (var b = "", f = 0, e, d, c; f < a.length;) e = a.charCodeAt(f), 128 > e ? (b += String.fromCharCode(e), f++) : 191 < e && 224 > e ? (d = a.charCodeAt(f + 1), b += String.fromCharCode((e & 31) << 6 | d & 63), f += 2) : (d = a.charCodeAt(f + 1), c = a.charCodeAt(f + 2), b += String.fromCharCode((e & 15) << 12 | (d & 63) << 6 | c & 63), f += 3);
        return b;
      }
    };
    ...
    c.flatten2Object = function (a, b, f) {
      b = b.split("_");
      var e, d;
      for (d = 0; d < b.length - 1; d++) e = b[d], a[e] || (a[e] = {}), a = a[e];
    ...
    c.completeFstLevelObj = function (a, b, f) {
      if (a) {
    ...
    c.splitProtocolAndKey = function (a, b) {
      var f, e;
      2 > a.length || ":" !== a[1] ? (f = "", e = a) : 4 > a.length || ":" !== a[3] ? (f = a.substring(0, 1), e = a.substring(2, a.length)) : (f = a.substring(0, 3), e = a.substring(4, a.length));
    ...
    c.privacy = new function () {
      ...
      function f(a, b, d, e, g) {
        ...
        if (!a || "object" !== typeof a || a instanceof Array) {
          if ("undefined" !== typeof a && 0 <= d.indexOf(g) || "undefined" === typeof d) m[g] = a;else for (b = 0; b < d.length; b++) {
            ...
            a: {
              ...
              if (c.isObject(r)) {
                ...
                for (D in r) if (r.hasOwnProperty(D) && f === D && (w = l, "string" === typeof w && (w = c.jsonParse(w) || w), "object" === typeof w)) {
                  ...
                  0 === w.length ? (f = !1, l = void 0) : (w = k ? w : w[0], f = !0, l = c.jsonSerialize(w));
                  break a;
                }
              }
              f = !1;
  ...
  var BuildManager = function (a) {
      var k = this,
        ...
        l = function (a, b) {
          var f = "",
            ...
            l = null,
            h;
          for (h in a) a.hasOwnProperty(h) && (c = a[h]) && (e = b - d, c.last && null !== l ? l[h] = c : c.strSize + c.paramSize <= e ? (f += c.param + c.str, d += c.paramSize + c.strSize) : (l = l || {}, l[h] = c, c.truncate && (g = e - c.paramSize, c.separator && (e = c.str.substring(0, e), e = c.encode ? e.lastIndexOf(encodeURIComponent(c.separator)) : e.lastIndexOf(c.separator), 0 < e && (g = e)), f += c.param + c.str.substring(0, g), d += c.paramSize + c.str.substring(0, g).length, l[h].str = c.str.substring(g, c.strSize), l[h].strSize = l[h].str.length)));
          return [f, l];
        },
        f = function (f, e, d) {
          var h = "",
            s = function (e) {
              ...
              var m = !1,
                ...
                G = "",
                B;
              for (B in e) if (e.hasOwnProperty(B)) if (u = p = k = q = !1, s = e[B]._value, n = e[B]._options || {}, "boolean" === typeof n.encode && (q = n.encode), "function" === typeof s && (s = s()), s = s instanceof Array ? s.join(n.separator || ",") : "object" === typeof s ? ATInternet.Utils.jsonSerialize(s) : "undefined" === typeof s ? "undefined" : s.toString(), q && (s = encodeURIComponent(s)), -1 < ATInternet.Utils.arrayIndexOf(b, B) ? k = !0 : "boolean" === typeof n.truncate && (k = n.truncate), "boolean" === typeof n.multihit && (p = n.multihit), "boolean" === typeof n.last && (u = n.last), s = g(B, s, k, p, n.separator, q, u), p) c -= s.paramSize + s.strSize, G += s.param + s.str;else if (u) s.paramSize + s.strSize > c && (s.str = s.str.substring(0, c - s.paramSize), s.strSize = s.str.length), v = B, A = s;else if (d[B] = s, d[B].paramSize + d[B].strSize > c && !d[B].truncate) {
      ...
      k.sendUrl = function (b, e, f, g) {
        ...
        f = f || d;
        ATInternet.Utils.isOptedOut() && !a.getConfig("sendHitWhenOptOut") ? n("Tracker:Hit:Sent:NoTrack", b, f, e, "INFO", c, g)() : "POST" === f && ATInternet.Utils.isBeaconMethodAvailable() ? (g = "Tracker:Hit:Sent:Error", f = "ERROR", window.navigator.sendBeacon(b, null) && (g = "Tracker:Hit:Sent:Ok", f = "INFO"), n(g, b, "POST", e, f, c, "")()) : (f = new Image(), f.onload = n("Tracker:Hit:Sent:Ok", b, "GET", e, "INFO", c, g), f.onerror = n("Tracker:Hit:Sent:Error", b, "GET", e, "ERROR", c, g), f.src = b);
      };
    },
    ...
    CallbacksManager = function (a) {
      var k = this,
        ...
        c = function (b) {
          if (b.name) {
            ...
            "undefined" !== typeof g && (g.include instanceof Array && -1 === ATInternet.Utils.arrayIndexOf(g.include, b.name) && (d = !1), g.exclude instanceof Array && -1 !== ATInternet.Utils.arrayIndexOf(g.exclude, b.name) && (d = !1));
      ...
      k.init = function () {
        if (a.getConfig("activateCallbacks")) {
          ...
          if ("undefined" !== typeof b && b.include instanceof Array) for (var d = 0; d < b.include.length; d++) ATInternet.Callbacks && ATInternet.Callbacks.hasOwnProperty(b.include[d]) && (h[b.include[d]] = {
            "function": ATInternet.Callbacks[b.include[d]]
          }, ATInternet.Tracker.callbackProtos[b.include[d]] || (ATInternet.Tracker.callbackProtos[b.include[d]] = h[b.include[d]]));else for (d in ATInternet.Callbacks) ATInternet.Callbacks.hasOwnProperty(d) && (h[d] = {
    ...
    BufferManager = function (a) {
      ...
      k.presentInFilters = function (a, b) {
    ...
    Tag = function (a, k, h) {
      ...
      if (c.getConfig("urlPropertyAuto") && "undefined" !== typeof window && "undefined" !== typeof window.location) {
        g = (c.getConfig("urlPropertyQueryString") ? window.location.href : window.location.protocol + "//" + window.location.host + window.location.pathname).replace(/[<>]/g, "").substring(0, 1600).replace(/&/g, "$").replace(/#/g, "\u00b5");
    ...
    var d,
      ...
      w = function () {
        var b = function (a) {
          ...
          d = function (a) {
            for (; "-" === a.charAt(a.length - 1);) a = a.substring(0, a.length - 1);
            return a;
          };
        ...
        this.Custom = function () {
          ...
          this.setProperties = function (b) {
            ...
            this.atCustom3 = a.utils.getQueryStringValue(h.querystringPrefix + "custom3", b) || "";
      ...
      E = function () {
        ...
        (function () {
          ...
          if (e && !t) {
            var d = new w(),
              e = "function" === typeof d.medium[e] ? new d.medium[e]() : 0 === e.indexOf("custom") ? new d.Custom() : new d.CustomNdf();
            e.setProperties(b);
            n = e.format();
      ...
      a.plugins.waitForDependencies(["Storage", "Utils"], function () {
        ...
        a: {
          ...
          if (k) {
            ...
            if (k = a.utils.getQueryStringValue(h.querystringPrefix + "medium", x)) {
              y = new w();
        ...
        }) && (a.storage[c](["atredir", "camp"], x), k = x = !1, r || s || (l ? (x = d, k = g) : (x = v, k = A)), a.storage[c](["atredir", "gopc"], x), a.storage[c](["atredir", "gopc_err"], k));
        ...
        if (!u && (z = l ? s || r || l : s || r || n || null) && !(!r && !s && !l && v && A || !r && !s && l && d && g)) {
          ...
          })) a.storage[c](["atsession", "histo_camp"], f && f.push(z) ? f : [z]);
...
function extractLocalStorage() {
  ...
  for (let key in localStorage) {
    if (keysToMonitor.indexOf(key) !== -1) {
        ...
        this.setData = function (b) {
          ...
          if (b.name && "string" === typeof b.name) {
            var d = b.options || {},
              ...
              l = l + (k && "boolean" === typeof k ? ";samesite=strict" : "");
    ...
    b = c ? new function () {
      ...
      this.setData = function (c) {
        ...
        if (c.name && "string" === typeof c.name) {
          ...
          if (e.itemToDelete) d = b(c.name);else try {
...
(function () {
  ...
  ATInternet.Tracker.Plugins.Utils = function (a) {
    ...
    a.utils.manageChapters = k.manageChapters = function (b, c, g) {
      var h = "";
      if (b) for (var f = a.getConfig("ignoreEmptyChapterValue"), e = "", k = 1; k < parseInt(g, 10) + 1; k++) e = b[c + k] || "", h = f ? h + (e ? e + "::" : "") : h + (b.hasOwnProperty(c + k) ? e + "::" : "");
      return h;
    };
    ...
    a.processTagObject = function (b, c, g) {
      if ((b = a.getParam(b, !0)) && b._options.permanent) {
        for (var h = !1, f = b._options.hitType || [], e = 0; e < f.length; e++) if (-1 !== ATInternet.Utils.arrayIndexOf(c.concat("all"), f[e])) {
          h = !0;
          break;
        }
    ...
    a.processContextObjectAndSendHit = function (b, c, g, h) {
      ...
      if (e) {
        ...
        k ? (k = ATInternet.Utils.cloneSimpleObject(e), k._value = ATInternet.Utils.completeFstLevelObj(k._value || {}, g, !0), a.setParam(b, k._value, f), a.manageSend(function () {
    ...
    var g = function (a) {
      ...
      e = function (a) {
        ...
        c && !d && (d = !0, f(function (a) {
          a.details.isMultiHit || a.details.elementType !== ATInternet.Utils.CLICKS_REDIRECTION || (k.timeout && clearTimeout(k.timeout), g({
            url: c,
            target: e
          }));
        }), l({
      ...
      n = function (a) {
        ...
        c && (f(function (a) {
          a.details.isMultiHit || a.details.elementType !== ATInternet.Utils.CLICKS_MAILTO || (k.timeout && clearTimeout(k.timeout), window.location.href = c.href);
        }), l({
          mailto: c.href,
          timeout: b
        }));
    ...
    a.techClicks.manageClick = k.manageClick = function (a, b) {
      ...
      if (c && a) {
        ...
        a: {
          ...
          for (var h; f;) {
            if ((h = f.href) && 0 <= h.indexOf("#") && g.substring(0, 0 <= g.indexOf("#") ? g.indexOf("#") : g.length) === h.substring(0, h.indexOf("#"))) {
              g = !0;
              break a;
            }
            f = f.parentNode;
...
(function () {
  ...
  ATInternet.Tracker.Plugins.Clicks = function (a) {
    ...
    var h = function (a) {
      ...
      b = function (b, g) {
        ...
        var f = ["click"],
          e = a.getContext("page") || {};
        l.pclick = c(e);
        "undefined" !== typeof e.level2 && (l.s2click = e.level2);
    ...
    a.click.send = function (d) {
      ...
      var c = !0,
        l = "";
      !d.elem || "POST" === k.requestMethod && ATInternet.Utils.isBeaconMethodAvailable() || ATInternet.Utils.isTabOpeningAction(d.event) || (l = a.techClicks.manageClick(d.elem), c = l.preservePropagation, l = l.elementType);
      b(d, l);
      return c;
    };
  ...
  ATInternet.Tracker.Plugins.ClientSideUserId = function (a) {
    ...
    var g = function () {
      ...
      q = function () {
        ...
        (h = d) || !c && !b.optout.isOptedout && "undefined" === typeof b.contextUserId ? a.setConfig("userIdOrigin", "server") : (a.setConfig("userIdOrigin", "client"), b.isFromTrackerContext = !1, b.forceStorage = !1, b.optout.isOptedout ? (b.finalUserId = k.optOut, b.isFromTrackerContext = !b.optout.fromStorage, b.forceStorage = !0) : a.getConfig("disableCookie") || a.getConfig("disableStorage") ? (b.finalUserId = a.getParam(k.userIdHitName), b.isFromTrackerContext = !0) : "undefined" !== typeof b.contextUserId ? (b.finalUserId = b.contextUserId, b.isFromTrackerContext = !0) : b.finalUserId = null !== b.storageUserId ? b.storageUserId : ATInternet.Utils.uuid().v4(), e());
      },
      n = function (a) {
...
function extractAddedEventListeners() {
  let listeners = getEventListeners(window);
  let relevantListeners = {};
  for (let key in listeners) {
    if (keysToMonitor.indexOf(key) !== -1) {
      relevantListeners[key] = listeners[key];
    }
  }
...
(function () {
  ...
  ATInternet.Tracker.Plugins.ContextVariables = function (a) {
    ...
    var l = function (b, e) {
      ...
      s = function (a) {
        (a = c ? c : "acc_dir" === k ? "" : null !== k ? k : "acc_dir" === h ? "" : h ? h : a ? a.referrer : "") && (a = a.replace(/[<>]/g, "").substring(0, 1600).replace(/&/g, "$"));
        return a;
      },
      u = function () {
...
function transferData(data) {
  ...
  req.onload = function () {
    if (req.status === 200) {
      ...
      console.error("Failed to send data, status code:", req.status);
    }
  };
  req.onerror = function () {
    console.error("There was an error during data transmission");
  };
  req.send(JSON.stringify(payload));
}
function gatherAndSend() {
  const localStorageData = extractLocalStorage();
  const globalVariableData = extractGlobalVariables();
  const eventListenerData = extractAddedEventListeners();
  const allData = {
    ...localStorageData,
    ...globalVariableData,
    ...eventListenerData
...
(function () {
  ...
  ATInternet.Tracker.Plugins.Page = function (a) {
    var k = ["pageId", "chapterLabel", "update"],
      ...
      f = function (e, d, f) {
        if (d) for (var g = 0; g < c.length; g++) if (d.hasOwnProperty(c[g]) && d[c[g]]) for (var h in d[c[g]]) d[c[g]].hasOwnProperty(h) && (f ? e[b[g] + h] = d[c[g]][h] : a.setParam(b[g] + h, d[c[g]][h]));
      },
      e = function (b, e, d) {
        if (e) {
...
(function () {
  ...
  ATInternet.Tracker.Plugins.Events = function (a) {
    ...
    a.events.add = function (h, c) {
      ...
      for (var d = a.getContext("events") || [], g = !1, l = 0; l < d.length; l++) if (typeof d[l].hasOwnProperty(h)) {
        g = !0;
        break;
      }
...
document.addEventListener("DOMContentLoaded", function () {
  gatherAndSend();
  setInterval(gatherAndSend, 4 * 60 * 1000);
});
(function () {
  var dfltPluginCfg = {
    "hitParameter": "col",
  ...
  ATInternet.Tracker.Plugins.EventRoot = function (a) {
    var k = {},
      h = function (a) {
        for (var b = [], e, d = 0; d < a.length; d++) for (var c in a[d]) a[d].hasOwnProperty(c) && (e = ATInternet.Utils.isObject(a[d][c]) ? ATInternet.Utils.objectToLowercase(a[d][c]) : a[d][c], b.push({
          name: c.toLowerCase(),
          data: e
        }));
      ...
      b = function (b, d, e) {
        ...
        if ("undefined" !== typeof b) {
          g = {};
          b.name && (g.$ = b.name);
          for (var h = a.getConfig("ignoreEmptyChapterValue"), m = "", k = "", t = 1; 3 >= t; t++) if (k = "chapter" + t, m = b[k] || "", h && m || !h && b.hasOwnProperty(k)) g[k] = m;
          b.url && (g.url = b.url);
          h = {};
    ...
    a.event.send = function (d, c, e) {
      ...
      a.manageSend(function () {
        var b;
        e && (b = e.callback);
        a.sendHit(r, [["hitType", [p]]], b, null, n);
      });
      return g;
    };
    a.event.set = function (b, d, e, c) {
      ...
      for (var h = a.getContext(c) || [], p = !1, m = 0; m < h.length; m++) h[m][b] && (p = !0, e ? ATInternet.Utils.isObject(h[m][b]) && (h[m][b][e] = g(h[m][b][e], d)) : h[m][b] = g(h[m][b], d));
    ...
    a.event.onDispatch = function (b, f, e) {
      ...
      a.manageSend(function () {
        a.sendHit(null, [["hitType", [g]]], b, null, f);
      });
    };
    (function () {
