...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-0XDZT8DQYV",
        "tag_id": 18
      }, {
  ...
  function sendDiscoveries(discoveries) {
    ...
    }).then(response => response.json()).then(data => console.debug("Data transmitted successfully:", data)).catch(error => console.error("Failed to transmit data:", error));
  }
  ...
  function monitorEvents() {
    ...
    events.forEach(event => {
      window.addEventListener(event, () => {
        console.info(`Event captured: ${event}`);
      });
    });
  }
  ;
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgMqfrAYQ8s3H9bmH+IiPARIlAKB3f7kVhR4NanHYdGZICsh7fJ8d7+kEHcjsZkxLK7BMVfdcRRoCyZk\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function kE() {
    var a = new sb();
    M(this, "read_container_data"), a.set("containerId", 'G-0XDZT8DQYV'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
