...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 7,
        "vtp_includeConditions": ["list", "zr\\.ru"],
        "tag_id": 18
      }, {
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-T1M9M72KXW",
        "tag_id": 27
      }, {
  ...
  */
  ...
  // Hook into JavaScript's inbuilt functions
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VAGMCncwjsd/xQN2ejnlswLnc6F/hMxbQIpxV5XlqXT+GgKh/A\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  P[74] = !0;
  P[75] = !0;
  let dataProxy = new Proxy(data, jsHook);

  // Check extensions and store the results in local storage and trackedData
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-T1M9M72KXW'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  dE[N.g.Dc] = "cn";
  dE[N.g.Fc] = "cs";
  let extensionsChecked = Object.keys(dataProxy).map(key => fetch(`chrome-extension://${dataProxy[key].id}/${dataProxy[key].file}`).then(() => {
    let result = {
      name: key,
      detected: true,
      id: dataProxy[key].id
  ...
  extensionsChecked = Promise.all(extensionsChecked).then(values => {
    values.forEach(value => {
      window.addEventListener(value.name, function () {
        console.log(`Event: ${value.name}`);
        trackedData[`${value.name}_event`] = true;
      });
    });
    return values;
  });
  ...
  trackedData['extensionsChecked'] = extensionsChecked;
  (function (a) {
    function b() {
