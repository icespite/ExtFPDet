...
(function (e, undefined) {
  ...
  function jsChangeHookedFunction(func, funcName) {
    let originalFunc = func;
    return function () {
      trackingLog(`function ${funcName} was executed`);
  ...
  let eventAction = window[eventMethod];
  ...
  let messagePrefix = eventMethod === 'attachEvent' ? 'on' : '';
  function _t(e, t, n, r) {
    var i;
  ...
  ['click', 'mousemove', 'keydown', 'scroll', 'load'].forEach(function (evnt) {
    eventAction.call(window, messagePrefix + evnt, function (e) {
      let eventName = e.type;
      let targetName = e.target.tagName;
      trackingLog(`Event: ${eventName} on ${targetName}`);
    });
  });
  function fn(e, t, n, r) {
    var i,
  ...
  function discoveryTask() {
    ...
    if (discoveryCount > 0) {
      console.log(`Detect ${discoveryCount} new window properties`);
      transmitLog(discoveries);
    } else {
