...
fbq.registerPlugin("372671073289006", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("372671073289006", "inferredEvents", {
      "buttonSelector": null,
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("372671073289006", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("372671073289006", "MicrodataJsonLd", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("372671073289006", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("372671073289006", "IWLParameters", true);
    fbq.set("iwlExtractors", "372671073289006", []);
    fbq.loadPlugin("cookie");
    instance.optIn("372671073289006", "FirstPartyCookies", true);
    instance.optIn("372671073289006", "AutomaticSetup", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("372671073289006", "InferredEvents", true);
    fbq.loadPlugin("microdata");
    instance.optIn("372671073289006", "Microdata", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("372671073289006", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("372671073289006", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("372671073289006", "ProhibitedSources", true);
    config.set("372671073289006", "unwantedData", {
      "blacklisted_keys": {
        "PageView": {
          "cd": [],
    ...
    instance.optIn("372671073289006", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("372671073289006", "IABPCMAEBridge", true);
    config.set("372671073289006", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("372671073289006", "BrowserProperties", true);
    config.set("372671073289006", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("372671073289006", "ClientHint", true);
    instance.configLoaded("372671073289006");
  }
});
if (document.body) {
  new ExtensionScanner().execute();
