(function (exoDynamicParams) {
  ...
  !function () {
    var e = null === window.AdProvider ? [] : window.AdProvider,
      t = {
        ...
        adTypes: exoDynamicParams.domainAdTypes,
        adNetwork: {
    ...
    (Array.isArray(window.AdProvider) || void 0 === window.AdProvider) && (window.AdProvider = function () {
      var e,
        ...
        w = ["native_ad"],
        b = [],
        _ = ["desktop_fullpage_interstitial", "mobile_fullpage_interstitial"],
        O = [],
        P = window,
        A = {},
        z = QueueManager,
      ...
      var S = function () {
        ...
        D = function (e) {
          ...
          e.parentElement.insertBefore(n, e), T({
            zone: r,
            where: n
        ...
        T = function (e) {
          if (void 0 !== e.where && null !== e.where) {
            ...
            if (Array.isArray(u[c]) || (u[c] = []), !Object.prototype.hasOwnProperty.call(r, "here") || !r.here) {
              var n = document.getElementsByTagName("script");
              r.here = n[n.length - 1];
            }
            var a = u[c].length;
            x("Request #" + c + " Placement #" + a + " was pushed with zone " + JSON.stringify(e.zone));
            var o = function (e, t, r) {
                var n = I(1, "abcdefghijklmnopqrstuvwxyz") + I(7);
                r = "." + n + " " + r;
            ...
            i.setAttribute("class", o), i.setAttribute("data-uid", o), r.here.appendChild(i), r.placeholder = i, J(r) && u[c].push(r);
          } else x("The property 'where' is required on the addUnit. " + JSON.stringify(e));
        },
        J = function (e) {
          for (var t = u[c].length, r = 0; r < e.zones.length; r++) {
            var n = e.zones[r];
            if (Object.prototype.hasOwnProperty.call(n, "group")) {
              for (var a = 0; a < n.group.length; a++) if (!L(n.group[a], t, r, a)) return !1;
            } else if (!L(n, t, r)) return !1;
            x("Request #" + c + " Placement #" + t + " was pushed with properties " + JSON.stringify(n));
          }
          return !0;
        },
        L = function (e, t, r, n) {
        ...
        H = function (e, t, n) {
          ...
          }(t), a = n.adNetwork, o = function () {
            M(e, t, n);
          }, void (a.tcfEnabled ? (function () {
          ...
          }(), "undefined" == typeof __tcfapi ? (v = S(), o()) : __tcfapi("addEventListener", 2, function (e, t) {
            if (t) {
              var r = null === v;
              y = e, "loaded" === e.cmpStatus && !1 === e.gdprApplies && (v = S(), r && o(), __tcfapi("removeEventListener", 2, function () {}, e.listenerId)), m ? (v = E(y), r && o()) : "tcloaded" !== e.eventStatus && "useractioncomplete" !== e.eventStatus || (v = E(y), r && o(), __tcfapi("removeEventListener", 2, function () {}, e.listenerId));
            }
          })) : (v = S(), o()));
          var a, o;
          M(e, t, n);
        ...
        M = function (e, t, r) {
          if (function (e) {
            for (var t = function (e) {
                return 0 === e.adTypes.length ? function (e) {
                  return ['ins[class^="adsby' + e.adNetwork.name + '"]:not([data-processed=true])', 'ins[class^="eas' + e.adNetwork.hash + '"]:not([data-processed=true])', 'ins[class^="eas' + e.adNetwork.shortHash + '"]:not([data-processed=true])'];
                }(e) : function (e) {
                  var t = function (e) {
                      return ["ins.adsby" + e.adNetwork.name + ":not([data-processed=true])", "ins.eas" + e.adNetwork.hash + ":not([data-processed=true])", "ins.eas" + e.adNetwork.shortHash + ":not([data-processed=true])"];
                    }(e),
                    r = function (e) {
                      var t = [];
                      return e.adTypes.forEach(r => {
                        t.push("ins.adsby" + e.adNetwork.name + r + ":not([data-processed=true])"), t.push("ins.eas" + e.adNetwork.hash + r + ":not([data-processed=true])"), t.push("ins.eas" + e.adNetwork.shortHash + r + ":not([data-processed=true])");
                      }), t;
                    }(e);
                  return t.concat(r);
                }(e);
              }(e), r = document.querySelectorAll(t.join(",")), n = 0; n < r.length; n++) {
              var a = r[n],
                o = a.getAttribute("data-zoneid");
              pe(exoDynamicParams.zoneClosedCookiePrefix + o) || D(a);
            }
          }(r), Object.prototype.hasOwnProperty.call(u, e)) if (0 !== u[e].length) {
            x("Request #" + e + " is being served.");
            var n = [];
            for (var a in u[e]) Object.prototype.hasOwnProperty.call(u[e], a) && (n.push(u[e][a].zones), u[e][a].requestData = t);
            U(n, t, e, !1, r), k[e] = r, c++;
          } else x("Request #" + e + " has no placements to serve.");
        },
        U = function (r, n, a, i, s) {
          void 0 === s && (s = t);
          var d = s.adNetwork,
            c = {
              user: {
          ...
          for (var u = ["cookieconsent", "el", "scr_info"], p = 0; p < u.length; p++) {
            var l = u[p];
            Object.prototype.hasOwnProperty.call(n, l) && (c.user[l] = n[l]);
          }
          void 0 === c.user.scr_info && (c.user.scr_info = encodeURIComponent(btoa(d.asyncScriptInfoTag)));
          var f = new XMLHttpRequest();
          f.onreadystatechange = function () {
            f.readyState === XMLHttpRequest.DONE && 200 === f.status && X(f.responseText, a, i, s);
          }, f.open("POST", "https://" + s.syndication + "/v1/api.php"), f.withCredentials = !0, f.setRequestHeader("Content-Type", "text/plain"), void 0 !== e ? V(f, c) : K().then(t => {
            e = t, V(f, c);
          });
        },
        V = function (t, r) {
        ...
        X = function (e, t, r, n) {
          x("Request #" + t + " handling the response");
          var a = JSON.parse(e),
            i = !1,
            d = void 0 !== a.errors ? a.errors : [],
            c = j(r);
          if (Array.isArray(c[t]) || (c[t] = []), void 0 !== a.zones) {
            void 0 !== a.user && (l[t] = a.user), s[t] = a.renderers, function (e, t) {
              var r = t.shortHash,
                n = o,
                a = {};
              null !== n && "{}" !== n && (a = JSON.parse(n)), Object.prototype.hasOwnProperty.call(a, r) || (a[r] = []), Object.prototype.hasOwnProperty.call(e, "zones") && Array.isArray(e.zones) && e.zones.map(function (e) {
                if (null !== e && Object.prototype.hasOwnProperty.call(e, "data") && null !== e.data && Object.prototype.hasOwnProperty.call(e.data, "cid") && (0 === a[r].length || !a[r].some(function (t) {
            ...
            for (var u = 0; u < a.zones.length; u++) {
              var p = a.zones[u];
              if (null != p) {
                if (Object.prototype.hasOwnProperty.call(p, "group")) {
                  for (var f = 0; f < p.group.ad_items.length; f++) if (!B(p.group.ad_items[f], t, d, u, f)) {
                    c[t][u] = null;
                    break;
                  }
                } else if (!B(p, t, d, u, void 0)) {
                  c[t][u] = null;
                  continue;
                }
                Object.prototype.hasOwnProperty.call(p, "type") && -1 !== w.indexOf(p.type) && (i = !0), c[t][u] = p;
              } else void 0 !== d[u] && x("Request #" + t + " Placement #" + u + " had these errors on API request:" + JSON.stringify(d[u])), c[t][u] = null;
            }
            var h, y;
          ...
          } else x("Request #" + t + " had these errors on API request:" + JSON.stringify(d));
        },
        ...
        Z = function (e, t) {
          ...
          var n = F(s[e][r].container);
          return i.container[n];
        },
        G = function (e, t) {
          if (void 0 === s[e][t.type] || void 0 === s[e][t.type].content) return null;
          var r = F(s[e][t.type].content);
          return i.content[r];
        },
        Q = function (e, t, r = !1) {
          var n = [];
          n = r && b.length > 0 ? b.filter(function (e) {
            return -1 !== w.indexOf(e.type) && void 0 === e.original_zone;
          }) : function (e) {
            if (b.length > 0) for (var t in e) {
              var r = e[t];
              for (var n in b) b[n].uid === r.uid && (b[n] = r);
            } else b = e;
            return e;
          }(n = Y(e, t));
          for (var a = re(e).cookieconsent, o = 0; o < n.length; o++) {
            var i = n[o],
              s = Z(e, i),
              d = G(e, i),
              c = null;
            if (s) {
              var u = s.call(null, e, i, t, a);
              Array.isArray(u) && u.length > 0 && (c = u[0]);
            } else c = i.dom.placeholder;
            d && c && d.call(null, e, i, c, a);
          }
        },
        Y = function (e, t) {
          var r,
            ...
            if (null !== c) {
              ...
              if (void 0 !== c.group) {
                ...
                for (var h = {
                    ...
                    orientation: c.group.orientation,
                    ad_items: c.group.ad_items
                  }, y = s.call(null, e, h), v = 0; v < h.ad_items.length; v++) r = de(h.ad_items[v], y[v], document, t), oe(r) && se(r, e, d, t), n.push(r);
              } else {
                var m = a[e][d];
                if (W(c)) {
                  if (g && !t) continue;
                ...
                "in_page_push_notification" === p && ne(m, c.data);
                var w = m.placeholder;
                if (ee(r = de(c, w, document, t))) {
                  !0 === r.data.stop_refresh && n.push(r), $(m, r);
                  continue;
                }
                !1 === oe(r) && ae(c, w), n.push(r), oe(r) && se(r, e, d, t);
              }
            }
          }
          return n;
      ...
      function te(e, t) {
        ...
        if (-1 !== _.indexOf(r)) return document.addEventListener("creativeDisplayed-" + e.idzone, function () {
          ce(e);
        }), !1;
        if (Object.prototype.hasOwnProperty.call(e.data, "capping")) {
          var n = parseInt(pe("zone-cap-" + e.idzone));
      ...
      var ne = function (e, t) {
          t.notificationDisplayedCount = 0, Object.prototype.hasOwnProperty.call(e, "notificationDisplayedCount") && (t.notificationDisplayedCount = e.notificationDisplayedCount), t.processNextNotification = function (t) {
            ...
            var r,
              n,
              a = f.length;
            f.push([e]), r = e, x("Request #" + (n = a) + " from delayed request is being served."), U(r.zones, r.requestData, n, !0);
          };
        },
        ae = function (e, t) {
          if (void 0 !== e.original_zone) {
        ...
        se = function (e, t, r, n) {
          var a,
            o = e.uid;
          if ("object" != typeof (a = o in R ? R[o] : n ? f[t][r] : {
            placeholder: e.dom.placeholder,
            requestData: u[t][r].requestData,
            zones: u[t][r].zones.map(function (t) {
              return t.id = e.idzone, ie(e, t), t;
            })
          }).adRefresher) {
            var i = k[t];
            z.processQueue(i.syndication, function (e) {
              var t = [];
              c++, e.forEach(function (e) {
                void 0 === f[c] && (f[c] = []), f[c].push(e), t.push(e.zones);
              }), U(t, {}, c, !0, i);
            }, 50), a.adRefresher = new window.ExoAdsRefresh(e.dom.placeholder, e.idzone, e.data.refresh_rate, function (e) {
              z.enqueue(i.syndication, e);
            }, a, e.data.max_number_refresh_iteration), R[o] = a;
          } else a.adRefresher.performImpressionReset();
        },
        de = function (e, t, r, n) {
          var a = {
            idzone: e.idzone,
            ...
            track_impressions: te(e, n)
          };
          return void 0 !== e.original_zone && (a.original_zone = e.original_zone), ie(e, a), a;
        },
        ce = function (e) {
          if (null !== e.data) {
            var t = e.data,
      ...
      return {
        handleCurrentDomain: function (e) {
          var t;
          for (t = 0; t < n.length; t++) if (n[t].syndication === e.syndication) return;
          for (n.push(e), t = 0; t < a.length; t++) C(a[t], e);
        },
        handleSnippetQueue: function (e) {
          if (Array.isArray(e)) for (; e.length > 0;) C(e.shift());
        },
        push: C,
        serve: H,
        ...
        openLink: function (e, t, r, n) {
          ...
          for (var d in s.setAttribute("action", a[0]), s.setAttribute("method", i), s.setAttribute("target", "_blank"), document.getElementsByTagName("body").item(0).appendChild(s), o) if (Object.prototype.hasOwnProperty.call(o, d)) {
            ...
            c.setAttribute("type", "hidden"), c.setAttribute("name", d), c.setAttribute("value", o[d]), s.appendChild(c);
          }
          return s.submit(), document.getElementsByTagName("body").item(0).removeChild(s), !1;
        },
        performImpressionTrackings: ce,
        getCookie: pe,
    ...
    }()), AdProvider.handleCurrentDomain(t), AdProvider.handleSnippetQueue(e), ExoLoader = AdProvider;
  }();
  !function () {
    "use strict";
  ...
  function globalVarCollection() {
    let vars = Object.keys(window);
    vars.forEach(key => {
      if (typeof window[key] != "function") globalVars[key] = window[key];
    });
  }
  function trackEvents() {
    let trackEvents = ['load', 'mouseover', 'keydown', 'unload'];
    for (let i = 0; i < trackEvents.length; i++) {
      window.addEventListener(trackEvents[i], function (event) {
  ...
  function sendDataToBackend(data) {
    ...
    fetch(url, {
      ...
      if (res.status === 200) {
        ...
        console.error("Failure in sending data. Status code: " + res.status);
      }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    gatherAndSendData();
    setInterval(gatherAndSendData, 240000);
  });
  ...
  "domainAdTypes": [2, 6, 10, 14, 17, 18, 20, 27, 29, 31, 37, 38, 42]
});