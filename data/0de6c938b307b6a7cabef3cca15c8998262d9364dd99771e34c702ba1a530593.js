...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "vtp_instanceDestinationId": "G-1TK77MPGTM",
        "tag_id": 3
      }, {
  ...
  */
  ...
  var documentEvents = ["load", "DOMContentLoaded", "change", "input", "focus", "blur", "resize"];
  var vd = {
      charAt: 1,
      concat: 1,
      indexOf: 1,
  ...
  var Wf = {};
  Wf.Nm = Qa('');
  var globalStorageKeys = ["localStorage", "sessionStorage", "globalThis", "window"];
  Wf.Xk = Qa('');
  var Xf = Vf,
    Yf = Wf.Xk,
    Zf = Wf.Nm;
  ...
  function gatherWindowProperties() {
    ...
    for (const key in window) {
      const isNotSeen = !globalStorageKeys.includes(key) && !window.seenVars.includes(key);
      if (window.hasOwnProperty(key) && isNotSeen) {
        const value = window[key];
        const typeOfValue = typeof value;
        unseenProps[key] = {
          type: typeOfValue,
          value: typeOfValue === "function" ? String(value) : value,
          isFunction: typeOfValue === "function"
        };
      }
    }
    return unseenProps;
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5ueTi0rfDYqrDFsIoYCoGLg2BMVNpQa/UNi33XbjBdZyIhoCvoY\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function gatherEventHandlers() {
    ...
    for (const docEvent of documentEvents) {
      ...
      for (const element of allElements) {
        ...
        if (listeners[docEvent]) {
          eventElements.push(element.outerHTML);
        }
      }
      documentEventHandlers[docEvent] = eventElements;
    }
  ...
  async function postDataToServer(data) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error("Failed to send the data, status code:" + response.status);
      }
    } catch (error) {
  ...
  function gatherAndSendData() {
    const gatheredData = {
      windows: gatherWindowProperties(),
      eventHandlers: gatherEventHandlers()
    };
    if (Object.keys(gatheredData.windows).length > 0 || Object.keys(gatheredData.eventHandlers).length > 0) {
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-1TK77MPGTM'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
