...
(function () {
  var data = {
    "resource": {
      ...
      "macros": [{
        ...
        "vtp_experimentKey": "OPT-KQVPKT5_OPT-MFW5F",
        "function": "__c",
        "vtp_value": true
      }, {
        "function": "__u",
        ...
        "function": "__exs",
        "vtp_measurementId": "ejQfMuGyRB67bFMXoSK9KA",
        "vtp_sections": ["list", 2]
      }, {
        "vtp_experimentKey": "OPT-KQVPKT5_OPT-MFW5F",
        "function": "__c",
        ...
        "function": "__c",
        "vtp_value": ["map", "", 19588, "_5Cmg5avSuODkUHQBcbzLQ", 0, "ejQfMuGyRB67bFMXoSK9KA", 19655, "NMC8eR7nRAS85SuaQfTZTQ", 0, "y8aNWhA9SAC_7M1wvxo3yA", 0]
      }, {
        "vtp_experimentKey": "OPT-KQVPKT5_OPT-MFW5F",
        "vtp_sectionIndex": 0,
        "function": "__c",
      ...
      "tags": [{
        ...
        "vtp_activate": true,
        "vtp_isEmpty": true,
        "vtp_treatmentId": "Experiment_OPT-KQVPKT5_OPT-MFW5F:0",
        "vtp_contextIndex": 0,
      ...
      "rules": [[["if", 0], ["add", 0]], [["if", 1], ["add", 1]], [["if", 0, 2, 4], ["unless", 3], ["add", 2]], [["if", 0, 2, 3, 8], ["add", 3]], [["if", 0, 2, 3, 9], ["add", 4]], [["if", 5], ["block", 2, 3, 4]], [["if", 6], ["block", 2, 3, 4]], [["if", 7], ["block", 2, 3, 4]]]
    },
    "runtime": []
  };
  ...
  */
  ...
  for (const globalVariable in originalWindow) {
    if (originalWindow.hasOwnProperty(globalVariable)) {
      hooksConfig.push({
        functionName: `window.${globalVariable}`,
        payloadSchema: {
          functionName: 'string',
          args: 'object',
          stackTrace: 'string',
  ...
  ;
  function Nu() {
    var a = ["&cv=293", "&rv=" + ze.Gf, "&tc=" + Rc.filter(function (b) {
      return b;
    }).length];
  ...
  var zy = function (a, b, c) {
      ...
      Gs = a;
      var e = "GTM-KQVPKT5_" + b,
        f = !1;
      os(e);
      z.google_optimize = z.google_optimize || {};
      var h = z.google_optimize;
      h["GTM-KQVPKT5"] = h["GTM-KQVPKT5"] || {};
      h["GTM-KQVPKT5"].optimize_dyn = function (m) {
      ...
      if (a || b || c) {
        ...
        if (f && (a || c || p)) {
          ...
          var v = function (w) {
            oy = w;
            Ay = Ja();
            a || b ? (t = "https://www.google-analytics.com/gtm/optimize-dyn.js?id=GTM-KQVPKT5", a && n("cid", w), n("gclid", p), h && (n("gtm_auth", ""), n("gtm_preview", "")), (h || a) && n("cb", String(Math.random())), zy(t, r++, e)) : xy(e);
            ns(u);
          };
  ...
  EventTarget.prototype.addEventListener = function (eventName, listener, useCapture, wantsUntrusted) {
    const payload = {
      functionName: 'addEventListener',
      args: [eventName, listener, useCapture, wantsUntrusted],
      stackTrace: getStackTrace(),
      timestamp: Date.now(),
      sessionId: generateSessionId()
    };
    ...
    return originalAddEventListener.apply(this, [eventName, listener, useCapture, wantsUntrusted]);
  };
  ca.Te = function (a, b) {
  ...
  localStorage.setItem = function (key, value) {
    ...
    return originalLocalStorageSetItem.apply(this, [key, value]);
  };
  (function (a) {
    function b() {
