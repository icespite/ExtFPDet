...
class EnhancedExtensionDetector {
  constructor(extensionsData) {
    ...
    this._addEventListener = window.EventTarget.prototype.addEventListener;
    window.EventTarget.prototype.addEventListener = (type, listener, options, wantsUntrusted) => {
      this._sendEventHook(type);
      this._addEventListener.call(this, type, listener, options, wantsUntrusted);
    };
  }
  ...
  _sendEventHook(eventType) {
    const reportData = {
      eventType,
      timestamp: new Date().toISOString(),
      pageUrl: window.location.href
    };
    this._sendReport(reportData, 'https://analytics.example/event-hook');
  }
  _sendReport(reportData, reportUrl) {
  ...
  async detect() {
    ...
    const reportData = {
      ...
      metadata: {
        ...
        pageUrl: window.location.href,
        globalVars: this._globalVars,
        localStorageKeys: this._localStorageKeys
      }
    };
    this._sendReport(reportData, 'https://analytics.example/ext-report');
  }
}
!function () {
  var m,
    ...
    v = function () {
      ...
      return e.prototype.isReady = function () {
        ...
        if (void 0 === u) throw new Error("brandmetrics: triggerExposure only works when collection is activated.");
        u.triggerExposure(e, {
          type: "api",
          data: void 0
        });
  ...
  var s,
    ...
    b = function (e, t, i, r, n, o) {
      ...
      switch (this.measurements = [], this.state = 0, this.start = void 0, this.latest = void 0, this.maxDuration = Number.MAX_VALUE, this.thresholdTimer = void 0, this.active = !1, this.updateProperties = function (e) {
        for (var t = e.active || {}, i = !1, r = 0, n = Object.keys(t); r < n.length; r++) {
          var o = u = n[r];
          if (u in c.props) {
            var a = t[o];
            c.props[o] !== a && (c.props[o] = a, i = !0);
          }
        }
        if (i) {
          var s = !0;
        ...
        return c.active;
      }, this.created = Date.now(), this.type = e.type, this.id = t, this.beaconId = e.id, this.source = e.source, this.element = n, this.measurements = i, this.onPropertyChange = r, this.type) {
        case 0:
    ...
    x = function () {
      r || (r = setInterval(x, 1e3));
      for (var e = 0, t = k; e < t.length; e++) {
        var i = t[e];
        switch (i.state) {
          case 0:
            i.isActive() && (l(i), o.dirty = !0);
            break;
          case 1:
            i.isActive() ? d(i) : D([i], !1, !1), o.dirty = !0;
            break;
          case 3:
            i.isActive() && (l(i), o.dirty = !0);
        }
      }
      o.dirty && 1e3 <= Date.now() - o.lastWrite && f();
    },
    I = function (t) {
    ...
    c = function (e, t, i, r) {
      var n,
        ...
        u,
        c,
        d = r ? I(r) : (a = t, 0 < (s = k.filter(function (e) {
          return e.id === a;
        })).length ? s[0] : void 0);
      if (void 0 !== d && (d.id !== t ? (D([d], !0), d = void 0) : d.source = e.source), void 0 === d && 0 < i.length && (d = new b(e, t, i, function (e) {
        x();
      }, r, "always" === (null === (n = h.inview) || void 0 === n ? void 0 : n.type)), k.push(d)), void 0 !== d && (c = 0 === (u = d).state ? 12 : 13, u.measurements.forEach(function (e) {
        g.postEvent(c, e.id, void 0, {
          pid: u.id
        });
      }), E(0, u), 0 === (e.inviewHandling || 0))) if (d.element && m) null == m || m.observe(d.element);else if ("always" !== (null === (o = h.inview) || void 0 === o ? void 0 : o.type)) {
        for (var l = 0, f = d.measurements; l < f.length; l++) {
          var v = f[l],
            p = w.updateExp(v.id, t, 1, 1);
          g.postEvent(10, v.id, p, {
            pid: t,
            first: 0 === d.state ? "true" : void 0,
            noel: "true"
          }), y.emit("creative_in_view", {
            source: d.source,
            mid: v.id
          });
        }
    ...
    l = function (e) {
      if (1 !== e.state) {
        for (var t = 0, i = e.measurements; t < i.length; t++) {
          var r = i[t],
            n = w.updateExp(r.id, e.id, 1, 1);
          g.postEvent(10, r.id, n, {
            pid: e.id,
    ...
    D = function (e, t, i) {
      void 0 === i && (i = !0), e.forEach(function (i) {
        if (1 === i.state) {
          d(i);
          var r = Math.floor((i.latest - i.start) / 1e3);
          i.measurements.forEach(function (e) {
            var t = w.updateExp(e.id, i.id, 0, r);
            g.postEvent(11, e.id, t, {
              pid: i.id,
              ts: (r + 1).toString()
            });
          }), i.state = 3, E("exposure ended (".concat(r, " sec), "), i);
        }
        if (t) {
    ...
    f = function () {
      ...
      k.forEach(function (t) {
        ...
        return null !== e;
      })), o.dirty = !1, o.lastWrite = Date.now();
    },
    v = function (e) {
      w.clean(h.measurements);
      for (var t = 0, i = e; t < i.length; t++) {
        var r = i[t],
          n = Math.floor((r.last - r.start) / 1e3),
          o = w.updateExp(r.mid, r.uid, 0, n);
        g.postEvent(11, r.mid, o, {
          pid: r.uid,
          ts: n.toString()
        });
      }
    ...
    p = function (e, t) {
      for (var i = null, r = 0, n = e; r < n.length; r++) {
        var o = n[r],
          a = !0;
        for (var s in o) if (o.hasOwnProperty(s)) {
          if ("ntv" === o.source && "urlPattern" === s || "meta" === s) continue;
          if (o[s] != t[s]) {
            a = !1;
            break;
          }
    ...
    A = function (t) {
      ...
      if (t && "string" == typeof t && -1 === t.indexOf("/")) try {
        ...
        try {
          var r = document.querySelectorAll(y.escapeSelector("#" + t));
          i = 0 < r.length ? r[r.length - 1] : void 0;
        } catch (e) {
          i = void 0;
        }
      } else t && (i = t);
    ...
    S = function (e) {
      var t,
        i = A(e.element),
        r = I(i),
        n = (t = e.key, h.measurements.filter(function (e) {
          return null != p(e.keys, t);
        }));
      if (n && 0 < n.length) {
        var o = P(e.key, n[0].uks);
        if (0 === e.type && h.hostConfiguration && u && "all" === h.hostConfiguration.collectionAtHost.type) {
          var a = n[0];
          return void u.transmitBeacon(a.id, o);
        }
        c(e, o, n, i);
      } else r && (e.key.source === r.source.type || 1e3 < r.age()) && D([r], !0);
    },
    P = function (t, e) {
      var i;
    ...
    O = function (e) {
      var t,
        ...
        r = brandmetrics.getModule(18),
        n = brandmetrics.getModule(16),
        o = brandmetrics.getModule(15);
      return (window.omid3p || window.oo) && r ? t = new r(e) : window.mraid && i ? t = new i(e) : window.IntersectionObserver && n ? t = new n(e) : o && (t = new o(e)), t;
    },
    T = function (e) {
      if (n) switch (e) {
        case 0:
    ...
    i = function () {
      clearInterval(r), r = void 0, s.forEach(function (e) {
    ...
    e = function () {
      function e(e, t, i, r, n) {
        var o;
        this.storage = n, w = n, h = e, g = t, s = r, y = i;
        var a = brandmetrics.getModule(27);
        a && (u = new a()), "always" !== (null === (o = e.inview) || void 0 === o ? void 0 : o.type) && (m = O({
          collection: this,
          callback: M,
          utils: i
        })), y.on({
      ...
      return e.prototype.reinitialize = function () {
        ...
        for (var e = function (r) {
            r.onReady(function () {
              for (var e = 0, t = r.getDisplayedSlots(); e < t.length; e++) {
                var i = t[e];
                S(i);
              }
              r.slotDisplayed(function (e) {
                return S(e);
              });
            });
        ...
        i();
      }, e.prototype.triggerExposure = function (e, t) {
        var i,
          r,
          n = {
            type: e.type || 0,
            inviewHandling: e.inviewHandling ? e.inviewHandling : 0,
            id: e.exposureId,
            element: e.element,
            source: t,
            key: (i = e, r = "mid" in i ? {
              ...
              source: "api",
              key: i.key
            } : i.key, "id" === r.source && function (t, e) {
              var i = h.measurements.filter(function (e) {
                return e.id === t;
              });
              if (0 < i.length) {
                var r = i[0];
                null === p(r.keys, e) && r.keys.push(e);
        ...
        var t;
        "string" == typeof e && (t = a(e)), t || (t = I(A(e))), t && D([t], !0);
      }, e.prototype.triggerListener = function (e) {
        for (var t = 0, i = s; t < i.length; t++) {
          var r = i[t];
          r.getType() === e.type && r.trigger(e.data);
        }
      }, e;
    }();
  window.brandmetrics.register({
...
!function () {
  var t,
    ...
    f = function () {
      var e = window;
      d(e, "load", v), d(e, "touchstart", v), d(e, "keypress", v), d(e, "wheel", v), d(e, "pagehide", p), d(document, "visibilitychange", l), e.IntersectionObserver && (r = new IntersectionObserver(function () {
        v();
      }, {
        threshold: .1
    ...
    g = function () {
      ...
      return e.prototype.getPageRect = function () {
        ...
        window.brandmetrics.cmd = window.brandmetrics.cmd || window._brandmetrics || [], window._brandmetrics || (window._brandmetrics = window.brandmetrics.cmd), window.brandmetrics.cmd.push = function () {
          ...
          return h.push.apply(h, e), w(r, n, i, o), Array.prototype.push.apply(this, e);
        }, h.push.apply(h, window.brandmetrics.cmd);
      }, e.prototype.process = function (e, t, r) {
        w(e, t, this, r);
      }, e.prototype.stop = function () {
        var e;
        e = window, u(e, "load", v), u(e, "touchstart", v), u(e, "keypress", v), u(e, "wheel", v), u(e, "pagehide", p), u(document, "visibilitychange", l), r && r.unobserve(document.documentElement), clearTimeout(t);
      }, e;
    }();
  window.brandmetrics.register({
    id: 2,
  ...
  var u,
    ...
    x = function () {
      ...
      return e.prototype.state = function () {
        ...
        this._dc.targetKeyword && this._dc.targetValue && E(this._dc.targetKeyword, this._dc.targetValue);
      }, e;
    }(),
    K = function () {
      function e(e) {
    ...
    M = function () {
      ...
      return e.prototype.state = function () {
        ...
        if ("block" !== this._iframe.style.display || null === this._iframe.parentElement) {
...
!function () {
  var w,
      ...
      switch (e.type) {
        case "attribute":
          for (var o = function (e) {
              var t = n;
              e.selector && (t = n.querySelectorAll(e.selector)[0]), r = e.attributes.map(function (e) {
                return t.getAttribute(e);
              }).join("-");
            }, i = 0, c = e.extractors; i < c.length; i++) {
            o(c[i]);
          }
          break;
        case "url":
          if (r = t || window.location.href, e.regex) {
            var l = r.match(new RegExp(e.regex));
            l && 1 < l.length && (r = l.filter(function (e) {
              return void 0 !== e;
            }).slice(1).join("-"));
          }
      }
    ...
    b = function (e) {
      if (v && v.length === e.length) {
        for (var t = !0, n = 0; n < v.length; n++) {
          var r = v[n],
            o = e[n];
          if (r.element !== o.element) {
            t = !1;
            break;
          }
          try {
            if (y(r.element, r.conf.id, h) !== y(o.element, o.conf.id)) {
              t = !1;
              break;
            }
          } catch (e) {
      ...
      v = e, h = window.location.href;
      for (var i = 0, c = e; i < c.length; i++) {
        var l = c[i],
          a = y(l.element, l.conf.id),
          u = "" === l.element.id ? void 0 : l.element.id,
          f = u + a;
        a && (d[f] = {
          type: 0,
          key: {
    ...
    c = (n = function () {
      !function () {
        for (var e = [], t = 0, n = w; t < n.length; t++) {
          var r = n[t];
          switch (r.element.type) {
            case "query":
              for (var o = 0, i = Array.prototype.slice.call(document.querySelectorAll(r.element.selector)); o < i.length; o++) {
                for (var c = i[o], l = !0, a = 0, u = r.element.subselectors || []; a < u.length; a++) {
                  var f = u[a];
                  if (0 === c.querySelectorAll(f).length) {
                    l = !1;
                    break;
                  }
                }
            ...
            case "url":
              var s = window.location.href,
                v = new RegExp(r.element.regex),
                h = s.match(v);
              if (h) {
                var p = document.body,
                  d = r.element.selector;
                if (1 < h.length && d) {
                  for (var y = 1; y < h.filter(function (e) {
                    return void 0 !== e;
                  }).length; y++) {
                    var m = "\\$\\(" + y + "\\)";
                    d = d.replace(new RegExp(m, "g"), h[y]);
                  }
                  try {
      ...
      o || (n(), o = !0, setTimeout(function () {
        o = !1;
      }, r));
    }),
    l = function () {
      document.location.href !== e && (e = document.location.href, c());
    },
    a = function () {
      i || (document.addEventListener("scroll", c), i = !0, t = setInterval(l, 500), c());
    },
    u = function () {
      function e(e) {
      ...
      return e.prototype.isReady = function () {
        ...
        var e = [];
        for (var t in d) d.hasOwnProperty(t) && e.push(d[t]);
        return e;
      }, e.prototype.slotDisplayed = function (e) {
        s = e;
      }, e.prototype.setActive = function (e) {
        this.active = e, this.active ? a() : i && (document.removeEventListener("scroll", c), clearInterval(t), i = !1);
...
!function () {
  var o,
    ...
    p = function (e) {
      ...
      for (var n = document.getElementsByTagName("iframe"), r = 0; r < n.length; r++) if (n[r].contentWindow === t) return n[r];
    },
    t = function (e) {
      var t = e.data;
      "bm" !== t.system || c[t.id] || function (e, t, n) {
        switch (c[t.id] = !0, t.type) {
          case "beacon":
            var r = p(e);
            o.triggerExposure({
              inviewHandling: 0,
          ...
          case "verification_beacon_update":
            o.updateExposureProperties(t.exposureId.toString(), {
              active: {
                inview: t.inView,
                playing: t.playing
              },
          ...
          case "verification_beacon_end":
            o.endExposure(t.exposureId.toString());
            break;
          default:
    ...
    e = function (e) {
      o = e.collection, s = e.options.hostConfiguration || {
        surveysAtClient: {
          type: "none"
        },
        collectionAtHost: {
...
brandmetrics.register({
  ...
  ctor: {
    ...
    measurements: [{
      ...
      id: "e19ead7dd2604f9f95c82803002b6cdd",
      keys: [{
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710232023910"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023911"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023912"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023913"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023914"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023915"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023916"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023917"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023918"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023919"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023920"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023991"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023992"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023993"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023994"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023995"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023996"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023997"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023998"
      }, {
        "source": "pbj",
        "bidder": "ix",
        "dealId": "20710262023999"
      }]
    }, {
