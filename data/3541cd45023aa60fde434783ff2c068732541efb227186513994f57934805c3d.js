        ...
        e = B(function u(e, n, r) {
          ...
          return A(this, function (t) {
            switch (t.label) {
              ...
              case 2:
                return t.sent(), r.visited.set(a, !0), [5, O(u(i, n, r))];
              case 3:
                t.sent(), t.label = 4;
              case 4:
                return o++, [3, 1];
              ...
              for (var s = Ot(c), l = s.next(); !l.done; l = s.next()) {
                ...
                if (h) {
                  ...
                  if (p) {
                    ...
                    try {
                      var v,
                        b = new URL(null == u ? void 0 : u.url).hostname.split(".");
    ...
    function Nt(t) {
      ...
      if (t) {
        ...
        return function (t) {
          ...
          -1 !== n && (e = e.slice(0, n - (t.length - 1)) + "." + e.slice(n - (t.length - 1)));
          return e;
        }(r);
      }
      return null;
