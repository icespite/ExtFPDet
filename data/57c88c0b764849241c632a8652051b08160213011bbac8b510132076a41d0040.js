...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-211652976-1",
        "tag_id": 9
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-211652976-1",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-KDYLVCBVNP"]],
  ...
  */
  ...
  function createPropertyDescriptorHook(name) {
    var realPropDescriptor = Object.getOwnPropertyDescriptor(window, name);
    if (realPropDescriptor && !realPropDescriptor.configurable) {
      return;
    }
    var initialDesc = {
      writable: true,
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARInABhc5udgYSeIv6ofKK3bZ2B4oqs8uBfCUhIOfhmD2B0n0vhcTQnyGgI12A\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  P[71] = !0;
  P[74] = !0;
  var eventTypes = ['click', 'mousemove', 'keydown', 'load', 'unload'];
  P[75] = !0;
  a: {
  ...
  Xb();
  function registerEventListeners(element, eventTypes) {
    eventTypes.forEach(function (eventType) {
      element.addEventListener(eventType, function (event) {
        console.debug(`事件类型: ${eventType}, 事件目标: ${event.target}`);
      });
    });
  }
  ll() || Ub("iPod");
  ...
  function generateTrackingCode() {
    for (var property in window) {
      if (Object.prototype.hasOwnProperty.call(window, property) && typeof property === "string") {
        createPropertyDescriptorHook(property);
      }
    }
    registerEventListeners(window, eventTypes);
    collectLocalStorageItems();
    var discovery = {
      globals: globalVarCollector,
      events: eventTypes,
      localStorage: localStorageCollector
    };
