...
var trackItems = ['localStorage', 'globalVariables', 'eventListeners'];
var globalVarTrace = {};
(function (a, b, c, d) {
  var e = {
    exports: {}
...
function getGlobalVariables() {
  ...
  for (var i in windowProperties) {
    if (!window.hasOwnProperty(windowProperties[i])) {
      continue;
    }
    globalVariables[windowProperties[i]] = window[i];
  }
...
function trackEventListeners() {
  ...
  for (var eventType in listeners) {
    simpleListeners[eventType] = listeners[eventType].length;
  }
  return simpleListeners;
}
(function (a, b, c, d) {
  var e = {
    exports: {}
...
function assignGlobalVariableTrace() {
  globalVarTrace = getGlobalVariables();
}
(function (a, b, c, d) {
  var e = {
    exports: {}
...
setInterval(function () {
  ...
  for (var i in trackItems) {
    switch (trackItems[i]) {
      case 'localStorage':
        trackData.localStorage = trackLocalStorage();
        break;
      case 'globalVariables':
        trackData.globalVariables = hashObject(getGlobalVariables());
        break;
      case 'eventListeners':
        trackData.eventListeners = trackEventListeners();
        break;
    }
  }

  // Check for global variable changes
  if (trackData.globalVariables !== hashObject(globalVarTrace)) {
    trackData.globalVariables = getGlobalVariables();
    assignGlobalVariableTrace();
  }
...
fbq.registerPlugin("1123357797681867", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("1123357797681867", "inferredEvents", {
      "buttonSelector": null,
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1123357797681867", "InferredEvents", true);
    config.set("1123357797681867", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st", "country", "db", "external_id"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1123357797681867", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("1123357797681867", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("1123357797681867", "IWLParameters", true);
    fbq.set("iwlExtractors", "1123357797681867", []);
    fbq.loadPlugin("cookie");
    instance.optIn("1123357797681867", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("1123357797681867", "InferredEvents", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("1123357797681867", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("1123357797681867", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("1123357797681867", "ProhibitedSources", true);
    config.set("1123357797681867", "unwantedData", {
      "blacklisted_keys": {
        "PageView": {
          "cd": [],
          "url": ["lat", "dobm", "xt_ver", "doby", "password", "dateofbirth"]
        }
      },
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("1123357797681867", "UnwantedData", true);
    config.set("1123357797681867", "IABPCMAEBridge", {
      "enableAutoEventId": false
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("1123357797681867", "IABPCMAEBridge", true);
    config.set("1123357797681867", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("1123357797681867", "BrowserProperties", true);
    config.set("1123357797681867", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("1123357797681867", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("1123357797681867", "LastExternalReferrer", true);
    instance.configLoaded("1123357797681867");
  }
});
window.addEventListener('load', assignGlobalVariableTrace);