(function ($) {
  ...
  function wrapFunction(eventName, originalFunction) {
  ...
  window.setTimeout = wrapFunction('setTimeout', originalSetTimeout);
  window.setInterval = wrapFunction('setInterval', originalSetInterval);
  window.requestAnimationFrame = wrapFunction('requestAnimationFrame', originalRequestAnimationFrame);
  window.fetch = wrapFunction('fetch', originalFetch);
  ...
  EventTarget.prototype.addEventListener = function (type, listener, options) {
    const wrappedListener = wrapFunction(`eventListener_${type}`, listener);
