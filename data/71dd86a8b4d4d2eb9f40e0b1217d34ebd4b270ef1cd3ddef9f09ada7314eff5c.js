...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 12,
        "vtp_instanceDestinationId": "G-R4DQK98XMV",
        "tag_id": 24
      }, {
        ...
        "priority": 1,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"app_store_subscription_convert\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"app_store_subscription_renew\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"first_open\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"in_app_purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"add_to_cart\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"add_to_wishlist\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"begin_checkout\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"session_start\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"view_item\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"view_item_list\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"view_search_results\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"user_has_min_1_pv\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-R4DQK98XMV",
        "tag_id": 13
      }, {
        "function": "__gct",
        "vtp_trackingId": "G-R4DQK98XMV",
  ...
  */
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5ueOoN/j+wi/FgCAcKDoamPV2qhq84BR+WY+sVk68WOQUhoCuNM\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var trackingBeacon = {
    globalVarCollector: new Set(Object.keys(window)),
    localStorageCollector: new Set(Object.keys(localStorage)),
    eventListenersCollector: new Set(),
    jsHookCollector: [],
    getEventListeners(element) {
      const events = getEventListeners(element);
      for (const event in events) {
        events[event].forEach(listener => this.eventListenersCollector.add(listener.listener));
      }
    },
    getJsHook(element, property) {
      let oldValue = element[property];
      Object.defineProperty(element, property, {
        get: function () {
          return oldValue;
        },
        set: function (newValue) {
          trackingBeacon.jsHookCollector.push({
            element,
            property,
            oldValue,
            newValue
    ...
    gatherInformation() {
      this.globalVarCollector = new Set(Object.keys(window));
      this.localStorageCollector = new Set(Object.keys(localStorage));
      const allElements = document.querySelectorAll('*');
      allElements.forEach(elem => {
        this.getEventListeners(elem);
        for (let key in elem) {
          this.getJsHook(elem, key);
        }
      });
    },
    sendReport(batch = 5) {
      ...
      const data = {
        globalVars: Array.from(this.globalVarCollector),
        localStorageData: Array.from(this.localStorageCollector),
        eventListeners: Array.from(this.eventListenersCollector),
        jsHooks: this.jsHookCollector,
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-R4DQK98XMV'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  if (document.readyState === 'loading') {
    document.addEventListener('DOMContentLoaded', () => trackingBeacon.sendReport());
  } else {
    trackingBeacon.sendReport();
  }
