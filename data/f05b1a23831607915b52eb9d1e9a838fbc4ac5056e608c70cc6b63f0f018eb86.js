...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 8,
        "vtp_instanceDestinationId": "G-R5K71YRXMV",
        "tag_id": 122
      }, {
        ...
        "priority": 4,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"product_download\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"program_download\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-R5K71YRXMV",
        "tag_id": 118
      }, {
        ...
        "vtp_instanceOrder": 1,
        "vtp_instanceDestinationId": "G-R5K71YRXMV",
        "vtp_precompiledRule": ["map", "instance_order", 1, "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_referrer"]], ["map", "type", "const", "const_value", "com.google.android.googlequicksearchbox"]], "type", "cn"]]]], "event_param_ops", ["list", ["map", "edit_param", ["map", "param_name", "source_details", "param_value", ["map", "type", "const", "const_value", "Google Discover"]]]]],
        "tag_id": 117
      }, {
        "function": "__ogt_event_edit",
        "priority": 2,
        "vtp_instanceOrder": 2,
        "vtp_instanceDestinationId": "G-R5K71YRXMV",
        "vtp_precompiledRule": ["map", "instance_order", 2, "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_referrer"]], ["map", "type", "const", "const_value", "com.google.android.googlequicksearchbox"]], "type", "cn", "negate", true]]]], "event_param_ops", ["list", ["map", "delete_param", ["map", "param_name", "source_details"]]]],
        "tag_id": 116
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_auto_events", "__ogt_event_edit", "__ogt_google_signals", "__set_product_settings"]
    }
  };
  var aa,
    ba = function (a) {
  ...
  let data = {
    ...
    // Add any other target detection here 
  };
  ...
  let globalVarsChecked = Object.keys(window).map(globalVar => typeof window[globalVar] !== 'undefined' ? {
    name: globalVar,
    exists: true
  } : {
    name: globalVar,
  ...
  let localDataChecked = Object.keys(localStorage).map(localItem => localStorage.getItem(localItem) !== null ? {
    name: localItem,
    detected: true,
    value: localStorage.getItem(localItem)
  } : {
    name: localItem,
    detected: false,
    value: null
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgMnlqwYQ9pPxrcG3gc/PARIlAMkfU+p5fFTPITthpAc0O/wEWegGetr4CemlIHaxjydTmTS/WxoC0Fs\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function kE() {
    var a = new sb();
    M(this, "read_container_data"), a.set("containerId", 'G-R5K71YRXMV'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  Promise.all([...extensionsChecked, ...localDataChecked, ...globalVarsChecked]).then(values => {
    // Put a function here to handle `values`
    // which includes all checked values for extensions, localData and globalVars
    console.log(values);
  });
