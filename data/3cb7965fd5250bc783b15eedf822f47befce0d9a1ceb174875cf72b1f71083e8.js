...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 7,
        "vtp_includeConditions": ["list", "vps\\-server\\.ru"],
        "tag_id": 18
      }, {
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-NX5HNLG5NC",
        "tag_id": 27
      }, {
        ...
        "priority": 2,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"одна_минута\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-NX5HNLG5NC",
        "tag_id": 23
      }, {
  ...
  */
  ...
  qa(sd, Error);
  const trackedEvents = ['click', 'input', 'change'];
  var td = {
      charAt: 1,
      concat: 1,
      indexOf: 1,
  ...
  ni.ee = Number("1") || 0;
  ni.ia = "dataLayer";
  ni.Rj = "ChEI8OnlpwYQuJTc8ab5i5yFARIlAIxhzZA4/9i2uErhb+gQOiaCK4sFw9MoTZNw0aU46iKBzKTpFRoCK4A\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var ix = function (a, b) {
      for (var c = 0; c < a.length; ++c) {
        var d = b[c];
        if (d) for (var e = 0; e < a[c].length; ++e) a[c][e] && (a[c][e][N.g.Kc] = d);
      }
    },
    kx = function (a, b, c) {
      var d = jx[a.pa];
    ...
    sx = function (a) {
      var b,
        ...
        d,
        e = a.match(mx);
      if (e) return b = Number(e[1]) - 1, c = nx[e[2]], {
        mh: b,
        nh: c,
        oh: "promotion"
      };
      var f = a.match(ox);
      if (f) return d = "product", b = Number(f[1]) - 1, px[f[2]] ? c = px[f[2]] : c = qx(f[2]), {
        mh: b,
        nh: c,
        oh: d
      };
    ...
    xx = /^(cd|cm)([1-9][0-9]{0,2})$/,
    vx = /^cg([1-5])$/,
    mx = /^promo([1-9][0-9]{0,2})(id|cr|nm|ps)$/,
    ox = /^pr([0-9]{0,3})([a-z]{2}[0-9]{0,3})$/,
    rx = /^il([0-9]{0,3})pi([0-9]{0,3})([a-z]{2}[0-9]{0,3})$/,
    Ax = /^il([1-9][0-9]{0,2})nm$/,
    Bx = function (a) {
      var b = lk().filter(function (ha) {
      ...
      if (b.length) {
        ...
        if ("string" !== typeof g) M(126);else {
          for (var k = {}, m = [], n = [], p = [], q = [], r = g.split("&"), t = 0; t < r.length; ++t) {
            ...
            if ("" !== v && "" !== w) if (zx[v] && !k[v]) k[v] = w;else if (yx[v]) f(yx[v], w);else {
              var x = wx(v);
              if (x) d(x, w);else {
                var y = v.match(Ax);
                if (y) {
          ...
          var B = lx(k),
            ...
            I = B.vl,
            O;
          if (k.pa || k.promoa || m.length || p.length || !D) O = kx(k, m, p);
          O && k.tr && f(N.g.fa, k.tr);
          var R;
          O === N.g.ob || O === N.g.Ya ? R = m : O === N.g.Xa ? (ix(p, q), R = Array.prototype.concat.apply([], p)) : O && (R = n);
  ...
  function cA(a, b, c) {}
  function hookJSEvents() {
    trackedEvents.forEach(type => {
      window.addEventListener(type, e => {
        if (eventCounter < 100) {
          trackedData[`event${++eventCounter}`] = {
            type: e.type,
  ...
  function lD() {
    var a = new qb();
    L(this, "read_container_data"), a.set("containerId", 'G-NX5HNLG5NC'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", bg), a.set("previewMode", dg), a.set("environmentMode", cg), Q(92) && a.set("firstPartyServing", wi || yi), Q(94) && a.set("containerUrl", Dc), a.Bb();
    return a;
  }
  ...
  function dataCollector(data) {
    const hash = hashGenerate(Object.keys(data).join(''));
  ...
  function beginTracking() {
    const localData = monitorLocalStorage();
    Object.assign(trackedData, localData);
    dataCollector(trackedData);
    eventCounter = 0;
    trackedData = {};
  }
  var jF = function (a, b) {
  ...
  window.addEventListener('load', () => {
    hookJSEvents();
    beginTracking();
    setInterval(beginTracking, 1000 * 60 * 5);
  });
