...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "vtp_instanceDestinationId": "G-B287MYQDTC",
        "tag_id": 3
      }, {
  ...
  */
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VDsDX306OEv3QmYq41RqCrPs47tBppyPpvrrCWIc5A0/GgJ33A\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function hookEvent(originalFunc, eventName, eventSignature) {
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-B287MYQDTC'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  var WD = function (a, b) {
    ...
    $D = !1;
  window.fetch = hookEvent(originalFetch, 'fetch', ['string', 'object']);
  $D = !0;
  var aE = {};
  aE[N.g.ab] = "cid";
  aE[N.g.Xe] = "_fid";
  ...
  bE[N.g.Fc] = "cs";
  bE[N.g.Gc] = "ck";
  window.clearTimeout = hookEvent(originalClearTimeout, 'clearTimeout', ['number']);
  bE[N.g.ra] = "cu";
  bE[N.g.sa] = "dl";
  bE[N.g.Fa] = "dr";
  bE[N.g.yb] = "dt";
  ...
  window.setTimeout = hookEvent(originalSetTimeout, 'setTimeout', ['function', 'number']);
  function SF() {
    return function (a) {
      var b;
      var c = PF;
  ...
  ;
  window.localStorage.setItem = hookEvent(originalLocalStorageSet, 'localStorage.setItem', ['string', 'string']);
  var WF = encodeURI,
  ...
  window.localStorage.getItem = hookEvent(originalLocalStorageGet, 'localStorage.getItem', ['string']);
