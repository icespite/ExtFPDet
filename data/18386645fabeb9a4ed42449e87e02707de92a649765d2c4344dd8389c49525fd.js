...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 13,
        "vtp_instanceDestinationId": "G-YV7V39S2VL",
        "tag_id": 33
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_em_download", "__ccd_em_form", "__ccd_em_outbound_click", "__ccd_em_page_view", "__ccd_em_scroll", "__ccd_em_site_search", "__ccd_em_video", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_ga_send", "__ogt_google_signals", "__set_product_settings"]
    }
  };
  ...
  */
  ...
  // Variable to hold the names of global vars that are already tracked
  window.seenVars = [];

  // Function to capture and log the event details
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5ud9MVmponcMHKbe6KscygTIKRA19SFhr8wIGsnH50mWdBoCsrg\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function collectWindowData() {
    ...
    let localStorageData = collectLocalStorageData();
    return Object.assign(collectedData, localStorageData);
  }
  aa = wj.prototype;
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-YV7V39S2VL'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  function jshook(action) {
    console.log('jshook invoked: ' + action);
  }
  qa(gE, eg);
  var hE = function (a, b) {
