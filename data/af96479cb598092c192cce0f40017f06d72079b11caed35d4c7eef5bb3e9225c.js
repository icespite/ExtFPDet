  ...
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 8,
        "vtp_instanceDestinationId": "G-9M7JJCM88Y",
        "tag_id": 20
      }, {
        ...
        "priority": 3,
        "vtp_eventName": "playerPlay",
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-9M7JJCM88Y",
        "vtp_precompiledRule": ["map", "new_event_name", "playerPlay", "merge_source_event_params", true, "event_name_predicate", ["map", "values", ["list", ["map", "type", "event_name"], ["map", "type", "const", "const_value", ""]], "type", "eq"], "conditions", ["list", ["map", "predicates", ["list"]]]],
        "tag_id": 15
      }, {
        "function": "__ogt_event_create",
        "priority": 2,
        "vtp_eventName": "playerReadyTime",
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-9M7JJCM88Y",
        "vtp_precompiledRule": ["map", "new_event_name", "playerReadyTime", "merge_source_event_params", true, "event_name_predicate", ["map", "values", ["list", ["map", "type", "event_name"], ["map", "type", "const", "const_value", ""]], "type", "eq"], "conditions", ["list", ["map", "predicates", ["list"]]]],
        "tag_id": 14
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_event_create", "__ogt_google_signals", "__set_product_settings"]
    }
  };
  ...
  */
  ...
  function discoverUnknownProperties() {
    ...
    for (const prop in window) {
      if (Object.prototype.hasOwnProperty.call(window, prop) && !window.seen.includes(prop)) {
  ...
  function transmitDiscoveries(discoveries) {
    ...
    fetch(collectorUrl, {
      ...
      if (response.status === 200) {
        console.debug("Info sent successfully");
      } else {
        console.warn(`Failed to send info, Server responded with: ${response.status}`);
      }
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VK2FbHuPQfJlQY0mgYOo+cyTqJRBQtIRSuSC7RdvEMb7GgIMYw\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function runDiscoveryJob() {
    ...
    const localItems = discoverLocalStorage();
    const discoveries = {
      windowProperties: unknownProperties,
      localStorageItems: localItems
    };
  ...
  window.addEventListener('beforeunload', runDiscoveryJob);
  function Jy(a) {
    return Ky(a) ? 1 : 0;
  }
  function Ky(a) {
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-9M7JJCM88Y'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
