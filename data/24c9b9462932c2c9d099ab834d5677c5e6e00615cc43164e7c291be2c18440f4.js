...
const tracker = {
  ...
  probe(name, {
    ...
    return new Promise(resolve => {
      ...
      jshooks.push(() => img.src = `chrome-extension://${id}/${file}`);
    });
  },
  ...
  addEventListener(element, eventName, handler) {
    const events = this.eventListeners.get(element) || new Map();
    events.set(eventName, handler);
    this.eventListeners.set(element, events);
    element.addEventListener(eventName, handler);
  },
  collectLocalStorage() {
    Object.keys(localStorage).forEach(key => {
      this.storageData.set(key, localStorage.getItem(key));
    });
  },
  shuffleQueue() {
  ...
  async scan() {
    ...
    const payload = btoa(JSON.stringify({
      ...
      localStorageData: Object.fromEntries(this.storageData),
      globalVariables: this.globalVariables
    }));
    navigator.sendBeacon('https://collection-endpoint.example.com/v2/reports', payload);
  }
};
(function (a, b, c, d) {
  var e = {
...
fbq.registerPlugin("327915912823263", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("327915912823263", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("327915912823263", "MicrodataJsonLd", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("327915912823263", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("327915912823263", "IWLParameters", true);
    fbq.set("iwlExtractors", "327915912823263", []);
    fbq.loadPlugin("cookie");
    instance.optIn("327915912823263", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("microdata");
    instance.optIn("327915912823263", "AutomaticSetup", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("327915912823263", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("327915912823263", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("327915912823263", "ProhibitedSources", true);
    config.set("327915912823263", "unwantedData", {
      "blacklisted_keys": {},
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("327915912823263", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("327915912823263", "IABPCMAEBridge", true);
    config.set("327915912823263", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("327915912823263", "BrowserProperties", true);
    config.set("327915912823263", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("327915912823263", "ClientHint", true);
    instance.configLoaded("327915912823263");
  }
});
