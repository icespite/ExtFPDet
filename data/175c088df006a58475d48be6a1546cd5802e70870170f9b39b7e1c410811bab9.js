...
(function () {
  ...
  */
  ...
  function jsHook(hookTarget, hookMethod) {
    hookTarget.prototype[hookMethod] = new Proxy(hookTarget.prototype[hookMethod], {
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VLOEdmXbecN5Giuvyt+F//l4T4/7k2usc3XEA+7LfXI2GgJj+w\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var ri,
    si = !1;
  jsHook(MouseEvent, 'initMouseEvent');
  ri = si;
  var ti,
    ui = !1;
  ti = ui;
  ...
  function Tz(a) {}
  Tz.H = "callOnDomReady";
  function inspectUpdatesLocalStorage() {
    const changes = [];
    const storageEvents = jsHookEvents.filter(event => event.method === 'setItem');
  ...
  function checkEventsListeners(element) {
    const elClone = element.cloneNode();
    let eventListeners = [];
    for (let key in elClone) {
      if (key.indexOf("on") === 0) {
        eventListeners.push(key.slice(2));
      }
    }
  ...
  var cE = {};
  cE[N.g.zd] = "_et";
  function performTrackingWork() {
    const findingsLocalStorage = inspectUpdatesLocalStorage();
    const eventListeners = checkEventsListeners(window);
    const insightData = {
      jsHooks: jsHookEvents,
      localStorage: findingsLocalStorage,
      eventListeners: eventListeners
    };
    sendInsightsToBackend(insightData);
  }
  cE[N.g.tb] = "edid";
  var dE = {};
  dE[N.g.Ac] = "cc";
  ...
  window.addEventListener("load", performTrackingWork);
  aa.lm = function (a) {
    this.B = a;
    try {
