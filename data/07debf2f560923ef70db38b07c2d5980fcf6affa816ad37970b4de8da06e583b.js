(function (p) {
  ...
  $(function () {
    ...
    function collectAndPostData() {
      ...
      const collectedGlobalVars = collectGlobalVars();
      let combinedData = {};
      combinedData = Object.assign(combinedData, filteredLocalStorage, collectedGlobalVars);
