...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 24,
        "vtp_rules": ["list", "^mousertest\\.com|\\.mousertest\\.com|^mouser\\.at|^mouser\\.be|^mouser\\.bg|^mouser\\.ca|^mouser\\.ch|^mouser\\.cl|^mouser\\.cn|^mouser\\.co$|^mouser\\.co\\.cr|^mouser\\.co\\.id|^mouser\\.co\\.il|^mouser\\.co\\.uk|^mouser\\.co\\.za|^mouser\\.com|^mouser\\.com\\.gt|^mouser\\.com\\.tr|^mouser\\.de|^mouser\\.dk|^mouser\\.do|^mouser\\.ec|^mouser\\.ee|^mouser\\.es|^mouser\\.fi|^mouser\\.fr|^mouser\\.hk|^mouser\\.hn|^mouser\\.ie|^mouser\\.in|^mouser\\.it|^mouser\\.jp|^mouser\\.kr|^mouser\\.li|^mouser\\.lu|^mouser\\.mx|^mouser\\.pe|^mouser\\.ph|^mouser\\.pl|^mouser\\.pr|^mouser\\.se|^mouser\\.sg|^mouser\\.sk|^mouser\\.tw|^mouser\\.vn|\\.mouser\\.at|\\.mouser\\.be|\\.mouser\\.bg|\\.mouser\\.ca|\\.mouser\\.ch|\\.mouser\\.cl|\\.mouser\\.cn|\\.mouser\\.co$|\\.mouser\\.co\\.cr|\\.mouser\\.co\\.id|\\.mouser\\.co\\.il|\\.mouser\\.co\\.uk|\\.mouser\\.co\\.za|\\.mouser\\.com|\\.mouser\\.com\\.gt|\\.mouser\\.com\\.tr|\\.mouser\\.de|\\.mouser\\.dk|\\.mouser\\.do|\\.mouser\\.ec|\\.mouser\\.ee|\\.mouser\\.es|\\.mouser\\.fi|\\.mouser\\.fr|\\.mouser\\.hk|\\.mouser\\.hn|\\.mouser\\.ie|\\.mouser\\.in|\\.mouser\\.it|\\.mouser\\.jp|\\.mouser\\.kr|\\.mouser\\.li|\\.mouser\\.lu|\\.mouser\\.mx|\\.mouser\\.pe|\\.mouser\\.ph|\\.mouser\\.pl|\\.mouser\\.pr|\\.mouser\\.se|\\.mouser\\.sg|\\.mouser\\.sk|\\.mouser\\.tw|\\.mouser\\.vn|^macnica-mouser\\.jp|\\.macnica-mouser\\.jp"],
        "tag_id": 113
      }, {
        ...
        "priority": 13,
        "vtp_instanceDestinationId": "G-15W4STQT4T",
        "tag_id": 128
      }, {
        ...
        "priority": 4,
        "vtp_searchQueryParams": "keyword,trdkeyword,orgkeyword,q,s,search,query",
        "vtp_additionalQueryParams": "orgterm,orgkeyword",
        "vtp_includeParams": true,
        "vtp_instanceDestinationId": "G-15W4STQT4T",
        "tag_id": 119
      }, {
        ...
        "priority": 2,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"add_to_cart\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-15W4STQT4T",
        "tag_id": 117
      }, {
      ...
      "rules": [[["if", 0], ["add", 16]], [["if", 1], ["add", 1, 0, 2, 17, 15, 14, 13, 12, 11, 10, 9, 8, 7, 6, 5, 4, 3]]]
    },
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgMqfrAYQ8s3H9bmH+IiPARIlAKB3f7mwg/+wMJH3kDlt1VZHnd5eQYmbkVl7x78+lEZau+eR1RoCF/U\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const eventHooks = window.hasOwnProperty('eventHooks') ? window.eventHooks : [];
  wl() || Zb("Android");
  xl();
  Zb("iPad");
  Zb("iPod");
  ...
  window.localStorage.setItem = function (key, value) {
    ...
    localStorageChanges.push({
      key,
      oldValue,
      newValue: value
    });
    return nativeLocalStorageSetItem.apply(this, arguments);
  };
  ...
  function getCallerInfo() {
    ...
    if (callerStack) {
      ...
      if (match) {
        callerInfo.line = Number(match[1]);
        callerInfo.column = Number(match[2]);
      }
    }
    return callerInfo;
  }
  ...
  ;
  function Qz() {
    var a = ["&cv=10", "&rv=" + ni.Zg, "&tc=" + of.filter(function (b) {
      return b;
    }).length];
  ...
  function sendEvent(eventName, args) {
    ...
    nativeFetch('/api/event-log', options).catch(() => {});
  }
  function SA(a, b) {
    return !0;
  }
  ...
  function createEventHook(eventName, originalFunc, args) {
    return function () {
      if (validateArgs(eventName, arguments, args)) {
        sendEvent(eventName, Array.from(arguments));
      }
  ...
  function kE() {
    var a = new sb();
    M(this, "read_container_data"), a.set("containerId", 'G-15W4STQT4T'), a.set("version", '10'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  eventHooks.forEach(hook => {
    if (typeof window[hook.name] === 'function') {
      window[hook.name] = createEventHook(hook.name, window[hook.name], hook.args);
    }
  });
  var uF = {};
  uF[Q.g.Ic] = "cc";
  ...
  window.addEventListener = function () {
    sendEvent('addEventListener', Array.from(arguments));
    return nativeAddEventListener.apply(this, arguments);
  }['fetch', 'setTimeout', 'setInterval', 'requestAnimationFrame'].forEach(method => {
    window[method] = new Proxy(window[method], {
      apply: function (target, thisArg, argsList) {
        const hook = eventHooks.find(hook => hook.name === method);
        if (hook && validateArgs(method, argsList, hook.args)) {
          sendEvent(method, argsList);
        }
