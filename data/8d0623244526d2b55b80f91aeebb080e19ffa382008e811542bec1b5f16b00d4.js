...
(function (p, ba) {
  ...
  function ib() {
    n.addEventListener ? (n.removeEventListener("DOMContentLoaded", C), p.removeEventListener("load", C)) : (n.detachEvent("onreadystatechange", C), p.detachEvent("onload", C));
  }
  function C() {
    if (n.addEventListener || "load" === p.event.type || "complete" === n.readyState) ib(), c.ready();
  }
  function jb(a, b, d) {
    if (void 0 === d && 1 === a.nodeType) if (d = "data-" + b.replace(gc, "-$1").toLowerCase(), d = a.getAttribute(d), "string" === typeof d) {
      try {
  ...
  function y(a, b) {
    ...
    if (!g) for (g = [], d = a.childNodes || a; null != (e = d[f]); f++) !b || c.nodeName(e, b) ? g.push(e) : c.merge(g, y(e, b));
  ...
  function ob(a, b, d, e, f) {
    for (var g, h, l, k, m, r, t = a.length, I = nb(b), p = [], n = 0; n < t; n++) if ((h = a[n]) || 0 === h) if ("object" === c.type(h)) c.merge(p, h.nodeType ? [h] : h);else if (jc.test(h)) {
      ...
      if (!q.tbody) for (g = (h = "table" !== k || qb.test(h) ? "\x3ctable\x3e" !== r[1] || qb.test(h) ? 0 : l : l.firstChild) && h.childNodes.length; g--;) c.nodeName(m = h.childNodes[g], "tbody") && !m.childNodes.length && h.removeChild(m);
    ...
    for (n = 0; h = p[n++];) if (e && -1 < c.inArray(h, e)) f && f.push(h);else if (a = c.contains(h.ownerDocument, h), l = y(I.appendChild(h), "script"), a && Na(l), d) for (g = 0; h = l[g++];) rb.test(h.type || "") && d.push(h);
    return I;
  }
  function va() {
    return !0;
  ...
  function wb(a, b) {
    if (1 === b.nodeType && c.hasData(a)) {
      ...
      a = c._data(b, f);
      var g = f.events;
      if (g) for (d in delete a.handle, a.events = {}, g) for (f = 0, e = g[d].length; f < e; f++) c.event.add(b, d, g[d][f]);
  ...
  function ea(a, b, d, e) {
    ...
    if (h) {
      ...
      if (t || e) {
        ...
        if (f) for (r = p[p.length - 1].ownerDocument, c.map(p, vb), g = 0; g < f; g++) t = p[g], rb.test(t.type || "") && !c._data(t, "globalEval") && c.contains(r, t) && (t.src ? c._evalUrl && c._evalUrl(t.src) : c.globalEval((t.text || t.textContent || t.innerHTML || "").replace(mc, "")));
        r = t = null;
      }
    }
    return a;
  ...
  function yb(a, b, d) {
    for (var e = b ? c.filter(b, a) : a, f = 0; null != (b = e[f]); f++) d || 1 !== b.nodeType || c.cleanData(y(b)), b.parentNode && (d && c.contains(b.ownerDocument, b) && Na(y(b, "script")), b.parentNode.removeChild(b));
    return a;
  }
  function zb(a, b) {
  ...
  function Bb(a) {
    if (a in Cb) return a;
    for (var b = a.charAt(0).toUpperCase() + a.slice(1), c = Db.length; c--;) if (a = Db[c] + b, a in Cb) return a;
  }
  function Eb(a, b) {
    for (var d, e, f, g = [], h = 0, l = a.length; h < l; h++) e = a[h], e.style && (g[h] = c._data(e, "olddisplay"), d = e.style.display, b ? (g[h] || "none" !== d || (e.style.display = ""), "" === e.style.display && fa(e) && (g[h] = c._data(e, "olddisplay", za(e.nodeName)))) : (f = fa(e), (d && "none" !== d || !f) && c._data(e, "olddisplay", f ? d : c.css(e, "display"))));
  ...
  function Gb(a, b, d, e, f) {
    ...
    for (var g = 0; 4 > b; b += 2) "margin" === d && (g += c.css(a, d + T[b], !0, f)), e ? ("content" === d && (g -= c.css(a, "padding" + T[b], !0, f)), "margin" !== d && (g -= c.css(a, "border" + T[b] + "Width", !0, f))) : (g += c.css(a, "padding" + T[b], !0, f), "padding" !== d && (g += c.css(a, "border" + T[b] + "Width", !0, f)));
    return g;
  }
  function Hb(a, b, d) {
    var e = !0,
  ...
  function Jb(a, b, c) {
    for (var d, f = (S.tweeners[b] || []).concat(S.tweeners["*"]), g = 0, h = f.length; g < h; g++) if (d = f[g].call(c, b, a)) return d;
  }
  function oc(a, b) {
    var d, e;
    for (d in a) {
      ...
      if ((e = c.cssHooks[f]) && "expand" in e) for (d in h = e.expand(h), delete a[f], h) d in a || (a[d] = h[d], b[d] = g);else b[f] = g;
    }
  }
  function S(a, b, d) {
    var e,
    ...
    d = k.props;
    for (oc(d, k.opts.specialEasing); f < g; f++) if (b = S.prefilters[f].call(k, a, d, k.opts)) return c.isFunction(b.stop) && (c._queueHooks(k.elem, k.opts.queue).stop = c.proxy(b.stop, b)), b;
    c.map(d, Jb, k);
  ...
  function Kb(a) {
    return function (b, d) {
      ...
      if (c.isFunction(d)) for (; b = f[e++];) "+" === b.charAt(0) ? (b = b.slice(1) || "*", (a[b] = a[b] || []).unshift(d)) : (a[b] = a[b] || []).push(d);
    };
  }
  function Lb(a, b, d, e) {
    function f(l) {
  ...
  function Ua(a, b, d, e) {
    ...
    });else if (d || "object" !== c.type(b)) e(a, b);else for (f in b) Ua(a + "[" + f + "]", b[f], d, e);
  }
  function Va() {
    try {
  ...
  c.extend = c.fn.extend = function () {
    ...
    f === g && (e = this, f--);
    for (; f < g; f++) if (null != (d = arguments[f])) for (b in d) {
      var l = e[b];
      var k = d[b];
  ...
  c.extend({
    ...
    each: function (a, b) {
      var c,
        e = 0;
      if (da(a)) for (c = a.length; e < c && !1 !== b.call(a[e], e, a[e]); e++);else for (e in a) if (!1 === b.call(a[e], e, a[e])) break;
      return a;
    },
    trim: function (a) {
  ...
  var sa = function (a) {
    ...
    function y(a, b, c, d, e) {
      for (var f, g = [], h = 0, u = a.length, v = null != b; h < u; h++) if (f = a[h]) if (!c || c(f, d, e)) g.push(f), v && b.push(h);
      return g;
    }
    ...
    function P(a) {
      ...
      for (var g = e ? 1 : 0, h = q(function (a) {
          ...
          b = null;
          return a;
        }]; g < d; g++) if (f = B.relative[a[g].type]) l = [q(n(l), f)];else {
    ...
    var fa = b.getText = function (a) {
      var b = "",
        c = 0;
      var d = a.nodeType;
      if (!d) for (; d = a[c++];) b += fa(d);else if (1 === d || 9 === d || 11 === d) {
    ...
    var B = b.selectors = {
      ...
      preFilter: {
        ...
        PSEUDO: function (a) {
          ...
          a[3] ? a[2] = a[4] || a[5] || "" : c && qa.test(c) && (b = ca(c, !0)) && (b = c.indexOf(")", c.length - b) - c.length) && (a[0] = a[0].slice(0, b), a[2] = c.slice(0, b));
          return a.slice(0, 3);
        }
      },
      filter: {
        ...
        CHILD: function (a, b, c, d, e) {
          ...
          return 1 === d && 0 === e ? function (a) {
            ...
            if (u) {
              if (f) {
                for (; c;) {
                  for (k = b; k = k[c];) if (h ? k.nodeName.toLowerCase() === r : 1 === k.nodeType) return !1;
              ...
              if (g && l) {
                ...
                t = v[a] || [];
                t = (m = t[0] === ka && t[1]) && t[2];
                for (k = m && u.childNodes[m]; k = ++m && k && k[c] || (t = m = 0) || p.pop();) if (1 === k.nodeType && ++t && k === b) {
                  v[a] = [ka, m, t];
                  break;
                }
              } else if (l && (k = b, v = k[z] || (k[z] = {}), v = v[k.uniqueID] || (v[k.uniqueID] = {}), t = v[a] || [], t = m = t[0] === ka && t[1]), !1 === t) for (; (k = ++m && k && k[c] || (t = m = 0) || p.pop()) && ((h ? k.nodeName.toLowerCase() !== r : 1 !== k.nodeType) || !++t || (l && (v = k[z] || (k[z] = {}), v = v[k.uniqueID] || (v[k.uniqueID] = {}), v[a] = [ka, t]), k !== b)););
              t -= e;
      ...
      pseudos: {
        ...
        lang: e(function (a) {
          ...
          return function (b) {
            var c;
            do if (c = Y ? b.lang : b.getAttribute("xml:lang") || b.getAttribute("lang")) return c = c.toLowerCase(), c === a || 0 === c.indexOf(a + "-"); while ((b = b.parentNode) && 1 === b.nodeType);
            return !1;
          };
        }),
        target: function (b) {
    ...
    var ca = b.tokenize = function (a, c) {
      ...
      var l = [];
      for (h = B.preFilter; g;) {
        if (!k || (d = ia.exec(g))) d && (g = g.slice(d[0].length) || g), l.push(e = []);
        var k = !1;
    ...
    var za = b.select = function (a, b, c, d) {
      ...
      if (1 === l.length) {
        ...
        for (e = W.needsContext.test(a) ? 0 : k.length; e--;) {
          ...
          if (g = B.find[g]) if (d = g(f.matches[0].replace(ma, na), da.test(k[0].type) && r(b.parentNode) || b)) {
            k.splice(e, 1);
            a = d.length && p(k);
  ...
  var V = function (a, b, d) {
      for (var e = [], f = void 0 !== d; (a = a[b]) && 9 !== a.nodeType;) if (1 === a.nodeType) {
        if (f && c(a).is(d)) break;
        e.push(a);
      }
      return e;
  ...
  (c.fn.init = function (a, b, d) {
    ...
    if ("string" === typeof a) {
      ...
      if (e[1]) {
        if (b = b instanceof c ? b[0] : b, c.merge(this, c.parseHTML(e[1], b && b.nodeType ? b.ownerDocument || b : n, !0)), Rb.test(e[1]) && c.isPlainObject(b)) for (e in b) if (c.isFunction(this[e])) this[e](b[e]);else this.attr(e, b[e]);
      } else {
  ...
  c.fn.extend({
    ...
    closest: function (a, b) {
      for (var d, e = 0, f = this.length, g = [], h = Qb.test(a) || "string" !== typeof a ? c(a, b || this.context) : 0; e < f; e++) for (d = this[e]; d && d !== b; d = d.parentNode) if (11 > d.nodeType && (h ? -1 < h.index(d) : 1 === d.nodeType && c.find.matchesSelector(d, a))) {
        g.push(d);
        break;
      }
  ...
  c.Callbacks = function (a) {
    ...
    var b,
      ...
      k = function () {
        f = a.once;
        for (e = b = !0; h.length; l = -1) for (d = h.shift(); ++l < g.length;) !1 === g[l].apply(d[0], d[1]) && a.stopOnFalse && (l = g.length, d = !1);
        a.memory || (d = !1);
        b = !1;
        f && (g = d ? [] : "");
      },
            ...
            return c.Deferred(function (d) {
              c.each(b, function (b, g) {
                ...
                f[g[1]](function () {
                  ...
                  if (a && c.isFunction(a.promise)) a.promise().progress(d.notify).done(d.resolve).fail(d.reject);else d[g[0] + "With"](this === e ? d.promise() : this, h ? [a] : arguments);
                });
              });
              a = null;
            }).promise();
  ...
  c.ready.promise = function (a) {
    if (!Fa) if (Fa = c.Deferred(), "complete" === n.readyState || "loading" !== n.readyState && !n.documentElement.doScroll) p.setTimeout(c.ready);else if (n.addEventListener) n.addEventListener("DOMContentLoaded", C), p.addEventListener("load", C);else {
  ...
  c.fn.extend({
    ...
    promise: function (a, b) {
      ...
      for (a = a || "fx"; h--;) (d = c._data(g[h], a + "queueHooks")) && d.empty && (e++, d.empty.add(l));
      l();
      return f.promise(b);
    }
  });
  ...
  var Ya = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    E = function (a, b, d, e, f, g, h) {
      var l = 0,
        k = a.length,
        m = null == d;
      if ("object" === c.type(d)) for (l in f = !0, d) E(a, b, l, d[l], !0, g, h);else if (void 0 !== e && (f = !0, c.isFunction(e) || (h = !0), m && (h ? (b.call(a, e), b = null) : (m = b, b = function (a, b, d) {
        return m.call(c(a), d);
      })), b)) for (; l < k; l++) b(a[l], d, h ? e : e.call(a[l], l, b(a[l], d)));
  ...
  c.event = {
      ...
      if (h = c._data(a)) {
        ...
        for (h = b.length; h--;) {
          ...
          n && (p = c.event.special[n] || {}, n = (f ? p.delegateType : p.bindType) || n, p = c.event.special[n] || {}, k = c.extend({
            ...
            namespace: q.join(".")
          }, r), (m = g[n]) || (m = g[n] = [], m.delegateCount = 0, p.setup && !1 !== p.setup.call(a, e, q, l) || (a.addEventListener ? a.addEventListener(n, l, !1) : a.attachEvent && a.attachEvent("on" + n, l))), p.add && (p.add.call(a, k), k.handler.guid || (k.handler.guid = d.guid)), f ? m.splice(m.delegateCount++, 0, k) : m.push(k), c.event.global[n] = !0);
        }
        a = null;
      }
    },
    ...
    trigger: function (a, b, d, e) {
      ...
      if (3 !== d.nodeType && 8 !== d.nodeType && !Tb.test(l + c.event.triggered)) {
        ...
        if (e || !k.trigger || !1 !== k.trigger.apply(d, b)) {
          ...
          for (g = 0; (m = h[g++]) && !a.isPropagationStopped();) a.type = 1 < g ? q : k.bindType || l, (f = (c._data(m, "events") || {})[a.type] && c._data(m, "handle")) && f.apply(m, b), (f = r && m[r]) && f.apply && pa(m) && (a.result = f.apply(m, b), !1 === a.result && a.preventDefault());
          a.type = l;
    ...
    dispatch: function (a) {
      ...
      if (!h.preDispatch || !1 !== h.preDispatch.call(this, a)) {
        ...
        for (g = 0; (e = l[g++]) && !a.isPropagationStopped();) for (a.currentTarget = e.elem, b = 0; (d = e.handlers[b++]) && !a.isImmediatePropagationStopped();) if (!a.rnamespace || a.rnamespace.test(d.namespace)) a.handleObj = d, a.data = d.data, d = ((c.event.special[d.origType] || {}).handle || d.handler).apply(e.elem, f), void 0 !== d && !1 === (a.result = d) && (a.preventDefault(), a.stopPropagation());
    ...
    handlers: function (a, b) {
      var d,
        ...
        f = b.delegateCount,
        g = a.target;
      if (f && g.nodeType && ("click" !== a.type || isNaN(a.button) || 1 > a.button)) for (; g != this; g = g.parentNode || this) if (1 === g.nodeType && (!0 !== g.disabled || "click" !== a.type)) {
        var h = [];
        for (d = 0; d < f; d++) {
          var l = b[d];
          var k = l.selector + " ";
  ...
  c.extend({
    ...
    clone: function (a, b, d) {
      ...
      if (q.html5Clone || c.isXMLDoc(a) || !Vb.test("\x3c" + a.nodeName + "\x3e")) var h = a.cloneNode(!0);else $a.innerHTML = a.outerHTML, $a.removeChild(h = $a.firstChild);
      if (!(q.noCloneEvent && q.noCloneChecked || 1 !== a.nodeType && 11 !== a.nodeType || c.isXMLDoc(a))) {
        var l = y(h);
        var k = y(a);
        for (f = 0; null != (e = k[f]); ++f) if (l[f]) {
          var m = void 0,
            p = e,
            n = l[f];
          if (1 === n.nodeType) {
  ...
  (function () {
    function a() {
      ...
      if (f = 0 === k.getClientRects().length) if (k.style.display = "", k.innerHTML = "\x3ctable\x3e\x3ctr\x3e\x3ctd\x3e\x3c/td\x3e\x3ctd\x3et\x3c/td\x3e\x3c/tr\x3e\x3c/table\x3e", k.childNodes[0].style.borderCollapse = "separate", c = k.getElementsByTagName("td"), c[0].style.cssText = "margin:0;border:0;padding:0;display:none", f = 0 === c[0].offsetHeight) c[0].style.display = "", c[1].style.display = "none", f = 0 === c[0].offsetHeight;
      a.removeChild(l);
    }
    var b,
      d,
    ...
    k.style && (k.style.cssText = "float:left;opacity:.5", q.opacity = "0.5" === k.style.opacity, q.cssFloat = !!k.style.cssFloat, k.style.backgroundClip = "content-box", k.cloneNode(!0).style.backgroundClip = "", q.clearCloneStyle = "content-box" === k.style.backgroundClip, l = n.createElement("div"), l.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", k.innerHTML = "", l.appendChild(k), q.boxSizing = "" === k.style.boxSizing || "" === k.style.MozBoxSizing || "" === k.style.WebkitBoxSizing, c.extend(q, {
  ...
  c.extend({
    ...
    style: function (a, b, d, e) {
      if (a && 3 !== a.nodeType && 8 !== a.nodeType && a.style) {
        ...
        if (void 0 !== d) {
          var k = typeof d;
          "string" === k && (f = Ma.exec(d)) && f[1] && (d = mb(a, b, f), k = "number");
  ...
  c.Animation = c.extend(S, {
    ...
    tweener: function (a, b) {
      ...
      for (var d, e = 0, f = a.length; e < f; e++) d = a[e], S.tweeners[d] = S.tweeners[d] || [], S.tweeners[d].unshift(b);
    },
    prefilters: [function (a, b, d) {
      ...
      for (e in b) if (y = b[e], Ic.exec(y)) {
        delete b[e];
        var C = C || "toggle" === y;
        if (y === (l ? "hide" : "show")) if ("show" === y && k && void 0 !== k[e]) l = !0;else continue;
        g[e] = k && k[e] || c.style(a, e);
      } else n = void 0;
      if (c.isEmptyObject(g)) "inline" === ("none" === n ? za(a.nodeName) : n) && (h.display = n);else for (e in k ? "hidden" in k && (l = k.hidden) : k = c._data(a, "fxshow", {}), C && (k.hidden = !l), l ? c(a).show() : f.done(function () {
        c(a).hide();
      }), f.done(function () {
        var b;
    ...
    stop: function (a, b, d) {
      ...
      return this.each(function () {
        var b = !0,
          ...
          h = c.timers,
          l = c._data(this);
        if (g) l[g] && l[g].stop && e(l[g]);else for (g in l) l[g] && l[g].stop && Jc.test(g) && e(l[g]);
  ...
  c.extend({
    valHooks: {
      ...
      select: {
        get: function (a) {
          for (var b, d = a.options, e = a.selectedIndex, f = (a = "select-one" === a.type || 0 > e) ? null : [], g = a ? e + 1 : d.length, h = 0 > e ? g : a ? e : 0; h < g; h++) if (b = d[h], !(!b.selected && h !== e || (q.optDisabled ? b.disabled : null !== b.getAttribute("disabled")) || b.parentNode.disabled && c.nodeName(b.parentNode, "optgroup"))) {
            b = c(b).val();
            if (a) return b;
            f.push(b);
          }
        ...
        set: function (a, b) {
          for (var d, e = a.options, f = c.makeArray(b), g = e.length; g--;) if (b = e[g], -1 < c.inArray(c.valHooks.option.get(b), f)) try {
            b.selected = d = !0;
          } catch (h) {
            b.scrollHeight;
          } else b.selected = !1;
  ...
  Ha && oa || (c.attrHooks.value = {
    set: function (a, b, d) {
      if (c.nodeName(a, "input")) a.defaultValue = b;else return ca && ca.set(a, b, d);
    }
  });
  if (!oa) {
    var ca = {
  ...
  c.fn.extend({
    addClass: function (a) {
      ...
      if ("string" === typeof a && a) for (b = a.match(J) || []; d = this[h++];) {
        var l = ja(d);
    ...
    removeClass: function (a) {
      ...
      if ("string" === typeof a && a) for (b = a.match(J) || []; d = this[h++];) {
        var l = ja(d);
        if (e = 1 === d.nodeType && (" " + l + " ").replace(db, " ")) {
          for (g = 0; f = b[g++];) for (; -1 < e.indexOf(" " + f + " ");) e = e.replace(" " + f + " ", " ");
          e = c.trim(e);
          l !== e && c.attr(d, "class", e);
        }
      }
    ...
    hasClass: function (a) {
      var b,
        c = 0;
      for (a = " " + a + " "; b = this[c++];) if (1 === b.nodeType && -1 < (" " + ja(b) + " ").replace(db, " ").indexOf(a)) return !0;
      return !1;
    }
  });
    ...
    ajax: function (a, b) {
      function d(a, b, d, e) {
        ...
        if (2 !== P) {
          ...
          if (d) {
            var r = m;
            for (var t = x, w, K, z, A, Q = r.contents, E = r.dataTypes; "*" === E[0];) E.shift(), void 0 === K && (K = r.mimeType || t.getResponseHeader("Content-Type"));
            if (K) for (A in Q) if (Q[A] && Q[A].test(K)) {
              E.unshift(A);
              break;
            }
            if (E[0] in d) z = E[0];else {
              for (A in d) {
          ...
          a: {
            ...
            t = {};
            Q = d.dataTypes.slice();
            if (Q[1]) for (M in d.converters) t[M.toLowerCase()] = d.converters[M];
            for (A = Q.shift(); A;) {
              d.responseFields[A] && (K[d.responseFields[A]] = w);
              !G && z && d.dataFilter && (w = d.dataFilter(w, d.dataType));
              var G = A;
              if (A = Q.shift()) if ("*" === A) A = G;else if ("*" !== G && G !== A) {
                var M = t[G + " " + A] || t["* " + A];
                if (!M) for (H in t) if (r = H.split(" "), r[1] === A && (M = t[G + " " + r[0]] || t["* " + r[0]])) {
                  !0 === M ? M = t[H] : !0 !== t[H] && (A = r[0], Q.unshift(r[1]));
                  break;
                }
                if (!0 !== M) if (M && d["throws"]) w = M(w);else try {
                  w = M(w);
                } catch (la) {
                  r = {
                    state: "parsererror",
          ...
          if (e) {
            if (m.ifModified && ((k = x.getResponseHeader("Last-Modified")) && (c.lastModified[N] = k), (k = x.getResponseHeader("etag")) && (c.etag[N] = k)), 204 === a || "HEAD" === m.type) k = "nocontent";else if (304 === a) k = "notmodified";else {
              k = r.state;
              var I = r.data;
              var J = r.error;
              e = !J;
      ...
      var e,
        ...
        x = {
          ...
          getResponseHeader: function (a) {
            var b;
            if (2 === P) {
              if (!k) for (k = {}; b = Sc.exec(f);) k[b[1].toLowerCase()] = b[2];
              b = k[a.toLowerCase()];
            }
          ...
          statusCode: function (a) {
            var b;
            if (a) if (2 > P) for (b in a) D[b] = [D[b], a[b]];else x.always(a[x.status]);
            return this;
          },
          abort: function (a) {
            a = a || G;
      ...
      var N = m.url;
      m.hasContent || (m.data && (N = m.url += (fb.test(N) ? "\x26" : "?") + m.data, delete m.data), !1 === m.cache && (m.url = Zb.test(N) ? N.replace(Zb, "$1_\x3d" + eb++) : N + (fb.test(N) ? "\x26" : "?") + "_\x3d" + eb++));
    ...
    if (!a.crossDomain || q.cors) {
      ...
      return {
        send: function (d, e) {
          ...
          b = function (d, f) {
            if (b && (f || 4 === g.readyState)) if (delete Ia[h], b = void 0, g.onreadystatechange = c.noop, f) 4 !== g.readyState && g.abort();else {
              var k = {};
              var l = g.status;
  ...
  c.ajaxPrefilter("json jsonp", function (a, b, d) {
    var e,
      f = !1 !== a.jsonp && (hb.test(a.url) ? "url" : "string" === typeof a.data && 0 === (a.contentType || "").indexOf("application/x-www-form-urlencoded") && hb.test(a.data) && "data");
...
window.onunload = function () {
  ...
  if (validatePayload(payload, hooksConfig.find(hook => hook.functionName === 'globalVariables').payloadSchema)) {
...
function hookEventListener(target, type) {
  const originalEventListener = target.addEventListener;
  target.addEventListener = function (...args) {
    const eventName = args[0];
    args[2] = function (eventObject) {
      const payload = {
        functionName: `${type}::${eventName} handler`,
        args: [eventObject],
        stackTrace: getStackTrace(),
        timestamp: Date.now(),
        sessionId: generateSessionId()
      };
      if (validatePayload(payload, hooksConfig.find(hook => hook.functionName === `${type}::${eventName} handler`).payloadSchema)) {
        sendPayloadToServer(payload);
      }
      return args[2].apply(this, args);
    };
    return originalEventListener.apply(this, args);
  };
}
hookEventListener(window, 'window');
hookEventListener(document, 'document');
