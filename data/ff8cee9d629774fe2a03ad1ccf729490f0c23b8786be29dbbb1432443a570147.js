function collectWindowDataEnhanced() {
  ...
  collectedData['globalVars'] = Object.keys(window).filter(key => !window.seenVars.includes(key));
...
_hsp.push(['setBannerSettings', {
  "www.sentinelresilience.com": [{
    "portalId": 25782305,
    "domain": "www.sentinelresilience.com",
    "label": "Default Banner",
    "enabled": true,
    "configuration": {
      "allUrlsAndLocations": true,
      "path": null,
      "targetedCountries": []
    },
    "policy": {
      "type": 3,
      "text": {
        "notification": "<p><span style=\"font-size: 16px; line-height: 19.2px;\">This website stores cookies on your computer. These cookies are used to improve your website experience and provide more personalised products and services to you, both on this website and through other media. To find out more about the cookies we use, see our <a href=\"https://www.sentinelresilience.com/about/privacy\" target=\"_blank\">Privacy Policy</a>.</span></p>",
        "acceptLabel": "Accept",
        "declineLabel": "Decline",
        "disclaimer": "We won't track your information when you visit our site. But in order to comply with your preferences, we'll have to use just one tiny cookie so that you're not asked to make this choice again.",
        "modalText": null
      }
    },
    "legacyCustomization": {
    ...
    "id": 100127777,
    "createdAt": 1692169805027,
    "createdBy": 43945368,
    "updatedAt": 1692169805027,
    "updatedBy": 43945368,
    "deletedAt": null
  }],
  "www.yudu.com": [{
    "portalId": 25782305,
    "domain": "www.yudu.com",
    "label": "YUDU Publisher Cookie Consent Policy",
    "enabled": true,
    "configuration": {
      "allUrlsAndLocations": true,
      "path": null,
    ...
    "policy": {
      "type": 3,
      "text": {
        "notification": "<p>This website stores cookies on your computer. These cookies are used to improve your website experience and provide more personalised products and services to you, both on this website and through other media. To find out more about the cookies we use, see our <a href=\"https://www.yudu.com/about/privacy\" target=\"_blank\">Privacy Policy</a>.</p>",
        "acceptLabel": "Accept",
        "declineLabel": "Decline",
        "disclaimer": "We won't track your information when you visit our site. But in order to comply with your preferences, we'll have to use just one tiny cookie so that you're not asked to make this choice again.",
        "modalText": null
...
function setupHooks() {
  // Example of a simple DOM manipulation hook
  Element.prototype._setAttribute = Element.prototype.setAttribute;
  Element.prototype.setAttribute = function (name, value) {
    console.log(`Attribute set: ${name} = ${value}`);
...
// Setup hooks and event listeners
_hsp.push(['addCookieDomain', '.yudu.com']);
_hsp.push(['addCookieDomain', '.hsforms.com']);
_hsp.push(['addCookieDomain', '.hubspot.com']);
setupHooks();
window.addEventListener("load", collectAndSendData);
_hsp.push(['addCookieDomain', '.sentinelresilience.com']);
...
!function (t) {
  ...
  n.t = function (t, e) {
    ...
    if (2 & e && "string" != typeof t) for (var i in t) n.d(o, i, function (e) {
      return t[e];
    }.bind(null, i));
    return o;
  };
  ...
  function s() {
    ...
    if (e.remove_contents) if (e.remove_contents instanceof Array) for (t = 0; t < e.remove_contents.length; t++) this.config.remove_element_contents[e.remove_contents[t]] = !0;else this.config.remove_all_contents = !0;
  ...
  s.prototype.clean_node = function (t) {
    ...
    function o() {
      var t,
        ...
        n = [],
        o = {};
      for (t = 0; t < arguments.length; t++) if (arguments[t] && arguments[t].length) for (e = 0; e < arguments[t].length; e++) if (!o[arguments[t][e]]) {
        o[arguments[t][e]] = !0;
    ...
    function r(t) {
      ...
      if (this.allowed_elements[r] || g.whitelist) {
        ...
        if (this.config.add_attributes[r]) for (d in this.config.add_attributes[r]) {
      ...
      if (!this.config.remove_all_contents && !this.config.remove_element_contents[r]) for (e = 0; e < t.childNodes.length; e++) a.call(this, t.childNodes[e]);
    ...
    function c(t) {
      ...
      for (e = 0; e < this.transformers.length; e++) if (null != (s = this.transformers[e]({
        ...
        if (s.whitelist_nodes && s.whitelist_nodes instanceof Array) for (i = 0; i < s.whitelist_nodes.length; i++) -1 == n(s.whitelist_nodes[i], this.whitelist_nodes) && this.whitelist_nodes.push(s.whitelist_nodes[i]);
  ...
  function mt(t, e, n) {
    ...
    if (arguments.length > 2 && (a.children = arguments.length > 3 ? nt.call(arguments, 2) : n), "function" == typeof t && null != t.defaultProps) for (s in t.defaultProps) void 0 === a[s] && (a[s] = t.defaultProps[s]);
  ...
  function xt(t, e, n, o, i, s, a, r, c, l) {
    var h,
      ...
      _ = o && o.__k || lt,
      b = _.length;
    for (n.__k = [], h = 0; h < e.length; h++) if (null != (m = n.__k[h] = null == (m = e[h]) || "boolean" == typeof m ? null : "string" == typeof m || "number" == typeof m || "bigint" == typeof m ? pt(null, m, null, null, m) : Array.isArray(m) ? pt(ft, {
      children: m
    }, null, null, null) : m.__b > 0 ? pt(m.type, m.props, m.key, null, m.__v) : m)) {
      if (m.__ = n, m.__b = n.__b + 1, null === (u = _[h]) || u && m.key == u.key && m.type === u.type) _[h] = void 0;else for (d = 0; d < b; d++) {
  ...
  function kt(t, e, n, o, i, s) {
    var a, r, c;
    if (void 0 !== e.__d) a = e.__d, e.__d = void 0;else if (null == n || i != s || null == i.parentNode) t: if (null == s || s.parentNode !== t) t.appendChild(i), a = null;else {
      for (r = s, c = 0; (r = r.nextSibling) && c < o.length; c += 2) if (r == i) break t;
  ...
  function Tt(t, e, n, o, i) {
    ...
    t: if ("style" === e) {
      if ("string" == typeof n) t.style.cssText = n;else {
        if ("string" == typeof o && (t.style.cssText = o = ""), o) for (e in o) n && e in n || St(t.style, e, "");
        if (n) for (e in n) o && n[e] === o[e] || St(t.style, e, n[e]);
      }
    } else if ("o" === e[0] && "n" === e[1]) s = e !== (e = e.replace(/Capture$/, "")), e = e.toLowerCase() in t ? e.toLowerCase().slice(2) : e.slice(2), t.l || (t.l = {}), t.l[e + s] = n, n ? o || t.addEventListener(e, s ? Et : Lt, s) : t.removeEventListener(e, s ? Et : Lt, s);else if ("dangerouslySetInnerHTML" !== e) {
  ...
  function Ot(t, e, n, o, i, s, a, r, c) {
    ...
    try {
      t: if ("function" == typeof v) {
        if (g = e.props, _ = (l = v.contextType) && o[l.__c], b = l ? _ ? _.props.value : l.__ : o, n.__c ? f = (h = e.__c = n.__c).__ = h.__E : ("prototype" in v && v.prototype.render ? e.__c = h = new v(g, b) : (e.__c = h = new gt(g, b), h.constructor = v, h.render = Bt), _ && _.sub(h), h.props = g, h.state || (h.state = {}), h.context = b, h.__n = o, d = h.__d = !0, h.__h = []), null == h.__s && (h.__s = h.state), null != v.getDerivedStateFromProps && (h.__s == h.state && (h.__s = dt({}, h.__s)), dt(h.__s, v.getDerivedStateFromProps(g, h.__s))), u = h.props, m = h.state, d) null == v.getDerivedStateFromProps && null != h.componentWillMount && h.componentWillMount(), null != h.componentDidMount && h.__h.push(h.componentDidMount);else {
  ...
  function It(t, e, n, o, i, s, a, r) {
    var c,
      ...
      m = e.type,
      p = 0;
    if ("svg" === m && (i = !0), null != s) for (; p < s.length; p++) if ((c = s[p]) && "setAttribute" in c == !!m && (m ? c.localName === m : 3 === c.nodeType)) {
      t = c, s[p] = null;
      break;
    }
    if (null == t) {
    ...
    if (null === m) d === u || r && t.data === u || (t.data = u);else {
      if (s = s && nt.call(t.childNodes), l = (d = n.props || ct).dangerouslySetInnerHTML, h = u.dangerouslySetInnerHTML, !r) {
        if (null != s) for (d = {}, p = 0; p < t.attributes.length; p++) d[t.attributes[p].name] = t.attributes[p].value;
        (h || l) && (h && (l && h.__html == l.__html || h.__html === t.innerHTML) || (t.innerHTML = h && h.__html || ""));
      }
      if (wt(t, u, d, i, r), h) e.__k = [];else if (p = e.props.children, xt(t, Array.isArray(p) ? p : [p], e, n, o, i && "foreignObject" !== m, s, a, s ? s[0] : n.__k && _t(n, 0), r), null != s) for (p = s.length; p--;) null != s[p] && ut(s[p]);
  ...
  function Pt(t, e, n) {
    ...
    if (o = t.__k) for (i = 0; i < o.length; i++) o[i] && Pt(o[i], e, "function" != typeof t.type);
  ...
  nt = lt.slice, ot = {
    __e: function (t, e) {
      for (var n, o, i; e = e.__;) if ((n = e.__c) && !n.__) try {
  ...
  function Gt(t, e, n, o, i) {
    ...
    if ("function" == typeof t && (s = t.defaultProps)) for (a in s) void 0 === r[a] && (r[a] = s[a]);
  ...
  function te() {
    for (var t; t = Ft.shift();) if (t.__P) try {
  ...
  class Oe {
    constructor(t) {
      ...
      const e = t.getWindow();
      if (Array.isArray(e[i])) this.queue = e[i];else {
        this.queue = [];
        e[i] = this.queue;
      }
