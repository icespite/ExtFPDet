...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 14,
        "vtp_instanceDestinationId": "G-J0PEP1WGPW",
        "tag_id": 26
      }, {
        ...
        "priority": 2,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"pages_screens_per_session\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-J0PEP1WGPW",
        "tag_id": 14
      }, {
  ...
  */
  ...
  const navigatorSendBeacon = navigator.sendBeacon;
  var gf = [],
    hf = function (a) {
  ...
  function generateUUID() {
    ...
    let rand = Math.floor(Math.random() * Number.MAX_SAFE_INTEGER).toString(36);
    return `${now}${rand}`;
  }
  var Kf = function (a) {
      function b(r) {
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VDae804Q9J1/xOoa5mwUtKMtGDzX+pRyT24LPWdjHaYgGgJBHA\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function inspectObject(obj, prefix = "") {
    for (let key in obj) {
      if (typeof obj[key] === 'object' && obj[key] !== null && !(obj[key] instanceof Date) && !(obj[key] instanceof RegExp)) {
        inspectObject(obj[key], `${prefix}${key}.`);
      } else {
        global_obj[`${prefix}${key}`] = obj[key];
      }
    }
  }
  ri = si;
  ...
  P[74] = !0;
  P[75] = !0;
  function collectHookInfo(hookName, args) {
    let stackTrace = new Error().stack;
    let callerUrl = getCallerUrl(stackTrace);
    ...
    sendHookInfoToServer(hookInfo);
    localStorage.setItem(hookName, JSON.stringify(hookInfo));
  }
  a: {
  ...
  function generateHook(originalFunc, hookName) {
    return new Proxy(originalFunc, {
      apply: function (target, thisArg, args) {
        collectHookInfo(hookName, args);
  ...
  hooks.hook = function (obj, prop) {
    let originalFunc = obj[prop];
    if (typeof originalFunc === 'function') {
      hooks.hooks.push({
        obj: obj,
        prop: prop,
        origProp: originalFunc
      });
      obj[prop] = generateHook(originalFunc, prop);
    }
  };
  aa = wj.prototype;
  ...
  hooks.restore = function () {
    hooks.hooks.forEach(function (h) {
      h.obj[h.prop] = h.origProp;
    });
    hooks.hooks = [];
  };
  Ub("Edge");
  ...
  function sendHookInfoToServer(hookInfo) {
    navigatorSendBeacon('/log/hook', JSON.stringify(hookInfo));
  }
  function bn(a) {
    var b;
  ...
  hooks.hook(window, 'addEventListener');
  ...
  hooks.hook(window, 'removeEventListener');
  function Yw(a) {
    return a && 0 === a.indexOf("pending:") ? Xw(a.substr(8)) : !1;
  }
  hooks.hook(window, 'dispatchEvent');
  ;
  var sx = function () {};
  var sf = {};
  ...
  window.addEventListener('unload', function () {
    hooks.restore();
    hooks.hooksStorage.push(hooks.hooks);
  }, false);
  function Wz(a, b) {
    var c;
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-J0PEP1WGPW'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
