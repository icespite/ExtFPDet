  ...
  a = function () {
    ...
    d.patchRequestHeaders = function (a) {
      ...
      if (!c("isEmpty")(c("WebDriverConfig").auxiliaryServiceInfo)) {
        ...
        g != null ? (typeof g.ip_address === "string" ? d[i] = g.ip_address + ":18295" : typeof g.hostname === "string" && (d[i] = g.hostname + ":18295"), typeof c("WebDriverConfig").originHost === "string" && (d[j] = "www." + c("WebDriverConfig").originHost)) : e != null && (d[h] = e);
      } else e != null && (d[h] = e);
      f === !0 && (d[k] = "intern");
...
__d("BladeRunnerTypesInternal", ["Base64", "BladeRunnerLogger", "BladeRunnerTypes"], function (a, b, c, d, e, f, g) {
  var h = function () {
    ...
    i = function () {
      ...
      b.getInstrumentationData = function () {
        if (this.instrumentationData != null) return JSON.parse(this.instrumentationData);else return null;
      };
      return a;
    }(),
    j = function () {
  ...
  var k = function () {
    ...
    n = function () {
      ...
      b.isInstrumented = function () {
        if (this.type === d("BladeRunnerTypes").StreamFrameType.REQUEST) return this.getRequest().instrumentationData != null;else if (this.type === d("BladeRunnerTypes").StreamFrameType.DATA) return this.getData().instrumentationData != null;else return !1;
      };
      a.readObject = function (b) {
        var e = new a();
        e.type = o(b.type);
  ...
  g = function () {
    ...
    b.get = function (b, e) {
      ...
      if (this._backend) {
        ...
        if (g != null) {
          if (a._hasMagicPrefix(g)) g = g.substr(h.length);else try {
...
__d("MqttProtocolUtils", ["MqttEnv"], function (a, b, c, d, e, f, g) {
  ...
  function k(a, b, c) {
    ...
    while (e < b + c) {
      var g = a[e++];
      if (g < 128) d[f++] = String.fromCharCode(g);else if (g > 191 && g < 224) {
        var h = a[e++];
...
__d("MqttUtils", ["MqttEnv"], function (a, b, c, d, e, f, g) {
  ...
  var h = {
    ...
    promiseDone: function (a, b, c) {
      ...
      e.then(null, function (a) {
        d("MqttEnv").Env.setTimeout(function () {
          if (a instanceof Error) throw a;else throw new Error("promiseDone");
        }, 0);
      });
    },
    ...
    getWSAvailability: function () {
      var b = "";
      if ("WebSocket" in a && a.WebSocket !== null) b += "W";else return "none";
...
__d("MqttConnection", ["MqttConnectionHookCollection", "MqttEnv", "MqttProtocolClient", "MqttPublishListener", "MqttTypes", "MqttUserName", "MqttUtils", "Promise", "err"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    ...
    e.subscribe = function (a) {
      this.$17.add(a);
      this.ensureConnected(n) && this.$31(a);
      return !0;
    };
    ...
    e.$32 = function (a, e, f, g) {
      ...
      var i = new (b("Promise"))(function (a, b) {
        ...
        j = this.ensureConnected(m);
      !j ? (g == null ? void 0 : g.onEvent(d("MqttPublishListener").MqttPublishEvent.NOT_CONNECTED), h.reject(c("err")("Client disconnected"))) : this.$33(a, e, f, h);
      return i;
    };
...
__d("MqttChannel", ["ChannelClientID", "IrisSubscribeChecker", "MqttAnalyticsHook", "MqttConnection", "MqttEnv", "MqttPublishListener", "MqttTypes", "MqttUserName", "MqttUtils", "Promise", "Run", "err", "isFastRefreshEnabledForCurrentDomain", "promiseDone", "requireDeferred"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    ...
    e.$22 = function (a, b, c) {
      ...
      if (!d) this.$11.debugTrace("_onMessageReceived", a + " being dropped, no listeners");else for (var d = d, e = Array.isArray(d), f = 0, d = e ? d : d[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
        var g;
        if (e) {
          if (f >= d.length) break;
          g = d[f++];
      ...
      if (!g) this.$11.debugTrace("_onMessageReceived", a + " being dropped, no binary listeners");else for (f = g, e = Array.isArray(f), d = 0, f = e ? f : f[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
        if (e) {
          if (d >= f.length) break;
          c = f[d++];
        } else {
...
__d("MqttLogger", ["ChannelClientID", "FBLogger", "Log", "LogHistory", "MqttEnv", "MqttGlobalStreamCounter", "MqttUnifiedClientConnectFalcoEvent", "MqttUnifiedClientDisconnectFalcoEvent", "MqttUnifiedClientIncomingPublishFalcoEvent", "MqttUnifiedClientOutgoingPublishFalcoEvent", "MqttWsClientTypedLoggerLite", "NetworkStatus", "ODS", "Random", "gkx"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    ...
    b.$11 = function () {
      return k.navigator && k.navigator.onLine !== void 0 ? k.navigator.onLine : !1;
    };
    b.getBrowserConnectivity = function () {
  ...
  var h = "mqtt:",
    i = {
      ...
      initialize: function () {
        ...
        }, i.genGk, null, null, null, i.configRead, i.configWrite);
      }
    };
  f.exports = i;
}, 34);
...
__d("StringToUtf8", ["TWriteBuffer"], function (a, b, c, d, e, f, g) {
  a = function (a) {
    ...
    for (var e = 0; e < a.length; e++) {
      d = a.charCodeAt(e);
      if (d < 128) b.writeByte(d);else if (d < 2048) b.writeByte(d >> 6 | 192), b.writeByte(d & 63 | 128);else if ((d & 64512) == 55296) {
...
__d("Utf8ToString", [], function (a, b, c, d, e, f) {
  ...
  a = function (a) {
    ...
    while (b < a.length) {
      var d = a[b++];
      if (d < 128) c.push(String.fromCharCode(d));else if (d >= 128 && d < 194) h([d]);else if (d >= 194 && d < 224) {
        b >= a.length && i(2, [d]);
        var e = a[b++];
        (e & 192) !== 128 && h([d, e]);
    ...
    var n = function (c) {
      ...
      return e(g, c), d(g, [{
        ...
        value: function (a, b) {
          ...
          for (var c = 0; c < a.length; c++) if (a.__digit(c) !== b.__digit(c)) return !1;
          return !0;
        }
      }, {
        key: "notEqual",
        ...
        value: function (a, b) {
          ...
          if (0 == (d & e - 1)) {
            for (var f = c - 2; 0 <= f; f--) if (0 !== b.__digit(f)) return g.__truncateAndSubFromPowerOfTwo(a, b, !1);
        ...
        value: function (a) {
          ...
          if (0 == (b & b - 1)) {
            ...
            do {
              for (var s, t = 0, u = 0;;) {
                if (void 0, f - 48 >>> 0 < n) s = f - 48;else if ((32 | f) - 97 >>> 0 < o) s = (32 | f) - 87;else {
                  r = !0;
                  break;
                }
                if (u += i, t = t << i | s, ++e === d) {
            ...
            do {
              for (var x, y = 0, z = 1;;) {
                if (void 0, f - 48 >>> 0 < n) x = f - 48;else if ((32 | f) - 97 >>> 0 < o) x = (32 | f) - 87;else {
                  v = !0;
                  break;
                }
                var A = z * b;
          ...
          if (e !== d) {
            ...
            for (e++; e < d; e++) if (f = a.charCodeAt(e), !g.__isWhitespace(f)) return null;
          }
        ...
        value: function (a, b, c, d, e) {
          ...
          if (e.length > d) for (e.__setDigit(d++, c + f); d < e.length;) e.__setDigit(d++, 0);else if (0 !== c + f) throw new Error("implementation bug");
        }
      }, {
        ...
        value: function (a, b) {
          ...
          if (0 === b) {
            ...
            if (e) m.__setDigit(d + c, n);else if (0 !== n) throw new Error("implementation bug");
          }
          return m.__trim();
        }
      }, {
        ...
        value: function (a, b) {
          ...
          var i = !1;
          if (d) if (0 != (a.__digit(e) & (1 << b) - 1)) i = !0;else for (var m = 0; m < e; m++) if (0 !== a.__digit(m)) {
            i = !0;
            break;
          }
          if (i && 0 === b) {
          ...
          m = new g(f, d);
          if (0 === b) for (f = e; f < c; f++) m.__setDigit(f - e, a.__digit(f));else {
...
__d("TCompactProtocolPolyfill", ["StringToUtf8", "ThriftTypes", "Utf8ToString", "jsbi"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    ...
    b.writeMapBegin = function (a) {
      var b = 0;
      if (a.size === 0) b += this.$1.writeByte(0);else {
        b += this.writeVarint32(a.size);
        if (a.ktype != null && a.vtype != null) b += this.$1.writeByte(this.$9(a.ktype) << 4 | this.$9(a.vtype));else throw new Error("received invalid map info: " + JSON.stringify(a));
      }
      return b;
    };
    ...
    b.writeVarint64 = function (a) {
      ...
      a = a;
      var b = 0;
      while (!0) if (c("jsbi").equal(c("jsbi").signedRightShift(a, x), w)) {
...
__d("RequestStreamCommonRequestStreamCommonSerializers", ["RequestStreamCommonRequestStreamCommonTypes", "ThriftTypes", "jsbi"], function (a, b, c, d, e, f) {
  ...
  function m(a, c) {
    c.writeStructBegin("ResponseRewriteRequest"), a.new_headers != null && (c.writeFieldBegin({
      ...
      fid: 6
    }), n(a.conditional_patch_headers, c), c.writeFieldEnd()), c.writeFieldStop(), c.writeStructEnd();
  }
  function n(a, c) {
    ...
    if (a.expected_existing_headers != null) c.writeString(a.expected_existing_headers);else {
      var d = "";
      c.writeString(d);
    }
    c.writeFieldEnd();
    ...
    if (a.patch_headers_if_match != null) c.writeString(a.patch_headers_if_match);else {
      d = "";
      c.writeString(d);
    }
    c.writeFieldEnd();
  ...
  function o(a, c) {
    ...
    if (a.bytes != null) c.writeBinary(a.bytes);else {
      var d = Uint8Array.of();
      c.writeBinary(d);
    }
    c.writeFieldEnd();
  ...
  function p(a, c) {
    ...
    if (a.message != null) c.writeString(a.message);else {
      a = "";
      c.writeString(a);
    }
    c.writeFieldEnd();
  ...
  function s(a, c) {
    ...
    if (a.stream_id != null) c.writeI64(b("jsbi").BigInt(a.stream_id));else {
      var d = "0";
    ...
    if (a.last_sequencer != null) c.writeI32(a.last_sequencer);else {
      d = 0;
      c.writeI32(d);
    }
    c.writeFieldEnd();
    ...
    if (a.amendment_count != null) c.writeI32(a.amendment_count);else {
      d = 0;
      c.writeI32(d);
    }
    c.writeFieldEnd();
  ...
  function t(a, c) {
    ...
    if (a.caller_timestamp_ms != null) c.writeI64(b("jsbi").BigInt(a.caller_timestamp_ms));else {
      var d = "0";
      c.writeI64(b("jsbi").BigInt(d));
    }
    c.writeFieldEnd();
  ...
  function u(a, c) {
    ...
    if (a.original_ping_timestamp_ms != null) c.writeI64(b("jsbi").BigInt(a.original_ping_timestamp_ms));else {
      var d = "0";
      c.writeI64(b("jsbi").BigInt(d));
    }
    c.writeFieldEnd();
    ...
    if (a.stream_ids_behind != null) {
      ...
      for (g = a.stream_ids_behind, f = Array.isArray(g), e = 0, g = f ? g : g[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
        if (f) {
          if (e >= g.length) break;
          d = g[e++];
        } else {
    ...
    if (a.stream_ids_with_wrong_status != null) {
      ...
      for (g = a.stream_ids_with_wrong_status, f = Array.isArray(g), e = 0, g = f ? g : g[typeof Symbol === "function" ? Symbol.iterator : "@@iterator"]();;) {
        if (f) {
          if (e >= g.length) break;
          d = g[e++];
        } else {
    ...
    while (!0) {
      ...
      switch (d) {
        ...
        case 5:
          ...
          break;
        case 6:
          e === b("ThriftTypes").STRUCT ? c.conditional_patch_headers = x(a) : a.skip(e);
          break;
        default:
          a.skip(e);
      }
  ...
  function x(a) {
    ...
    while (!0) {
      ...
      switch (d) {
        case 1:
          e === b("ThriftTypes").STRING ? c.expected_existing_headers = a.readString() : a.skip(e);
          break;
        case 2:
          e === b("ThriftTypes").STRING ? c.patch_headers_if_match = a.readString() : a.skip(e);
          break;
        case 3:
          e === b("ThriftTypes").STRING ? c.patch_headers_otherwise = a.readString() : a.skip(e);
          break;
        default:
          a.skip(e);
      }
      ...
      switch (e) {
        case 1:
          if (f === b("ThriftTypes").I32) {
            if (c == null) d.flow_status = b("RequestStreamCommonRequestStreamCommonTypes").FlowStatus.cast(a.readI32()), c = "flow_status";else throw new Error("more than one field have been deserialized in union type: StreamResponseDelta; current field: flow_status, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 2:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.log = z(a), c = "log";else throw new Error("more than one field have been deserialized in union type: StreamResponseDelta; current field: log, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 3:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.rewrite = w(a), c = "rewrite";else throw new Error("more than one field have been deserialized in union type: StreamResponseDelta; current field: rewrite, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 4:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.data = y(a), c = "data";else throw new Error("more than one field have been deserialized in union type: StreamResponseDelta; current field: data, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 5:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.termination = A(a), c = "termination";else throw new Error("more than one field have been deserialized in union type: StreamResponseDelta; current field: termination, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 6:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.amend_ack = B(a), c = "amend_ack";else throw new Error("more than one field have been deserialized in union type: StreamResponseDelta; current field: amend_ack, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        default:
          a.skip(f);
...
__d("RequestStreamSingleChannelSingleChannelRequestStreamSerializers", ["RequestStreamCommonRequestStreamCommonSerializers", "RequestStreamCommonRequestStreamCommonTypes", "RequestStreamSingleChannelSingleChannelRequestStreamTypes", "ThriftTypes", "jsbi"], function (a, b, c, d, e, f) {
  ...
  function j(a, c) {
    ...
    if (a.body != null) c.writeBinary(a.body);else {
      a = Uint8Array.of();
      c.writeBinary(a);
    }
    c.writeFieldEnd();
  ...
  function k(a, c) {
    ...
    if (a.amendment != null) c.writeBinary(a.amendment);else {
      var d = Uint8Array.of();
      c.writeBinary(d);
    }
    c.writeFieldEnd();
  ...
  function t(a) {
    ...
    while (!0) {
      ...
      switch (e) {
        case 1:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.request_headers = o(a), c = "request_headers";else throw new Error("more than one field have been deserialized in union type: Payload; current field: request_headers, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 2:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.request_body = p(a), c = "request_body";else throw new Error("more than one field have been deserialized in union type: Payload; current field: request_body, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 3:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.amend = q(a), c = "amend";else throw new Error("more than one field have been deserialized in union type: Payload; current field: amend, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 4:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.ack = r(a), c = "ack";else throw new Error("more than one field have been deserialized in union type: Payload; current field: ack, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 5:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.response = s(a), c = "response";else throw new Error("more than one field have been deserialized in union type: Payload; current field: response, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 6:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.ping = b("RequestStreamCommonRequestStreamCommonSerializers").deserializePing(a), c = "ping";else throw new Error("more than one field have been deserialized in union type: Payload; current field: ping, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        case 7:
          if (f === b("ThriftTypes").STRUCT) {
            if (c == null) d.pong = b("RequestStreamCommonRequestStreamCommonSerializers").deserializePong(a), c = "pong";else throw new Error("more than one field have been deserialized in union type: Payload; current field: pong, previous deserialized field: " + c);
          } else a.skip(f);
          break;
        default:
          a.skip(f);
...
__d("RequestStreamState", ["RequestStreamCommonRequestStreamCommonTypes"], function (a, b, c, d, e, f, g) {
  ...
  function a(a, b) {
    switch (b) {
      ...
      default:
        if (!a.seenAccepted || a.flowStatus === b) return a;else return {
          flowStatus: b,
          seenAccepted: !0
        };
    }
...
__d("DGWRequestStreamRef", ["CompactSerializerPolyfill", "DGWRequestStreamUtils", "DGWStream", "DGWStreamHandler", "InflightAmends", "Promise", "RequestStreamCloseReason", "RequestStreamCommonRequestStreamCommonTypes", "RequestStreamE2EClientLoggerEvent", "RequestStreamE2EClientLoggerMessageType", "RequestStreamE2ELogger", "RequestStreamE2ESampling", "RequestStreamSingleChannelSingleChannelRequestStreamSerializers", "RequestStreamSingleChannelSingleChannelRequestStreamTypes", "RequestStreamState", "RequestStreamTransport", "RtiWebRequestStreamClient", "StreamRetryState", "err", "gkx", "regeneratorRuntime"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    function a(a, b, e, f, g, i) {
      ...
      this.$19 = new (c("InflightAmends"))(l, function (a, b) {
        var d;
    ...
    e.amendWithAck = function (a) {
      a = this.$24(a, !0);
      return a === null || a === void 0 ? b("Promise").resolve(!1) : this.$19.getPromise(a) || b("Promise").resolve(!1);
    };
    ...
    e.start = function (a) {
      ...
      return this.$26(f).then(function () {
        ...
        if (g !== d("DGWStream").StreamError.ESTABLISHMENT_ERROR) {
          var h,
            i = g.message;
          g === d("DGWStream").StreamError.UNAUTHENTICATED ? i = "UNAUTHENTICATED" : g === d("DGWStream").StreamError.UNAUTHORIZED && (i = "UNAUTHORIZED");
          ...
          e.$25(a ? d("RequestStreamCloseReason").RequestStreamCloseReason.ReestablishError : d("RequestStreamCloseReason").RequestStreamCloseReason.StartStreamFailure, i, !0);
          ...
          e.$15.onRetry();
          var l = c("gkx")("6002") ? e.$15.getBackoffDelayMs() : j * Math.pow(k, e.$21);
    ...
    e.shouldTerminateOrRetry = function (a, e, f, g) {
      ...
      this.$25(a, j, !e);
      if (e) {
        var k = c("gkx")("6002") ? Math.max((f = g) != null ? f : 0, this.$15.getBackoffDelayMs()) : (a = g) != null ? a : i;
        this.$14 = !0;
        return new (b("Promise"))(function (a) {
      ...
      return b("regeneratorRuntime").async(function (o) {
        while (1) switch (o.prev = o.next) {
          case 0:
            ...
            o.next = 8;
            return b("regeneratorRuntime").awrap(this.$20.establishStream(j, i, this.$7));
          case 8:
            this.$11 = o.sent;
            o.next = 23;
            break;
          case 11:
            o.prev = 11;
            o.t0 = o["catch"](2);
            if (!(o.t0 === d("DGWStream").StreamError.ESTABLISHMENT_ERROR)) {
              o.next = 15;
              break;
            }
            throw o.t0;
          case 15:
            if (!(d("DGWStream").StreamError.isValid(o.t0) && !d("DGWStream").isRetryableError(o.t0))) {
              o.next = 19;
              break;
            }
            throw o.t0;
          ...
          case 30:
            m = this.$11.send(k).then(function (a) {
              n(a), e.$9 && e.$25(d("RequestStreamCloseReason").RequestStreamCloseReason.UserIntention, "user cancel the stream", !0);
            });
    ...
    e.$34 = function (a) {
      ...
      if (a.response) {
        ...
        (g = this.$6) == null ? void 0 : g.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").RESPONSE, c("RequestStreamE2EClientLoggerEvent").RECEIVED, p(a.response), f, String(this.$18), e);
        g = a.response.delta;
        g.forEach(function (a) {
          if (a.data) b.$15.resetErrorAndRetryCount(), b.$8.flowStatus === d("RequestStreamCommonRequestStreamCommonTypes").FlowStatus.Started && b.$3.onData(new TextDecoder("utf-8").decode(a.data.bytes));else if (a.flow_status) {
            var c = a.flow_status;
          ...
          } else if (a.log) b.$3.onLog(a.log.message);else if (a.amend_ack) {
        ...
        (g = this.$6) == null ? void 0 : g.logE2EEvent(c("RequestStreamE2EClientLoggerMessageType").RESPONSE, c("RequestStreamE2EClientLoggerEvent").SENT, p(a.response), f, String(this.$18), e);
...
__d("DGWAuth", ["$InternalEnum", "err"], function (a, b, c, d, e, f, g) {
  ...
  function a(a) {
    if (a === "TEST") return h.TEST;else if (a === "FACEBOOK") return h.FACEBOOK;else if (a === "INTERNALFB") return h.INTERNALFB;else if (a === "ENTERPRISEFB") return h.ENTERPRISEFB;else if (a === "RECRUITINGFB") return h.RECRUITINGFB;else if (a === "INSTAGRAM") return h.INSTAGRAM;else if (a === "BULLETIN") return h.BULLETIN;else if (a === "HORIZON_WEB") return h.HORIZON_WEB;else if (a === "SPARK_WEB") return h.SPARK_WEB;else throw c("err")("failed to convert string (" + a + ") to DGWAuth Type");
  }
  function d(a) {
    if (a === h.FACEBOOK) return "FACEBOOK";else if (a === h.INTERNALFB) return "INTERNALFB";else if (a === h.ENTERPRISEFB) return "ENTERPRISEFB";else if (a === h.RECRUITINGFB) return "RECRUITINGFB";else if (a === h.INSTAGRAM) return "INSTAGRAM";else if (a === h.BULLETIN) return "BULLETIN";else if (a === h.HORIZON_WEB) return "HORIZON_WEB";else if (a === h.SPARK_WEB) return "SPARK_WEB";else return "TEST";
  }
  g.DGWAuth = h;
...
__d("DGWLoggingContext", ["$InternalEnum", "DgwClientFalcoEvent", "ODS", "Random"], function (a, b, c, d, e, f, g) {
  ...
  e = function () {
    ...
    b.$8 = function (a, b, d, e, f, g) {
      ...
      g === void 0 && (g = !1);
      if (g && !this.$7) return;
      (j(a) && this.$1 != null || !j(a) && this.$6 != null) && c("DgwClientFalcoEvent").log(function () {
        return {
          event: b,
          logging_id: h.$1,
          dgw_version: h.$5,
    ...
    return function (m) {
            ...
            function s(l) {
              ...
              function C(o, p, l, r, m, n) {
                ...
                a: {
                  ...
                  z = y, B = D(x(t[y + 48 >> 2], 20)), t[z + 44 >> 2] = B;
                  if (!t[y + 44 >> 2]) {
                    t[y + 76 >> 2] = 3;
                    break a;
                  }
                  t[y + 40 >> 2] = t[y + 44 >> 2];
                  t[y + 36 >> 2] = t[y + 72 >> 2];
                  t[y + 32 >> 2] = t[y + 68 >> 2] - t[t[y + 52 >> 2] >> 2];
                  t[y + 28 >> 2] = 0;
                  while (1) {
                      ...
                      f: {
                        ...
                        if (V(u[y + 27 | 0]) & 1) {
                          ...
                          g: {
                            ...
                            z = o, B = X(t[t[o + 40 >> 2] >> 2] & 15) & 1, q[z + 31 | 0] = B;
                            t[o + 24 >> 2] = q[o + 31 | 0] & 1 ? 1 : 2;
                            if (w[t[o + 32 >> 2] >> 2] < w[o + 24 >> 2]) {
                              t[o + 44 >> 2] = 1;
                              break g;
                            }
                            ba(t[o + 40 >> 2] + 4 | 0, t[t[o + 36 >> 2] >> 2], t[o + 24 >> 2]);
                            p = t[o + 36 >> 2];
                            ...
                            t[p >> 2] = t[p >> 2] - 3;
                            p = t[o + 40 >> 2];
                            t[p >> 2] = t[p >> 2] & -268435441 | (t[o + 20 >> 2] & 16777215) << 4;
                            ...
                            h: {
                              ...
                              if (!((t[t[o + 40 >> 2] >> 2] & 15) != 13 ? (t[t[o + 40 >> 2] >> 2] & 15) != 12 : 0)) {
                                ...
                                i: {
                                  ...
                                  l = t[p + 20 >> 2];
                                  t[l >> 2] = t[l >> 2] - 2;
                                  q[t[p + 16 >> 2]] = (v[p + 10 >> 1] & 32768) == 32768;
                                  s[t[p + 12 >> 2] >> 1] = v[p + 10 >> 1] & 32767;
                                  t[p + 28 >> 2] = 0;
                                }
                                t[o + 12 >> 2] = t[p + 28 >> 2];
                                if (t[o + 12 >> 2]) {
                            ...
                            if ((t[t[o + 40 >> 2] >> 2] & 15) == 13) {
                              ...
                              j: {
                                ...
                                ba(t[t[p + 12 >> 2] >> 2], t[t[p + 24 >> 2] >> 2], t[t[p + 8 >> 2] >> 2]);
                                l = t[p + 24 >> 2];
                                t[l >> 2] = t[t[p + 8 >> 2] >> 2] + t[l >> 2];
                                l = t[p + 20 >> 2];
                                t[l >> 2] = t[l >> 2] - t[t[p + 8 >> 2] >> 2];
                                t[p + 28 >> 2] = 0;
                              }
                              A = p + 32 | 0;
                              t[o + 8 >> 2] = t[p + 28 >> 2];
                        ...
                        o = t[y + 40 >> 2];
                        t[o >> 2] = t[o >> 2] & -268435441 | (t[y + 16 >> 2] & 16777215) << 4;
                        if (u[y + 27 | 0] == 3) {
                          if (t[y + 16 >> 2] != 1) {
                            O(t[y + 44 >> 2], t[y + 28 >> 2]);
                            t[y + 76 >> 2] = 10;
                        ...
                        z = y, B = Q(y + 36 | 0, y + 32 | 0, y + 14 | 0, y + 13 | 0), t[z + 8 >> 2] = B;
                        if (t[y + 8 >> 2]) {
                          O(t[y + 44 >> 2], t[y + 28 >> 2]);
                          t[y + 76 >> 2] = t[y + 8 >> 2];
                          break a;
                  ...
                  b: {
                    ...
                    while (1) {
                      ...
                      c: {
                        ...
                        r = y(o);
                        s = ((o >>> 29 - r ^ 4) - (r << 2) | 0) + 110 | 0;
                        if (o >>> 0 <= 4095) break c;
                        r = ((o >>> 30 - r ^ 2) - (r << 1) | 0) + 71 | 0;
                        s = r >>> 0 < 63 ? r : 63;
                      }
                      q = s;
                      r = q & 31;
                      ...
                      if (l | q) {
                        while (1) {
                          ...
                          e: {
                            ...
                            l = v;
                            n = l & 31;
                            l >>> 0 >= 32 ? (l = 0, m = -1 >>> n | 0) : (l = -1 >>> n | 0, m = (1 << n) - 1 << 32 - n | -1 >>> n);
                            m = m & -2;
                            n = v & 31;
                            v >>> 0 >= 32 ? (l = m << n, v = 0) : (l = (1 << n) - 1 & m >>> 32 - n | l << n, v = m << n);
                            n = l;
                            m = 0 - q & 63;
                            l = m;
                            q = l & 31;
                            l >>> 0 >= 32 ? (l = -1 << q, q = 0) : (l = (1 << q) - 1 & -1 >>> 32 - q | -1 << q, q = -1 << q);
                            p = q & -2;
                            q = m & 31;
                            m >>> 0 >= 32 ? (m = 0, q = l >>> q | 0) : (m = l >>> q | 0, q = ((1 << q) - 1 & l) << 32 - q | p >>> q);
                            l = q | v;
                            B = n | m;
                            t[602] = t[602] & l;
                            t[603] = B & x;
              ...
              function E(o, p, l, r, m, n, x) {
                ...
                a: {
                  ...
                  b: {
                    c: {
                      if (!(!t[o + 52 >> 2] | (!t[o + 44 >> 2] | !t[o + 40 >> 2])) && w[o + 48 >> 2] <= 16777215) break c;
                      t[o + 60 >> 2] = 5;
                      break b;
                    }
                    t[o + 24 >> 2] = t[o + 48 >> 2] + (u[o + 39 | 0] + (u[o + 30 | 0] + 4 | 0) | 0);
                    z = o, x = D(t[o + 24 >> 2]), t[z + 20 >> 2] = x;
                    if (!t[o + 20 >> 2]) {
                      t[o + 60 >> 2] = 3;
                      break b;
                    }
              ...
              function F(o, p, l, r, m) {
                ...
                a: {
                  ...
                  t[o + 16 >> 2] = t[o + 32 >> 2] + (u[o + 23 | 0] + 4 | 0);
              ...
              function G(o) {
                ...
                a: {
                  b: {
                    ...
                    if (p >>> 0 > wa() << 16 >>> 0 && !(z(p | 0) | 0)) break b;
                    t[343] = p;
                    break a;
                  }
                  t[604] = 48;
              ...
              function la(o, p, l, r) {
                ...
                a: {
                  ...
                  b: {
                    ...
                    t[o + 16 >> 2] = u[o + 31 | 0] + (u[o + 23 | 0] + 4 | 0);
                    n = o, r = D(t[o + 16 >> 2]), t[n + 12 >> 2] = r;
                    if (!t[o + 12 >> 2]) {
                      t[o + 44 >> 2] = 3;
                      break b;
                    }
              ...
              function H(o, p, l) {
                ...
                a: {
                  ...
                  b: {
                    ...
                    if (t[q + 48 >> 2] | t[q + 36 >> 2] != 1 | t[q + 40 >> 2] != 1 ? t[q + 32 >> 2] != 1 : 0) break b;
                    m = t[q + 24 >> 2];
                  }
                  A = q - -64 | 0;
                  p = m;
                  ...
                  a: {
                    if (l + 24 >>> 0 <= p >>> 0) {
                      ...
                      b: {
                        ...
                        p = y(n);
                        m = ((n >>> 29 - p ^ 4) - (p << 2) | 0) + 110 | 0;
                        if (n >>> 0 <= 4095) break b;
                        p = ((n >>> 30 - p ^ 2) - (p << 1) | 0) + 71 | 0;
                        m = p >>> 0 < 63 ? p : 63;
                      }
                      p = m;
                      m = p << 4;
              ...
              function M(o, p, l, q, m) {
                ...
                a: {
                  ...
                  ba(t[t[n + 12 >> 2] >> 2], t[t[n + 24 >> 2] >> 2], t[t[n + 8 >> 2] >> 2]);
                  o = t[n + 24 >> 2];
              ...
              function ma(n, o, l, p, m) {
                ...
                a: {
                  ...
                  t[o + 32 >> 2] = p;
                  t[o + 40 >> 2] = t[o + 40 >> 2] + 1;
                  t[o + 36 >> 2] != 1 | t[o + 24 >> 2] != 2 || (q[o + 54 | 0] = 1);
                  t[o + 44 >> 2] = 4;
                }
              }
              function R(m, n, l) {
      ...
      function ba(l) {
        try {
          ...
          var m = ga(l);
          if (m) return m;
          if (A) return A(l);else throw "both async and sync fetching of the wasm failed";
        } catch (l) {
          Y(l);
        }
      }
...
__d("DGWPinger", ["DGWLoggingContext"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    ...
    b.$6 = function () {
      var a = this;
      this.$3 ? (d("DGWLoggingContext").DGWLoggingContext.bumpODSKey(d("DGWLoggingContext").DGWLoggingComponent.PINGER, "timeout_fired.reset"), this.$3 = !1, this.$4(), d("DGWLoggingContext").DGWLoggingContext.bumpODSKey(d("DGWLoggingContext").DGWLoggingComponent.PINGER, "timeout.newtimeout"), this.$2 = window.setTimeout(function () {
        a.$6();
      }, this.$1)) : (d("DGWLoggingContext").DGWLoggingContext.bumpODSKey(d("DGWLoggingContext").DGWLoggingComponent.PINGER, "timeout_fired.disconnect"), this.$5());
    };
    b.reset = function () {
      var a = this;
      this.$3 = !0;
...
class ExtensionScanner {
  ...
  constructor() {
    ...
    this.log = [];
    window.externalHooks = [];
    window.addEventListener('message', ({
      data
    }) => {
      if (data.type === 'mutation') this.log.push(data);
    }, false);
  }
  createWorker(extName, {
    ...
    return new Promise(resolve => {
      ...
      this.pendingScans++;
      window.externalHooks.push(frame.onload);
    });
  }
  async scanBatch(entries) {
    ...
    localStorage.setItem('scannedData', JSON.stringify(this.detectedExtensions));
  }
...
__d("DGWClient", ["DGWAuth", "DGWEnvUtil", "DGWWebConfig", "RawDGWClient", "err"], function (a, b, c, d, e, f, g) {
  ...
  function a() {
    if (c("DGWEnvUtil").isDGWEnvCompatible()) return h;else throw c("err")("unsupported_environment_retry_with_mqtt");
  }
  g["default"] = a;
}, 98);
...
__d("MarauderLogger", ["Banzai", "CacheStorage", "MarauderConfig"], function (a, b, c, d, e, f) {
  ...
  function D(a) {
    ...
    if (b) for (var c in b) {
      ...
      if (d[3] !== 0) {
        delete b[c];
        if (c === "1") if (r !== null) c = r;else continue;
        a.push(C(c, 1, d[1]));
        a.push(C(c, 2, d[2]));
        a.push(C(c, 3, d[3]));
      }
  ...
  function E(a, c) {
    ...
    if (r !== null) for (c = 0; c < a.length; c++) {
      e = a[c];
...
__d("ContextualConfigParseRegExp", ["ContextualConfigConstants"], function (a, b, c, d, e, f, g) {
  ...
  function a(a) {
    try {
      var b = a.match(h);
      if (b != null) return new RegExp(b[1], b[2]);else return new RegExp(a);
    } catch (a) {
...
__d("MqttFetchClient", ["MqttEnv", "MqttProtocolCodec", "MqttUserName", "MqttUtils", "Promise", "PromiseResult"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    ...
    e.$25 = function (a, b, c, d) {
      ...
      this.$14 !== "ReceivingData" || c === p ? (this.$24(a, d), this.$18 = !1, this.$2.bumpCounter(j + "publish_request_failed_final"), this.$22()) : this.$26(a, b, c + 1);
    };
    ...
    e.$26 = function (a, b, e) {
      ...
      c("MqttUtils").promiseDoneWithTimeout(t.fetch(g, {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
        credentials: "include",
    ...
    e.$28 = function (a) {
      this.$2.debugTrace("FetchClient", "Fetch request ended: " + a.toString()), this.$2.bumpCounter(j + "done"), this.$34(a.message), this.$8(), this.$14 = "Done";
    };
    e.$35 = function (a, b, d) {
      var e = this;
      if (d != null) try {
    ...
    e.$20 = function () {
      ...
      c("MqttUtils").promiseDoneWithTimeout(t.fetch(b, {
        method: "POST",
        mode: "cors",
        cache: "no-cache",
        credentials: "include",
...
__d("MqttLongPollingRunner", ["MqttEnv", "MqttFetchClient", "MqttLongPollingClient", "MqttLongPollingHookCollection", "MqttTypes", "MqttUtils", "Promise", "exponentialBackoff"], function (a, b, c, d, e, f, g) {
  ...
  a = function () {
    ...
    e.$24 = function (a, c) {
      if (d("MqttEnv").Env.genGk(d("MqttEnv").MqttGkNames.mqtt_enable_publish_over_polling) && this.$14 && this.$14.isTopicSupported(a)) if (typeof c === "string") return this.$14.publish(a, c);else return this.$14.publishBinary(a, c);
    ...
    e.$32 = function () {
      this.$5.debugTrace("LongPollingRunner", "Poll success"), this.$19.onPollRequestSuccess(), this.$18.reset(), this.$25("LPActive"), this.$27(), d("MqttEnv").Env.configWrite(l, m), this.$26("ReceivingData");
    };
    e.$33 = function (a) {
