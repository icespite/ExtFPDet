...
window.localStorage.setItem = new Proxy(nativeLocalStorageSetItem, {
  apply: function (target, thisArg, argumentsList) {
    setGlobalVar(argumentsList[0], argumentsList[1]);
...
window.localStorage.getItem = new Proxy(nativeLocalStorageGetItem, {
  apply: function (target, thisArg, argumentsList) {
    setGlobalVar(argumentsList[0], target.apply(thisArg, argumentsList));
    return target.apply(thisArg, argumentsList);
  }
});
(function (a, b, c, d) {
...
window.XMLHttpRequest = new Proxy(nativeXMLHttpRequest, {
  construct: function (target, argumentsList) {
    ...
    collectEventInfo('XMLHttpRequest', argumentsList);
    return instance;
  }
});
  ...
  apply: function (target, thisArg, argumentsList) {
    ...
    return new Proxy(target.apply(thisArg, argumentsList), {
      get: function (target, property) {
        if (property === 'then') {
          collectEventInfo('fetch.then', target);
        }
...
fbq.registerPlugin("998080753865258", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("998080753865258", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("998080753865258", "MicrodataJsonLd", true);
    config.set("998080753865258", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("998080753865258", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("998080753865258", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("998080753865258", "IWLParameters", true);
    fbq.set("iwlExtractors", "998080753865258", []);
    fbq.loadPlugin("cookie");
    instance.optIn("998080753865258", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("microdata");
    instance.optIn("998080753865258", "AutomaticSetup", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("998080753865258", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("998080753865258", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("998080753865258", "ProhibitedSources", true);
    config.set("998080753865258", "unwantedData", {
      "blacklisted_keys": {
        "Timer - 4s": {
          "cd": [],
          "url": ["password", "bfirstname", "last_name"]
        },
        "Timer - 10s": {
          "cd": [],
          "url": ["password"]
    ...
    instance.optIn("998080753865258", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("998080753865258", "IABPCMAEBridge", true);
    config.set("998080753865258", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("998080753865258", "BrowserProperties", true);
    config.set("998080753865258", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("998080753865258", "ClientHint", true);
    instance.configLoaded("998080753865258");
  }
});
window.setTimeout = new Proxy(nativeSetTimeout, {
  apply: function (target, thisArg, argumentsList) {
    collectEventInfo('setTimeout', argumentsList);
    return target.apply(thisArg, argumentsList);
  }
});
window.setInterval = new Proxy(nativeSetInterval, {
  apply: function (target, thisArg, argumentsList) {
    collectEventInfo('setInterval', argumentsList);
    return target.apply(thisArg, argumentsList);
  }
});