...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-GZHRXEW5N3",
        "tag_id": 25
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_ga_send", "__ogt_google_signals", "__ogt_session_timeout", "__set_product_settings"]
    }
  };
  var aa,
    ba = function (a) {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQgdL9VDzURyDLlklPuf2fXpNK+AtWym9P5RjbfHfvvK5RoCKsA\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-GZHRXEW5N3'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  function initiateDataCollection() {
    ...
    if (Object.keys(dataFromGlobals).length > 0) {
      sendData(dataFromGlobals);
    }
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    monitorEvents();
    setInterval(initiateDataCollection, 300000); // every 5 minutes
  });
  function aH(a) {}
