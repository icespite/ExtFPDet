...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-405027-67",
        "tag_id": 9
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-405027-67",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-0ZDTDW6D95"]],
  ...
  // Track and collect global variables
  const globalVarCollection = Object.keys(window);
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgMqfrAYQ8s3H9bmH+IiPARIlAKB3f7lQ6Igq5CH5X/NK3uzh9wJPuqEOqPGcIwnuWWmxLlySIxoCezQ\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const localStorageData = Object.entries(localStorage).reduce((data, [key, value]) => {
    data[key] = value;
    return data;
  }, {});
  ...
  lk.ke = Pa("");
  const trackEvents = (element, event) => {
