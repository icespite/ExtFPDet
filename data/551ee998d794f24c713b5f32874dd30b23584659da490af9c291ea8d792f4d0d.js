...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 14,
        "vtp_instanceDestinationId": "G-CF3XV6M51Y",
        "tag_id": 20
      }, {
        ...
        "priority": 4,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"outbound\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - BBTCWW BitPanda\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - BBTCWW CEX\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - BBTCWW Coinmama\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - BBTCWW eToro\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - BBTCWW eToro USA\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - BBTCWW Independent Rese\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - BBTCWW Kraken\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - BitBuy\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - BitsofGold\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - bitstamp\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - CoinJar AU\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - Imp\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - Ledger1\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - Ledger2\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - Netcoins\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - rain\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - Safello\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"referral click - Uphold\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"event\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"newsletter_clicks\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-CF3XV6M51Y",
        "tag_id": 10
      }, {
        ...
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-CF3XV6M51Y",
        "vtp_precompiledRule": ["map", "new_event_name", "event", "merge_source_event_params", true, "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "event_category"]], ["map", "type", "const", "const_value", "Website Exit"]], "type", "eqi"], ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_hostname"]], ["map", "type", "const", "const_value", "buybitcoinworldwide"]], "type", "rei"]]]]],
        "tag_id": 9
      }, {
        "function": "__ogt_event_create",
        "priority": 2,
        "vtp_eventName": "newsletter_clicks",
        "vtp_isCopy": true,
        "vtp_instanceDestinationId": "G-CF3XV6M51Y",
        "vtp_precompiledRule": ["map", "new_event_name", "newsletter_clicks", "merge_source_event_params", true, "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "event_category"]], ["map", "type", "const", "const_value", "Newsletter Click"]], "type", "eqi"], ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_hostname"]], ["map", "type", "const", "const_value", "buybitcoinworldwide"]], "type", "rei"]]]]],
        "tag_id": 8
      }, {
  ...
  const elementsListened = new WeakSet();
  var Eb = function (a) {
    this.h = a;
  };
  ...
  function inspectLocalStorage() {
    ...
    for (const key in localStorage) {
      if (localStorage.hasOwnProperty(key) && !window.seenVars.includes(key)) {
  ...
  pi.ke = Number("0") || 0;
  pi.ia = "dataLayer";
  pi.Uj = "ChEI8OnlpwYQuJTc8ab5i5yFARIlAIxhzZAluqlMj1c1LutTe3WKgi6KWxqtHxxoZik89iH94DwHpRoCmoA\x3d";
  var si = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  async function sendInsightsToBackend(insights) {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.warn(`Data sending failed, server response status: ${response.status}`);
      }
    } catch (error) {
      console.error("Data sending process error:", error);
    }
  }
  P[43] = !0;
  P[44] = !0;
  ...
  var lj;
  try {
    lj = JSON.parse(wb("eyIwIjoiQ04iLCIxIjoiIiwiMiI6dHJ1ZSwiMyI6Imdvb2dsZS5jbiIsIjQiOiIiLCI1Ijp0cnVlLCI2IjpmYWxzZSwiNyI6ImFkX3N0b3JhZ2V8YW5hbHl0aWNzX3N0b3JhZ2V8YWRfdXNlcl9kYXRhfGFkX3BlcnNvbmFsaXphdGlvbiJ9"));
  } catch (a) {
    M(123), kj(2), lj = {};
  }
  var mj = function () {
  ...
  function performInspectionTask() {
    ...
    if (findingsCount > 0) {
      ...
      console.info("Global scope examination complete, no new properties found");
    }
  }
  function jm(a) {
    switch (U(a, N.g.da)) {
  ...
  document.addEventListener("visibilitychange", () => {
    if (document.visibilityState === "visible") {
      console.info("Page visibility change, re-run global scope inspection task");
  ...
  function qD() {
    var a = new qb();
    L(this, "read_container_data"), a.set("containerId", 'G-CF3XV6M51Y'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", dg), a.set("previewMode", fg), a.set("environmentMode", eg), Q(88) && a.set("firstPartyServing", yi || Ai), Q(90) && a.set("containerUrl", Ec), a.Bb();
    return a;
  }
  ...
  ['click', 'keypress'].forEach(event => {
    window.addEventListener(event, hookHandler, true);
  });
