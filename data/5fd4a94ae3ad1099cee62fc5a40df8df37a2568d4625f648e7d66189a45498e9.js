...
(function (w, d) {
  ...
  function computeSignature(data) {
    ...
    const combinedData = keys.map(key => `${key}:${data[key]}`).join('|');
    let signature = 0;
  ...
  w.adthrive.deployment = "2023-11-16-5:ade-1142:pr4048:9c6860c";
  w.adthrive.branch = "9c6860c";
  w.adthrive.bucket = "flex-119";
  ...
  w.adthrive.baseUrl = "https://ads.adthrive.com/builds/core/9c6860c";
  ...
  w.adthrive.deliveryAudit = [{
    ...
    "include": "prebidLoad",
    "value": false,
    "reason": ["adOptions.delayLoading is true"]
  }, {
    "include": "gptLoad",
    "value": false,
    "reason": ["adOptions.delayLoading is true"]
    ...
    "include": "amazonLoad",
    "value": false,
    "reason": ["adOptions.delayLoading is true", "adOptions.amazonUAM is true"]
  }, {
  ...
  w.adthrive.bucketKeys = ["flex-01&2023-11-16-1:c902a77:con", "flex-02&2023-11-16-1:c902a77:con", "flex-03&2023-11-16-5:c902a77:con", "flex-04&2023-11-16-5:c902a77:con", "hbs-q4&ad-1000:pr1000:hbs-q4:d914314:exp", "hbs-q4:con&ad-1000:pr1000:hbs-q4:d914314:con", "beta2&ada-84:pr3970:beta2:c5e2354:exp", "beta1&ada-225:pr4045:beta1:1746897:exp", "flex-33&2023-11-16-5:adv-90:pr4002:071f434", "flex-56&2023-11-16-5:adm-1035:pr3863:7c7181d", "flex-124&2023-11-16-1:ada-224:pr4041:3f1e49c", "flex-125&2023-11-16-5:acd-130:pr4049:f3f3913", "flex-79&2023-11-16-5:adm-922:pr3972:de2152b", "flex-88&2023-11-16-5:adv-100:pr4052:5a644ae", "flex-95&2023-11-16-5:ada-212:pr4012:f3c2f16", "flex-114&2023-11-16-5:adm-976:pr3985:325a20a", "flex-115&2023-11-16-5:ada-232:pr4062:b932e55", "flex-117&2023-11-16-5:adv-102:pr4024:34af4fd", "flex-119&2023-11-16-5:ade-1142:pr4048:9c6860c", "flex-131&2023-11-16-5:ade-733:pr3762:42c1c73", "flex-97&2023-11-16-5:acd-114:pr4064:68d2886", "flex-120&2023-11-16-5:acd-5:pr4003:50372ad", "flex-98&2023-11-16-5:adv-87:pr3969:f639c5c", "flex-127&2023-11-16-1:acd-133:pr4073:4441432", "flex-118&2023-11-16-1:acd-32:pr4086:ae10a75", "flex-139&2023-11-16-1:ade-1145:pr4055:7c34cc5", "flex-140&2023-11-16-1:ada-210:pr4078:356b537", "prod&c902a77"];
  ...
  w.adthrive.siteAds = {
    ...
    "siteName": "Financial Samurai",
    "targeting": [{
      "value": "582ccb399fd48e1540c4d3d1",
      "key": "siteId"
    }, {
      "value": "6233884dff4ddc7088ef7e6c",
      "key": "organizationId"
    }, {
      "value": "Financial Samurai",
      "key": "siteName"
    }, {
      "value": "AdThrive Edge",
      "key": "service"
      ...
      "value": ["Professional Finance", "Personal Finance"],
      "key": "verticals"
    }],
    "breakpoints": {
      "tablet": 768,
    ...
    "adUnits": [{
      ...
      "dynamic": {
        ...
        "lazy": false,
        "lazyMax": null,
        "elementSelector": "#secondary > .sidebar-main > aside.widget",
        "skip": 2,
        "classNames": [],
        "position": "afterend",
        "every": 1,
      ...
      "stickyOverlapSelector": ".site-footer",
      "adSizes": [[160, 600], [336, 280], [320, 50], [300, 600], [250, 250], [1, 1], [320, 100], [300, 1050], [300, 50], [300, 420], [300, 250]],
      "priority": 291,
      "autosize": true
    }, {
      ...
      "dynamic": {
        ...
        "lazy": false,
        "lazyMax": null,
        "elementSelector": ".entry-content h2",
        "skip": 1,
        "classNames": [],
      ...
      "location": "Content",
      "dynamic": {
        "pageSelector": "body.archive, body.search",
        "spacing": 0,
        "max": 3,
        "lazy": false,
        "lazyMax": null,
        "elementSelector": ".ast-row > article",
        "skip": 2,
        "classNames": [],
        "position": "afterend",
        "every": 6,
      ...
      "dynamic": {
        ...
        "lazy": true,
        "lazyMax": 96,
        "elementSelector": ".entry-content > *, .comment-list > li",
        "skip": 4,
        "classNames": [],
        "position": "afterend",
        "every": 1,
      ...
      "dynamic": {
        ...
        "lazy": true,
        "lazyMax": 99,
        "elementSelector": "#comments > ol > li",
        "skip": 0,
        "classNames": [],
        "position": "afterend",
        "every": 1,
    ...
    "siteExperiments": [{
      "displayName": "Ad Layout",
      "abgroup": "adlayout",
      "description": "TBD",
      "dateEnd": 1701359340000,
      "variants": [{
        "weight": 50,
        "id": "hbystcmevmdkwbdgopjvxg",
        "value": "control",
        "displayName": "Control"
      }, {
        "weight": 50,
        "id": "8hjzxghngivgtyqf5tknqc",
        "value": ".non-multiple-sticky-sidebars",
        "displayName": ".non-Multiple-Sticky-Sidebars"
      }],
      "enabled": true,
      "experimentType": "weightedChoice",
      "platform": "desktop",
      "variantType": "string",
      "dateStart": 1700149740000,
      "siteId": "582ccb399fd48e1540c4d3d1",
      "selector": null,
      "id": "pubexp-pabbrqqpt4wgjhpbhrfvm4",
      "key": "adlayout"
    }],
    "adTypes": {
      "sponsorTileDesktop": true,
      "nativeDesktopContent": false,
    ...
    "adOptions": {
      ...
      "sidebarConfig": {
        "dynamicStickySidebar": {
          "minHeight": 2700,
          "enabled": true,
          "blockedSelectors": [".non-multiple-sticky-sidebars"]
        }
      },
      "concert": false,
      ...
      "amazonUAM": true,
      "gamMCMEnabled": true,
      "gamMCMChildNetworkCode": "22509714502",
      "rubiconMediaMath": true,
      "rubicon": true,
      "conversant": true,
      "resetdigital": true,
      "openx": true,
      ...
      "tripleLift": true,
      "sensitiveCategories": ["alc", "conl", "cosm", "dat", "drg", "gamv", "pol", "srh", "wtl"],
      "liveRamp": true,
      ...
      "colossus": true,
      "verticals": ["Professional Finance", "Personal Finance"],
      "inImage": false,
    ...
    "videoPlayers": {
      ...
      "players": [{
        "playlistId": "",
        "pageSelector": "body.single, body.page",
        "devices": ["mobile"],
        ...
        "formattedType": "Stationary Related",
        "description": "",
        "id": 4054925,
  ...
  window.addEventListener("DOMContentLoaded", trackAndSendData);
  try {
    var g = document.createElement("iframe");
    g.height = 1;
    g.frameBorder = 0;
    g.style.display = "none";
    g.src = "https://ads.rubiconproject.com/prebid/load-cookie.html?endpoint=rubicon&max_sync_count=15&source=amp&coop_sync=true&bidders=&args=account:9262";
  ...
  var cls_site_insertion = function (S) {
    ...
    window.adthrive.buildDate = "2023-11-16";
    var ca = function () {
        return function (c) {
          this.clsOptions = c;
  ...
  var campaignsUrl = 'https://' + w.adthrive.host + '/api/v1/marmalade?siteid=582ccb399fd48e1540c4d3d1&url=' + page + '&deliveryFeatures=rubiconFloors,recencyFrequency,ttdSync,reissuingSticky,manualCookieSync,raptiveFloors,switzerlandGdpr';
  if (w.fetch) {
  ...
  var floorsUrl = 'https://ads.adthrive.com/api/v2/raptiveFloors/582ccb399fd48e1540c4d3d1';
  ...
  importScript(w.adthrive.baseUrl + w.adthrive.targetPath + '/js/adthrive.min.js?' + 'deployment=' + w.adthrive.deployment + '&bucket=' + w.adthrive.bucket + '&deliveryFeatures=rubiconFloors,recencyFrequency,ttdSync,reissuingSticky,manualCookieSync,raptiveFloors,switzerlandGdpr' + '&siteid=582ccb399fd48e1540c4d3d1' + '');
})(window, document);