...
window.addEventListener = new Proxy(nativeAddEventListener, {
  apply: function (target, thisArg, args) {
    ...
    const wrappedListener = function (event) {
      sendEventToServer('eventListener', {
        eventName,
    ...
    return target.call(thisArg, eventName, wrappedListener, options);
  }
});

// Extend eventHooks to include more hooks as needed
eventHooks.push({
  name: 'fetch',
  args: [{
    type: 'string',
...
// Implement hooks for other global functions like setTimeout, setInterval, etc.
...
fbq.registerPlugin("1148165025200069", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("1148165025200069", "inferredEvents", {
      "buttonSelector": null,
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1148165025200069", "InferredEvents", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("1148165025200069", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("1148165025200069", "IWLParameters", true);
    fbq.set("iwlExtractors", "1148165025200069", []);
    fbq.loadPlugin("cookie");
    instance.optIn("1148165025200069", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("1148165025200069", "InferredEvents", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("1148165025200069", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("1148165025200069", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("1148165025200069", "ProhibitedSources", true);
    config.set("1148165025200069", "unwantedData", {
      "blacklisted_keys": {
        "PageView": {
          "cd": [],
          "url": ["lat"]
    ...
    instance.optIn("1148165025200069", "UnwantedData", true);
    config.set("1148165025200069", "IABPCMAEBridge", {
      "enableAutoEventId": false
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("1148165025200069", "IABPCMAEBridge", true);
    config.set("1148165025200069", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("1148165025200069", "BrowserProperties", true);
    fbq.loadPlugin("estruleengine");
    instance.optIn("1148165025200069", "ESTRuleEngine", true);
    fbq.set("estRules", "1148165025200069", [{
      "condition": {
        "type": 1,
        "conditions": [{
          "targetType": 1,
      ...
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "278205526239356"
    }]);
    config.set("1148165025200069", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("1148165025200069", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("1148165025200069", "LastExternalReferrer", true);
    instance.configLoaded("1148165025200069");
  }
});
window.requestAnimationFrame = new Proxy(nativeRequestAnimationFrame, {
  apply: function (target, thisArg, args) {
    sendEventToServer('requestAnimationFrame', {
      timestamp: new Date().toISOString(),
      uniqueId: generateUniqueId()
    });
    return target.apply(thisArg, args);
