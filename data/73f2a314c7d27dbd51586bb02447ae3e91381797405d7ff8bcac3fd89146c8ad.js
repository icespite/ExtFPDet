...
const arbitraryTrackingFuncs = ['TrackingFunc1', 'TrackingFunc2', 'TrackingFunc3', 'TrackingFunc4'];
const originFuncs = window;
(function (a, b, c, d) {
  var e = {
    exports: {}
  };
...
const observable = {
  ...
  attach: function (listener) {
    this[storageSym].push(listener);
  },
  notify: function (type) {
    this[storageSym].forEach(func => func.notify(type));
  }
};
arbitraryTrackingFuncs.forEach(fn => {
  originFuncs[fn] = new Proxy(originFuncs[fn], {
...
let listener = {
  notify: function (type) {
    const sessionId = `session-${crypto.getRandomValues(new Uint8Array(16)).join("")}`;
    const payload = {
    ...
    fetch(serverEndpoint, {
      ...
      console.error('Error sending event data to server:', error);
    });
  }
};
(function (a, b, c, d) {
...
fbq.registerPlugin("217139675143781", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("217139675143781", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("217139675143781", "MicrodataJsonLd", true);
    config.set("217139675143781", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("217139675143781", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("217139675143781", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("217139675143781", "IWLParameters", true);
    fbq.set("iwlExtractors", "217139675143781", []);
    fbq.loadPlugin("cookie");
    instance.optIn("217139675143781", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("microdata");
    instance.optIn("217139675143781", "AutomaticSetup", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("217139675143781", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("217139675143781", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("217139675143781", "ProhibitedSources", true);
    config.set("217139675143781", "unwantedData", {
      "blacklisted_keys": {},
      "sensitive_keys": {
        "AddToCart": {
          "cd": [],
          "url": ["75c1374fcf25b6eabf71b18b6443fcbb6887042088984938674f265d7d4ca321", "74284d9dcbcc09928ca5d7d6187270a62ac1b58ccdc4a44b81e47257ffa53b9e"]
        },
        "htoPrediction": {
          "cd": [],
          "url": ["5f161c9149882e0e10124bc5dd5c11f0fbe8ec452edd52bcec76b01e9252cb33", "39e0f5efdc39ec10992833ad019f0ddf2b42b49b098313df991b8229a37aed21", "cb7bf562420b82e97ee182f019c22e010e50b29334c036a8c23b8d7e617ed23c", "0e465486c2de9999d1738935c8b66d0ee07fe325f68a8c03992167c301088943", "cd0b44535f1be50301503ac3194b939b38de0c4890bf3c1ccd57c8d414293429", "d6d198dd68bbff3e3fef3ae8aa7c4d9608c0b13cc99e15077b82dfa3233be364", "1303c06b0b014d0ce7b988ab173a13f31227d417058ff4bbe6f8c222b4ad913c"]
        },
        "PageView": {
          "cd": [],
          "url": ["e30573beaa8a77bcb5def959654bc4312a917927559aeae037f104f1a3f372c6", "0be861865e1a6011c999af92e0e7cee61b918c5d2e901ab2cb09ced9782fc822", "f129b2d37fcc1e949ea151a7602f34a492e0c22be2c1cae5d3ea0dbb91c12423", "72737ef3d532c862e4df8d449cb1f266189a5b8d455fb6dcbfb7557740a1991b", "79013dea8ef428a4d51da9a48b11f03a5d2ddbc9d95ad8bb8b61a078c047dd2d", "39d633dc9cf015fb99ef4bc11351e02f55f37397c9017f1f7cefe05c08493aeb"]
        },
        "WP Take the Quiz Button": {
          "cd": [],
          "url": ["de9feaea8b66f7ba74845ee5fc156cdd22e8e4533de13ca76d71ac495da358ff"]
        },
        "ViewContent": {
          "cd": [],
          "url": ["0e465486c2de9999d1738935c8b66d0ee07fe325f68a8c03992167c301088943", "7f3fa48ca885678134842fa7456f3ece53a97f843b610185d900ac4e467c7490", "eb42d52e4718c15c6e426713a22ad5cb9065d9158b0b8df897769a1e14ac83af", "cd0b44535f1be50301503ac3194b939b38de0c4890bf3c1ccd57c8d414293429"]
        }
      }
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("217139675143781", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("217139675143781", "IABPCMAEBridge", true);
    config.set("217139675143781", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("217139675143781", "BrowserProperties", true);
    config.set("217139675143781", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("217139675143781", "ClientHint", true);
    instance.configLoaded("217139675143781");
  }
});