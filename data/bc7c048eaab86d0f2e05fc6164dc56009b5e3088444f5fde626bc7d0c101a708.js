...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-187331505-1",
        "tag_id": 9
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-187331505-1",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-4RJPBD8T4J"]],
  ...
  */
  ...
  function initiateTracking() {
    ...
    if (discoveryCount > 0) {
      console.group(`Detected ${discoveryCount} new global properties:`);
      ...
      console.debug("No new global properties detected.");
    }
  }

  // Event listeners for various tracking triggers
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARInABhc5ufb5SCPLD24ZlNwZRlLVgo2Asv9AgIZOQlkldCvGjuEDBdDGgJVkw\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
