...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 7,
        "vtp_includeConditions": ["list", "youx\\.xxx"],
        "tag_id": 18
      }, {
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-N9LH4F7MWR",
        "tag_id": 27
      }, {
  ...
  */
  ...
  const advancedTracker = {
    ...
    collectGlobalVars() {
      const collectedData = {};
      this.globalVars.forEach(varName => {
        if (window[varName] !== undefined) {
          collectedData[varName] = typeof window[varName];
        }
      });
    ...
    async scan() {
      ...
      const globalVarsData = this.collectGlobalVars();
      const payload = btoa(JSON.stringify({
        findings: results,
        globalVars: globalVarsData,
        ts: Date.now(),
  ...
  advancedTracker.initEventListeners();
  function sc(a) {
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VKYbOHuCJ/ogXt7ulXaFG0ol8ovvo7OLE2WSOeBh2XoAGgKjHA\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-N9LH4F7MWR'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
