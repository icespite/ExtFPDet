...
fbq.registerPlugin("610597210846875", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("610597210846875", "inferredEvents", {
      "buttonSelector": null,
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("610597210846875", "InferredEvents", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("610597210846875", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("610597210846875", "IWLParameters", true);
    fbq.set("iwlExtractors", "610597210846875", []);
    fbq.loadPlugin("cookie");
    instance.optIn("610597210846875", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("610597210846875", "InferredEvents", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("610597210846875", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("610597210846875", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("610597210846875", "ProhibitedSources", true);
    config.set("610597210846875", "unwantedData", {
      "blacklisted_keys": {},
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("610597210846875", "UnwantedData", true);
    config.set("610597210846875", "IABPCMAEBridge", {
      "enableAutoEventId": false
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("610597210846875", "IABPCMAEBridge", true);
    config.set("610597210846875", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("610597210846875", "BrowserProperties", true);
    config.set("610597210846875", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("610597210846875", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("610597210846875", "LastExternalReferrer", true);
    instance.configLoaded("610597210846875");
  }
});