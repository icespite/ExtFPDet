...
(function () {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLvcqgYQuqbl1cDT0urCARImAFgXOW4jcRRqbVcLSebiETGjZFHThG3a3JJhTTp7BjjycZK4KQsaAkVn";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'UA-10307238-1'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
