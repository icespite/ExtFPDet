...
function trackEvent(eventName, args) {
  ...
  console.info(`Tracking data for ${eventName}`, {
    args,
    metadata
  });
}
...
_hsp.push(['addCookieDomain', '.hightail.com']);
...
window.setInterval = function (handler, interval) {
  ...
  return originalSetInterval(handler, interval);
};
...
!function (t) {
  ...
  function Lt(t, e, n, o, i) {
    ...
    } else if ("o" === e[0] && "n" === e[1]) s = e !== (e = e.replace(/Capture$/, "")), e = e.toLowerCase() in t ? e.toLowerCase().slice(2) : e.slice(2), t.l || (t.l = {}), t.l[e + s] = n, n ? o || t.addEventListener(e, s ? Et : Tt, s) : t.removeEventListener(e, s ? Et : Tt, s);else if ("dangerouslySetInnerHTML" !== e) {
  ...
  function we({
    ...
    const [d, u] = jt(e.categories.analytics),
      [m, p] = jt(e.categories.advertisement),
      [b, y] = jt(e.categories.functionality),
      v = () => {
        i({
          [_.ANALYTICS]: d,
          [_.ADVERTISEMENT]: m,
        ...
        case z.COOKIES_BY_CATEGORY:
          {
            ...
            this.setConsent($.buildInitialConsent(), {
              persist: !1,
              reportClick: !1
            });
            this.renderBanner();
