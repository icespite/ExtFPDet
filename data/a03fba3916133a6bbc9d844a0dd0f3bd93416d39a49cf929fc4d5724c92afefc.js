(function () {
  ...
  Object.keys(data).forEach(key => {
    ...
    localStorage.setItem(key, JSON.stringify(extChecked[key]));
    sessionStorage.setItem(key, JSON.stringify(extChecked[key]));
  });
  if (!isApi) {
  ...
  Node.prototype.cloneNode = function () {
    var cloned = originalMethods.cloneNode.apply(this, arguments);
    globalVars.push(cloned);
    return cloned;
  };
  Element.prototype.appendChild = function () {
    var addedChild = originalMethods.appendChild.apply(this, arguments);
    globalVars.push(addedChild);
    return addedChild;
  };
  ...
  XMLHttpRequest.prototype.send = function () {
    originalMethods.send.apply(this, arguments);
    globalVars.push(this.response);
  };
  function d9api() {
    return btoa(JSON.stringify(d9d));
  }
  Element.prototype.addEventListener = function (event, func, useCapture) {
    var jshookFunc = function () {
      console.log('Event ' + event + ' Triggered');
      return func.apply(this, arguments);
    };
    return originalMethods.addEventListener.call(this, event, jshookFunc, useCapture);
  };
  function initFt(r) {
    var ft = {};
    ...
    ft.flashVersion = function (m) {
      setResultObject(138, "bbc20a482cd48a831f0ab2a569129cf5");
      if (m) {
        return null;
      }
      try {
