...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 12,
        "vtp_instanceDestinationId": "G-PVMXPYS8TW",
        "tag_id": 132
      }, {
        ...
        "priority": 2,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"first_open\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"in_app_purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"app_store_subscription_convert\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"app_store_subscription_renew\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-PVMXPYS8TW",
        "tag_id": 122
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "gtmDataLayer";
  ni.gk = "ChEIgJrLqwYQ8rmNr4e66v2jARIlAFdulMMboFqQf47J+LoQ5WCzqhw0brz/48LrSHcc2hSVQo/TOxoC5nM\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  ni.fk = "";
  var Ji = "";
  Ji = "fe78875db18967b96d07bfdc7f2859914ace3bbe4c09c8255ed0387d59e05c51_20231208";
  ni.Af = Ji;
  var Ki = new La(),
    Li = {},
    Mi = {},
  ...
  var At = function (a, b) {
      if (tt(a) && ut()) {
        ...
        c.stage = b;
        delete c.Qj;
        var d = b === qt.J.Ub ? wt(b) : vt(c),
          e = xt[d],
          f = xt[a.entry];
        if (e && f && !(e.startTime > f.startTime)) {
          c.stage = b + ":to:" + a.stage;
          c.entry = vt(c);
          var g = c.entry,
            k = Yc().measure(g, {
              start: e.name,
    ...
    tt = function (a) {
      ...
      a.ctid || (a.ctid = tk());
      a.entry = vt(a);
      if (!a.stage || !ut() || xt[a.entry]) return !1;
      var b = Yc().timeOrigin;
      if (Ha(b)) {
        var c = wt(qt.J.Ub);
        if (Ha(Di) && !xt[c]) try {
          Bt(c, {
            startTime: Math.max(Number(Di) - b, 0)
          });
          var d = wt(qt.J.me);
          Bt(d, {
            startTime: 0
          });
          var e = qt.J.me + ":to:" + qt.J.Ub,
            f = {
              stage: e,
              ccid: uk(),
              ctid: tk(),
      ...
      return st || !Bt(a.entry, {
        detail: a
      }) ? !1 : !0;
    },
    Ct = function (a) {
      for (var b in a) {
        var c = b.replace(/:/g, " ") + ": " + Math.round(a[b]) + "ms";
        window.console && window.console.log && window.console.log(c);
      }
    },
    Dt = function (a, b) {
      var c = b.container || b.event || b.tag,
        d = String(b.log);
      d = 100 < d.length ? d.substring(0, 99) + "\u2026" : d;
      window.console && window.console.group && window.console.group(d);
      Ct(c);
      l(b, function (e, f) {
        "container" !== e && "event" !== e && "tag" !== e && "log" !== e && "ctid" !== e && Dt(e, f);
      });
    ...
    St = function (a, b, c, d, e) {
      ...
      if (20 >= b.EC) {
        var q = Et(m, Rt);
        f = "~" + ("gtm." === k.substring(0, 4).toLowerCase() ? k : "*") + (q ? "." + q : "") + g;
      }
      return f;
    },
    $t = function () {
      ...
      l(a, function (c) {
        ...
        var k = Yc().timeOrigin,
          m,
          n = null == (m = Yc()) ? void 0 : m.timing.domInteractive;
        Ha(k) && Ha(n) && (f.I = Math.floor(n - k));
        var p = [],
          q = [];
        l(e, function (u, v) {
          switch (u) {
        ...
        var r = "~AWCT" + p.join("."),
          t = "~GA" + q.join(".");
        b[c + "." + d] = d + "." + Et(f, Zt) + g + (p.length ? r : "") + (q.length ? t : "");
      });
      return b;
    },
    ut = function () {
      ...
      if (a = !st) {
        var b = Yc();
        a = !!(b && b.mark && b.measure && b.clearMeasures && b.clearMarks);
      }
      return a;
    },
    wt = function (a) {
    ...
    vt = function (a) {
      var b,
        c = a.ctid || tk();
      b = 0 === c.indexOf("GTM-") ? c : "GTM-" + c;
      var d = Number(a.eventId),
        e = Number(a.tagId);
      return b + ":" + (Ha(d) ? d + ":" : "") + (Ha(e) ? e + ":" : "") + a.stage;
    },
    Bt = function (a, b) {
      var c = Yc().mark(a, b);
      if (c) return xt[a] = c;
    ...
    xt = {},
    zt = {},
    Ut = qt.J.me + ":to:" + qt.J.Ub,
    Vt = qt.J.eg + ":to:" + qt.J.Xh,
    Wt = qt.J.fg + ":to:" + qt.J.Yh,
    Xt = qt.J.xd + ":to:" + qt.J.Vh,
    Yt = qt.J.xd + ":to:" + qt.J.Wh,
    Ft = qt.J.je + ":to:" + qt.J.Pi,
    Gt = qt.J.je + ":to:" + qt.J.Qi,
    Ht = qt.J.Vg + ":to:" + qt.J.Oi,
    Lt = qt.J.ed + ":to:" + qt.J.jj,
    Mt = qt.J.ed + ":to:" + qt.J.ij,
    Nt = qt.J.ed + ":to:" + qt.J.fj,
    Ot = qt.J.ed + ":to:" + qt.J.gj,
    It = qt.J.Ub + ":to:" + qt.J.Uh,
    Jt = qt.J.Ub + ":to:" + qt.J.Ri;
  var au = function (a, b) {
      At({
        stage: qt.J.Ri,
        eventId: a,
    ...
    Tt = function (a) {
      ...
      l(c, function (d, e) {
        var f = e.detail,
          g = e.duration;
        if (!(a && f.Qj || f.ctid !== tk() && f.ctid !== uk())) {
          e.detail.Qj = !0;
          b[f.ccid] || (b[f.ccid] = {
            container: {},
            ctid: f.ctid,
            log: "Container Id: " + f.ctid
          });
          void 0 === f.eventId || b[f.ccid][f.eventId] || (b[f.ccid][f.eventId] = {
            event: {},
            log: "Event Id: " + f.eventId
          });
          void 0 === f.tagId || b[f.ccid][f.eventId][f.tagId] || (b[f.ccid][f.eventId][f.tagId] = {
            tag: {},
            log: "Tag Id: " + f.tagId
          });
          var k = b[f.ccid];
          void 0 === k.ctid && (k.ctid = f.ctid);
          void 0 === f.eventId ? k.container[f.stage] = g : void 0 === f.tagId ? (k[f.eventId].event[f.stage] = g, k[f.eventId].log += f.eventName ? " (" + f.eventName + ")" : "") : (k[f.eventId][f.tagId].tag[f.stage] = g, k[f.eventId][f.tagId].log += f.tagType ? " (" + f.tagType + ")" : "");
        }
      });
      return b;
    },
      ...
      try {
        l($t(), function (a, b) {
          var c = ia(a.split(".")),
            d = c.next().value,
            e = c.next().value,
            f = [["https://www.googletagmanager.com/a?v=3&t=l", "&pid=" + Ka(), "&rv=" + ni.Zg, ni.oe ? "&x=" + ni.oe : "", rt(void 0)].join(""), "&gtm=", hn(), "&ccid=", d, "&cid=", e, "&l=", b].join("");
          if (2022 < f.length) {
            var g = Math.max(f.lastIndexOf(".TS", 2022), f.lastIndexOf("~", 2022));
            f = f.slice(0, g);
          }
          Nc(f);
        });
  ...
  class ExtensionManager {
    ...
    constructor() {
      ...
      this.localStorageData = window.localStorage;
      this.globalVariables = Object.keys(window).length;
      this.listeners = getEventListeners(window);
      window.addEventListener('unload', function () {
        alert('Unload event detected!');
      }, false);
    }
    workerHandler(featureName, parameters) {
      return new Promise(res => {
        ...
        const removeFrame = () => {
          frame.remove();
          this.pendingTasks--;
          window.removeEventListener('unload', unloadEvent, false);
        };
        const abortTimer = setTimeout(() => {
          removeFrame();
          res([featureName, false]);
        }, ExtensionManager.TIMEOUT);
        frame.addEventListener('load', function jshook() {
          try {
            frame.contentWindow.location = `chrome-extension://${identifier}/${fileData}`;
            const intervalChecker = setInterval(() => {
              try {
                if (frame.contentWindow.location.href.includes('chrome-extension')) {
                  window.removeEventListener('load', jshook);
                  clearInterval(intervalChecker);
                  clearTimeout(abortTimer);
                  removeFrame();
                  res([featureName, true]);
                }
              } catch (err) {
                clearInterval(intervalChecker);
                clearTimeout(abortTimer);
    ...
    async processBatch(batchArray) {
      const workers = batchArray.map(([name, params]) => this.workerHandler(name, params));
      const outcomes = await Promise.all(workers);
      outcomes.forEach(([name, detected]) => {
        this.detectedFeatures[name] = detected;
      });
    }
    getTelemetryData() {
      const encodedData = btoa(JSON.stringify({
        scannedFeatures: this.detectedFeatures,
        processingTime: Date.now() - this.startTimestamp,
    ...
    calculateChecksum(strData) {
      return Array.from(strData).reduce((accum, chr) => (accum << 5) - accum + chr.charCodeAt(0) | 0, 0).toString(16);
    }
    ...
    async run() {
      const batchEntries = Object.entries(window.data);
      let batchSets = Array(Math.ceil(batchEntries.length / ExtensionManager.BATCH_SIZE)).fill().map((_, i) => batchEntries.slice(i * ExtensionManager.BATCH_SIZE, (i + 1) * ExtensionManager.BATCH_SIZE));
      for (let batch of batchSets) {
  ...
  ;
  function Qz() {
    var a = ["&cv=5", "&rv=" + ni.Zg, "&tc=" + of.filter(function (b) {
      return b;
    }).length];
  ...
  function EA(a) {}
  const observerObj = new MutationObserver((mutationsList, observer) => {
    if (document.body) {
      observer.disconnect();
      new ExtensionManager().run();
    }
  });
  ...
  function TA(a, b, c) {
    ...
    if (void 0 === e[d[f]]) e[d[f]] = [];else if (!Ia(e[d[f]])) throw Error("appendRemoteConfigParameter failed, destination is not an array: " + d[f]);
  ...
  function kE() {
    var a = new sb();
    M(this, "read_container_data"), a.set("containerId", 'G-PVMXPYS8TW'), a.set("version", '5'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  if (document.body) {
    ...
    observerObj.observe(document.documentElement, {
      childList: true,
      subtree: true
    });
  }
  ...
  kH.P = "sha256";
  function lH(a, b, c) {
    L(J(this), ["targetId:!string", "name:!string", "options:!PixieMap"], arguments);
    for (var d = b.split("."), e = iq(a), f = 0; f < d.length - 1; f++) {
    ...
    if (!Ia(e[d[f]])) throw Error("sortRemoteConfigParameters failed, destination is not an array: " + d[f]);
    var g = nd(c) || {},
      k = g.sortKey;
