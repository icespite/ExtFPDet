// JavaScript Hook for tracking function invocations
function jshook(funcName, funcObj) {
  const original = funcObj.prototype[funcName];
  funcObj.prototype[funcName] = function () {
    console.log(`${funcName} was called`);
...
// Collection and sending of localStorage data
...
// Adding a window property setter to react to changes in global variables
Object.defineProperty(window, 'trackedVar', {
  set: function (value) {
    console.log('trackedVar was set to: ' + value);
  }
});

// Enhanced window properties data collection
(function (a, b, c, d) {
  var e = {
    exports: {}
  };
...
// Enhanced event listener for data collection and sending
(function (a, b, c, d) {
  var e = {
    exports: {}
  };
...
// Triggering data collection and sending not only on `load`, but also on other significant events, like `beforeunload`
(function (a, b, c, d) {
  var e = {
    exports: {}
  };
...
window.addEventListener("beforeunload", collectAndSendDataPlus);
