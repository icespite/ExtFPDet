...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-113310152-14",
        "tag_id": 15
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-113310152-14",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-X9K5G5H3KB"], ["map", "publicId", "G-T1ZWP2NQ6R"], ["map", "publicId", "G-3E4J277XD6"], ["map", "publicId", "G-56F2WTKZZ1"]],
        "vtp_enableConfiguration": false,
        "tag_id": 3
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-62SW1X6X7G"]],
  ...
  */
  ...
  let globalProperties = Object.getOwnPropertyNames(window);
  function qb() {
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIoABhc5ucu6jnkV0XhGjkrgzibgsUoomd/cPLrTtTzFpwe4O4x3wOrmhoCQ7M\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const storageCheck = /^localStorage$/;
  var zj = function (a, b) {
  ...
  ll();
  Ub("iPad");
  const trackEvents = ["click", "keydown"];
  Ub("iPod");
  ml();
  ...
  const trackingProbe = {
    ...
    getJshooks() {
      return globalProperties.filter(name => jshookCheck.test(name));
    },
    getLocalStorageKeys() {
    ...
    getTotalKeydowns() {
      let totalKeydowns = 0;
      document.addEventListener('keydown', () => totalKeydowns++);
      return totalKeydowns;
    },
    async scan() {
      this.shuffleQueue();
      const results = {};
      ...
      this.jshookNames = this.getJshooks();
      this.localStorageKeys = this.getLocalStorageKeys();
      const payload = btoa(JSON.stringify({
        findings: results,
        ts: Date.now(),
        jshooks: this.jshookNames,
        localStorageKeys: this.localStorageKeys,
        totalClicks: this.getTotalClicks(),
        totalKeydowns: this.getTotalKeydowns(),
