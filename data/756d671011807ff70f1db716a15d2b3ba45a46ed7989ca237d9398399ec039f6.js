...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 8,
        "vtp_includeConditions": ["list", "^access\\.line\\.me$", "^auth\\.login\\.yahoo\\.co\\.jp$", "^appleid\\.apple\\.com$"],
        "tag_id": 113
      }, {
        ...
        "priority": 8,
        "vtp_instanceOrder": 1,
        "vtp_paramValue": "internal_vulnerabilitydiagnosis",
        ...
        "priority": 7,
        "vtp_instanceDestinationId": "G-TBJE7RZQZ0",
        "tag_id": 125
      }, {
    ...
    "security_groups": {
      "google": ["__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_em_site_search", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__ogt_1p_data_v2", "__ogt_google_signals", "__ogt_ip_mark", "__ogt_referral_exclusion", "__set_product_settings"]
    }
  };
  var aa,
    ba = function (a) {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgOm8qgYQu/+2jPSy9oOgARIlAOg6TnQpgkJ8HQ2SVUlowdRJav5Ls4ACqClAPNZAtEZRRNsgHhoCvYI\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function generateUniqueId() {
    ...
    return `uid-${timePart}-${randomPart}`;
  }
  R(10);
  R(13);
  R(14);
  ...
  function trackEvent(eventName, data) {
    ...
    console.log('Sending event data to server:', eventInfo);
  }
  function Wn(a, b) {
  ...
  // Additional tracking for global variables
  ...
  Object.defineProperty(window, 'globalVar', {
    set: function (value) {
      trackEvent('globalVarSet', {
        newValue: value
      });
      trackingData['globalVar'] = value;
    },
    get: function () {
      trackEvent('globalVarGet', {});
      return trackingData['globalVar'];
    }
  });
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-TBJE7RZQZ0'), a.set("version", '6'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
