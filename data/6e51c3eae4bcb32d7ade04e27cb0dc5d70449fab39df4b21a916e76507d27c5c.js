...
$(document).ready(function () {
  ...
  if (pathname === '/') {
    $(".review-homepage-section__title").after("<center><p style='font-size: 12px;font-family:Raleway;font-weight: 500; color: #848484; margin-bottom: 0px;'> supported by</p><img src='https://preview-kly.akamaized.net/fimela/product-review/brands/sidomuncul-natural-logo-rev1.png' width='20%' style='margin-bottom:20px; object-fit: cover; width: 180px; height: 90px;' /></center>");
  } else if (pageType === 'Review Page') {
    $(".review-breadcrumb").after("<center><p style='font-size: 12px;font-family:Raleway;font-weight: 500; color: #848484; margin-bottom: 0px;'> supported by</p><img src='https://preview-kly.akamaized.net/fimela/product-review/brands/sidomuncul-natural-logo-rev1.png' width='20%' style='margin-bottom:0px; object-fit: cover; width: 180px; height: 90px;' /></center>");
  } else if (pathname === '/product-review') {
    $(".review-index__title").after("<center><p style='font-size: 12px;font-family:Raleway;font-weight: 500; color: #848484; margin-bottom: 0px;'> supported by</p><img src='https://preview-kly.akamaized.net/fimela/product-review/brands/sidomuncul-natural-logo-rev1.png' width='20%' style='margin-bottom:7px; object-fit: cover; width: 180px; height: 90px;' /></center>");
  }
});
...
function handleCredentialResponse(response) {
  $.post('https://www.staging.fimela.com/auth/google/tapin', {
    ...
    if (data.status === 'success') {
      data.redirect !== undefined ? window.location.replace(data.redirect) : window.location.reload();
    }
  });
}
function getCsrf() {
        ...
        const formInput = {
          do: function () {
            ...
            if ($('.review-form__form-input--select-brand').attr('id') === 'input-brand') {
              ...
              formInput.autocomplete(document.querySelector("input[id='input-brand']"), listBrand);
            }
