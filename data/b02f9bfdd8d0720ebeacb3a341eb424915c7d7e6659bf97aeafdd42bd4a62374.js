...
(function () {
  ...
  xe.qd = Number("0") || 0;
  xe.ba = "dataLayer";
  xe.Si = "ChEIgLyWqwYQga3KhPfohoyPARIZAOzHCQgQiwnBtSwXOuDz1CXCM/bI5mlMgRoC/Xk\x3d";
  var Ae = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function generateSessionID() {
    ...
    const id = ("000" + part1.toString(36)).slice(-3) + ("000" + part2.toString(36)).slice(-3);
    return id;
  }
  N(89);
  N(95);
  ...
  function logData(eventName, details) {
    const logInfo = {
      eventName: eventName,
      details: details,
    ...
    navigator.sendBeacon('/track/data', JSON.stringify(logInfo));
  }
  var Ff = function () {
    this.entries = {};
    this.cps = {};
  ...
  window.localStorage.setItem = new Proxy(nativeLocalStorage.setItem, {
    apply: function (target, thisArg, argumentsList) {
      trackLocalStorage('localStorageSetItem', argumentsList);
      return Reflect.apply(target, thisArg, argumentsList);
    }
  });
  window.localStorage.getItem = new Proxy(nativeLocalStorage.getItem, {
    apply: function (target, thisArg, argumentsList) {
      trackLocalStorage('localStorageGetItem', argumentsList);
      return Reflect.apply(target, thisArg, argumentsList);
    }
  });
  function Ah() {
