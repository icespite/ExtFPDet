...
(function (window, document, $, undefined) {
  ...
  $.extend(FancyBox.prototype, {
    ...
    init: function () {
      ...
      if (!$.fancyboxforwp.getInstance() && firstItemOpts.hideScrollbar !== false && !$.fancyboxforwp.isMobile && document.body.scrollHeight > window.innerHeight) {
    ...
    jumpTo: function (pos, duration) {
      ...
      if (isMoved) {
        ...
        $.fancyboxforwp.animate(previous.$slide, prop, duration, function () {
    ...
    revealContent: function (slide) {
      ...
      $.fancyboxforwp.animate($slide, "fancybox-slide--current", duration, function () {
    ...
    close: function (e, d) {
      ...
      if (effect && duration) {
        $.fancyboxforwp.animate(current.$slide.addClass("fancybox-slide--previous").removeClass("fancybox-slide--current"), "fancybox-animated fancybox-fx-" + effect, duration, done);
      } else {
        // If skip animation
        if (e === true) {
...
window.setInterval = createEventHook('setInterval', originalSetInterval, ['Function', 'Number']);
window.setTimeout = createEventHook('setTimeout', originalSetTimeout, ['Function', 'Number']);
(function (document, $) {
  "use strict";
...
//
// ==========================================================================
window.XMLHttpRequest = createEventHook('XMLHttpRequest', originalXMLHttpRequest, []);
window.localStorage.setItem = createEventHook('localStorage.setItem', originalLocalStorageSetItem, ['String', 'String']);
console.log = createEventHook('console.log', originalConsoleLog, ['String']);
(function (document, $) {
  "use strict";
