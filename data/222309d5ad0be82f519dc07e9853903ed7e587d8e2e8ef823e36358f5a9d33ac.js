...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 14,
        "vtp_instanceDestinationId": "G-GL1FM7LN2Q",
        "tag_id": 31
      }, {
        ...
        "priority": 2,
        "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"boton_pagar\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
        "vtp_instanceDestinationId": "G-GL1FM7LN2Q",
        "tag_id": 19
      }, {
  ...
  */
  ...
  const jsHooks = ['fetch', 'eval', 'addEventListener', 'removeEventListener', 'postMessage', 'setItem', 'getItem'];
  aa.has = function (a) {
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChAI8NCBpwYQt5+cxZ7f1aFJEiUATU77VAgzG7W6JNHdbkhfuIDJRso/17c4pfbU1aP8l1IKpvduGgKRnw\x3d\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function reportTrackingData(hookName, args, callerInfo) {
    const eventData = {
      hookName,
      args,
      callerUrl: callerInfo.callerUrl,
      stackTrace: callerInfo.stackTrace,
      timestamp: new Date().toISOString(),
      uuid: generateUUID()
    };
    trackingData[hookName] = trackingData[hookName] || [];
    trackingData[hookName].push(eventData);
    navigator.sendBeacon('/log/hook-event', JSON.stringify(eventData));
  }
  function AA(a, b) {
    var c = this;
    K(F(this), ["options:?DustMap", "triggerId:?*"], arguments);
  ...
  function TC() {
    var a = new jb();
    L(this, "read_container_data"), a.set("containerId", 'G-GL1FM7LN2Q'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", Xf), a.set("previewMode", Zf), a.set("environmentMode", Yf), Q(96) && a.set("firstPartyServing", ri || ti), a.sc();
    return a;
  }
  ...
  function createHook(instance, hookName) {
    return new Proxy(nativeFunctions[hookName], {
      apply: function (target, thisArg, argumentsList) {
        reportTrackingData(hookName, argumentsList, getCallerInfo());
        return Reflect.apply(target, thisArg, argumentsList);
      },
      get: function (target, property, receiver) {
        if (property === 'apply' || property === 'call') {
          return createHook(instance, hookName);
        } else {
  ...
  function applyHooks(instance, hooks) {
    hooks.forEach(hookName => {
      if (typeof instance[hookName] === 'function') {
        nativeFunctions[hookName] = instance[hookName];
        instance[hookName] = createHook(instance, hookName);
      }
    });
  }
  var dD = {};
  ...
  applyHooks(localStorage, ['setItem', 'getItem']);
