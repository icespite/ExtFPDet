...
fbq.registerPlugin("1844996479099441", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("1844996479099441", "inferredEvents", {
      "buttonSelector": "extended",
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1844996479099441", "InferredEvents", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("1844996479099441", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("1844996479099441", "IWLParameters", true);
    fbq.set("iwlExtractors", "1844996479099441", []);
    fbq.loadPlugin("cookie");
    instance.optIn("1844996479099441", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("1844996479099441", "InferredEvents", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("1844996479099441", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("1844996479099441", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("1844996479099441", "ProhibitedSources", true);
    config.set("1844996479099441", "unwantedData", {
      "blacklisted_keys": {
        "PageView": {
          "cd": [],
          "url": ["eml", "EML", "lat"]
      ...
      "sensitive_keys": {
        ...
        "PageView": {
          "cd": [],
          "url": ["72dfcfb0c470ac255cde83fb8fe38de8a128188e03ea5ba5b2a93adbea1062fa", "043a718774c572bd8a25adbeb1bfcd5c0256ae11cecf9f9c3f925d0e52beaf89"]
        },
        "ViewContent": {
          "cd": ["9a52318eac53daf2702e6fb0070c35beb9b66288d32dfabb9adba2cdbc549565"],
          "url": ["f6c80f39edacded53548b613373490ed28b585223cb965a0a2a36a0edc55c7e2", "043a718774c572bd8a25adbeb1bfcd5c0256ae11cecf9f9c3f925d0e52beaf89", "bc3f2697597bc4d8717c15d0bada9bcf5ac2c24c43a454956eade1dfa18bf299", "e383665f2877c7e628273ee0cf89b32318636e81946c87594970939b2fa82fa6", "f933812ac2c8f3d528525b24828a1669457bba37c7c1a7941a80c4ef98cfbaec", "24e74c5301a3b0e458b8b67987cd37b42bc68335b3d7b8c278830d2ba5b8abbe", "8f84b89bdc2aa18af73a15328a4761e8d8505100028f2224dd06cef0111c961b", "abd7ecbf1c3e160597ffd8bf7ca40c9a60e2e4c9da28cab9e3616ff9415f485c"]
        }
      }
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("1844996479099441", "UnwantedData", true);
    config.set("1844996479099441", "IABPCMAEBridge", {
      "enableAutoEventId": false
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("1844996479099441", "IABPCMAEBridge", true);
    config.set("1844996479099441", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("1844996479099441", "BrowserProperties", true);
    fbq.loadPlugin("estruleengine");
    instance.optIn("1844996479099441", "ESTRuleEngine", true);
    fbq.set("estRules", "1844996479099441", [{
      "condition": {
        "type": 1,
        "conditions": [{
          "targetType": 1,
      ...
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "428926011130886"
    }]);
    config.set("1844996479099441", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("1844996479099441", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("1844996479099441", "LastExternalReferrer", true);
    instance.configLoaded("1844996479099441");
  }
});
