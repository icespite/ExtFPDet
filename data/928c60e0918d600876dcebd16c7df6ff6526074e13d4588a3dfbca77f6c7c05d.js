    ...
    args[1] = function (event) {
      if (listener) {
        ...
        const payload = {
          ...
          metadata,
          eventListeners: window.eventListeners || "none"
        };
        sendEventPayload(payload);
...
window.setTimeout = createEventWrapper('setTimeout', originalSetTimeout, ['Function', 'Number']);
window.setInterval = createEventWrapper('setInterval', originalSetInterval, ['Function', 'Number']);
fbq.registerPlugin("392493621308469", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("392493621308469", "inferredEvents", {
      "buttonSelector": "extended",
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("392493621308469", "InferredEvents", true);
    config.set("392493621308469", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("392493621308469", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("392493621308469", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("392493621308469", "IWLParameters", true);
    fbq.set("iwlExtractors", "392493621308469", []);
    fbq.loadPlugin("cookie");
    instance.optIn("392493621308469", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("392493621308469", "InferredEvents", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("392493621308469", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("392493621308469", "prohibitedSources", {
      "prohibitedSources": [{
        "domain": "649f8a2dbc936a5eb3ad83c55f4da09d44bc8c962ce80930fba49c3ad55629c8"
      }]
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("392493621308469", "ProhibitedSources", true);
    config.set("392493621308469", "unwantedData", {
      "blacklisted_keys": {
        "PageView": {
          "cd": [],
          "url": ["af_ip", "firstname", "lastname", "doBypass", "bv", "mip", "bfirstname", "admin_password2"]
        },
        "ViewContent": {
          "cd": [],
          "url": ["schemaver", "xt_ver"]
        }
      },
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("392493621308469", "UnwantedData", true);
    config.set("392493621308469", "IABPCMAEBridge", {
      "enableAutoEventId": false
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("392493621308469", "IABPCMAEBridge", true);
    config.set("392493621308469", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("392493621308469", "BrowserProperties", true);
    fbq.loadPlugin("estruleengine");
    instance.optIn("392493621308469", "ESTRuleEngine", true);
    fbq.set("estRules", "392493621308469", [{
      "condition": {
        "type": 1,
        "conditions": [{
          "targetType": 1,
      ...
      "condition": {
        ...
        "conditions": [{
          ...
          "operator": 2,
          "action": 2,
          "value": "https:\/\/www.fanduel.com\/"
        }]
      },
      "derived_event_name": "ViewContent",
      "transformations": [1],
      "rule_status": "ACTIVE",
      "rule_id": "295537225506137"
    }]);
    config.set("392493621308469", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("392493621308469", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("392493621308469", "LastExternalReferrer", true);
    instance.configLoaded("392493621308469");
  }
});
window.requestAnimationFrame = createEventWrapper('requestAnimationFrame', originalRequestAnimationFrame, ['Function']);
window.fetch = createEventWrapper('fetch', originalFetch, ['String']);
console.log = createEventWrapper('log', originalConsoleLog, ['any']);