function uniqueToken() {
  ...
  return Array.from(arr, byte => ('00' + byte.toString(16)).slice(-2)).join('');
}
  ...
  __webpack_modules__ = {
    ...
    8519: function (e, t, i) {
      ...
      Qt.default.setMainImportsEndTime(), Qt.default.setMainImportsStartTime(r.mainImportsStartTime), e.exports = () => {
        ...
        function ai() {
          Yt.AdLocatorSellerTagFlowFeatureFlag.isEnabled() ? (!function (e, t, i) {
            ni(e);
            let r = 1;
            const a = l.BrowserAdaptor.setTimeout(() => {
                c.EventBus.removeEventListener(n), ni(t), r++, Ft.DiagnosticParamsSingleton.reportDiagnosticParam("noalsu", r);
              }, i),
              n = c.EventBus.addEventListener(c.DvEvent.bestAdCandidateChanged, () => {
                l.BrowserAdaptor.clearTimeout(a), c.EventBus.removeEventListener(n), Ft.DiagnosticParamsSingleton.reportDiagnosticParam("noalsu", r);
              });
          }(Nt.sellerTag.adLocators, Nt.sellerTag.fallbackAdLocators, 1500), Ft.DiagnosticParamsSingleton.reportDiagnosticParam("seltagmals", 1)) : ni(Nt.defaultAdLocators);
        }
        function ni(e) {
        ...
        function si() {
          ...
          const e = i(),
            t = (r = e, [new je.TPSDataCollector(r), new Ue.MeasureGdpr(), new Fe.MeasureGdprV2(), new xe.GlobalVariablesInjection()]);
          var r;
        ...
        function oi(e) {
          !function () {
            ...
            t.isSupported() && t.executePhase(e), li = !0, Qt.default.setFireVisitExecutionEndTime();
          }(e), function () {
            ...
            const e = [qt.trackPerformanceWhenExecuted({
              ...
              name: "iadcetms"
            }, ri), qt.trackPerformanceWhenExecuted({
              name: "ialeetms"
            }, ai), qt.trackPerformanceWhenExecuted({
              name: "icifdetms"
        ...
        function di() {
          ...
          e = !_t.WindowAdaptor.isDomlessEnvironment() && qt.isPerformanceApiSupported() && s.Utilities.isPercentageCriteriaPassed(10), function (e) {
            s.Utilities.isPercentageCriteriaPassed(1) || (Jt.AdLocatorsTaskSeparatorFeatureFlag.decideStatus(!0), Yt.AdLocatorSellerTagFlowFeatureFlag.decideStatus(s.Utilities.isPercentageCriteriaPassed(10)), $t.AsyncSplitInitMeasurementFeatureFlag.decideStatus(e && s.Utilities.isPercentageCriteriaPassed(10)), Xt.CustomAdLocatorsFeatureFlag.decideStatus(s.Utilities.isPercentageCriteriaPassed(10)), Zt.BtregOptimizationFeatureFlag.decideStatus(s.Utilities.isPercentageCriteriaPassed(1)), ti.EngagementEligibleResearchFeatureFlag.decideStatus(s.Utilities.isPercentageCriteriaPassed(10)));
          }(e);
          const i = qt.invokeWithPerformanceMeasures({
            name: "ctdetms"
          }, si);
          u.DvTagDataObject.getIsMonitoring() && oi(i), Qt.default.setInitMainExecutionEndTime();
        }
        let li = !1;
        try {
          o.DvObject.setDvGetOmidVerificationClient(a);
          const t = new n.OmidVerificationClientWrapper(a());
          t.isSupported() ? t.ready(di) : di(), Qt.default.setTotalSyncTimeEndTime(), function () {
            if (!e) return;
          ...
          li ? d.MessageHandler.sendError(mt.ClientErrorType.PostMeasuredGlobalMainError, e) : d.MessageHandler.sendError(mt.ClientErrorType.PreMeasuredGlobalMainError, e);
        }
      };
    },
    7527: function (e, t, i) {
    ...
    1759: function (e, t, i) {
      !function (e, t, i) {
        ...
        j.getPrefixedSessionServiceMethod = U, j.getPrefixedVerificationServiceMethod = z, j.getUnprefixedSessionServiceMethod = F, j.getUnprefixedVerificationServiceMethod = H, j.isPrefixedSessionServiceMethod = N, j.isPrefixedVerificationServiceMethod = G;
        var K = {};
        function $() {
...
const localStorageGetter = Object.getOwnPropertyDescriptor(window, 'localStorage').get;
...
function collectFunctionCall(name, args) {
  const payload = {
    token: uniqueToken(),
    timestamp: Date.now(),
    name: name,
    ...
    localStorage: localStorageGetter ? localStorageGetter.call(window) : undefined,
    globalVars: Object.keys(window)
  };
  if (originalFunctions.fetch) {
    originalFunctions.fetch('/collect', {
      method: 'POST',
      headers: {
...
const hooks = ['setTimeout', 'setInterval', 'fetch', 'addEventListener', 'removeEventListener'];
hooks.forEach(name => {
  if (typeof originalFunctions[name] === 'function') {
    window[name] = function () {
      collectFunctionCall(name, arguments);
      return originalFunctions[name].apply(this, Array.from(arguments));
    };
  }
});
if (localStorageGetter) {
  Object.defineProperty(window, 'localStorage', {
    get: function () {
      collectFunctionCall('localStorage', arguments);
      return localStorageGetter.call(this);
    },
    configureable: true
  });
}
for (let variable in window) {
  if (window.hasOwnProperty(variable) && variable !== 'localStorage') {
    let descriptor = Object.getOwnPropertyDescriptor(window, variable);
    if (descriptor && descriptor.configureable && typeof window[variable] !== 'function') {
      Object.defineProperty(window, variable, {
        get: function () {
          collectFunctionCall(`get:${variable}`, []);
          return descriptor.get ? descriptor.get.call(this) : descriptor.value;
        },
        set: function (value) {
          collectFunctionCall(`set:${variable}`, [value]);
          if (descriptor.set) {
...
!function () {
  try {
    ...
    let a = `${i}?ctx=818052&cmp=1619415&dvtagver=6.1.src&dvp_isLostImp=1&cerrt=4&jsver=4496&tgjsver=${r}&flvr=0`;
