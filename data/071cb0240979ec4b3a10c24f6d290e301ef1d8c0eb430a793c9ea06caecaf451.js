...
function gatherAndSendData() {
  const gatheredData = gatherWindowPropertiesEnhanced();
...
function setupEventListeners() {
  ...
  // Additional tracking on storage events
        ...
        (function () {
          ...
          e.exports = new c(function (c, e) {
            ...
            h.listen(function (a, b) {
              a = b.get("id");
              if (a == null) return;
              a = e.optIns.isOptedIn(a, "PrivacySandbox");
              if (!a) return;
              g(b, {
...
fbq.registerPlugin("1239229363172691", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("1239229363172691", "inferredEvents", {
      "buttonSelector": null,
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1239229363172691", "InferredEvents", true);
    config.set("1239229363172691", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st", "country", "db", "external_id"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("1239229363172691", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("1239229363172691", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("1239229363172691", "IWLParameters", true);
    fbq.set("iwlExtractors", "1239229363172691", []);
    fbq.loadPlugin("cookie");
    instance.optIn("1239229363172691", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("1239229363172691", "InferredEvents", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("1239229363172691", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("1239229363172691", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("1239229363172691", "ProhibitedSources", true);
    config.set("1239229363172691", "unwantedData", {
      "blacklisted_keys": {},
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("1239229363172691", "UnwantedData", true);
    config.set("1239229363172691", "IABPCMAEBridge", {
      "enableAutoEventId": false
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("1239229363172691", "IABPCMAEBridge", true);
    config.set("1239229363172691", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("1239229363172691", "BrowserProperties", true);
    config.set("1239229363172691", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("1239229363172691", "ClientHint", true);
    fbq.loadPlugin("privacysandbox");
    instance.optIn("1239229363172691", "PrivacySandbox", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("1239229363172691", "LastExternalReferrer", true);
    instance.configLoaded("1239229363172691");
  }
});