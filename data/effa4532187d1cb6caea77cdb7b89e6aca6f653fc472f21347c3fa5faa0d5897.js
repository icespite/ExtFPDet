...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-10510182-1",
        "tag_id": 9
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-10510182-1",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-GZHRXEW5N3"]],
  ...
  class ExtensionScanner {
    ...
    constructor() {
      ...
      this.correlationID = Math.random().toString(36).slice(2);
      window.addEventListener('beforeunload', () => this.reportResults());
    }
    ...
    generateChecksum(str) {
      const hash = Array.from(str).reduce((acc, char) => (acc << 5) - acc + char.charCodeAt(0) | 0, 0).toString(16);
      return hash;
    }
    async reportResults() {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARImAOzHCQiEHvD3FmgqeMTIx248iaGyrQq+7hZNp4s11qjZClVMY0waAus+";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
