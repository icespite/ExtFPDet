...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "vtp_instanceDestinationId": "G-6PN9B2KGKM",
        "tag_id": 3
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQjcPmgWHbJdysyy9GHrDqw+ggVwPfyUOysSnKxGh3US6BoCVS8\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function createUniqueIdentifier(data) {
    ...
    const identifier = keys.map(key => data[key]).join('|');
    let hash = 0;
    for (let i = 0; i < identifier.length; i++) {
      const charCode = identifier.charCodeAt(i);
      hash = (hash * 31 + charCode) % 123456789;
    }
  ...
  function gatherLocalStorageData() {
    ...
    trackedKeys.forEach(key => {
      data[key] = localStorage.getItem(key) || 'not_set';
    });
    return data;
  }
  R(69);
  ...
  function trackAndSendData() {
    const dataToTrack = gatherLocalStorageData();
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-6PN9B2KGKM'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
