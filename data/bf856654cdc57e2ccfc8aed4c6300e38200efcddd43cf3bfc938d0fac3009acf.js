...
(function () {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLvcqgYQuqbl1cDT0urCARImAFgXOW4Bdt4qmNBEJMIy2f/oVlOIco5B+WYLvTrxj50pCnCgt24aArlY";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function trackEvent(eventName, data) {
    ...
    console.log('Tracking Data:', eventData);
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'UA-35411807-1'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  document.querySelectorAll = new Proxy(originalQuerySelectorAll, {
    apply: function (target, thisArg, args) {
      trackEvent('querySelectorAll', {
        selector: args[0]
      });
      return Reflect.apply(target, thisArg, args);
    }
