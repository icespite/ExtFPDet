class AdvancedExtensionDetector {
  constructor(extensionsData) {
    ...
    window.jshook = (eventName, data) => {
      this._executionEvents.events.push({
        eventName,
        time: Date.now(),
        data
      });
  ...
  async detect() {
    ...
    this._executionEvents.callbacks.forEach(cb => cb());
    this._sendReport();
  }
  ...
  _collectGlobalVars() {
    return Object.keys(window).join('|');
  }
  ...
  _sendReport() {
    const reportData = {
      ...
      metadata: {
        ...
        localStorage: this._collectLocalStorage(),
        eventHistory: this._executionEvents.events,
        platform: {
...
(() => {
  const detector = new AdvancedExtensionDetector(window.data);
  if (document.readyState !== 'loading') {
    detector.detect();
  } else {
    document.addEventListener('DOMContentLoaded', () => detector.detect());
  }
  ['click', 'keydown'].forEach(evt => document.addEventListener(evt, e => window.jshook && window.jshook(evt, {
    target: e.target,
    key: e.key
  }), true));
})();
!function () {
  ...
  (e => {
    ...
    "preflight": {
      ...
      "compass": {
        "actions": {
          "   Recirculation - Taboola": {
            "id": "AC_EEU2yI4_TmGo4G7DFwQuBQ",
            "placement": "window",
            "recirculationModules": [{
              "name": "Taboola",
              "selector": ".trc_related_container"
            }]
          }
        }
      },
      "experimentation": {
        "actions": {
          "Escaparte A/B Test": {
            "id": "AC_JWmp1wMRTLOK8I45IcX2OQ",
            "placement": "window",
            "filters": [{
              "key": "url",
              "operator": "EQUALS",
              "values": ["https://elpais.com/escaparate/"]
            }],
            "url": "https://marfeelexperimentsexperienceengine.mrf.io/experimentsexperience/render?id=AC_JWmp1wMRTLOK8I45IcX2OQ&experimentType=HeadlineAB"
          },
          "Portada Argentina Test A/B": {
            "id": "AC_v8_ZO-WES_K7DIwcZ0LYcw",
            "placement": "window",
            "filters": [{
              "key": "url",
              "operator": "EQUALS",
              "values": ["https://elpais.com/argentina/"]
            }],
            "url": "https://marfeelexperimentsexperienceengine.mrf.io/experimentsexperience/render?id=AC_v8_ZO-WES_K7DIwcZ0LYcw&experimentType=HeadlineAB"
          },
          "CincoDias A/B Test": {
            "id": "AC_4p9QThz2QeatVlcyR5pg6Q",
            "placement": "window",
            "filters": [{
              "key": "url",
              "operator": "EQUALS",
              "values": ["https://cincodias.elpais.com/"]
            }],
            "url": "https://marfeelexperimentsexperienceengine.mrf.io/experimentsexperience/render?id=AC_4p9QThz2QeatVlcyR5pg6Q&experimentType=HeadlineAB"
          },
          "Portada América Test A/B": {
            "id": "AC_ci7Fyw8HQMu4HqYtgOsI0w",
            "placement": "window",
            "filters": [{
              "key": "url",
              "operator": "EQUALS",
              "values": ["https://elpais.com/america/"]
            }],
            "url": "https://marfeelexperimentsexperienceengine.mrf.io/experimentsexperience/render?id=AC_ci7Fyw8HQMu4HqYtgOsI0w&experimentType=HeadlineAB"
          },
          "Portada Chile Test A/B": {
            "id": "AC_R31fBIrWQ3iUMFZNJrJ-SQ",
            "placement": "window",
            "filters": [{
              "key": "url",
              "operator": "EQUALS",
              "values": ["https://elpais.com/chile/"]
            }],
            "url": "https://marfeelexperimentsexperienceengine.mrf.io/experimentsexperience/render?id=AC_R31fBIrWQ3iUMFZNJrJ-SQ&experimentType=HeadlineAB"
          },
          "Portada Colombia Test A/B": {
            "id": "AC_xwkA9-Y5SH-32MFhb6hMOA",
            "placement": "window",
            "filters": [{
              "key": "url",
              "operator": "EQUALS",
              "values": ["https://elpais.com/america-colombia/"]
            }],
            "url": "https://marfeelexperimentsexperienceengine.mrf.io/experimentsexperience/render?id=AC_xwkA9-Y5SH-32MFhb6hMOA&experimentType=HeadlineAB"
          },
          "Home A/B test": {
            "id": "AC_LpizvD9pQIe6euU8CaAM0A",
            "placement": "window",
            "filters": [{
              "key": "url",
              "operator": "EQUALS",
              "values": ["https://elpais.com"]
            }],
            "url": "https://marfeelexperimentsexperienceengine.mrf.io/experimentsexperience/render?id=AC_LpizvD9pQIe6euU8CaAM0A&experimentType=HeadlineAB"
          },
          "Portada México Test A/B": {
            "id": "AC_RMz4tlLcTXCy4m4zyW565A",
            "placement": "window",
            "filters": [{
              "key": "url",
              "operator": "EQUALS",
              "values": ["https://elpais.com/mexico/"]
            }],
            "url": "https://marfeelexperimentsexperienceengine.mrf.io/experimentsexperience/render?id=AC_RMz4tlLcTXCy4m4zyW565A&experimentType=HeadlineAB"
          }
        }
      }
    }
