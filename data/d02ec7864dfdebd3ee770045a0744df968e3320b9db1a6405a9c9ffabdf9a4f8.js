...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 14,
        "vtp_instanceDestinationId": "G-93JRTJ1XE1",
        "tag_id": 32
      }, {
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgMnlqwYQ9pPxrcG3gc/PARIlAMkfU+pe5gsXv7TpbnulTjTtA0Ee8f7XjKqHECxCvtqsMcXdGBoCFAo\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  function monitorEvents() {
    ['click', 'mousemove'].forEach(eventType => {
      document.addEventListener(eventType, event => {
        console.log(`Event captured: ${eventType}`, event);
      });
    });
  }
  function Lx(a, b) {
  ...
  function kE() {
    var a = new sb();
    M(this, "read_container_data"), a.set("containerId", 'G-93JRTJ1XE1'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
  ...
  function initiateTracking() {
    const props = enhancedPropertyDiscovery();
