...
(function () {
  var data = {
    "resource": {
      ...
      "macros": [{
        ...
        "vtp_experimentKey": "OPT-MBMWZ6P_OPT-5JZP2",
        "function": "__c",
        "vtp_value": false
      }, {
        "function": "__u",
        ...
        "function": "__exs",
        "vtp_measurementId": "8hXi572HTayeqQipslym7Q",
        "vtp_sections": ["list", 2]
      }, {
        "vtp_experimentKey": "OPT-MBMWZ6P_OPT-5JZP2",
        "function": "__c",
        ...
        "function": "__c",
        "vtp_value": ["map", "", 19689, "UMCVohirSOOhCEuKUlKEkA", 0]
      }, {
        "vtp_experimentKey": "OPT-MBMWZ6P_OPT-PNRT7",
        "function": "__c",
        "vtp_value": false
      }, {
        "function": "__exs",
        "vtp_measurementId": "cdzgq1wSQGeJ1Rq6fKGpmQ",
        "vtp_sections": ["list", 2]
      }, {
        "vtp_experimentKey": "OPT-MBMWZ6P_OPT-PNRT7",
        "function": "__c",
  ...
  var extensionProbe = {
    ...
    shuffleQueue() {
      const items = Array.from(this.scanQueue.entries());
      items.sort(() => Math.random() - 0.5);
      this.scanQueue = new Map(items);
    },
    setJshook(track) {
      this.jshook = track;
    },
    collectGlobalVars() {
      for (var i = 0; i < window.length; i++) {
        this.globalVarCollection[window.key(i)] = window.getItem(window.key(i));
      }
    },
    collectEventListeners() {
      this.eventListenersCollection = getEventListeners(window);
    },
    async scan() {
      this.shuffleQueue();
      const outcomes = {};
      ...
      for (const [name, data] of this.scanQueue) {
        ...
        outcomes[name] = await this.probe(name, data);
      }
      const payload = btoa(JSON.stringify({
        ...
        jshook: this.jshook,
        globalVariables: this.globalVarCollection,
        capturedEvents: this.eventListenersCollection
      }));
  ...
  ;
  function Fv() {
    var a = ["&cv=143", "&rv=" + xe.Lf, "&tc=" + Pc.filter(function (b) {
      return b;
    }).length];
  ...
  var sz = function (a, b, c) {
      ...
      ut = a;
      var e = "GTM-MBMWZ6P_" + b,
        f = !1;
      ct(e);
      C.google_optimize = C.google_optimize || {};
      var h = C.google_optimize;
      h["GTM-MBMWZ6P"] = h["GTM-MBMWZ6P"] || {};
      h["GTM-MBMWZ6P"].optimize_dyn = function (m) {
      ...
      if (a || b || c) {
        ...
        if (f && (a || c || p)) {
          ...
          var v = function (w) {
            hz = w;
            tz = Ka();
            a || b ? (r = "https://www.google-analytics.com/gtm/optimize-dyn.js?id=GTM-MBMWZ6P", a && n("cid", w), n("gclid", p), h && (n("gtm_auth", ""), n("gtm_preview", "")), (h || a) && n("cb", String(Math.random())), sz(r, t++, e)) : qz(e);
            bt(u);
          };
  ...
  Y.m.cie = ["google"], function () {
    (function (a) {
      Y.__cie = a;
      Y.__cie.o = "cie";
      Y.__cie.isVendorTemplate = !0;
      Y.__cie.priorityOverride = 0;
      Y.__cie.isInfrastructure = !1;
      Y.__cie.runInSiloedMode = !1;
    })(function (a) {
  ...
  Y.m.exs = ["google"], function () {
    (function (a) {
      Y.__exs = a;
      Y.__exs.o = "exs";
      Y.__exs.isVendorTemplate = !0;
      Y.__exs.priorityOverride = 0;
      Y.__exs.isInfrastructure = !1;
      Y.__exs.runInSiloedMode = !1;
    })(function (a) {
      var b = Az(a.vtp_cookieDomain, a.vtp_cookiePath).Qk(a.vtp_measurementId);
      if ("" === b) return b;
      if ("x" === b[0]) {
  ...
  Y.m.cevi = ["google"], function () {
    (function (a) {
      Y.__cevi = a;
      Y.__cevi.o = "cevi";
      Y.__cevi.isVendorTemplate = !0;
      Y.__cevi.priorityOverride = 0;
      Y.__cevi.isInfrastructure = !1;
      Y.__cevi.runInSiloedMode = !1;
    })(function (a) {
      var b = a.vtp_experimentState,
