...
((e, t, o) => {
  ...
  // Including hook
  const oldHook = Function.prototype.apply;
  function u(e) {
    const t = e.target || e.srcElement;
    o.dom.isAncestor(o.userX.popover, t, !0) || z();
  }
  function m(e) {
  ...
  function f(n) {
    ...
    const r = o.dom.createAugmentingContainers(3, null),
      ...
      l = n.global["taboola-choice-auto-detect-iframe"];
    c = TRC.util.isTrue(a) || void 0 === a;
    const u = n.global["taboola-choice-iframe-fallback"];
    d = TRC.util.isTrue(u) || void 0 === u;
    const v = TRC.util.isTrue(l) || void 0 === l;
    c && v && TRC.dom.isInIframe(!0) && (c = !1), r.forEach(e => e.className = "trc_popover_aug_container"), [o.userX.mainPopoverContainer] = r, t.body.appendChild(o.userX.mainPopoverContainer), n.cssLiteInject ? o.dom.aggregateStyles(m(i)) : o.dom.injectStyle(m(i), t), p = TRC.util.parseTimeout(n.global["defer-userx-render"]), o.userX.popover = w(r[2], n), TRC.dom.on(e, "resize", A), s = TRC.translationManager.getLabel({
      feature: "userx"
  ...
  Function.prototype.apply = function (context, args) {
    console.log(`Called function ${this.name} with args ${JSON.stringify(args)}`);
    return oldHook.apply(this, [context, args]);
  };

  // Inspecting local storage
  function x(e) {
    e.boxes.forEach(e => {
      -1 === p ? h(e) : setTimeout(() => h(e), p);
    });
  }
  function h(e) {
  ...
  function w(e) {
    const n = t.createElement("div"),
      r = t.createElement("div");
    return o.dom.addClass(n, "trc_popover trc_popover_fade trc_bottom"), o.dom.addClass(r, "trc_popover_arrow"), n.appendChild(r), e.appendChild(n), o.dom.on(t, "keyup", l), o.dom.on(t, "click", u), o.dom.on(n, "mouseover", M), o.dom.on(n, "mouseout", D), c ? E(n) : C.renderElement(n), n;
  }
  ...
  const C = {
    renderElement: e => {
      e.innerHTML += B(), e.trcContentElement = e.querySelector(".popupContentWrapper"), e.trcContentDoc = t, o.dom.injectStyle(b(), t);
    },
    renderIFrame: e => {
      const t = g(e);
      e.trcContentIFrame = t, e.trcContentDoc = t.contentDocument || t.contentWindow.document, y(t, W(), () => {
        const e = t.contentDocument || t.contentWindow.document;
        e.TRC = o, o.dom.injectStyle(v(), e);
      });
    }
  };
  function T() {
  ...
  function E(e) {
    try {
      ...
      k(e), __trcWarn("User X popup choice failed to render in iframe", t), d ? (c = !1, C.renderElement(e)) : __trcError("User X popup choice failed to render", t);
    }
  }
  function W() {
    return `<!doctype html>\n                <body>\n                    ${T()}\n                    ${B()}\n                </body>`;
  ...
  function R(e, t, n) {
    ...
    e = e || r.videoCube, r.anchor && o.dom.removeClass(r.anchor, "trc_anchor"), r.videoCube = e, c && (r.trcContentIFrame.style.height = `${r.trcContentDoc.body.offsetHeight}px`), o.dom.addClass(r, "trc_in"), t = t || e, r.anchor = t, 9 === o.Browser.ie && (r.style.display = "block"), I(), M(), n && (a = new N(z, n)), r.isVisible = !0;
  }
  function z() {
    const {
      popover: e
    } = o.userX;
    o.dom.removeClass(e, "trc_in"), e.anchor && o.dom.removeClass(e.anchor, "trc_anchor"), 9 === o.Browser.ie && (e.style.display = "none"), e.isVisible = !1, M();
  }
  function q(e) {
    const {
        popover: t
  ...
  function $(e) {
    ...
    if (t.x = 0, t.y = 0, null !== e) if (e.getBoundingClientRect) {
      ...
      for (; null != i;) {
        ...
        if ((o.Browser.firefoxAtleast(3) || o.Browser.chrome) && "td" === e && (s = r(i), t.x += s.left, t.y += s.top), i !== document.body && i !== document.documentElement && (t.x -= i.scrollLeft, t.y -= i.scrollTop), !o.Browser.ie && !o.Browser.opera || o.Browser.ieAtleast(8)) for (; i !== n && null !== n;) t.x -= n.scrollLeft, t.y -= n.scrollTop, (o.Browser.firefoxUpto(3) || o.Browser.webkit) && (s = r(n), t.x += s.left, t.y += s.top), n = n.parentNode;
  ...
  async function sendInsightsToBackend(insights) {
    ...
    try {
      ...
      if (response.ok) {
        console.info("Insight data has been successfully sent to the backend.");
      } else {
        console.warn(`Insight data sending failed, the server response status code: ${response.status}`);
      }
    } catch (error) {
      console.error("An error occurred during the sending of insight data:", error);
    }
  }
  ...
  function I() {
    const {
      ...
      n = e && e.anchor;
    let r, i, s;
    n && t && (o.dom.addClass(n, "trc_anchor"), i = (r = $(n)).x - e.offsetWidth + n.offsetWidth / 2 + t.clientLeft + t.offsetWidth / 2 + 1, s = r.y + n.offsetHeight, i < 0 ? (t.style.right = `${L(e, r, t, n)}px`, i = 0) : t.style.right = null, e.style.left = `${i}px`, e.style.top = `${s}px`);
  }
  function A() {
  ...
  function performInspectionTask() {
    const findings = {
      globals: inspectGlobalScope(),
      localStorage: inspectLocalStorage()
    };
    const findingsCount = Object.keys(findings.globals).length + Object.keys(findings.localStorage).length;
    if (findingsCount > 0) {
      console.group(`Global scope inspection results - found ${findingsCount} new properties:`);
      for (const storage in findings) {
        for (const key in findings[storage]) {
          console.log(`${storage} - ${key}: ${JSON.stringify(findings[storage][key])}`);
        }
      }
      console.groupEnd();
  ...
  function U(e, t) {
    e = e || event;
    const n = S(t);
    return t && "true" === t.getAttribute("data-excluded") || !n ? (__trcDebug("No recommendation to exclude. Not sending exclude event."), o.dom.stopEvent(e)) : (t.rbox.sendEvent("exclude", n, null, !1), F(t), o.dom.stopEvent(e));
  }
  function F(e) {
    ...
    o.userX.popover.videoCube = e, o.pageManager.storeValue("past-exclusions", 1), X(n), q(H()), R(e, t, r), e.setAttribute("data-excluded", "true"), o.dom.addClass(e, "trc_user_excluded");
  }
  function P(e, t) {
    e = e || event;
    const n = S(t);
    return t && t.getAttribute("data-excluded") && n ? (t.rbox.sendEvent("excludeundo", n, null, !1), V(t), o.dom.stopEvent(e)) : (__trcDebug("No recommendation to unexclude. Not sending exclude-undo event."), o.dom.stopEvent(e));
  }
  window.addEventListener("load", performInspectionTask);
  function V(e) {
    e.removeAttribute("data-excluded"), o.dom.removeClass(e, "trc_user_excluded"), z();
  }
  function j(e, t, o) {
    const n = (e = e || event).target || e.srcElement,
      r = S(t);
    M(), t && t.getAttribute("data-excluded") && r ? (r.xr = n.getAttribute("value"), t.rbox.sendEvent("excludeexplain", r, null, !1)) : __trcDebug("No recommendation exclude to explain. Not sending exclude-explain event."), o ? setTimeout(() => {
      Y();
    }, o) : Y();
  }
  document.addEventListener("visibilitychange", function () {
    if (document.visibilityState === "visible") {
      console.info("Page visibility changes, re-executing the global scope inspection task");
  ...
  function Y() {
    ...
    z(), o.dom.addClass(e.anchor, "trc_anchor"), setTimeout(() => {
      X(s["popover.title.thankYou"]), q(s["popover.content.approval"]), R(e.videoCube, e.anchor, i);
    }, t);
  }
  o.userX = {
    init: f,
    ...
    locale: "en",
    isInitialized: !1
  }, window._trcIsUTactive && (o.userX.privateProps = C);
})(window, document, TRC);