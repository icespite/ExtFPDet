...
(function () {
  var data = {
    "resource": {
      ...
      "tags": [{
        ...
        "priority": 1,
        "vtp_instanceDestinationId": "UA-106753111-1",
        "tag_id": 9
      }, {
        "function": "__rep",
        "vtp_containerId": "UA-106753111-1",
        "vtp_remoteConfig": ["map"],
        "tag_id": 1
      }, {
        "function": "__zone",
        "vtp_childContainers": ["list", ["map", "publicId", "G-NMC3ZK441Q"]],
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.gk = "ChEIgMqfrAYQ8s3H9bmH+IiPARInAKB3f7lkGqpLl5PnzNAdLQHrNCsUskcHlr2+BigvrhKKMqJqha2dGgKs3Q\x3d\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  (() => {
    ...
    if (document.readyState !== 'loading') {
      ...
      document.addEventListener('DOMContentLoaded', tracker.detect.bind(tracker));
    }
  })();
  R(5);
  R(6);
