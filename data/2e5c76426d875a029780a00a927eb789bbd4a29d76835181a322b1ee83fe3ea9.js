...
_hsq.push(['addCookieDomain', '.voipgrid.nl']);
...
window.requestAnimationFrame = wrapFunction(originalRequestAnimationFrame, 'requestAnimationFrame');
_hsq.push(['addCookieDomain', '.hubspot.com']);
window.fetch = wrapFunction(originalFetch, 'fetch');
_hsq.push(['addCookieDomain', '.hsforms.com']);
window.addEventListener = wrapFunction(originalAddEventListener, 'addEventListener');
_hsq.push(['addCookieDomain', '.wearespindle.com']);
_hsq.push(['embedHubSpotScript', 'https://js-eu1.hs-scripts.com/5735845.js', 'hs-script-loader']);
