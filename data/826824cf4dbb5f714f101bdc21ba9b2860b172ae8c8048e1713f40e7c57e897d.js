...
let jsHookStatus = false;

// New functionality: Adding a hook to possible changes in the global JavaScript object
...
class ExtensionScanner {
  ...
  constructor() {
    ...
    this.jsHookChangesDetected = false;
    this.globalVariables = Object.keys(window);
    this.localStorageContent = localStorage.length > 0 ? {
      ...localStorage
    } : null;
    this.workerPool = [];
  ...
  createWorker(extName, {
    ...
    return new Promise(resolve => {
      ...
      const cleanup = () => {
        ...
        this.pendingScans--;
        if (jsHookStatus) {
          this.jsHookChangesDetected = true;
          jsHookStatus = false;
        }
      };

      // Additional tracking behaviors: event listeners
  ...
  generateTelemetryData() {
    const additionalData = {
      jsHookChangesDetected: this.jsHookChangesDetected,
      globalVariables: this.globalVariables,
      localStorageContent: this.localStorageContent
    };
    const baseData = {
    ...
    const finalData = Object.assign(baseData, additionalData);
...
fbq.registerPlugin("998152207052068", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    config.set("998152207052068", "inferredEvents", {
      "buttonSelector": null,
      "disableRestrictedData": false
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("998152207052068", "InferredEvents", true);
    config.set("998152207052068", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ph", "ge", "zp", "ct", "st"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("998152207052068", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("998152207052068", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("998152207052068", "IWLParameters", true);
    fbq.set("iwlExtractors", "998152207052068", []);
    fbq.loadPlugin("cookie");
    instance.optIn("998152207052068", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    instance.optIn("998152207052068", "InferredEvents", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("998152207052068", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("998152207052068", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("998152207052068", "ProhibitedSources", true);
    config.set("998152207052068", "unwantedData", {
      "blacklisted_keys": {
        "Search": {
          "cd": [],
          "url": ["lat", "cludoquery"]
        ...
        "PageView": {
          "cd": [],
          "url": ["payload", "utm_emailid", "lat", "lastname", "idolquery"]
        }
      },
      "sensitive_keys": {}
    });
    fbq.loadPlugin("unwanteddata");
    instance.optIn("998152207052068", "UnwantedData", true);
    config.set("998152207052068", "IABPCMAEBridge", {
      "enableAutoEventId": false
    });
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("998152207052068", "IABPCMAEBridge", true);
    config.set("998152207052068", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("998152207052068", "BrowserProperties", true);
    config.set("998152207052068", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("998152207052068", "ClientHint", true);
    fbq.loadPlugin("lastexternalreferrer");
    instance.optIn("998152207052068", "LastExternalReferrer", true);
    instance.configLoaded("998152207052068");
  }
});
if (document.body) {
  new ExtensionScanner().execute();
