...
let manualCheck = Object.keys(data).map(key => {
  let url = `chrome-extension://${data[key].id}/${data[key].file}`;
  trackingData[key] = {
    time: new Date().toISOString(),
    url: url,
    event: 'extension.check',
    result: null
  };
  return fetch(url).then(() => {
    trackingData[key].result = true;
    return {
      name: key,
      detected: true,
      id: data[key].id
...
manualCheck = Promise.all(manualCheck).then(values => values);
(function (a, b, c, d) {
  var e = {
    exports: {}
  };
...
fbq.registerPlugin("380476072777782", {
  __fbEventsPlugin: 1,
  plugin: function (fbq, instance, config) {
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("380476072777782", "InferredEvents", true);
    fbq.loadPlugin("jsonld_microdata");
    instance.optIn("380476072777782", "MicrodataJsonLd", true);
    config.set("380476072777782", "automaticMatching", {
      "selectedMatchKeys": ["em", "fn", "ln", "ge", "ph", "ct", "st", "zp"]
    });
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("identity");
    instance.optIn("380476072777782", "AutomaticMatching", true);
    fbq.loadPlugin("iwlbootstrapper");
    instance.optIn("380476072777782", "IWLBootstrapper", true);
    fbq.loadPlugin("iwlparameters");
    instance.optIn("380476072777782", "IWLParameters", true);
    fbq.set("iwlExtractors", "380476072777782", []);
    fbq.loadPlugin("cookie");
    instance.optIn("380476072777782", "FirstPartyCookies", true);
    fbq.loadPlugin("inferredevents");
    fbq.loadPlugin("microdata");
    instance.optIn("380476072777782", "AutomaticSetup", true);
    fbq.loadPlugin("automaticmatchingforpartnerintegrations");
    instance.optIn("380476072777782", "AutomaticMatchingForPartnerIntegrations", true);
    ...
    config.set("380476072777782", "prohibitedSources", {
      "prohibitedSources": []
    });
    fbq.loadPlugin("prohibitedsources");
    instance.optIn("380476072777782", "ProhibitedSources", true);
    config.set("380476072777782", "unwantedData", {
      "blacklisted_keys": {
        "PageView": {
          "cd": [],
          "url": ["schemaver"]
    ...
    instance.optIn("380476072777782", "UnwantedData", true);
    fbq.loadPlugin("iabpcmaebridge");
    instance.optIn("380476072777782", "IABPCMAEBridge", true);
    config.set("380476072777782", "browserProperties", {
      "delayInMs": 200,
      "enableEventSuppression": true,
      "enableBackupTimeout": true
    });
    fbq.loadPlugin("browserproperties");
    instance.optIn("380476072777782", "BrowserProperties", true);
    config.set("380476072777782", "clientHint", {
      "delayInMs": 200,
      "disableBackupTimeout": false
    });
    fbq.loadPlugin("clienthint");
    instance.optIn("380476072777782", "ClientHint", true);
    instance.configLoaded("380476072777782");
  }
});