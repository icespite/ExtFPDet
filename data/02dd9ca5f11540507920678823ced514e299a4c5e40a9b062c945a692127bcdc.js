...
(function () {
  ...
  function observeLocalStorage() {
    ...
    localStorage.setItem = function (key, value) {
      let event = new CustomEvent('localStorageChange', {
        detail: {
          key: key,
          value: value
        }
  ...
  ni.oe = Number("0") || 0;
  ni.ia = "dataLayer";
  ni.fk = "ChEIgOm8qgYQu/+2jPSy9oOgARIkAOg6TnRVQRFcafRWvAK1U9wUvxnRypBqRwA9KCFcGWYSPkiPGgKT+w\x3d\x3d";
  var qi = {
      __cl: 1,
      __ecl: 1,
      __ehl: 1,
  ...
  // Function to interact with global variables
  ...
  // Function to detect installed extensions
  ...
  function hE() {
    var a = new sb();
    N(this, "read_container_data"), a.set("containerId", 'DC-11992325'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
    return a;
  }
